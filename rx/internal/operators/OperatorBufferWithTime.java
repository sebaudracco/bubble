...
public final class OperatorBufferWithTime<T> implements Observable$Operator<List<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        class C70991 implements Action0 {
            C70991() {
            }
        ...
        void scheduleExact() {
            this.inner.schedulePeriodically(new C70991(), OperatorBufferWithTime.this.timespan, OperatorBufferWithTime.this.timespan, OperatorBufferWithTime.this.unit);
        }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        class C71001 implements Action0 {
            C71001() {
            }
        ...
        void scheduleChunk() {
            this.inner.schedulePeriodically(new C71001(), OperatorBufferWithTime.this.timeshift, OperatorBufferWithTime.this.timeshift, OperatorBufferWithTime.this.unit);
        }
