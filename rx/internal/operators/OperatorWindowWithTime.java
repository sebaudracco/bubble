...
public final class OperatorWindowWithTime<T> implements Observable$Operator<Observable<T>, T> {
    ...
    final class ExactSubscriber extends Subscriber<T> {
        ...
        class C72042 implements Action0 {
            C72042() {
            }
        ...
        void scheduleExact() {
            this.worker.schedulePeriodically(new C72042(), 0, OperatorWindowWithTime.this.timespan, OperatorWindowWithTime.this.unit);
        }
    ...
    final class InexactSubscriber extends Subscriber<T> {
        ...
        class C72051 implements Action0 {
            C72051() {
            }
        ...
        void scheduleChunk() {
            this.worker.schedulePeriodically(new C72051(), OperatorWindowWithTime.this.timeshift, OperatorWindowWithTime.this.timeshift, OperatorWindowWithTime.this.unit);
        }
