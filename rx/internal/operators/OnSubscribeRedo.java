...
public final class OnSubscribeRedo<T> implements Observable$OnSubscribe<T> {
    static final Func1<Observable<? extends Notification<?>>, Observable<?>> REDO_INFINITE = new C70741();
    ...
    static class C70741 implements Func1<Observable<? extends Notification<?>>, Observable<?>> {

        class C70731 implements Func1<Notification<?>, Notification<?>> {
            C70731() {
            }
        ...
        public Observable<?> call(Observable<? extends Notification<?>> ts) {
            return ts.map(new C70731());
        }
    }

    class C70783 implements Observable$Operator<Notification<?>, Notification<?>> {
        C70783() {
        }
    ...
    public static final class RedoFinite implements Func1<Observable<? extends Notification<?>>, Observable<?>> {
        ...
        class C70821 implements Func1<Notification<?>, Notification<?>> {
            int num;
        ...
        public Observable<?> call(Observable<? extends Notification<?>> ts) {
            return ts.map(new C70821()).dematerialize();
        }
    }
    ...
    public static final class RetryWithPredicate implements Func1<Observable<? extends Notification<?>>, Observable<? extends Notification<?>>> {
        ...
        class C70831 implements Func2<Notification<Integer>, Notification<?>, Notification<Integer>> {
            C70831() {
            }
        ...
        public Observable<? extends Notification<?>> call(Observable<? extends Notification<?>> ts) {
            return ts.scan(Notification.createOnNext(Integer.valueOf(0)), new C70831());
        }
    }
    ...
    public void call(Subscriber<? super T> child) {
        ...
        Action0 subscribeToSource = new Action0() {
            ...
            class C70751 extends Subscriber<T> {
                boolean done;
            ...
            public void call() {
                if (!subscriber.isUnsubscribed()) {
                    Subscriber<T> terminalDelegatingSubscriber = new C70751();
        ...
        final Observable<?> restarts = (Observable) this.controlHandlerFunction.call(terminals.lift(new C70783()));
