...
public abstract class AppleDataBox extends AbstractBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        ...
        ajc$tjp_0 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig(SchemaSymbols.ATTVAL_TRUE_1, "getLanguageString", "com.googlecode.mp4parser.boxes.apple.AppleDataBox", "", "", "", "java.lang.String"), 25);
        ajc$tjp_1 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig(SchemaSymbols.ATTVAL_TRUE_1, "getDataType", "com.googlecode.mp4parser.boxes.apple.AppleDataBox", "", "", "", SchemaSymbols.ATTVAL_INT), 43);
        ajc$tjp_2 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig(SchemaSymbols.ATTVAL_TRUE_1, "getDataCountry", "com.googlecode.mp4parser.boxes.apple.AppleDataBox", "", "", "", SchemaSymbols.ATTVAL_INT), 47);
        ajc$tjp_3 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig(SchemaSymbols.ATTVAL_TRUE_1, "setDataCountry", "com.googlecode.mp4parser.boxes.apple.AppleDataBox", SchemaSymbols.ATTVAL_INT, "dataCountry", "", "void"), 51);
        ajc$tjp_4 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig(SchemaSymbols.ATTVAL_TRUE_1, "getDataLanguage", "com.googlecode.mp4parser.boxes.apple.AppleDataBox", "", "", "", SchemaSymbols.ATTVAL_INT), 55);
        ajc$tjp_5 = factory.makeSJP(JoinPoint.METHOD_EXECUTION, factory.makeMethodSig(SchemaSymbols.ATTVAL_TRUE_1, "setDataLanguage", "com.googlecode.mp4parser.boxes.apple.AppleDataBox", SchemaSymbols.ATTVAL_INT, "dataLanguage", "", "void"), 59);
    }
    ...
    static {
        ajc$preClinit();
        language.put(SchemaSymbols.ATTVAL_FALSE_0, "English");
        language.put(SchemaSymbols.ATTVAL_TRUE_1, "French");
