    ...
    public static Entry parseCacheHeaders(NetworkResponse response) {
        ...
        if (headerValue != null) {
            ...
            for (String trim : tokens) {
                ...
                if (token.equals(HeaderConstants.CACHE_CONTROL_NO_CACHE) || token.equals(HeaderConstants.CACHE_CONTROL_NO_STORE)) {
                    return null;
                }
                ...
                } else if (token.equals(HeaderConstants.CACHE_CONTROL_MUST_REVALIDATE) || token.equals(HeaderConstants.CACHE_CONTROL_PROXY_REVALIDATE)) {
                    maxAge = 0;
                }
            }
        }
