...
*/
        ...
        L_0x0247:
            ...
            goto L_0x0052;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.core42matters.android.registrar.Base64.Encoder.process(byte[], int, int, boolean):boolean");
        }
    }
    ...
    public static String encodeToString(byte[] input, int flags) {
        try {
            return new String(encode(input, flags), "US-ASCII").trim();
