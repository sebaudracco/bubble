...
class NotificationOpenedProcessor {
    ...
    private static void addChildNotifications(JSONArray dataArray, String summaryGroup, SQLiteDatabase writableDb) {
        ...
        Cursor cursor = sQLiteDatabase.query("notification", new String[]{NotificationTable.COLUMN_NAME_FULL_DATA}, "group_id = ? AND dismissed = 0 AND opened = 0 AND is_summary = 0", new String[]{summaryGroup}, null, null, null);
    ...
    private static void markNotificationsConsumed(Context context, Intent intent, SQLiteDatabase writableDb) {
        ...
        writableDb.update("notification", newContentValuesWithConsumed(intent), whereStr, whereArgs);
