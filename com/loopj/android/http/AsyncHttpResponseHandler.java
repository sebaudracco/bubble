...
public abstract class AsyncHttpResponseHandler implements ResponseHandlerInterface {
    ...
    public void setUseSynchronousMode(boolean sync) {
        if (!sync && this.looper == null) {
            sync = true;
            AsyncHttpClient.log.mo6463w(LOG_TAG, "Current thread has not called Looper.prepare(). Forcing synchronous mode.");
        }
    ...
    public void onProgress(long bytesWritten, long totalSize) {
        ...
        objArr[2] = Double.valueOf(totalSize > 0 ? ((((double) bytesWritten) * MoPubAdapter.DEFAULT_MOPUB_IMAGE_SCALE) / ((double) totalSize)) * 100.0d : -1.0d);
        logInterface.mo6461v(str, String.format(str2, objArr));
    }
    ...
    public void onRetry(int retryNo) {
        AsyncHttpClient.log.mo6450d(LOG_TAG, String.format("Request retry no. %d", new Object[]{Integer.valueOf(retryNo)}));
    }

    public void onCancel() {
        AsyncHttpClient.log.mo6450d(LOG_TAG, "Request got cancelled");
    }

    public void onUserException(Throwable error) {
        AsyncHttpClient.log.mo6453e(LOG_TAG, "User-space exception detected!", error);
            ...
            switch (message.what) {
                case 0:
                    ...
                    if (response == null || response.length < 3) {
                        AsyncHttpClient.log.mo6452e(LOG_TAG, "SUCCESS_MESSAGE didn't got enough params");
                        return;
                    } else {
                ...
                case 1:
                    ...
                    if (response == null || response.length < 4) {
                        AsyncHttpClient.log.mo6452e(LOG_TAG, "FAILURE_MESSAGE didn't got enough params");
                        return;
                    } else {
                ...
                case 4:
                    ...
                    if (response == null || response.length < 2) {
                        AsyncHttpClient.log.mo6452e(LOG_TAG, "PROGRESS_MESSAGE didn't got enough params");
                        return;
                    } else {
                ...
                case 5:
                    ...
                    if (response == null || response.length != 1) {
                        AsyncHttpClient.log.mo6452e(LOG_TAG, "RETRY_MESSAGE didn't get enough params");
                        return;
                    } else {
