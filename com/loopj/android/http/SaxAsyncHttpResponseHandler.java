        ...
        if (entity != null) {
            ...
            if (instream != null) {
                try {
                    ...
                    InputStreamReader inputStreamReader2 = new InputStreamReader(instream, getCharset());
                    try {
                        ...
                        try {
                            AsyncHttpClient.log.mo6453e(LOG_TAG, "getResponseData exception", e);
                            AsyncHttpClient.silentCloseInputStream(instream);
                        ...
                        e2 = e7;
                        inputStreamReader = inputStreamReader2;
                        AsyncHttpClient.log.mo6453e(LOG_TAG, "getResponseData exception", e2);
                        AsyncHttpClient.silentCloseInputStream(instream);
                        if (inputStreamReader != null) {
                            try {
                                inputStreamReader.close();
