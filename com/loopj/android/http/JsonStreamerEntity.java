...
public class JsonStreamerEntity implements HttpEntity {
    ...
    private static final byte[] JSON_FALSE = SchemaSymbols.ATTVAL_FALSE.getBytes();
    private static final byte[] JSON_NULL = "null".getBytes();
    private static final byte[] JSON_TRUE = SchemaSymbols.ATTVAL_TRUE.getBytes();
    ...
    public void writeTo(OutputStream out) throws IOException {
        ...
        if (keysCount > 0) {
            ...
            AsyncHttpClient.log.mo6455i(LOG_TAG, "Uploaded JSON in " + Math.floor((double) (elapsedTime / 1000)) + " seconds");
        }
        os.write(125);
        os.flush();
