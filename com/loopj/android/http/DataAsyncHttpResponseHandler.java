...
public abstract class DataAsyncHttpResponseHandler extends AsyncHttpResponseHandler {
    ...
    public void onProgressData(byte[] responseBody) {
        AsyncHttpClient.log.mo6450d(LOG_TAG, "onProgressData(byte[]) was not overriden, but callback was received");
    }
        ...
        switch (message.what) {
            case 7:
                ...
                if (response == null || response.length < 1) {
                    AsyncHttpClient.log.mo6452e(LOG_TAG, "PROGRESS_DATA_MESSAGE didn't got enough params");
                    return;
                }
                try {
                    ...
                    AsyncHttpClient.log.mo6453e(LOG_TAG, "custom onProgressData contains an error", t);
                    return;
                }
            default:
                return;
