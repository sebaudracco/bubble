            ...
            Runnable parser = new Runnable() {
                public void run() {
                    try {
                        ...
                        AsyncHttpClient.log.mo6451d(BaseJsonHttpResponseHandler.LOG_TAG, "parseResponse thrown an problem", t);
                        BaseJsonHttpResponseHandler.this.postRunnable(new Runnable() {
                            public void run() {
    ...
    public final void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
        if (responseString != null) {
            ...
            Runnable parser = new Runnable() {
                ...
                class C33602 implements Runnable {
                    C33602() {
                    }
                ...
                public void run() {
                    try {
                        ...
                        AsyncHttpClient.log.mo6451d(BaseJsonHttpResponseHandler.LOG_TAG, "parseResponse thrown an problem", t);
                        BaseJsonHttpResponseHandler.this.postRunnable(new C33602());
                    }
                }
            };
            if (getUseSynchronousMode() || getUsePoolThread()) {
