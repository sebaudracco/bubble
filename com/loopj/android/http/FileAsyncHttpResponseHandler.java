...
public abstract class FileAsyncHttpResponseHandler extends AsyncHttpResponseHandler {
    ...
    public FileAsyncHttpResponseHandler(File file, boolean append, boolean renameTargetFileIfExists, boolean usePoolThread) {
        ...
        if (file.isDirectory() && !file.mkdirs()) {
            AsyncHttpClient.log.mo6450d(LOG_TAG, "Cannot create directories for requested Directory location, might not be a problem");
        }
        this.file = file;
        this.append = append;
    ...
    protected File getTemporaryFile(Context context) {
        ...
        try {
            ...
            AsyncHttpClient.log.mo6453e(LOG_TAG, "Cannot create temporary file", e);
            return null;
        }
    }
