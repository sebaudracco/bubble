...
class SimpleMultipartEntity implements HttpEntity {
    ...
    private class FilePart {
        ...
        private byte[] createHeader(String key, String filename, String type) {
            ...
            try {
                ...
                AsyncHttpClient.log.mo6453e(SimpleMultipartEntity.LOG_TAG, "createHeader ByteArrayOutputStream exception", e);
            }
    ...
    public void addPart(String key, String value, String contentType) {
        try {
            ...
            AsyncHttpClient.log.mo6453e(LOG_TAG, "addPart ByteArrayOutputStream exception", e);
        }
    }
