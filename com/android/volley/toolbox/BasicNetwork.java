...
public class BasicNetwork implements Network {
    ...
    L_0x0129:
        ...
        r7 = r28.getUrl();
        r4[r5] = r7;
        com.android.volley.VolleyLog.m1817e(r3, r4);
    L_0x0140:
    ...
    protected void logError(String what, String url, long start) {
        ...
        VolleyLog.m1819v("HTTP ERROR(%s) %d ms to fetch %s", what, Long.valueOf(now - start), url);
    }
    ...
    private byte[] entityToBytes(HttpEntity entity) throws IOException, ServerError {
        ...
        try {
            ...
            try {
                ...
                VolleyLog.m1819v("Error occured when calling consumingContent", new Object[0]);
            }
