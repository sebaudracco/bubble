...
public class JsonArrayRequest extends JsonRequest<JSONArray> {
    ...
    protected Response<JSONArray> parseNetworkResponse(NetworkResponse response) {
        try {
            return Response.success(new JSONArray(new String(response.data, HttpHeaderParser.parseCharset(response.headers, AudienceNetworkActivity.WEBVIEW_ENCODING))), HttpHeaderParser.parseCacheHeaders(response));
        } catch (Throwable e) {
