...
final class Utils {
    ...
    static boolean parseResponseSourceHeader(String header) {
        ...
        try {
            if (!("CONDITIONAL_CACHE".equals(parts[0]) && Integer.parseInt(parts[1]) == HttpStatus.SC_NOT_MODIFIED)) {
                z = false;
            }
            return z;
    ...
    static int calculateMemoryCacheSize(Context context) {
        ActivityManager am = (ActivityManager) getService(context, C1404b.aw);
