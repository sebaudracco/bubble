...
public class JsonReader implements Closeable {
    ...
    static class C28711 extends JsonReaderInternalAccess {
        C28711() {
        }
    ...
    static {
        JsonReaderInternalAccess.INSTANCE = new C28711();
    }
    ...
    private int peekKeyword() throws IOException {
        ...
        String keywordUpper;
        if (c == 't' || c == 'T') {
            keyword = SchemaSymbols.ATTVAL_TRUE;
            keywordUpper = "TRUE";
            peeking = 5;
        } else if (c == 'f' || c == 'F') {
            keyword = SchemaSymbols.ATTVAL_FALSE;
            keywordUpper = "FALSE";
            peeking = 6;
        } else if (c != 'n' && c != 'N') {
            return 0;
