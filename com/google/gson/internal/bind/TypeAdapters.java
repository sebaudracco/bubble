...
public final class TypeAdapters {
    public static final TypeAdapter<AtomicBoolean> ATOMIC_BOOLEAN = new C28709().nullSafe();
    public static final TypeAdapterFactory ATOMIC_BOOLEAN_FACTORY = newFactory(AtomicBoolean.class, ATOMIC_BOOLEAN);
    public static final TypeAdapter<AtomicInteger> ATOMIC_INTEGER = new C28698().nullSafe();
    ...
    public static final TypeAdapter<BitSet> BIT_SET = new C28622();
    public static final TypeAdapterFactory BIT_SET_FACTORY = newFactory(BitSet.class, BIT_SET);
    public static final TypeAdapter<Boolean> BOOLEAN = new C28643();
    public static final TypeAdapter<Boolean> BOOLEAN_AS_STRING = new C28654();
    public static final TypeAdapterFactory BOOLEAN_FACTORY = newFactory(Boolean.TYPE, Boolean.class, BOOLEAN);
    public static final TypeAdapter<Number> BYTE = new C28665();
    ...
    public static final TypeAdapter<Class> CLASS = new C28601();
    ...
    public static final TypeAdapter<Number> INTEGER = new C28687();
    ...
    public static final TypeAdapter<Locale> LOCALE = new TypeAdapter<Locale>() {
        public Locale read(JsonReader in) throws IOException {
            ...
            StringTokenizer tokenizer = new StringTokenizer(in.nextString(), BridgeUtil.UNDERLINE_STR);
    ...
    public static final TypeAdapter<Number> SHORT = new C28676();
    ...
    static class C28601 extends TypeAdapter<Class> {
        C28601() {
        }
    ...
    static class C28622 extends TypeAdapter<BitSet> {
        C28622() {
        }
    ...
    static class C28643 extends TypeAdapter<Boolean> {
        C28643() {
        }
    ...
    static class C28654 extends TypeAdapter<Boolean> {
        C28654() {
        }
    ...
    static class C28665 extends TypeAdapter<Number> {
        C28665() {
        }
    ...
    static class C28676 extends TypeAdapter<Number> {
        C28676() {
        }
    ...
    static class C28687 extends TypeAdapter<Number> {
        C28687() {
        }
    ...
    static class C28698 extends TypeAdapter<AtomicInteger> {
        C28698() {
        }
    ...
    static class C28709 extends TypeAdapter<AtomicBoolean> {
        C28709() {
        }
