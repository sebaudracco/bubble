...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C28431();
    ...
    static class C28431 implements Comparator<Comparable> {
        C28431() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C28441 extends LinkedTreeMapIterator<Entry<K, V>> {
            C28441() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C28451 extends LinkedTreeMapIterator<K> {
            C28451() {
                super();
            }
