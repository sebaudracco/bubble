...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C28401();
    ...
    static class C28401 implements Comparator<Comparable> {
        C28401() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C28411 extends LinkedTreeMapIterator<Entry<K, V>> {
            C28411() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C28421 extends LinkedTreeMapIterator<K> {
            C28421() {
                super();
            }
