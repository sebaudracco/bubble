...
public class DefaultDrmSessionManager<T extends ExoMediaCrypto> implements DrmSessionManager<T>, DrmSession<T> {
    ...
    class C15682 implements Runnable {
        C15682() {
        }
    ...
    class C15693 implements Runnable {
        C15693() {
        }
    ...
    private class PostRequestHandler extends Handler {
        ...
        L_0x000b:
            ...
            r1 = r0;
        L_0x000d:
            r2 = com.google.android.exoplayer2.drm.DefaultDrmSessionManager.this;
            ...
            return;
        L_0x001b:
            r2 = com.google.android.exoplayer2.drm.DefaultDrmSessionManager.this;	 Catch:{ Exception -> 0x000b }
        ...
        L_0x002c:
            ...
            goto L_0x000d;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.drm.DefaultDrmSessionManager.PostRequestHandler.handleMessage(android.os.Message):void");
        }
    }
    ...
    public static DefaultDrmSessionManager<FrameworkMediaCrypto> newWidevineInstance(MediaDrmCallback callback, HashMap<String, String> optionalKeyRequestParameters, Handler eventHandler, EventListener eventListener) throws UnsupportedDrmException {
        return newFrameworkInstance(C1566C.WIDEVINE_UUID, callback, optionalKeyRequestParameters, eventHandler, eventListener);
    }
    ...
    public static DefaultDrmSessionManager<FrameworkMediaCrypto> newPlayReadyInstance(MediaDrmCallback callback, String customData, Handler eventHandler, EventListener eventListener) throws UnsupportedDrmException {
        ...
        return newFrameworkInstance(C1566C.PLAYREADY_UUID, callback, optionalKeyRequestParameters, eventHandler, eventListener);
    }
        ...
        if (i == 1) {
            ...
            if (this.offlineLicenseKeySetId == null) {
                ...
                if (schemeData == null) {
                    ...
                    if (Util.SDK_INT < 21) {
                        byte[] psshData = PsshAtomUtil.parseSchemeSpecificData(this.schemeInitData, C1566C.WIDEVINE_UUID);
                        if (psshData != null) {
                            this.schemeInitData = psshData;
                        }
                    }
                    if (Util.SDK_INT < 26 && C1566C.CLEARKEY_UUID.equals(this.uuid) && ("video/mp4".equals(this.schemeMimeType) || "audio/mp4".equals(this.schemeMimeType))) {
                ...
                if (this.offlineLicenseKeySetId == null) {
                    ...
                    if (this.mode == 0 && licenseDurationRemainingSec <= 60) {
                        ...
                        if (this.eventHandler != null && this.eventListener != null) {
                            this.eventHandler.post(new C15671());
                            return;
                        }
                        return;
                    }
    ...
    private long getLicenseDurationRemainingSec() {
        if (!C1566C.WIDEVINE_UUID.equals(this.uuid)) {
    ...
    private void onKeyResponse(Object response) {
        ...
        try {
            if (this.mode == 3) {
                ...
                if (this.eventHandler != null && this.eventListener != null) {
                    this.eventHandler.post(new C15682());
                    return;
                }
                return;
            }
            ...
            this.state = 4;
            if (this.eventHandler != null && this.eventListener != null) {
                this.eventHandler.post(new C15693());
            }
        } catch (Exception e) {
            onKeysError(e);
        }
