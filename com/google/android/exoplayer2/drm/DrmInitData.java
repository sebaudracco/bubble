...
public final class DrmInitData implements Comparator<SchemeData>, Parcelable {
    public static final Creator<DrmInitData> CREATOR = new 1();
    private int hashCode;
    public final int schemeDataCount;
    private final SchemeData[] schemeDatas;

    public static final class SchemeData implements Parcelable {
        public static final Creator<SchemeData> CREATOR = new 1();
        ...
        public boolean matches(UUID schemeUuid) {
            return C1566C.UUID_NIL.equals(this.uuid) || schemeUuid.equals(this.uuid);
        }
    ...
    public int compare(SchemeData first, SchemeData second) {
        if (C1566C.UUID_NIL.equals(first.uuid)) {
            return C1566C.UUID_NIL.equals(second.uuid) ? 0 : 1;
        } else {
