...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    public static final ExtractorsFactory FACTORY = new C27141();
    ...
    static class C27141 implements ExtractorsFactory {
        C27141() {
        }
    ...
    private void processMoovAtom(ContainerAtom moov) throws ParserException {
        ...
        for (int i = 0; i < moov.containerChildren.size(); i++) {
            ...
            if (atom.type == Atom.TYPE_trak) {
                Track track = AtomParsers.parseTrak(atom, moov.getLeafAtomOfType(Atom.TYPE_mvhd), -9223372036854775807L, null, this.isQuickTime);
                if (track != null) {
