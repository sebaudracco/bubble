...
public final class FragmentedMp4Extractor implements Extractor {
    public static final ExtractorsFactory FACTORY = new C15731();
    ...
    static class C15731 implements ExtractorsFactory {
        C15731() {
        }
    ...
    private void maybeInitExtraTracks() {
        ...
        if ((this.flags & 8) != 0 && this.cea608TrackOutputs == null) {
            this.extractorOutput.track(this.trackBundles.size() + 1, 3).format(Format.createTextSampleFormat(null, "application/cea-608", null, -1, 0, null, null));
