...
public final class MatroskaExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new C15711();
    ...
    static class C15711 implements ExtractorsFactory {
        C15711() {
        }
    ...
    private static final class Track {
        ...
        public void initializeOutput(ExtractorOutput output, int trackId) throws ParserException {
            ...
            } else if ("application/vobsub".equals(mimeType) || "application/pgs".equals(mimeType) || "application/dvbsubs".equals(mimeType)) {
                type = 3;
    ...
    void endMasterElement(int id) throws ParserException {
        switch (id) {
            ...
            case ID_CONTENT_ENCODING /*25152*/:
                ...
                this.currentTrack.drmInitData = new DrmInitData(new SchemeData(C1566C.UUID_NIL, "video/webm", this.currentTrack.encryptionKeyId));
                return;
            case ID_CONTENT_ENCODINGS /*28032*/:
    ...
    private static void setSubripSampleEndTimecode(byte[] subripSampleData, long timeUs) {
        ...
        if (timeUs == -9223372036854775807L) {
            ...
            int milliseconds = (int) ((timeUs - ((long) (1000000 * ((int) (timeUs / 1000000))))) / 1000);
            timeCodeData = Util.getUtf8Bytes(String.format(Locale.US, "%02d:%02d:%02d,%03d", new Object[]{Integer.valueOf(hours), Integer.valueOf(minutes), Integer.valueOf((int) (timeUs / 1000000)), Integer.valueOf(milliseconds)}));
        }
