...
final class DefaultEbmlReader implements EbmlReader {
    ...
    public boolean read(ExtractorInput input) throws IOException, InterruptedException {
        ...
        while (true) {
            if (this.masterElementsStack.isEmpty() || input.getPosition() < MasterElement.access$000((MasterElement) this.masterElementsStack.peek())) {
                ...
                switch (type) {
                    ...
                    case 1:
                        ...
                        this.masterElementsStack.add(new MasterElement(this.elementId, elementContentPosition + this.elementContentSize, null));
            ...
            this.output.endMasterElement(MasterElement.access$100((MasterElement) this.masterElementsStack.pop()));
            return true;
        }
    }
