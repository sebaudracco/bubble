...
public final class MimeTypes {
    ...
    public static int getTrackType(String mimeType) {
        ...
        if ("application/id3".equals(mimeType) || "application/x-emsg".equals(mimeType) || "application/x-scte35".equals(mimeType) || "application/x-camera-motion".equals(mimeType)) {
            return 4;
        }
        return -1;
    }
