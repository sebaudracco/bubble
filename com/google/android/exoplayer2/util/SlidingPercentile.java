...
public class SlidingPercentile {
    private static final Comparator<Sample> INDEX_COMPARATOR = new C27731();
    private static final int MAX_RECYCLED_SAMPLES = 5;
    private static final int SORT_ORDER_BY_INDEX = 1;
    private static final int SORT_ORDER_BY_VALUE = 0;
    private static final int SORT_ORDER_NONE = -1;
    private static final Comparator<Sample> VALUE_COMPARATOR = new C27742();
    ...
    static class C27731 implements Comparator<Sample> {
        C27731() {
        }
    ...
    static class C27742 implements Comparator<Sample> {
        C27742() {
        }
