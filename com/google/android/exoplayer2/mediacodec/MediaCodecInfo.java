...
public final class MediaCodecInfo {
    ...
    public static MediaCodecInfo newInstance(String name, String mimeType, CodecCapabilities capabilities, boolean forceDisableAdaptive) {
        return new MediaCodecInfo(name, mimeType, capabilities, forceDisableAdaptive);
    }

    private MediaCodecInfo(String name, String mimeType, CodecCapabilities capabilities, boolean forceDisableAdaptive) {
        boolean z;
        boolean z2 = true;
    ...
    private static int adjustMaxInputChannelCount(String name, String mimeType, int maxChannelCount) {
        ...
        if ((Util.SDK_INT >= 26 && maxChannelCount > 0) || "audio/mpeg".equals(mimeType) || "audio/3gpp".equals(mimeType) || "audio/amr-wb".equals(mimeType) || "audio/mp4a-latm".equals(mimeType) || "audio/vorbis".equals(mimeType) || "audio/opus".equals(mimeType) || "audio/raw".equals(mimeType) || "audio/flac".equals(mimeType) || "audio/g711-alaw".equals(mimeType) || "audio/g711-mlaw".equals(mimeType) || "audio/gsm".equals(mimeType)) {
            return maxChannelCount;
        }
