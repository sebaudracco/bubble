...
public final class Id3Decoder implements MetadataDecoder {
    ...
    private static com.google.android.exoplayer2.metadata.id3.Id3Frame decodeFrame(int r24, com.google.android.exoplayer2.util.ParsableByteArray r25, boolean r26, int r27, com.google.android.exoplayer2.metadata.id3.Id3Decoder.FramePredicate r28) {
...
*/
    ...
    public Metadata decode(byte[] data, int size) {
        ...
        int frameHeaderSize = Id3Header.access$000(id3Header) == 2 ? 6 : 10;
        int framesSize = Id3Header.access$100(id3Header);
        if (Id3Header.access$200(id3Header)) {
            framesSize = removeUnsynchronization(id3Data, Id3Header.access$100(id3Header));
        }
        id3Data.setLimit(startPosition + framesSize);
        boolean unsignedIntFrameSizeHack = false;
        if (!validateFrames(id3Data, Id3Header.access$000(id3Header), frameHeaderSize, false)) {
            if (Id3Header.access$000(id3Header) == 4 && validateFrames(id3Data, 4, frameHeaderSize, true)) {
                unsignedIntFrameSizeHack = true;
            } else {
                Log.w(TAG, "Failed to validate ID3 tag with majorVersion=" + Id3Header.access$000(id3Header));
                return null;
            }
        }
        while (id3Data.bytesLeft() >= frameHeaderSize) {
            Id3Frame frame = decodeFrame(Id3Header.access$000(id3Header), id3Data, unsignedIntFrameSizeHack, frameHeaderSize, this.framePredicate);
            if (frame != null) {
                id3Frames.add(frame);
            }
        }
