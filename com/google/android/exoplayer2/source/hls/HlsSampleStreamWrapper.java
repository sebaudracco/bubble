...
final class HlsSampleStreamWrapper implements com.google.android.exoplayer2.upstream.Loader.Callback<Chunk>, SequenceableLoader, ExtractorOutput, UpstreamFormatChangedListener {
    ...
    private final Runnable maybeFinishPrepareRunnable = new C27571();
    ...
    class C27571 implements Runnable {
        C27571() {
        }
