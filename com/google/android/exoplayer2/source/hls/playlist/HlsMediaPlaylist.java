...
public final class HlsMediaPlaylist extends HlsPlaylist {
    ...
    public static final class Segment implements Comparable<Long> {
        ...
        public Segment(String uri, long byterangeOffset, long byterangeLength) {
            this(uri, 0, -1, -9223372036854775807L, false, null, null, byterangeOffset, byterangeLength);
        }

        public Segment(String uri, long durationUs, int relativeDiscontinuitySequence, long relativeStartTimeUs, boolean isEncrypted, String encryptionKeyUri, String encryptionIV, long byterangeOffset, long byterangeLength) {
            this.url = uri;
    ...
    public HlsMediaPlaylist(int playlistType, String baseUri, long startOffsetUs, long startTimeUs, boolean hasDiscontinuitySequence, int discontinuitySequence, int mediaSequence, int version, long targetDurationUs, boolean hasEndTag, boolean hasProgramDateTime, Segment initializationSegment, List<Segment> segments, List<String> dateRanges) {
        super(baseUri);
    ...
    public HlsMediaPlaylist copyWith(long startTimeUs, int discontinuitySequence) {
        return new HlsMediaPlaylist(this.playlistType, this.baseUri, this.startOffsetUs, startTimeUs, true, discontinuitySequence, this.mediaSequence, this.version, this.targetDurationUs, this.hasEndTag, this.hasProgramDateTime, this.initializationSegment, this.segments, this.dateRanges);
    }
