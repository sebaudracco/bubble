...
public class DashManifest {
    ...
    public final DashManifest copy(List<RepresentationKey> representationKeys) {
        ...
        return new DashManifest(this.availabilityStartTime, this.duration != -9223372036854775807L ? this.duration - shiftMs : -9223372036854775807L, this.minBufferTime, this.dynamic, this.minUpdatePeriod, this.timeShiftBufferDepth, this.suggestedPresentationDelay, this.utcTiming, this.location, copyPeriods);
    }
