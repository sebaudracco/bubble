...
public final class DynamiteModule {
    ...
    public static Uri getQueryUri(String str, boolean z) {
        ...
        return Uri.parse(new StringBuilder((String.valueOf(str2).length() + 42) + String.valueOf(str).length()).append("content://com.google.android.gms.chimera/").append(str2).append(BridgeUtil.SPLIT_MARK).append(str).toString());
    }
                    ...
                    synchronized (loadClass) {
                        ...
                        if (classLoader != null) {
                            ...
                            try {
                                ...
                                ClassLoader com_google_android_gms_dynamite_zzh = new zzh(zzabu, ClassLoader.getSystemClassLoader());
    ...
    public static DynamiteModule load(Context context, VersionPolicy versionPolicy, String str) throws LoadingException {
        ...
        try {
            ...
            if (selectModule.selection == 0 || ((selectModule.selection == -1 && selectModule.localVersion == 0) || (selectModule.selection == 1 && selectModule.remoteVersion == 0))) {
                ...
                zzd = zzd(context, str);
                if (com_google_android_gms_dynamite_DynamiteModule_zza2.zzaby != null) {
                    com_google_android_gms_dynamite_DynamiteModule_zza2.zzaby.close();
                }
                zzabv.set(com_google_android_gms_dynamite_DynamiteModule_zza);
                return zzd;
            } else if (selectModule.selection == 1) {
    ...
    private static DynamiteModule zzc(Context context, String str, int i) throws LoadingException {
        ...
        Context zza = zza(context.getApplicationContext(), str, i, com_google_android_gms_dynamite_DynamiteModule_zza.zzaby, iDynamiteLoaderV2);
        if (zza != null) {
