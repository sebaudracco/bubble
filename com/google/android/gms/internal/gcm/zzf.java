...
public final class zzf {
    ...
    static {
        Integer zzy;
        zzg com_google_android_gms_internal_gcm_zzk;
        Throwable th;
        ...
        try {
            ...
            if (zzy != null) {
                try {
                    if (zzy.intValue() >= 19) {
                        com_google_android_gms_internal_gcm_zzk = new zzk();
                        zzdc = com_google_android_gms_internal_gcm_zzk;
                    ...
                    com_google_android_gms_internal_gcm_zzk = new zzd();
                    zzdc = com_google_android_gms_internal_gcm_zzk;
                    if (zzy != null) {
                    }
                    zzdd = zzy != null ? 1 : zzy.intValue();
            ...
            com_google_android_gms_internal_gcm_zzk = (!Boolean.getBoolean("com.google.devtools.build.android.desugar.runtime.twr_disable_mimic") ? 1 : null) != null ? new zzj() : new zzd();
        } catch (Throwable th3) {
            Throwable th4 = th3;
            zzy = null;
            th = th4;
