...
interface zzbey {
    ...
    void zza(int i, zzbah com_google_android_gms_internal_ads_zzbah) throws IOException;

    <K, V> void zza(int i, zzbcn<K, V> com_google_android_gms_internal_ads_zzbcn_K__V, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzbdm com_google_android_gms_internal_ads_zzbdm) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzbdm com_google_android_gms_internal_ads_zzbdm) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzbdm com_google_android_gms_internal_ads_zzbdm) throws IOException;

    void zzb(int i, List<zzbah> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzbdm com_google_android_gms_internal_ads_zzbdm) throws IOException;
