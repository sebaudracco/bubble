...
final class zzjs extends zzjr$zza<zzks> {
    ...
    zzjs(zzjr com_google_android_gms_internal_ads_zzjr, Context context, zzjn com_google_android_gms_internal_ads_zzjn, String str, zzxn com_google_android_gms_internal_ads_zzxn) {
    ...
    public final /* synthetic */ Object zza(zzld com_google_android_gms_internal_ads_zzld) throws RemoteException {
        return com_google_android_gms_internal_ads_zzld.createBannerAdManager(ObjectWrapper.wrap(this.val$context), this.zzarq, this.zzarr, this.zzars, 12451000);
    }

    public final /* synthetic */ Object zzib() throws RemoteException {
        zzks zza = zzjr.zzb(this.zzart).zza(this.val$context, this.zzarq, this.zzarr, this.zzars, 1);
        if (zza != null) {
            return zza;
        }
        zzjr.zza(this.zzart, this.val$context, "banner");
        return new zzmj();
    }
}
