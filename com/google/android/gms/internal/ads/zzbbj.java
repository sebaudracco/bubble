...
public enum zzbbj {
    ...
    static {
        ...
        int i;
        while (i < length) {
            zzbbj com_google_android_gms_internal_ads_zzbbj = values[i];
            zzdtf[com_google_android_gms_internal_ads_zzbbj.id] = com_google_android_gms_internal_ads_zzbbj;
            i++;
        }
    }

    private zzbbj(int i, zzbbl com_google_android_gms_internal_ads_zzbbl, zzbbw com_google_android_gms_internal_ads_zzbbw) {
        this.id = i;
        this.zzdtc = com_google_android_gms_internal_ads_zzbbl;
        this.zzdtb = com_google_android_gms_internal_ads_zzbbw;
        switch (com_google_android_gms_internal_ads_zzbbl) {
            case MAP:
                this.zzdtd = com_google_android_gms_internal_ads_zzbbw.zzadt();
                break;
            case VECTOR:
                this.zzdtd = com_google_android_gms_internal_ads_zzbbw.zzadt();
                break;
        ...
        boolean z = false;
        if (com_google_android_gms_internal_ads_zzbbl == zzbbl.SCALAR) {
            switch (com_google_android_gms_internal_ads_zzbbw) {
                case BYTE_STRING:
                case MESSAGE:
                case STRING:
                    break;
