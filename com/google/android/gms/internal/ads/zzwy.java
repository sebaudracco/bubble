...
public final class zzwy {
    ...
    public zzwy(JSONObject jSONObject) throws JSONException {
        ...
        for (int i2 = 0; i2 < jSONArray.length(); i2++) {
            zzwx com_google_android_gms_internal_ads_zzwx = new zzwx(jSONArray.getJSONObject(i2));
            if (com_google_android_gms_internal_ads_zzwx.zzmf()) {
                this.zzbte = true;
            }
            arrayList.add(com_google_android_gms_internal_ads_zzwx);
            if (i < 0) {
                boolean z;
        ...
        JSONObject optJSONObject = jSONObject.optJSONObject(C1404b.f2107K);
