...
public final class zze {
    ...
    public static class zza implements BaseColumns {
        ...
        private static zzh zza(ContentResolver contentResolver, Uri uri) {
            zzh com_google_android_gms_internal_stable_zzh = (zzh) zzagq.get(uri);
            if (com_google_android_gms_internal_stable_zzh == null) {
                com_google_android_gms_internal_stable_zzh = new zzh();
                zzagq.put(uri, com_google_android_gms_internal_stable_zzh);
                contentResolver.registerContentObserver(uri, true, new zzf(null, com_google_android_gms_internal_stable_zzh));
                return com_google_android_gms_internal_stable_zzh;
            } else if (!com_google_android_gms_internal_stable_zzh.zzagu.getAndSet(false)) {
                return com_google_android_gms_internal_stable_zzh;
            } else {
                synchronized (com_google_android_gms_internal_stable_zzh) {
                    com_google_android_gms_internal_stable_zzh.zzags.clear();
                    com_google_android_gms_internal_stable_zzh.zzagt = new Object();
                }
                return com_google_android_gms_internal_stable_zzh;
            }
        }
        ...
        private static void zza(zzh com_google_android_gms_internal_stable_zzh, Object obj, String str, String str2) {
            synchronized (com_google_android_gms_internal_stable_zzh) {
                if (obj == com_google_android_gms_internal_stable_zzh.zzagt) {
                    com_google_android_gms_internal_stable_zzh.zzags.put(str, str2);
                }
            }
        }
    }
