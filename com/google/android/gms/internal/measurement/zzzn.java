...
final /* synthetic */ class zzzn {
    ...
    static {
        ...
        try {
            zzbrv[zzabu.LONG.ordinal()] = 2;
        } catch (NoSuchFieldError e20) {
        }
        try {
            zzbrv[zzabu.FLOAT.ordinal()] = 3;
        } catch (NoSuchFieldError e21) {
        }
        try {
            zzbrv[zzabu.DOUBLE.ordinal()] = 4;
        } catch (NoSuchFieldError e22) {
        }
        try {
            zzbrv[zzabu.BOOLEAN.ordinal()] = 5;
        } catch (NoSuchFieldError e23) {
        }
        try {
            zzbrv[zzabu.STRING.ordinal()] = 6;
        } catch (NoSuchFieldError e24) {
        }
        try {
            zzbrv[zzabu.BYTE_STRING.ordinal()] = 7;
        } catch (NoSuchFieldError e25) {
        }
        try {
            zzbrv[zzabu.ENUM.ordinal()] = 8;
        } catch (NoSuchFieldError e26) {
        }
        try {
            zzbrv[zzabu.MESSAGE.ordinal()] = 9;
