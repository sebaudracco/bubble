...
public class zzjr implements zzec {
    ...
    private final boolean zza(String str, zzeu com_google_android_gms_internal_measurement_zzeu) {
        long round;
        Object string = com_google_android_gms_internal_measurement_zzeu.zzafq.getString(FirebaseAnalytics$Param.CURRENCY);
        if (Event.ECOMMERCE_PURCHASE.equals(com_google_android_gms_internal_measurement_zzeu.name)) {
            double doubleValue = com_google_android_gms_internal_measurement_zzeu.zzafq.zzbh(FirebaseAnalytics$Param.VALUE).doubleValue() * 1000000.0d;
            if (doubleValue == 0.0d) {
                doubleValue = ((double) com_google_android_gms_internal_measurement_zzeu.zzafq.getLong(FirebaseAnalytics$Param.VALUE).longValue()) * 1000000.0d;
            }
            ...
            round = com_google_android_gms_internal_measurement_zzeu.zzafq.getLong(FirebaseAnalytics$Param.VALUE).longValue();
        }
    ...
    private final void zzb(zzdy com_google_android_gms_internal_measurement_zzdy) {
        ...
        if (TextUtils.isEmpty(com_google_android_gms_internal_measurement_zzdy.getGmpAppId())) {
            zzb(com_google_android_gms_internal_measurement_zzdy.zzah(), HttpStatus.SC_NO_CONTENT, null, null, null);
            return;
        }
    ...
    private final void zzc(zzeu com_google_android_gms_internal_measurement_zzeu, zzdz com_google_android_gms_internal_measurement_zzdz) {
        ...
        if (!com_google_android_gms_internal_measurement_zzdz.zzadw) {
            ...
            zzg(com_google_android_gms_internal_measurement_zzdz);
            if (("_iap".equals(com_google_android_gms_internal_measurement_zzeu.name) || Event.ECOMMERCE_PURCHASE.equals(com_google_android_gms_internal_measurement_zzeu.name)) && !zza(str, com_google_android_gms_internal_measurement_zzeu)) {
            ...
            try {
                ...
                if (zzf != null) {
                    ...
                    zzge().zzim().zzd("Too many event names used, ignoring event. appId, name, supported count", zzfg.zzbm(str), zzga().zzbj(com_google_android_gms_internal_measurement_zzep2.name), Integer.valueOf(HttpStatus.SC_INTERNAL_SERVER_ERROR));
    ...
    private final boolean zzd(java.lang.String r31, long r32) {
        ...
        r3 = 0;
        r2 = r14.getWritableDatabase();	 Catch:{ SQLiteException -> 0x0c10 }
        r5 = 0;
        r5 = android.text.TextUtils.isEmpty(r5);	 Catch:{ SQLiteException -> 0x0c10 }
    ...
    L_0x0037:
        r5 = 2;
        r5 = new java.lang.String[r5];	 Catch:{ SQLiteException -> 0x0c10 }
        r6 = 0;
        r7 = java.lang.String.valueOf(r16);	 Catch:{ SQLiteException -> 0x0c10 }
        r5[r6] = r7;	 Catch:{ SQLiteException -> 0x0c10 }
        r6 = 1;
        r7 = java.lang.String.valueOf(r32);	 Catch:{ SQLiteException -> 0x0c10 }
        r5[r6] = r7;	 Catch:{ SQLiteException -> 0x0c10 }
        r6 = r5;
    L_0x0049:
        r8 = -1;
    ...
    L_0x004f:
        r5 = "rowid <= ? and ";
    L_0x0052:
        r7 = java.lang.String.valueOf(r5);	 Catch:{ SQLiteException -> 0x0c10 }
        r7 = r7.length();	 Catch:{ SQLiteException -> 0x0c10 }
        r7 = r7 + 148;
        r8 = new java.lang.StringBuilder;	 Catch:{ SQLiteException -> 0x0c10 }
        r8.<init>(r7);	 Catch:{ SQLiteException -> 0x0c10 }
        r7 = "select app_id, metadata_fingerprint from raw_events where ";
        r7 = r8.append(r7);	 Catch:{ SQLiteException -> 0x0c10 }
        r5 = r7.append(r5);	 Catch:{ SQLiteException -> 0x0c10 }
        r7 = "app_id in (select app_id from apps where config_fetched_time >= ?) order by rowid limit 1;";
        r5 = r5.append(r7);	 Catch:{ SQLiteException -> 0x0c10 }
        r5 = r5.toString();	 Catch:{ SQLiteException -> 0x0c10 }
        r3 = r2.rawQuery(r5, r6);	 Catch:{ SQLiteException -> 0x0c10 }
        r5 = r3.moveToFirst();	 Catch:{ SQLiteException -> 0x0c10 }
    ...
    L_0x0172:
        r5 = 0;
        r4 = r3.getString(r5);	 Catch:{ SQLiteException -> 0x0c10 }
        r5 = 1;
        r5 = r3.getString(r5);	 Catch:{ SQLiteException -> 0x0c10 }
        r3.close();	 Catch:{ SQLiteException -> 0x0c10 }
        r13 = r5;
        r11 = r3;
        r12 = r4;
    L_0x0182:
        ...
        r4 = 1;
        r4 = new java.lang.String[r4];	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r5 = 0;
        r6 = "metadata";
        r4[r5] = r6;	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r5 = "app_id = ? and metadata_fingerprint = ?";
        r6 = 2;
        r6 = new java.lang.String[r6];	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r7 = 0;
        r6[r7] = r12;	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r7 = 1;
        r6[r7] = r13;	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r7 = 0;
        r8 = 0;
        r9 = "rowid";
        r10 = "2";
        r11 = r2.query(r3, r4, r5, r6, r7, r8, r9, r10);	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r3 = r11.moveToFirst();	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        if (r3 != 0) goto L_0x023c;
    L_0x01ac:
        r2 = r14.zzge();	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r2 = r2.zzim();	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r3 = "Raw event metadata record is missing. appId";
        r4 = com.google.android.gms.internal.measurement.zzfg.zzbm(r12);	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r2.zzg(r3, r4);	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
    ...
    L_0x023c:
        r3 = 0;
        r3 = r11.getBlob(r3);	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r4 = 0;
        r5 = r3.length;	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r3 = com.google.android.gms.internal.measurement.zzabv.zza(r3, r4, r5);	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r4 = new com.google.android.gms.internal.measurement.zzkq;	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r4.<init>();	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r4.zzb(r3);	 Catch:{ IOException -> 0x02cf }
        r3 = r11.moveToNext();	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        if (r3 == 0) goto L_0x0267;
    L_0x0255:
        r3 = r14.zzge();	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r3 = r3.zzip();	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r5 = "Get multiple raw event metadata records, expected one. appId";
        r6 = com.google.android.gms.internal.measurement.zzfg.zzbm(r12);	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r3.zzg(r5, r6);	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
    L_0x0267:
        r11.close();	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r0 = r21;
        r0.zzb(r4);	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r4 = -1;
    ...
    L_0x0275:
        ...
        r3 = 3;
        r6 = new java.lang.String[r3];	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r3 = 0;
        r6[r3] = r12;	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r3 = 1;
        r6[r3] = r13;	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r3 = 2;
        r4 = java.lang.String.valueOf(r16);	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r6[r3] = r4;	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
    L_0x0288:
        r3 = "raw_events";
        r4 = 4;
        r4 = new java.lang.String[r4];	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r7 = 0;
        r8 = "rowid";
        r4[r7] = r8;	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r7 = 1;
        r8 = "name";
        r4[r7] = r8;	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r7 = 2;
        ...
        r9 = "rowid";
        r10 = 0;
        r3 = r2.query(r3, r4, r5, r6, r7, r8, r9, r10);	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r2 = r3.moveToFirst();	 Catch:{ SQLiteException -> 0x0c13 }
        if (r2 != 0) goto L_0x0312;
    L_0x02b6:
        r2 = r14.zzge();	 Catch:{ SQLiteException -> 0x0c13 }
        r2 = r2.zzip();	 Catch:{ SQLiteException -> 0x0c13 }
        r4 = "Raw event data disappeared while in transaction. appId";
        r5 = com.google.android.gms.internal.measurement.zzfg.zzbm(r12);	 Catch:{ SQLiteException -> 0x0c13 }
        r2.zzg(r4, r5);	 Catch:{ SQLiteException -> 0x0c13 }
        if (r3 == 0) goto L_0x0086;
    L_0x02ca:
        r3.close();	 Catch:{ all -> 0x01c5 }
        goto L_0x0086;
    L_0x02cf:
        r2 = move-exception;
        r3 = r14.zzge();	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r3 = r3.zzim();	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r4 = "Data loss. Failed to merge raw event metadata. appId";
        r5 = com.google.android.gms.internal.measurement.zzfg.zzbm(r12);	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        r3.zze(r4, r5, r2);	 Catch:{ SQLiteException -> 0x02f6, all -> 0x0c0c }
        if (r11 == 0) goto L_0x0086;
    L_0x02e4:
        r11.close();	 Catch:{ all -> 0x01c5 }
        goto L_0x0086;
    ...
    L_0x0312:
        r2 = 0;
        r4 = r3.getLong(r2);	 Catch:{ SQLiteException -> 0x0c13 }
        r2 = 3;
        r2 = r3.getBlob(r2);	 Catch:{ SQLiteException -> 0x0c13 }
        r6 = 0;
        r7 = r2.length;	 Catch:{ SQLiteException -> 0x0c13 }
        r2 = com.google.android.gms.internal.measurement.zzabv.zza(r2, r6, r7);	 Catch:{ SQLiteException -> 0x0c13 }
        r6 = new com.google.android.gms.internal.measurement.zzkn;	 Catch:{ SQLiteException -> 0x0c13 }
        r6.<init>();	 Catch:{ SQLiteException -> 0x0c13 }
        r6.zzb(r2);	 Catch:{ IOException -> 0x034b }
        r2 = 1;
        r2 = r3.getString(r2);	 Catch:{ SQLiteException -> 0x0c13 }
        r6.name = r2;	 Catch:{ SQLiteException -> 0x0c13 }
        r2 = 2;
        r8 = r3.getLong(r2);	 Catch:{ SQLiteException -> 0x0c13 }
        r2 = java.lang.Long.valueOf(r8);	 Catch:{ SQLiteException -> 0x0c13 }
        r6.zzatb = r2;	 Catch:{ SQLiteException -> 0x0c13 }
        r0 = r21;
        r2 = r0.zza(r4, r6);	 Catch:{ SQLiteException -> 0x0c13 }
    ...
    L_0x034b:
        r2 = move-exception;
        r4 = r14.zzge();	 Catch:{ SQLiteException -> 0x0c13 }
        r4 = r4.zzim();	 Catch:{ SQLiteException -> 0x0c13 }
        r5 = "Data loss. Failed to merge raw event. appId";
        r6 = com.google.android.gms.internal.measurement.zzfg.zzbm(r12);	 Catch:{ SQLiteException -> 0x0c13 }
        r4.zze(r5, r6, r2);	 Catch:{ SQLiteException -> 0x0c13 }
    L_0x035e:
        r2 = r3.moveToNext();	 Catch:{ SQLiteException -> 0x0c13 }
        if (r2 != 0) goto L_0x0312;
    L_0x0364:
        if (r3 == 0) goto L_0x0086;
    L_0x0366:
    ...
    L_0x0bc1:
        ...
        r5 = 2;
        r5 = new java.lang.String[r5];	 Catch:{ SQLiteException -> 0x0be8 }
        r7 = 0;
        r5[r7] = r6;	 Catch:{ SQLiteException -> 0x0be8 }
        r7 = 1;
        r5[r7] = r6;	 Catch:{ SQLiteException -> 0x0be8 }
        r2.execSQL(r4, r5);	 Catch:{ SQLiteException -> 0x0be8 }
    L_0x0bd8:
        r2 = r30.zzix();	 Catch:{ all -> 0x01c5 }
    ...
    private final zzdy zzg(zzdz com_google_android_gms_internal_measurement_zzdz) {
        ...
        Object obj2 = null;
        if (zzbc == null) {
            zzdy com_google_android_gms_internal_measurement_zzdy = new zzdy(this.zzacw, com_google_android_gms_internal_measurement_zzdz.packageName);
            com_google_android_gms_internal_measurement_zzdy.zzal(this.zzacw.zzfv().zzii());
            com_google_android_gms_internal_measurement_zzdy.zzan(zzbp);
            zzbc = com_google_android_gms_internal_measurement_zzdy;
            obj2 = 1;
    ...
    final void zzb(String str, int i, Throwable th, byte[] bArr, Map<String, List<String>> map) {
        ...
        zzix().beginTransaction();
        zzdy zzbc = zzix().zzbc(str);
        boolean z2 = (i == 200 || i == HttpStatus.SC_NO_CONTENT || i == HttpStatus.SC_NOT_MODIFIED) && th == null;
        if (zzbc == null) {
            zzge().zzip().zzg("App does not exist in onConfigFetched. appId", zzfg.zzbm(str));
        } else if (z2 || i == 404) {
            List list = map != null ? (List) map.get("Last-Modified") : null;
            String str2 = (list == null || list.size() <= 0) ? null : (String) list.get(0);
            if (i == 404 || i == HttpStatus.SC_NOT_MODIFIED) {
    ...
    final void zzd(zzdz com_google_android_gms_internal_measurement_zzdz) {
        ...
        try {
            ...
            int delete = writableDatabase.delete("main_event_params", "app_id=?", strArr) + ((((((((writableDatabase.delete("apps", "app_id=?", strArr) + 0) + writableDatabase.delete(Constants.VIDEO_TRACKING_EVENTS_KEY, "app_id=?", strArr)) + writableDatabase.delete("user_attributes", "app_id=?", strArr)) + writableDatabase.delete("conditional_properties", "app_id=?", strArr)) + writableDatabase.delete("raw_events", "app_id=?", strArr)) + writableDatabase.delete("raw_events_metadata", "app_id=?", strArr)) + writableDatabase.delete("queue", "app_id=?", strArr)) + writableDatabase.delete("audience_filter_values", "app_id=?", strArr));
            if (delete > 0) {
            ...
            if (com_google_android_gms_internal_measurement_zzdz.zzadw) {
                ...
                try {
                    ...
                    if (!(zzbc == null || zzbc.getGmpAppId() == null || zzbc.getGmpAppId().equals(com_google_android_gms_internal_measurement_zzdz.zzadm))) {
                        ...
                        i2 = writableDatabase.delete("audience_filter_values", "app_id=?", strArr) + ((((((((writableDatabase.delete(Constants.VIDEO_TRACKING_EVENTS_KEY, "app_id=?", strArr) + 0) + writableDatabase.delete("user_attributes", "app_id=?", strArr)) + writableDatabase.delete("conditional_properties", "app_id=?", strArr)) + writableDatabase.delete("apps", "app_id=?", strArr)) + writableDatabase.delete("raw_events", "app_id=?", strArr)) + writableDatabase.delete("raw_events_metadata", "app_id=?", strArr)) + writableDatabase.delete("event_filters", "app_id=?", strArr)) + writableDatabase.delete("property_filters", "app_id=?", strArr));
                        if (i2 > 0) {
