...
public final class zzew {
    ...
    public static zzex<Integer> zzagv = zzex.zzc("measurement.upload.max_conversions_per_day", HttpStatus.SC_INTERNAL_SERVER_ERROR, HttpStatus.SC_INTERNAL_SERVER_ERROR);
    ...
    public static zzex<Long> zzahj = zzex.zzb("measurement.upload.retry_time", (long) CycledLeScanner.ANDROID_N_MAX_SCAN_DURATION_MILLIS, (long) CycledLeScanner.ANDROID_N_MAX_SCAN_DURATION_MILLIS);
