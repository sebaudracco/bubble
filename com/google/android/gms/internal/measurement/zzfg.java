...
public final class zzfg extends zzhh {
    ...
    private static String zza(boolean z, Object obj) {
        ...
        if (valueOf instanceof Long) {
            ...
            return new StringBuilder((String.valueOf(str).length() + 43) + String.valueOf(str).length()).append(str).append(Math.round(Math.pow(10.0d, (double) (valueOf2.length() - 1)))).append("...").append(str).append(Math.round(Math.pow(10.0d, (double) valueOf2.length()) - MoPubAdapter.DEFAULT_MOPUB_IMAGE_SCALE)).toString();
