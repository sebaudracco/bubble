...
final class zzfn implements Runnable {
    ...
    private zzfn(String str, zzfm com_google_android_gms_internal_measurement_zzfm, int i, Throwable th, byte[] bArr, Map<String, List<String>> map) {
        Preconditions.checkNotNull(com_google_android_gms_internal_measurement_zzfm);
        this.zzajh = com_google_android_gms_internal_measurement_zzfm;
        this.status = i;
        this.zzaji = th;
        this.zzajj = bArr;
