...
final class zzacb implements Cloneable {
    ...
    final int zza() {
        ...
        if (this.value != null) {
            ...
            for (i2 = 0; i2 < length; i2++) {
                if (Array.get(obj, i2) != null) {
                    i += com_google_android_gms_internal_measurement_zzabz.zzv(Array.get(obj, i2));
                }
            }
            return i;
        }
        ...
        for (zzacg com_google_android_gms_internal_measurement_zzacg : this.zzbxf) {
            i2 = (com_google_android_gms_internal_measurement_zzacg.zzbrc.length + (zzabw.zzas(com_google_android_gms_internal_measurement_zzacg.tag) + 0)) + i2;
        }
        return i2;
    }
