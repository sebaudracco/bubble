...
public final class zzef extends zzhg {
    ...
    @WorkerThread
    public final long zza(String str, @NonNull zzex<Long> com_google_android_gms_internal_measurement_zzex_java_lang_Long) {
        if (str == null) {
    ...
    public final boolean zzat(String str) {
        return SchemaSymbols.ATTVAL_TRUE_1.equals(this.zzaet.zze(str, "gaia_collection_enabled"));
    }

    public final boolean zzau(String str) {
        return SchemaSymbols.ATTVAL_TRUE_1.equals(this.zzaet.zze(str, "measurement.event_sampling_enabled"));
    }
    ...
    @WorkerThread
    public final int zzb(String str, @NonNull zzex<Integer> com_google_android_gms_internal_measurement_zzex_java_lang_Integer) {
        if (str == null) {
    ...
    @WorkerThread
    public final double zzc(String str, @NonNull zzex<Double> com_google_android_gms_internal_measurement_zzex_java_lang_Double) {
        if (str == null) {
    ...
    public final String zzhj() {
        try {
            return (String) Class.forName(C1404b.f2144v).getMethod("get", new Class[]{String.class, String.class}).invoke(null, new Object[]{"debug.firebase.analytics.app", ""});
