...
public final class zzl {
    ...
    public static int zzb(int i, zzt com_google_android_gms_internal_wearable_zzt) {
        int zzk = zzk(i);
        int zzx = com_google_android_gms_internal_wearable_zzt.zzx();
    ...
    public final void zza(int i, zzt com_google_android_gms_internal_wearable_zzt) throws IOException {
        zzf(i, 2);
        if (com_google_android_gms_internal_wearable_zzt.zzhl < 0) {
            com_google_android_gms_internal_wearable_zzt.zzx();
        }
        zzl(com_google_android_gms_internal_wearable_zzt.zzhl);
        com_google_android_gms_internal_wearable_zzt.zza(this);
    }
    ...
    public final void zza(int i, String str) throws IOException {
        ...
        try {
            ...
            zzm com_google_android_gms_internal_wearable_zzm = new zzm(this.zzhb.position(), this.zzhb.limit());
            com_google_android_gms_internal_wearable_zzm.initCause(e);
            throw com_google_android_gms_internal_wearable_zzm;
        }
    }
