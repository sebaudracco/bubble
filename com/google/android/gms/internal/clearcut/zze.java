...
public final class zze extends GoogleApi<Api$ApiOptions$NoOptions> implements zzb {
    ...
    public final PendingResult<Status> zzb(com.google.android.gms.clearcut.zze com_google_android_gms_clearcut_zze) {
        return doBestEffortWrite(new zzh(com_google_android_gms_clearcut_zze, asGoogleApiClient()));
    }
}
