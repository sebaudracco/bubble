...
final class zzbq extends zzav<Double> implements zzcn<Double>, RandomAccess {
    ...
    static {
        zzav com_google_android_gms_internal_clearcut_zzbq = new zzbq();
        zzgj = com_google_android_gms_internal_clearcut_zzbq;
        com_google_android_gms_internal_clearcut_zzbq.zzv();
    }
    ...
    public final boolean addAll(Collection<? extends Double> collection) {
        ...
        zzbq com_google_android_gms_internal_clearcut_zzbq = (zzbq) collection;
        if (com_google_android_gms_internal_clearcut_zzbq.size == 0) {
            return false;
        }
        if (Integer.MAX_VALUE - this.size < com_google_android_gms_internal_clearcut_zzbq.size) {
            throw new OutOfMemoryError();
        }
        int i = this.size + com_google_android_gms_internal_clearcut_zzbq.size;
        if (i > this.zzgk.length) {
            this.zzgk = Arrays.copyOf(this.zzgk, i);
        }
        System.arraycopy(com_google_android_gms_internal_clearcut_zzbq.zzgk, 0, this.zzgk, this.size, com_google_android_gms_internal_clearcut_zzbq.size);
        this.size = i;
        this.modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        zzbq com_google_android_gms_internal_clearcut_zzbq = (zzbq) obj;
        if (this.size != com_google_android_gms_internal_clearcut_zzbq.size) {
            return false;
        }
        double[] dArr = com_google_android_gms_internal_clearcut_zzbq.zzgk;
