...
final class zzdu<T> implements zzef<T> {
    ...
    private zzdu(zzex<?, ?> com_google_android_gms_internal_clearcut_zzex___, zzbu<?> com_google_android_gms_internal_clearcut_zzbu_, zzdo com_google_android_gms_internal_clearcut_zzdo) {
        this.zzmx = com_google_android_gms_internal_clearcut_zzex___;
        this.zzmo = com_google_android_gms_internal_clearcut_zzbu_.zze(com_google_android_gms_internal_clearcut_zzdo);
        this.zzmy = com_google_android_gms_internal_clearcut_zzbu_;
        this.zzmn = com_google_android_gms_internal_clearcut_zzdo;
    }

    static <T> zzdu<T> zza(zzex<?, ?> com_google_android_gms_internal_clearcut_zzex___, zzbu<?> com_google_android_gms_internal_clearcut_zzbu_, zzdo com_google_android_gms_internal_clearcut_zzdo) {
        return new zzdu(com_google_android_gms_internal_clearcut_zzex___, com_google_android_gms_internal_clearcut_zzbu_, com_google_android_gms_internal_clearcut_zzdo);
    }
    ...
    public final void zza(T t, zzfr com_google_android_gms_internal_clearcut_zzfr) throws IOException {
        ...
        while (it.hasNext()) {
            ...
            if (com_google_android_gms_internal_clearcut_zzca.zzav() != zzfq.MESSAGE || com_google_android_gms_internal_clearcut_zzca.zzaw() || com_google_android_gms_internal_clearcut_zzca.zzax()) {
                throw new IllegalStateException("Found invalid MessageSet item.");
            } else if (entry instanceof zzct) {
                com_google_android_gms_internal_clearcut_zzfr.zza(com_google_android_gms_internal_clearcut_zzca.zzc(), ((zzct) entry).zzbs().zzr());
            } else {
                com_google_android_gms_internal_clearcut_zzfr.zza(com_google_android_gms_internal_clearcut_zzca.zzc(), entry.getValue());
            }
        }
        zzex com_google_android_gms_internal_clearcut_zzex = this.zzmx;
        com_google_android_gms_internal_clearcut_zzex.zzc(com_google_android_gms_internal_clearcut_zzex.zzq(t), com_google_android_gms_internal_clearcut_zzfr);
    }

    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void zza(T r10, byte[] r11, int r12, int r13, com.google.android.gms.internal.clearcut.zzay r14) throws java.io.IOException {
        /*
        r9 = this;
        r7 = 2;
        r0 = r10;
    ...
    public final int zzm(T t) {
        zzex com_google_android_gms_internal_clearcut_zzex = this.zzmx;
        int zzr = com_google_android_gms_internal_clearcut_zzex.zzr(com_google_android_gms_internal_clearcut_zzex.zzq(t)) + 0;
