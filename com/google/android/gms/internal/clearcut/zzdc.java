...
final class zzdc extends zzav<Long> implements zzcn<Long>, RandomAccess {
    ...
    static {
        zzav com_google_android_gms_internal_clearcut_zzdc = new zzdc();
        zzlw = com_google_android_gms_internal_clearcut_zzdc;
        com_google_android_gms_internal_clearcut_zzdc.zzv();
    }
    ...
    public final boolean addAll(Collection<? extends Long> collection) {
        ...
        zzdc com_google_android_gms_internal_clearcut_zzdc = (zzdc) collection;
        if (com_google_android_gms_internal_clearcut_zzdc.size == 0) {
            return false;
        }
        if (Integer.MAX_VALUE - this.size < com_google_android_gms_internal_clearcut_zzdc.size) {
            throw new OutOfMemoryError();
        }
        int i = this.size + com_google_android_gms_internal_clearcut_zzdc.size;
        if (i > this.zzlx.length) {
            this.zzlx = Arrays.copyOf(this.zzlx, i);
        }
        System.arraycopy(com_google_android_gms_internal_clearcut_zzdc.zzlx, 0, this.zzlx, this.size, com_google_android_gms_internal_clearcut_zzdc.size);
        this.size = i;
        this.modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        zzdc com_google_android_gms_internal_clearcut_zzdc = (zzdc) obj;
        if (this.size != com_google_android_gms_internal_clearcut_zzdc.size) {
            return false;
        }
        long[] jArr = com_google_android_gms_internal_clearcut_zzdc.zzlx;
