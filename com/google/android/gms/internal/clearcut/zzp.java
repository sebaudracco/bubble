...
public final class zzp implements ClearcutLogger$zza {
    ...
    private static final ConcurrentHashMap<String, zzae<zza>> zzas = new ConcurrentHashMap();
    ...
    private static zzb zza(String str) {
        ...
        try {
            ...
            Log.e("LogSamplerImpl", "negative values not supported: " + parseLong + BridgeUtil.SPLIT_MARK + parseLong2);
            return null;
        } catch (Throwable e) {
            Throwable th = e;
            str3 = "LogSamplerImpl";
    ...
    public final boolean zza(zze com_google_android_gms_clearcut_zze) {
        ...
        if (com_google_android_gms_clearcut_zze.zzaa != null) {
            int i2 = com_google_android_gms_clearcut_zze.zzaa.zzbji;
        } else {
            boolean z = false;
        }
        zzae com_google_android_gms_internal_clearcut_zzae;
        zzb zza;
        if (((Boolean) zzaw.get()).booleanValue()) {
            ...
            if (str != null) {
                ...
                if (this.zzh == null) {
                    ...
                    com_google_android_gms_internal_clearcut_zzae = (zzae) zzas.get(str);
                    if (com_google_android_gms_internal_clearcut_zzae == null) {
                        zzae zza2 = zzaq.zza(str, zza.zzft(), zzq.zzax);
                        com_google_android_gms_internal_clearcut_zzae = (zzae) zzas.putIfAbsent(str, zza2);
                        if (com_google_android_gms_internal_clearcut_zzae == null) {
                            com_google_android_gms_internal_clearcut_zzae = zza2;
                        }
                    }
                    emptyList = ((zza) com_google_android_gms_internal_clearcut_zzae.get()).zzfs();
                }
                for (zzb zza3 : r0) {
            ...
            if (str != null) {
                ...
                if (this.zzh == null || !zzc(this.zzh)) {
                    ...
                    com_google_android_gms_internal_clearcut_zzae = (zzae) zzat.get(str);
                    if (com_google_android_gms_internal_clearcut_zzae == null) {
                        com_google_android_gms_internal_clearcut_zzae = zzar.zza(str, null);
                        zzat.put(str, com_google_android_gms_internal_clearcut_zzae);
                    }
                    str2 = (String) com_google_android_gms_internal_clearcut_zzae.get();
                }
                zza3 = zza(str2);
                if (zza3 != null) {
