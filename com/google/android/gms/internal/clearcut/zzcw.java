...
public final class zzcw extends zzav<String> implements zzcx, RandomAccess {
    ...
    static {
        zzav com_google_android_gms_internal_clearcut_zzcw = new zzcw();
        zzlq = com_google_android_gms_internal_clearcut_zzcw;
        com_google_android_gms_internal_clearcut_zzcw.zzv();
    }
    ...
    public final /* synthetic */ Object get(int i) {
        ...
        if (obj instanceof zzbb) {
            zzbb com_google_android_gms_internal_clearcut_zzbb = (zzbb) obj;
            zzz = com_google_android_gms_internal_clearcut_zzbb.zzz();
            if (com_google_android_gms_internal_clearcut_zzbb.zzaa()) {
                this.zzls.set(i, zzz);
            }
            return zzz;
        }
