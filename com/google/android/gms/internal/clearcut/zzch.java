...
final class zzch extends zzav<Integer> implements zzcn<Integer>, RandomAccess {
    ...
    static {
        zzav com_google_android_gms_internal_clearcut_zzch = new zzch();
        zzkr = com_google_android_gms_internal_clearcut_zzch;
        com_google_android_gms_internal_clearcut_zzch.zzv();
    }
    ...
    public final boolean addAll(Collection<? extends Integer> collection) {
        ...
        zzch com_google_android_gms_internal_clearcut_zzch = (zzch) collection;
        if (com_google_android_gms_internal_clearcut_zzch.size == 0) {
            return false;
        }
        if (Integer.MAX_VALUE - this.size < com_google_android_gms_internal_clearcut_zzch.size) {
            throw new OutOfMemoryError();
        }
        int i = this.size + com_google_android_gms_internal_clearcut_zzch.size;
        if (i > this.zzks.length) {
            this.zzks = Arrays.copyOf(this.zzks, i);
        }
        System.arraycopy(com_google_android_gms_internal_clearcut_zzch.zzks, 0, this.zzks, this.size, com_google_android_gms_internal_clearcut_zzch.size);
        this.size = i;
        this.modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        zzch com_google_android_gms_internal_clearcut_zzch = (zzch) obj;
        if (this.size != com_google_android_gms_internal_clearcut_zzch.size) {
            return false;
        }
        int[] iArr = com_google_android_gms_internal_clearcut_zzch.zzks;
