...
final class zzep implements Comparable<zzep>, Entry<K, V> {
    ...
    zzep(zzei com_google_android_gms_internal_clearcut_zzei, K k, V v) {
        this.zzos = com_google_android_gms_internal_clearcut_zzei;
        this.zzov = k;
        this.value = v;
    }

    zzep(zzei com_google_android_gms_internal_clearcut_zzei, Entry<K, V> entry) {
        this(com_google_android_gms_internal_clearcut_zzei, (Comparable) entry.getKey(), entry.getValue());
    }
