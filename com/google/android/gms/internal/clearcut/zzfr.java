...
interface zzfr {
    ...
    void zza(int i, zzbb com_google_android_gms_internal_clearcut_zzbb) throws IOException;

    <K, V> void zza(int i, zzdh<K, V> com_google_android_gms_internal_clearcut_zzdh_K__V, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzef com_google_android_gms_internal_clearcut_zzef) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzef com_google_android_gms_internal_clearcut_zzef) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzef com_google_android_gms_internal_clearcut_zzef) throws IOException;

    void zzb(int i, List<zzbb> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzef com_google_android_gms_internal_clearcut_zzef) throws IOException;
