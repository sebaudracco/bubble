...
public enum zzcb {
    ...
    static {
        ...
        int i;
        while (i < length) {
            zzcb com_google_android_gms_internal_clearcut_zzcb = values[i];
            zzjb[com_google_android_gms_internal_clearcut_zzcb.id] = com_google_android_gms_internal_clearcut_zzcb;
            i++;
        }
    }

    private zzcb(int i, zzcd com_google_android_gms_internal_clearcut_zzcd, zzcq com_google_android_gms_internal_clearcut_zzcq) {
        this.id = i;
        this.zziy = com_google_android_gms_internal_clearcut_zzcd;
        this.zzix = com_google_android_gms_internal_clearcut_zzcq;
        switch (zzcc.zzje[com_google_android_gms_internal_clearcut_zzcd.ordinal()]) {
            case 1:
                this.zziz = com_google_android_gms_internal_clearcut_zzcq.zzbq();
                break;
            case 2:
                this.zziz = com_google_android_gms_internal_clearcut_zzcq.zzbq();
                break;
        ...
        boolean z = false;
        if (com_google_android_gms_internal_clearcut_zzcd == zzcd.SCALAR) {
            switch (zzcc.zzjf[com_google_android_gms_internal_clearcut_zzcq.ordinal()]) {
                case 1:
                case 2:
                case 3:
                    break;
