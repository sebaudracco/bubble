...
public final class zzad extends GmsClient<zzq> {
    ...
    public final void zza(CreateWalletObjectsRequest createWalletObjectsRequest, int i) {
        ...
        try {
            ((zzq) getService()).zza(createWalletObjectsRequest, zzd(), com_google_android_gms_internal_wallet_zzae);
        } catch (Throwable e) {
            Log.e("WalletClientImpl", "RemoteException creating wallet objects", e);
            com_google_android_gms_internal_wallet_zzae.zza(8, Bundle.EMPTY);
        }
    }
    ...
    public final void zza(CreateWalletObjectsRequest createWalletObjectsRequest, TaskCompletionSource<AutoResolvableVoidResult> taskCompletionSource) {
        ...
        zzu com_google_android_gms_internal_wallet_zzah = new zzah(taskCompletionSource);
        try {
            ((zzq) getService()).zza(createWalletObjectsRequest, zzd, com_google_android_gms_internal_wallet_zzah);
        } catch (Throwable e) {
            Log.e("WalletClientImpl", "RemoteException creating wallet objects", e);
            com_google_android_gms_internal_wallet_zzah.zza(8, Bundle.EMPTY);
        }
    }
    ...
    public final void zza(IsReadyToPayRequest isReadyToPayRequest, TaskCompletionSource<Boolean> taskCompletionSource) throws RemoteException {
        zzu com_google_android_gms_internal_wallet_zzag = new zzag(taskCompletionSource);
        try {
            ((zzq) getService()).zza(isReadyToPayRequest, zzd(), com_google_android_gms_internal_wallet_zzag);
        } catch (Throwable e) {
            Log.e("WalletClientImpl", "RemoteException during isReadyToPay", e);
            com_google_android_gms_internal_wallet_zzag.zza(Status.RESULT_INTERNAL_ERROR, false, Bundle.EMPTY);
        }
    }
    ...
    public final void zza(MaskedWalletRequest maskedWalletRequest, int i) {
        ...
        Bundle zzd = zzd();
        zzu com_google_android_gms_internal_wallet_zzae = new zzae(activity, i);
        try {
            ((zzq) getService()).zza(maskedWalletRequest, zzd, com_google_android_gms_internal_wallet_zzae);
        } catch (Throwable e) {
    ...
    public final void zza(PaymentDataRequest paymentDataRequest, TaskCompletionSource<PaymentData> taskCompletionSource) {
        Bundle zzd = zzd();
        zzd.putBoolean("com.google.android.gms.wallet.EXTRA_USING_AUTO_RESOLVABLE_RESULT", true);
        zzu com_google_android_gms_internal_wallet_zzaj = new zzaj(taskCompletionSource);
        try {
            ((zzq) getService()).zza(paymentDataRequest, zzd, com_google_android_gms_internal_wallet_zzaj);
        } catch (Throwable e) {
            Log.e("WalletClientImpl", "RemoteException getting payment data", e);
            com_google_android_gms_internal_wallet_zzaj.zza(Status.RESULT_INTERNAL_ERROR, null, Bundle.EMPTY);
        }
    }
    ...
    public final void zza(String str, String str2, int i) {
        Activity activity = (Activity) this.zzgh;
        Bundle zzd = zzd();
        Object com_google_android_gms_internal_wallet_zzae = new zzae(activity, i);
        try {
            ((zzq) getService()).zza(str, str2, zzd, com_google_android_gms_internal_wallet_zzae);
        } catch (Throwable e) {
    ...
    public final void zzb(int i) {
        Bundle zzd = zzd();
        Object com_google_android_gms_internal_wallet_zzae = new zzae((Activity) this.zzgh, i);
        try {
            ((zzq) getService()).zza(zzd, com_google_android_gms_internal_wallet_zzae);
        } catch (Throwable e) {
            Log.e("WalletClientImpl", "RemoteException during checkForPreAuthorization", e);
            com_google_android_gms_internal_wallet_zzae.zza(8, false, Bundle.EMPTY);
        }
    }
}
