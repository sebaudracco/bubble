...
public final class MaskedWallet extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Constructor
    MaskedWallet(@Param(id = 2) String str, @Param(id = 3) String str2, @Param(id = 4) String[] strArr, @Param(id = 5) String str3, @Param(id = 6) zza com_google_android_gms_wallet_zza, @Param(id = 7) zza com_google_android_gms_wallet_zza2, @Param(id = 8) LoyaltyWalletObject[] loyaltyWalletObjectArr, @Param(id = 9) OfferWalletObject[] offerWalletObjectArr, @Param(id = 10) UserAddress userAddress, @Param(id = 11) UserAddress userAddress2, @Param(id = 12) InstrumentInfo[] instrumentInfoArr) {
        this.zzaw = str;
        this.zzax = str2;
        this.zzbc = strArr;
        this.zzaz = str3;
