...
public final class FullWallet extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Constructor
    FullWallet(@Param(id = 2) String str, @Param(id = 3) String str2, @Param(id = 4) ProxyCard proxyCard, @Param(id = 5) String str3, @Param(id = 6) zza com_google_android_gms_wallet_zza, @Param(id = 7) zza com_google_android_gms_wallet_zza2, @Param(id = 8) String[] strArr, @Param(id = 9) UserAddress userAddress, @Param(id = 10) UserAddress userAddress2, @Param(id = 11) InstrumentInfo[] instrumentInfoArr, @Param(id = 12) PaymentMethodToken paymentMethodToken) {
        this.zzaw = str;
        this.zzax = str2;
        this.zzay = proxyCard;
        this.zzaz = str3;
