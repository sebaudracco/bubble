...
public class Configuration extends AbstractSafeParcelable implements Comparable<Configuration> {
    ...
    @Constructor
    public Configuration(@Param(id = 2) int i, @Param(id = 3) zzi[] com_google_android_gms_phenotype_zziArr, @Param(id = 4) String[] strArr) {
        this.zzc = i;
        this.zzd = com_google_android_gms_phenotype_zziArr;
        for (zzi com_google_android_gms_phenotype_zzi : com_google_android_gms_phenotype_zziArr) {
            this.zzf.put(com_google_android_gms_phenotype_zzi.name, com_google_android_gms_phenotype_zzi);
        }
        this.zze = strArr;
        if (this.zze != null) {
