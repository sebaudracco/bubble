...
public final class zzi extends AbstractSafeParcelable implements Comparable<zzi> {
    ...
    public final /* synthetic */ int compareTo(Object obj) {
        ...
        int compareTo = this.name.compareTo(com_google_android_gms_phenotype_zzi.name);
        if (compareTo != 0) {
            return compareTo;
        }
        compareTo = compare(this.zzag, com_google_android_gms_phenotype_zzi.zzag);
        if (compareTo != 0) {
            return compareTo;
        }
        switch (this.zzag) {
            case 1:
                long j = this.zzab;
                long j2 = com_google_android_gms_phenotype_zzi.zzab;
                return j < j2 ? -1 : j != j2 ? 1 : 0;
            case 2:
                boolean z = this.zzac;
                return z != com_google_android_gms_phenotype_zzi.zzac ? z ? 1 : -1 : 0;
            case 3:
                return Double.compare(this.zzad, com_google_android_gms_phenotype_zzi.zzad);
            case 4:
                String str = this.zzae;
                String str2 = com_google_android_gms_phenotype_zzi.zzae;
                return str != str2 ? str == null ? -1 : str2 == null ? 1 : str.compareTo(str2) : 0;
            case 5:
                if (this.zzaf == com_google_android_gms_phenotype_zzi.zzaf) {
                    return 0;
                }
                if (this.zzaf == null) {
                    return -1;
                }
                if (com_google_android_gms_phenotype_zzi.zzaf == null) {
                    return 1;
                }
                while (i < Math.min(this.zzaf.length, com_google_android_gms_phenotype_zzi.zzaf.length)) {
                    compareTo = this.zzaf[i] - com_google_android_gms_phenotype_zzi.zzaf[i];
                    if (compareTo != 0) {
                        return compareTo;
                    }
                    i++;
                }
                return compare(this.zzaf.length, com_google_android_gms_phenotype_zzi.zzaf.length);
            default:
    ...
    public final boolean equals(Object obj) {
        ...
        zzi com_google_android_gms_phenotype_zzi = (zzi) obj;
        if (!zzn.equals(this.name, com_google_android_gms_phenotype_zzi.name) || this.zzag != com_google_android_gms_phenotype_zzi.zzag || this.zzah != com_google_android_gms_phenotype_zzi.zzah) {
            return false;
        }
        switch (this.zzag) {
            case 1:
                return this.zzab == com_google_android_gms_phenotype_zzi.zzab;
            case 2:
                return this.zzac == com_google_android_gms_phenotype_zzi.zzac;
            case 3:
                return this.zzad == com_google_android_gms_phenotype_zzi.zzad;
            case 4:
                return zzn.equals(this.zzae, com_google_android_gms_phenotype_zzi.zzae);
            case 5:
                return Arrays.equals(this.zzaf, com_google_android_gms_phenotype_zzi.zzaf);
            default:
                throw new AssertionError("Invalid enum value: " + this.zzag);
        }
    }
