...
public final class zzf implements Creator<zze> {
    public final /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        int[] iArr2 = null;
        byte[] bArr2 = null;
        zzr com_google_android_gms_internal_clearcut_zzr = null;
        while (parcel.dataPosition() < validateObjectHeader) {
            int readHeader = SafeParcelReader.readHeader(parcel);
            switch (SafeParcelReader.getFieldId(readHeader)) {
                case 2:
                    com_google_android_gms_internal_clearcut_zzr = (zzr) SafeParcelReader.createParcelable(parcel, readHeader, zzr.CREATOR);
                    break;
                case 3:
        ...
        return new zze(com_google_android_gms_internal_clearcut_zzr, bArr2, iArr2, strArr, iArr, bArr, z, experimentTokensArr);
    }
