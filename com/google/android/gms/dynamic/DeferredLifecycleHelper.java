...
public abstract class DeferredLifecycleHelper<T extends LifecycleDelegate> {
    ...
    public static void showGooglePlayUnavailableMessage(FrameLayout frameLayout) {
        GoogleApiAvailabilityLight instance = GoogleApiAvailability.getInstance();
    ...
    private final void zza(Bundle bundle, zza com_google_android_gms_dynamic_DeferredLifecycleHelper_zza) {
        if (this.zzabc != null) {
            com_google_android_gms_dynamic_DeferredLifecycleHelper_zza.zza(this.zzabc);
            return;
        }
        if (this.zzabe == null) {
            this.zzabe = new LinkedList();
        }
        this.zzabe.add(com_google_android_gms_dynamic_DeferredLifecycleHelper_zza);
        if (bundle != null) {
            if (this.zzabd == null) {
