...
public final class GmsLogger {
    ...
    public GmsLogger(String str, String str2) {
        ...
        Preconditions.checkArgument(str.length() <= 23, "tag \"%s\" is longer than the %d character maximum", new Object[]{str, Integer.valueOf(23)});
        this.zzuc = str;
    ...
    public final void m8587d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zzl(str2));
        }
    }

    public final void m8588d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    public final void m8589e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zzl(str2));
        }
    }

    public final void m8590e(String str, String str2, Throwable th) {
        if (canLog(6)) {
    ...
    public final void m8591i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zzl(str2));
        }
    }

    public final void m8592i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    public final void m8593v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zzl(str2));
        }
    }

    public final void m8594v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    public final void m8595w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zzl(str2));
        }
    }

    public final void m8596w(String str, String str2, Throwable th) {
        if (canLog(5)) {
