...
public final class CrossFadingDrawable extends Drawable implements Callback {
    ...
    static final class zzb extends ConstantState {
        ...
        zzb(zzb com_google_android_gms_common_images_internal_CrossFadingDrawable_zzb) {
            if (com_google_android_gms_common_images_internal_CrossFadingDrawable_zzb != null) {
                this.mChangingConfigurations = com_google_android_gms_common_images_internal_CrossFadingDrawable_zzb.mChangingConfigurations;
                this.zzql = com_google_android_gms_common_images_internal_CrossFadingDrawable_zzb.zzql;
            }
        }
    ...
    public CrossFadingDrawable(Drawable drawable, Drawable drawable2) {
        ...
        zzb com_google_android_gms_common_images_internal_CrossFadingDrawable_zzb = this.zzqc;
        com_google_android_gms_common_images_internal_CrossFadingDrawable_zzb.zzql |= drawable.getChangingConfigurations();
        if (drawable2 == null) {
            drawable2 = zza.zzqj;
        }
        this.zzqe = drawable2;
        drawable2.setCallback(this);
        com_google_android_gms_common_images_internal_CrossFadingDrawable_zzb = this.zzqc;
        com_google_android_gms_common_images_internal_CrossFadingDrawable_zzb.zzql |= drawable2.getChangingConfigurations();
    }

    CrossFadingDrawable(zzb com_google_android_gms_common_images_internal_CrossFadingDrawable_zzb) {
        this.zzpw = 0;
        this.zzpz = 255;
        this.mAlpha = 0;
        this.zzpl = true;
        this.zzqc = new zzb(com_google_android_gms_common_images_internal_CrossFadingDrawable_zzb);
    }
