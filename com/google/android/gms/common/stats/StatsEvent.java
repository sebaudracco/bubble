...
public abstract class StatsEvent extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public String toString() {
        ...
        return new StringBuilder(String.valueOf(specificString).length() + 53).append(timeMillis).append(Utils.FILE_SEPARATOR).append(eventType).append(Utils.FILE_SEPARATOR).append(durationMillis).append(specificString).toString();
    }
}
