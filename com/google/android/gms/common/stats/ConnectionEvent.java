...
public final class ConnectionEvent extends StatsEvent {
    ...
    public final String getSpecificString() {
        ...
        return new StringBuilder(((((String.valueOf(callingProcess).length() + 26) + String.valueOf(callingService).length()) + String.valueOf(targetProcess).length()) + String.valueOf(targetService).length()) + String.valueOf(str).length()).append(Utils.FILE_SEPARATOR).append(callingProcess).append(BridgeUtil.SPLIT_MARK).append(callingService).append(Utils.FILE_SEPARATOR).append(targetProcess).append(BridgeUtil.SPLIT_MARK).append(targetService).append(Utils.FILE_SEPARATOR).append(str).append(Utils.FILE_SEPARATOR).append(getHeapAlloc()).toString();
    }
