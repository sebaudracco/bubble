...
public final class WakeLockEvent extends StatsEvent {
    ...
    public final String getSpecificString() {
        ...
        return new StringBuilder(((((String.valueOf(wakeLockName).length() + 45) + String.valueOf(join).length()) + String.valueOf(secondaryWakeLockName).length()) + String.valueOf(hostPackage).length()) + String.valueOf(codePackage).length()).append(Utils.FILE_SEPARATOR).append(wakeLockName).append(Utils.FILE_SEPARATOR).append(wakeLockType).append(Utils.FILE_SEPARATOR).append(join).append(Utils.FILE_SEPARATOR).append(deviceState).append(Utils.FILE_SEPARATOR).append(secondaryWakeLockName).append(Utils.FILE_SEPARATOR).append(hostPackage).append(Utils.FILE_SEPARATOR).append(beginPowerPercentage).append(Utils.FILE_SEPARATOR).append(codePackage).toString();
    }
