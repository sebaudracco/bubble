...
public final class zzch<R extends Result> extends TransformedResult<R> implements ResultCallback<R> {
    ...
    public final <S extends Result> TransformedResult<S> then(@NonNull ResultTransform<? super R, ? extends S> resultTransform) {
        TransformedResult com_google_android_gms_common_api_internal_zzch;
        boolean z = true;
        synchronized (this.zzfa) {
            ...
            com_google_android_gms_common_api_internal_zzch = new zzch(this.zzfc);
            this.zzme = com_google_android_gms_common_api_internal_zzch;
            zzcb();
        }
