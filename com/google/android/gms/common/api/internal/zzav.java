...
public final class zzav extends GoogleApiClient implements zzbq {
    ...
    public zzav(Context context, Lock lock, Looper looper, ClientSettings clientSettings, GoogleApiAvailability googleApiAvailability, AbstractClientBuilder<? extends SignInClient, SignInOptions> abstractClientBuilder, Map<Api<?>, Boolean> map, List<ConnectionCallbacks> list, List<OnConnectionFailedListener> list2, Map<Api$AnyClientKey<?>, Client> map2, int i, int i2, ArrayList<zzp> arrayList, boolean z) {
    ...
    public final PendingResult<Status> clearDefaultAccountAndReconnect() {
        ...
        PendingResult statusPendingResult = new StatusPendingResult(this);
    ...
    @NonNull
    public final <C extends Client> C getClient(@NonNull Api$AnyClientKey<C> api$AnyClientKey) {
        Client client = (Client) this.zzil.get(api$AnyClientKey);
