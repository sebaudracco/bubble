...
public final class ArrayUtils {
    ...
    private static class zza {
        ...
        private final zza zzd(Object obj) {
            zza com_google_android_gms_common_util_zza = (zza) this.zzzb.get(obj);
            if (com_google_android_gms_common_util_zza != null) {
                return com_google_android_gms_common_util_zza;
            }
            com_google_android_gms_common_util_zza = new zza();
            this.zzzb.put(obj, com_google_android_gms_common_util_zza);
            return com_google_android_gms_common_util_zza;
        }
    ...
    public static boolean equalsAnyOrder(Object[] objArr, Object[] objArr2) {
        ...
        zza com_google_android_gms_common_util_ArrayUtils_zza = new zza(length);
        for (Object zzb : objArr) {
            com_google_android_gms_common_util_ArrayUtils_zza.zzb(zzb);
        }
        for (Object zzb2 : objArr2) {
            com_google_android_gms_common_util_ArrayUtils_zza.zzc(zzb2);
        }
        for (zza com_google_android_gms_common_util_zza : com_google_android_gms_common_util_ArrayUtils_zza.zzzb.values()) {
            if (com_google_android_gms_common_util_zza.count != 0) {
                return false;
            }
        }
        return true;
