    ...
    private static synchronized String zza(Context context, String str, String str2, int i) {
        ...
        synchronized (CrashUtils.class) {
            ...
            if (i2 > 0) {
                ...
                try {
                    Process start = new ProcessBuilder(new String[]{"/system/bin/logcat", "-v", "time", "-b", Constants.VIDEO_TRACKING_EVENTS_KEY, "-b", "system", "-b", "main", "-b", AppMeasurement.CRASH_ORIGIN, "-t", String.valueOf(i2)}).redirectErrorStream(true).start();
                    try {
