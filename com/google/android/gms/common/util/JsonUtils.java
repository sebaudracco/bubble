        ...
        while (matcher.find()) {
            ...
            switch (matcher.group().charAt(1)) {
                case '\"':
                    ...
                    break;
                case '/':
                    matcher.appendReplacement(stringBuffer, BridgeUtil.SPLIT_MARK);
                    break;
                case '\\':
                    matcher.appendReplacement(stringBuffer, "\\\\");
                    break;
                ...
                case 'n':
                    ...
                    break;
                case 'r':
                    matcher.appendReplacement(stringBuffer, LineSeparator.Macintosh);
                    break;
                case 't':
                    matcher.appendReplacement(stringBuffer, Utils.FILE_SEPARATOR);
                    break;
                default:
