        ...
        if (i == 18) {
            ...
            if (DeviceProperties.isWearable(context)) {
                ...
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    style.addAction(C1579R.drawable.common_full_open_on_phone, resources.getString(C1579R.string.common_open_on_phone), pendingIntent);
                } else {
