...
final class zzn {
    ...
    private static com.google.android.gms.iid.zzo zzd(java.io.File r7) throws com.google.android.gms.iid.zzp, java.io.IOException {
        /*
        r1 = 0;
    ...
    private final void zze(Context context, String str, zzo com_google_android_gms_iid_zzo) {
        SharedPreferences sharedPreferences = context.getSharedPreferences("com.google.android.gms.appid", 0);
        try {
            if (com_google_android_gms_iid_zzo.equals(zzd(sharedPreferences, str))) {
                return;
            }
        } catch (zzp e) {
        }
        ...
        edit.putString(zzak.zzh(str, "|P|"), com_google_android_gms_iid_zzo.zzo());
        edit.putString(zzak.zzh(str, "|K|"), com_google_android_gms_iid_zzo.zzp());
        edit.putString(zzak.zzh(str, "cre"), String.valueOf(com_google_android_gms_iid_zzo.zzbx));
        edit.commit();
    }
    ...
    private final zzo zzh(Context context, String str) throws zzp {
        zzp com_google_android_gms_iid_zzp;
        zzp com_google_android_gms_iid_zzp2;
        try {
            ...
            com_google_android_gms_iid_zzp = null;
            try {
                ...
                com_google_android_gms_iid_zzp2 = com_google_android_gms_iid_zzp;
                if (com_google_android_gms_iid_zzp2 == null) {
                    return null;
                }
                throw com_google_android_gms_iid_zzp2;
            } catch (zzp e) {
                com_google_android_gms_iid_zzp2 = e;
            }
        } catch (zzp com_google_android_gms_iid_zzp22) {
            com_google_android_gms_iid_zzp = com_google_android_gms_iid_zzp22;
        }
    }
    ...
    final zzo zzf(Context context, String str) {
        zzo com_google_android_gms_iid_zzo = new zzo(zzd.zzk(), System.currentTimeMillis());
        try {
            zzo zzh = zzh(context, str);
            if (zzh != null) {
                if (!Log.isLoggable("InstanceID", 3)) {
        ...
        zzd(context, str, com_google_android_gms_iid_zzo);
        zze(context, str, com_google_android_gms_iid_zzo);
        return com_google_android_gms_iid_zzo;
    }
}
