...
public final class zzak {
    ...
    @VisibleForTesting
    private zzak(Context context, zzn com_google_android_gms_iid_zzn) {
        this.zzdb = new ArrayMap();
        this.zzk = context;
        this.zzcz = context.getSharedPreferences("com.google.android.gms.appid", 0);
        this.zzda = com_google_android_gms_iid_zzn;
    ...
    public final synchronized zzo zzj(String str) {
        zzo com_google_android_gms_iid_zzo;
        com_google_android_gms_iid_zzo = (zzo) this.zzdb.get(str);
        if (com_google_android_gms_iid_zzo == null) {
            try {
                com_google_android_gms_iid_zzo = this.zzda.zze(this.zzk, str);
            } catch (zzp e) {
                Log.w("InstanceID/Store", "Stored data is corrupt, generating new identity");
                InstanceIDListenerService.zzd(this.zzk, this);
                com_google_android_gms_iid_zzo = this.zzda.zzf(this.zzk, str);
            }
            this.zzdb.put(str, com_google_android_gms_iid_zzo);
        }
