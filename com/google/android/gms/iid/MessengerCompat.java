...
public class MessengerCompat implements ReflectedParcelable {
    ...
    public MessengerCompat(IBinder iBinder) {
        ...
        zzl com_google_android_gms_iid_zzl;
        if (iBinder == null) {
            com_google_android_gms_iid_zzl = null;
        } else {
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.iid.IMessengerCompat");
            com_google_android_gms_iid_zzl = queryLocalInterface instanceof zzl ? (zzl) queryLocalInterface : new zzm(iBinder);
        }
        this.zzby = com_google_android_gms_iid_zzl;
    }
