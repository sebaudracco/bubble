...
public abstract class GcmTaskService extends Service {
    ...
    class zze implements Runnable {
        ...
        zze(GcmTaskService gcmTaskService, @NonNull String str, IBinder iBinder, Bundle bundle, List<Uri> list) {
            zzg com_google_android_gms_gcm_zzg;
            this.zzy = gcmTaskService;
            this.tag = str;
            if (iBinder == null) {
                com_google_android_gms_gcm_zzg = null;
            } else {
                IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.gcm.INetworkTaskCallback");
                com_google_android_gms_gcm_zzg = queryLocalInterface instanceof zzg ? (zzg) queryLocalInterface : new zzh(iBinder);
            }
            this.zzaa = com_google_android_gms_gcm_zzg;
            this.extras = bundle;
            this.zzz = list;
            this.zzab = null;
        }

        zze(GcmTaskService gcmTaskService, @NonNull String str, Messenger messenger, Bundle bundle, List<Uri> list) {
            this.zzy = gcmTaskService;
            this.tag = str;
            this.zzab = messenger;
            this.extras = bundle;
    ...
    private final void zzd(zze com_google_android_gms_gcm_GcmTaskService_zze) {
        try {
            this.zzu.execute(com_google_android_gms_gcm_GcmTaskService_zze);
        } catch (Throwable e) {
            Log.e("GcmTaskService", "Executor is shutdown. onDestroy was called but main looper had an unprocessed start task message. The task will be retried with backoff delay.", e);
            com_google_android_gms_gcm_GcmTaskService_zze.zze(1);
        }
    }
