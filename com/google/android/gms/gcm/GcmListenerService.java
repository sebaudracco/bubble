        ...
        if ("com.google.android.c2dm.intent.RECEIVE".equals(intent.getAction())) {
            ...
            switch (obj) {
                case null:
                    ...
                    Object obj2 = (SchemaSymbols.ATTVAL_TRUE_1.equals(zzd.zzd(extras, "gcm.n.e")) || zzd.zzd(extras, "gcm.n.icon") != null) ? 1 : null;
                    if (obj2 != null) {
                        Bundle bundle;
                        Iterator it;
                        String string;
                        if (!((KeyguardManager) getSystemService("keyguard")).inKeyguardRestrictedInputMode()) {
                            ...
                            List<RunningAppProcessInfo> runningAppProcesses = ((ActivityManager) getSystemService(C1404b.aw)).getRunningAppProcesses();
