...
final class zzd {
    ...
    static synchronized zzd zzd(Context context) {
        ...
        synchronized (zzd.class) {
            ...
            com_google_android_gms_gcm_zzd = zzj;
        }
        return com_google_android_gms_gcm_zzd;
    }
    ...
    private final String zze(Bundle bundle, String str) {
        ...
        int identifier = resources.getIdentifier(valueOf, SchemaSymbols.ATTVAL_STRING, this.zzk.getPackageName());
        if (identifier == 0) {
                        ...
                        if (PlatformVersion.isAtLeastO()) {
                            ...
                            if (this.zzl != null) {
                                ...
                                if (notificationManager.getNotificationChannel("fcm_fallback_notification_channel") == null) {
                                    notificationManager.createNotificationChannel(new NotificationChannel("fcm_fallback_notification_channel", this.zzk.getString(C2793R.string.gcm_fallback_notification_channel_label), 3));
                                }
