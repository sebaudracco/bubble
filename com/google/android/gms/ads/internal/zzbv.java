...
public final class zzbv {
    ...
    static {
        ...
        synchronized (sLock) {
            zzabf = com_google_android_gms_ads_internal_zzbv;
        }
    }

    protected zzbv() {
        int i = VERSION.SDK_INT;
        zzakq com_google_android_gms_internal_ads_zzala = i >= 21 ? new zzala() : i >= 19 ? new zzakz() : i >= 18 ? new zzakx() : i >= 17 ? new zzakw() : i >= 16 ? new zzaky() : new zzakv();
        this.zzabm = com_google_android_gms_internal_ads_zzala;
        this.zzabn = new zzgg();
    ...
    private static zzbv zzef() {
        ...
        synchronized (sLock) {
            com_google_android_gms_ads_internal_zzbv = zzabf;
        }
