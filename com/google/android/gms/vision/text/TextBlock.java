        ...
        if (this.cornerPoints == null) {
            if (this.zzcw.length == 0) {
                ...
                for (zzt com_google_android_gms_internal_vision_zzt : this.zzcw) {
                    zzn com_google_android_gms_internal_vision_zzn = com_google_android_gms_internal_vision_zzt.zzde;
                    zzn com_google_android_gms_internal_vision_zzn2 = this.zzcw[0].zzde;
                    int i8 = -com_google_android_gms_internal_vision_zzn2.left;
                    int i9 = -com_google_android_gms_internal_vision_zzn2.top;
                    ...
                    pointArr[0].x = i2;
                    pointArr[0].y = i8;
                    pointArr[1] = new Point(com_google_android_gms_internal_vision_zzn.width + i2, i8);
                    pointArr[2] = new Point(com_google_android_gms_internal_vision_zzn.width + i2, com_google_android_gms_internal_vision_zzn.height + i8);
                    pointArr[3] = new Point(i2, com_google_android_gms_internal_vision_zzn.height + i8);
                    i3 = 0;
                    while (i3 < 4) {
                ...
                zzn com_google_android_gms_internal_vision_zzn3 = this.zzcw[0].zzde;
                i3 = com_google_android_gms_internal_vision_zzn3.left;
                i2 = com_google_android_gms_internal_vision_zzn3.top;
