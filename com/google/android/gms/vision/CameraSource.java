...
public class CameraSource {
    ...
    private CameraSource() {
        this.zzd = new Object();
        this.zzf = 0;
        this.zzi = BitmapDescriptorFactory.HUE_ORANGE;
        this.zzj = 1024;
        this.zzk = 768;
        this.zzl = false;
    ...
    private final Camera zza() throws IOException {
        ...
        while (i7 < size4) {
            ...
            int i8 = i7 + 1;
            zze com_google_android_gms_vision_CameraSource_zze3 = (zze) arrayList2.get(i7);
        ...
        if (com_google_android_gms_vision_CameraSource_zze == null) {
            throw new IOException("Could not find suitable preview size.");
        }
        Size zzc = com_google_android_gms_vision_CameraSource_zze.zzc();
        this.zzh = com_google_android_gms_vision_CameraSource_zze.zzb();
