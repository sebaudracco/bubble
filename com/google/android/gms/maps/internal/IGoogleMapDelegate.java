...
public interface IGoogleMapDelegate extends IInterface {
    ...
    void setOnMyLocationClickListener(zzaz com_google_android_gms_maps_internal_zzaz) throws RemoteException;

    void setOnPoiClickListener(zzbb com_google_android_gms_maps_internal_zzbb) throws RemoteException;

    void setOnPolygonClickListener(zzbd com_google_android_gms_maps_internal_zzbd) throws RemoteException;

    void setOnPolylineClickListener(zzbf com_google_android_gms_maps_internal_zzbf) throws RemoteException;
    ...
    void snapshot(zzbs com_google_android_gms_maps_internal_zzbs, IObjectWrapper iObjectWrapper) throws RemoteException;

    void snapshotForTest(zzbs com_google_android_gms_maps_internal_zzbs) throws RemoteException;
