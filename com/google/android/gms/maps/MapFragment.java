...
public class MapFragment extends Fragment {
    ...
    public final void onEnterAmbient(Bundle bundle) {
        ...
        zzb com_google_android_gms_maps_MapFragment_zzb = this.zzay;
        if (com_google_android_gms_maps_MapFragment_zzb.getDelegate() != null) {
            ((zza) com_google_android_gms_maps_MapFragment_zzb.getDelegate()).onEnterAmbient(bundle);
        }
    }
    ...
    public final void onExitAmbient() {
        ...
        zzb com_google_android_gms_maps_MapFragment_zzb = this.zzay;
        if (com_google_android_gms_maps_MapFragment_zzb.getDelegate() != null) {
            ((zza) com_google_android_gms_maps_MapFragment_zzb.getDelegate()).onExitAmbient();
        }
    }
