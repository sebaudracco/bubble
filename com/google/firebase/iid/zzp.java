...
final class zzp {
    ...
    L_0x0024:
        return r0;
    L_0x0025:
        r3 = zzc(r3, r4);	 Catch:{ Throwable -> 0x0044, all -> 0x004e }
        r4 = "cre";
        r0 = r0.getProperty(r4);	 Catch:{ NumberFormatException -> 0x003d }
        r4 = java.lang.Long.parseLong(r0);	 Catch:{ NumberFormatException -> 0x003d }
        r0 = new com.google.firebase.iid.zzq;	 Catch:{ Throwable -> 0x0044, all -> 0x004e }
        r0.<init>(r3, r4);	 Catch:{ Throwable -> 0x0044, all -> 0x004e }
        zza(r1, r2);
        goto L_0x0024;
    L_0x003d:
        r0 = move-exception;
        r3 = new com.google.firebase.iid.zzr;	 Catch:{ Throwable -> 0x0044, all -> 0x004e }
    ...
    private final zzq zzd(Context context, String str) throws zzr {
        ...
        try {
            ...
            try {
                ...
                com_google_firebase_iid_zzr2 = com_google_firebase_iid_zzr;
                if (com_google_firebase_iid_zzr2 == null) {
                    return null;
                }
                throw com_google_firebase_iid_zzr2;
            } catch (zzr e) {
                com_google_firebase_iid_zzr2 = e;
            }
        } catch (zzr com_google_firebase_iid_zzr22) {
            com_google_firebase_iid_zzr = com_google_firebase_iid_zzr22;
        }
    }
