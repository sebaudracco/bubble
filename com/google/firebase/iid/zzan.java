    ...
    private final int zzb(Context context, Intent intent) {
        ...
        if (str == null) {
            ...
            if (!context.getPackageName().equals(serviceInfo.packageName) || serviceInfo.name == null) {
                ...
                Log.e("FirebaseInstanceId", new StringBuilder((String.valueOf(str2).length() + 94) + String.valueOf(str).length()).append("Error resolving target intent service, skipping classname enforcement. Resolved service was: ").append(str2).append(BridgeUtil.SPLIT_MARK).append(str).toString());
                if (this.zzcn == null) {
