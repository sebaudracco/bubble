...
public class VersionInfo {
    ...
    public static VersionInfo loadVersionInfo(String pckg, ClassLoader clsldr) {
        ...
        Properties vip = null;
        try {
            is = cl.getResourceAsStream(pckg.replace('.', '/') + BridgeUtil.SPLIT_MARK + VERSION_PROPERTY_FILE);
            if (is != null) {
    ...
    public static String getUserAgent(String name, String pkg, Class<?> cls) {
        ...
        return name + BridgeUtil.SPLIT_MARK + (vi != null ? vi.getRelease() : UNAVAILABLE) + " (Java 1.5 minimum; Java/" + System.getProperty("java.version") + ")";
    }
}
