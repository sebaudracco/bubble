        ...
        try {
            if (firstTime) {
                synchronized (cacheProps) {
                    if (firstTime) {
                        configFile = new StringBuilder(String.valueOf(ss.getSystemProperty("java.home"))).append(File.separator).append("lib").append(File.separator).append("stax.properties").toString();
                        ...
                        if (ss.doesFileExist(f)) {
                            ...
                            configFile = new StringBuilder(String.valueOf(ss.getSystemProperty("java.home"))).append(File.separator).append("lib").append(File.separator).append("jaxp.properties").toString();
