...
public class EncodingMap {
    ...
    static {
        ...
        fIANA2JavaMap.put("US-ASCII", HTTP.ASCII);
        fIANA2JavaMap.put("ISO-IR-6", HTTP.ASCII);
        fIANA2JavaMap.put("ANSI_X3.4-1968", HTTP.ASCII);
        fIANA2JavaMap.put("ANSI_X3.4-1986", HTTP.ASCII);
        fIANA2JavaMap.put("ISO_646.IRV:1991", HTTP.ASCII);
        fIANA2JavaMap.put(HTTP.ASCII, HTTP.ASCII);
        fIANA2JavaMap.put("CSASCII", HTTP.ASCII);
        fIANA2JavaMap.put("ISO646-US", HTTP.ASCII);
        fIANA2JavaMap.put("US", HTTP.ASCII);
        fIANA2JavaMap.put("IBM367", HTTP.ASCII);
        fIANA2JavaMap.put("CP367", HTTP.ASCII);
        ...
        fIANA2JavaMap.put("IBM-367", HTTP.ASCII);
