...
public final class SchemaSymbols {
    ...
    public static final String ATT_NAMESPACE = FavaDiagnosticsEntity.EXTRA_NAMESPACE.intern();
    ...
    public static final String ATT_PUBLIC = HeaderConstants.PUBLIC.intern();
    ...
    public static final String ATT_VALUE = FirebaseAnalytics$Param.VALUE.intern();
    ...
    public static final String ELT_ALL = BannerAdRequest.TYPE_ALL.intern();
    ...
    public static final String ELT_EXTENSION = ATTVAL_EXTENSION.intern();
    ...
    public static final String ELT_KEY = C1028c.gv.intern();
    public static final String ELT_KEYREF = "keyref".intern();
    public static final String ELT_LENGTH = "length".intern();
    public static final String ELT_LIST = ATTVAL_LIST.intern();
    ...
    public static final String ELT_RESTRICTION = ATTVAL_RESTRICTION.intern();
    ...
    public static final String ELT_UNION = ATTVAL_UNION.intern();
    ...
    public static final String URI_XSI = XMLConstants.W3C_XML_SCHEMA_INSTANCE_NS_URI.intern();
