...
public class WMLDocumentImpl extends DocumentImpl implements WMLDocument {
    ...
    static {
        ...
        _elementTypesWML.put(BannerFormat.BANNER, WMLSmallElementImpl.class);
        ...
        _elementTypesWML.put(MetaBox.TYPE, WMLMetaElementImpl.class);
        ...
        _elementTypesWML.put(RequestParams.f9038U, WMLUElementImpl.class);
        ...
        _elementTypesWML.put(RequestParams.IP, WMLIElementImpl.class);
        _elementTypesWML.put(Token.TYPE_CARD, WMLCardElementImpl.class);
    }
