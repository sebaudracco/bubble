...
public class Util {
    ...
    private static final ThreadLocal<DateFormat> DATE_FORMAT_THREAD_LOCAL = new C47291();
    ...
    static class C47291 extends ThreadLocal<DateFormat> {
        C47291() {
        }
    ...
    public static String getAppName(Context context) {
        ...
        if (applicationInfo != null) {
            ...
            appTitle = context.getString(C4702R.string.hockeyapp_crash_dialog_app_name_fallback);
        }
        return appTitle;
    }
