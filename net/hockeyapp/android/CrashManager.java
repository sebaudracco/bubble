...
public class CrashManager {
    ...
    static class C46841 implements FilenameFilter {
        C46841() {
        }
    ...
    static class C46896 implements FilenameFilter {
        C46896() {
        }
    ...
    public static CrashDetails getLastCrashDetails() {
        ...
        for (File file : new File(Constants.FILES_PATH + BridgeUtil.SPLIT_MARK).listFiles(new C46841())) {
            ...
            for (int index = 0; index < list.length; index++) {
                ...
                try {
                    ...
                    if (stacktrace.length() > 0) {
                        ...
                        urlConnection = new HttpURLConnectionBuilder(getURLString()).setRequestMethod(HttpPost.METHOD_NAME).writeFormFields(parameters).build();
    ...
    private static void showDialog(final WeakReference<Context> weakContext, final CrashManagerListener listener, final boolean ignoreDefaultHandler) {
        ...
        if (context != null) {
            if (listener == null || !listener.onHandleAlertView()) {
                ...
                builder.setMessage(C4702R.string.hockeyapp_crash_dialog_message);
                builder.setNegativeButton(C4702R.string.hockeyapp_crash_dialog_negative_button, new OnClickListener() {
                ...
                builder.setNeutralButton(C4702R.string.hockeyapp_crash_dialog_neutral_button, new OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                ...
                builder.setPositiveButton(C4702R.string.hockeyapp_crash_dialog_positive_button, new OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
    ...
    private static String getAlertTitle(Context context) {
        ...
        return String.format(context.getString(C4702R.string.hockeyapp_crash_dialog_title), new Object[]{appTitle});
    }
    ...
    private static String[] searchForStackTraces() {
        if (Constants.FILES_PATH != null) {
            ...
            File dir = new File(Constants.FILES_PATH + BridgeUtil.SPLIT_MARK);
            if (dir.mkdir() || dir.exists()) {
                return dir.list(new C46896());
            }
            return new String[0];
        }
