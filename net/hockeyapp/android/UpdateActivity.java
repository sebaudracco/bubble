...
public class UpdateActivity extends Activity implements UpdateActivityInterface, UpdateInfoListener, OnClickListener {
    ...
    class C47031 implements DialogInterface.OnClickListener {
        C47031() {
        }
    ...
    class C47064 extends DownloadFileListener {
        C47064() {
        }
    ...
    class C47075 implements Runnable {
        C47075() {
        }
    ...
    class C47086 implements Runnable {
        C47086() {
        }
    ...
    class C47097 implements Runnable {
        C47097() {
        }
    ...
    protected Dialog onCreateDialog(int id, Bundle args) {
        switch (id) {
            case 0:
                return new Builder(this).setMessage("An error has occured").setCancelable(false).setTitle("Error").setIcon(17301543).setPositiveButton("OK", new C47031()).create();
            default:
                return null;
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (permissions.length != 0 && grantResults.length != 0 && requestCode == 1) {
            ...
            new Builder(this.mContext).setTitle(getString(C4702R.string.hockeyapp_permission_update_title)).setMessage(getString(C4702R.string.hockeyapp_permission_update_message)).setNegativeButton(getString(C4702R.string.hockeyapp_permission_dialog_negative_button), null).setPositiveButton(getString(C4702R.string.hockeyapp_permission_dialog_positive_button), new DialogInterface.OnClickListener() {
    ...
    public View getLayoutView() {
        return getLayoutInflater().inflate(C4702R.layout.hockeyapp_activity_update, null);
    }
    ...
    protected void configureView() {
        ((TextView) findViewById(C4702R.id.label_title)).setText(getAppName());
        final TextView versionLabel = (TextView) findViewById(C4702R.id.label_version);
            ...
            AsyncTaskUtils.execute(new GetFileSizeTask(this, getIntent().getStringExtra("url"), new DownloadFileListener() {
                public void downloadSuccessful(DownloadFileTask task) {
                    if (task instanceof GetFileSizeTask) {
                        ...
                        versionLabel.setText(UpdateActivity.this.getString(C4702R.string.hockeyapp_update_version_details_label, new Object[]{str, fileDate, appSizeString}));
                    }
                }
            }));
        }
        versionLabel.setText(getString(C4702R.string.hockeyapp_update_version_details_label, new Object[]{versionString, fileDate, appSizeString}));
        ((Button) findViewById(C4702R.id.button_update)).setOnClickListener(this);
        WebView webView = (WebView) findViewById(C4702R.id.web_update_details);
    ...
    protected void startDownloadTask(String url) {
        createDownloadTask(url, new C47064());
    ...
    public void enableUpdateButton() {
        findViewById(C4702R.id.button_update).setEnabled(true);
    }
    ...
    protected void prepareDownload() {
        if (!Util.isConnectedToNetwork(this.mContext)) {
            ...
            this.mError.setMessage(getString(C4702R.string.hockeyapp_error_no_network_message));
            runOnUiThread(new C47075());
