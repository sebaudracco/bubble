...
public class PaintActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, getString(C4702R.string.hockeyapp_paint_indicator_toast), 1).show();
    }

    public boolean onCreateOptionsMenu(Menu menu) {
        super.onCreateOptionsMenu(menu);
        menu.add(0, 1, 0, getString(C4702R.string.hockeyapp_paint_menu_save));
        menu.add(0, 2, 0, getString(C4702R.string.hockeyapp_paint_menu_undo));
        menu.add(0, 3, 0, getString(C4702R.string.hockeyapp_paint_menu_clear));
        return true;
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        OnClickListener dialogClickListener = new C47001();
        new Builder(this).setMessage(C4702R.string.hockeyapp_paint_dialog_message).setPositiveButton(C4702R.string.hockeyapp_paint_dialog_positive_button, dialogClickListener).setNegativeButton(C4702R.string.hockeyapp_paint_dialog_negative_button, dialogClickListener).setNeutralButton(C4702R.string.hockeyapp_paint_dialog_neutral_button, dialogClickListener).show();
        return true;
    }
    ...
    private void makeResult() {
        ...
        int suffix = 1;
        while (result.exists()) {
            result = new File(hockeyAppCache, this.mImageName + BridgeUtil.UNDERLINE_STR + suffix + ".jpg");
            suffix++;
        }
