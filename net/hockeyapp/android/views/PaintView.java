...
public class PaintView extends ImageView {
    ...
    class C47351 extends AsyncTask<Object, Void, Bitmap> {
        C47351() {
        }
    ...
    public PaintView(Context context, Uri imageUri, int displayWidth, int displayHeight) {
        ...
        new C47351().execute(new Object[]{context, imageUri, Integer.valueOf(displayWidth), Integer.valueOf(displayHeight)});
    }
