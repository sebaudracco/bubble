...
public class LoginActivity extends Activity {
    ...
    class C46991 implements OnClickListener {
        C46991() {
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(C4702R.layout.hockeyapp_activity_login);
    ...
    private void configureView() {
        if (this.mMode == 1) {
            ((EditText) findViewById(C4702R.id.input_password)).setVisibility(4);
        }
        ((TextView) findViewById(C4702R.id.text_headline)).setText(this.mMode == 1 ? C4702R.string.hockeyapp_login_headline_text_email_only : C4702R.string.hockeyapp_login_headline_text);
        this.mButtonLogin = (Button) findViewById(C4702R.id.button_login);
        this.mButtonLogin.setOnClickListener(new C46991());
    }
    ...
    private void performAuthentication() {
        if (Util.isConnectedToNetwork(this)) {
            String email = ((EditText) findViewById(C4702R.id.input_email)).getText().toString();
            String password = ((EditText) findViewById(C4702R.id.input_password)).getText().toString();
            boolean ready = false;
            ...
            Toast.makeText(this, getString(C4702R.string.hockeyapp_login_missing_credentials_toast), 1).show();
            return;
        }
