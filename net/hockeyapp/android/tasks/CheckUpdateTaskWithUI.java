...
public class CheckUpdateTaskWithUI extends CheckUpdateTask {
    ...
    class C47192 implements OnCancelListener {
        C47192() {
        }
    ...
    private void showDialog(final JSONArray updateInfo) {
        ...
        if (this.mActivity != null && !this.mActivity.isFinishing()) {
            ...
            builder.setTitle(C4702R.string.hockeyapp_update_dialog_title);
            if (this.mandatory.booleanValue()) {
                String appName = Util.getAppName(this.mActivity);
                Toast.makeText(this.mActivity, String.format(this.mActivity.getString(C4702R.string.hockeyapp_update_mandatory_toast), new Object[]{appName}), 1).show();
                startUpdateIntent(updateInfo, Boolean.valueOf(true));
                return;
            }
            builder.setMessage(C4702R.string.hockeyapp_update_dialog_message);
            builder.setNegativeButton(C4702R.string.hockeyapp_update_dialog_negative_button, new C47181());
            builder.setOnCancelListener(new C47192());
            builder.setPositiveButton(C4702R.string.hockeyapp_update_dialog_positive_button, new OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
