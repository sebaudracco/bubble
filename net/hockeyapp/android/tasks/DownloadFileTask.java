...
import net.hockeyapp.android.C4702R;
...
public class DownloadFileTask extends AsyncTask<Void, Integer, Long> {
    ...
    class C47211 implements OnClickListener {
        C47211() {
        }
    ...
    class C47222 implements OnClickListener {
        C47222() {
        }
    ...
    protected URLConnection createConnection(URL url, int remainingRedirects) throws IOException {
        ...
        if ((code != HttpStatus.SC_MOVED_PERMANENTLY && code != HttpStatus.SC_MOVED_TEMPORARILY && code != HttpStatus.SC_SEE_OTHER) || remainingRedirects == 0) {
            return connection;
        }
        URL movedUrl = new URL(connection.getHeaderField(HttpHeaders.LOCATION));
    ...
    protected void onPostExecute(Long result) {
        ...
        try {
            ...
            builder.setTitle(C4702R.string.hockeyapp_download_failed_dialog_title);
            if (this.mDownloadErrorMessage == null) {
                message = this.mContext.getString(C4702R.string.hockeyapp_download_failed_dialog_message);
            } else {
                message = this.mDownloadErrorMessage;
            }
            builder.setMessage(message);
            builder.setNegativeButton(C4702R.string.hockeyapp_download_failed_dialog_negative_button, new C47211());
            builder.setPositiveButton(C4702R.string.hockeyapp_download_failed_dialog_positive_button, new C47222());
            builder.create().show();
        } catch (Exception e2) {
        }
    }
