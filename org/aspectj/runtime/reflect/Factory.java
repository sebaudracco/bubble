...
public final class Factory {
    ...
    static {
        ...
        prims.put(SchemaSymbols.ATTVAL_BOOLEAN, Boolean.TYPE);
        prims.put(SchemaSymbols.ATTVAL_BYTE, Byte.TYPE);
        prims.put("char", Character.TYPE);
        prims.put(SchemaSymbols.ATTVAL_SHORT, Short.TYPE);
        prims.put(SchemaSymbols.ATTVAL_INT, Integer.TYPE);
        prims.put(SchemaSymbols.ATTVAL_LONG, Long.TYPE);
        prims.put(SchemaSymbols.ATTVAL_FLOAT, Float.TYPE);
        prims.put(SchemaSymbols.ATTVAL_DOUBLE, Double.TYPE);
    }
