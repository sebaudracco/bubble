...
class MessagesController$60 implements Runnable {
    ...
    class C50251 implements Runnable {
        C50251() {
        }
    ...
    public void run() {
        ...
        AndroidUtilities.runOnUIThread(new C50251());
    }
}
