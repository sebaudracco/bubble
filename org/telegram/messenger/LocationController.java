...
public class LocationController implements NotificationCenterDelegate {
    ...
    class C49376 implements Runnable {
        C49376() {
        }
        ...
        public void run() {
            ...
            if (!result.isEmpty()) {
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    class C49351 implements Runnable {

                        class C49341 implements Runnable {
                            C49341() {
                            }
                        ...
                        public void run() {
                            ...
                            AndroidUtilities.runOnUIThread(new C49341());
                        }
                    }
                    ...
                    public void run() {
                        ...
                        Utilities.stageQueue.postRunnable(new C49351());
                    }
                });
            }
        }
    ...
    class C49449 implements Runnable {

        class C49421 implements RequestDelegate {
            C49421() {
            }
        ...
        class C49432 implements Runnable {
            C49432() {
            }
        ...
        public void run() {
            for (int a = 0; a < LocationController.this.sharingLocations.size(); a++) {
                ...
                ConnectionsManager.getInstance().sendRequest(req, new C49421());
            }
            LocationController.this.sharingLocations.clear();
            LocationController.this.sharingLocationsMap.clear();
            LocationController.this.saveSharingLocation(null, 2);
            LocationController.this.stop(true);
            AndroidUtilities.runOnUIThread(new C49432());
        }
    }
    ...
    private class GpsLocationListener implements LocationListener {
        ...
        public void onLocationChanged(Location location) {
            if (location != null) {
                ...
                } else if (!LocationController.this.started && location.distanceTo(LocationController.this.lastKnownLocation) > CloseButton.TEXT_SIZE_SP) {
                    LocationController.this.lastKnownLocation = location;
        ...
        if (this.lastKnownLocation != null) {
            ...
            for (a = 0; a < this.sharingLocations.size(); a++) {
                ...
                final int[] reqId = new int[]{ConnectionsManager.getInstance().sendRequest(req, new RequestDelegate() {
                    ...
                    class C49291 implements Runnable {
                        C49291() {
                        }
                    ...
                    public void run(TLObject response, TLRPC$TL_error error) {
                        if (error == null) {
                            ...
                            AndroidUtilities.runOnUIThread(new C49291());
                        }
                    }
                })};
    ...
    public void cleanup() {
        ...
        stopService();
        Utilities.stageQueue.postRunnable(new C49324());
    }
    ...
    private void loadSharingLocations() {
        MessagesStorage.getInstance().getStorageQueue().postRunnable(new C49376());
    }
    ...
    public void removeSharingLocation(final long did) {
        Utilities.stageQueue.postRunnable(new Runnable() {
            ...
            class C49391 implements RequestDelegate {
                C49391() {
                }
            ...
            public void run() {
                ...
                if (info != null) {
                    ...
                    req.id = info.mid;
                    req.stop_geo_live = true;
                    ConnectionsManager.getInstance().sendRequest(req, new C49391());
                    LocationController.this.sharingLocations.remove(info);
                    LocationController.this.saveSharingLocation(info, 1);
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        public void run() {
    ...
    public void removeAllLocationSharings() {
        Utilities.stageQueue.postRunnable(new C49449());
    }

    public void setGoogleMapLocation(Location location, boolean first) {
        if (location != null) {
            this.lastLocationByGoogleMaps = true;
            if (first || (this.lastKnownLocation != null && this.lastKnownLocation.distanceTo(location) >= CloseButton.TEXT_SIZE_SP)) {
