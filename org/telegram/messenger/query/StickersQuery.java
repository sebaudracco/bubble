...
public class StickersQuery {
    ...
    static class C53721 implements RequestDelegate {
        C53721() {
        }
    ...
    static class C53843 implements RequestDelegate {
        C53843() {
        }
    ...
    static class C53917 implements RequestDelegate {
        C53917() {
        }
    ...
    public static void addRecentSticker(final int type, TLRPC$Document document, int date, boolean remove) {
        ...
        if (type == 2) {
            ...
            req.unfave = remove;
            ConnectionsManager.getInstance().sendRequest(req, new C53721());
    ...
    public static void removeRecentGif(final TLRPC$Document document) {
        ...
        req.id.access_hash = document.access_hash;
        req.unsave = true;
        ConnectionsManager.getInstance().sendRequest(req, new C53843());
        MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable() {
            public void run() {
                try {
    ...
    private static void loadGroupStickerSet(final TLRPC$StickerSet stickerSet, boolean cache) {
        ...
        ConnectionsManager.getInstance().sendRequest(req, new C53917());
    }
    ...
    private static int calcDocumentsHash(ArrayList<TLRPC$Document> arrayList) {
        ...
        for (int a = 0; a < Math.min(200, arrayList.size()); a++) {
            ...
            if (document != null) {
                acc = (((((((acc * 20261) + CacheValidityPolicy.MAX_AGE) + ((long) ((int) (document.id >> 32)))) % CacheValidityPolicy.MAX_AGE) * 20261) + CacheValidityPolicy.MAX_AGE) + ((long) ((int) document.id))) % CacheValidityPolicy.MAX_AGE;
            }
        }
        return (int) acc;
    }
    ...
    private static void processLoadedFeaturedStickers(ArrayList<TLRPC$StickerSetCovered> res, ArrayList<Long> unreadStickers, boolean cache, int date, int hash) {
        ...
        Utilities.stageQueue.postRunnable(new Runnable() {
            ...
            class C53691 implements Runnable {
                C53691() {
                }
            ...
            class C53713 implements Runnable {
                C53713() {
                }
            ...
            public void run() {
                ...
                if ((z && (arrayList == null || Math.abs((System.currentTimeMillis() / 1000) - ((long) i)) >= 3600)) || (!z && arrayList == null && i2 == 0)) {
                    Runnable c53691 = new C53691();
                    if (arrayList != null || z) {
                        j = 0;
                    }
                    AndroidUtilities.runOnUIThread(c53691, j);
                    if (arrayList == null) {
                        return;
                    }
                }
                if (arrayList != null) {
                    ...
                    AndroidUtilities.runOnUIThread(new C53713());
    ...
    private static int calcFeaturedStickersHash(ArrayList<TLRPC$StickerSetCovered> sets) {
        ...
        for (int a = 0; a < sets.size(); a++) {
            ...
            if (!set.archived) {
                acc = (((((((acc * 20261) + CacheValidityPolicy.MAX_AGE) + ((long) ((int) (set.id >> 32)))) % CacheValidityPolicy.MAX_AGE) * 20261) + CacheValidityPolicy.MAX_AGE) + ((long) ((int) set.id))) % CacheValidityPolicy.MAX_AGE;
                if (unreadStickerSets.contains(Long.valueOf(set.id))) {
                    acc = (((acc * 20261) + CacheValidityPolicy.MAX_AGE) + 1) % CacheValidityPolicy.MAX_AGE;
                }
            }
        }
        return (int) acc;
    ...
    private static int calcStickersHash(ArrayList<TLRPC$TL_messages_stickerSet> sets) {
        ...
        for (int a = 0; a < sets.size(); a++) {
            ...
            if (!set.archived) {
                acc = (((20261 * acc) + CacheValidityPolicy.MAX_AGE) + ((long) set.hash)) % CacheValidityPolicy.MAX_AGE;
            }
        }
        return (int) acc;
    }
    ...
    private static void processLoadedStickers(final int type, ArrayList<TLRPC$TL_messages_stickerSet> res, boolean cache, int date, int hash) {
        ...
        Utilities.stageQueue.postRunnable(new Runnable() {
            ...
            class C53771 implements Runnable {
                C53771() {
                }
            ...
            class C53793 implements Runnable {
                C53793() {
                }
            ...
            public void run() {
                if ((z && (arrayList == null || Math.abs((System.currentTimeMillis() / 1000) - ((long) i)) >= 3600)) || (!z && arrayList == null && i2 == 0)) {
                    C53771 c53771 = new C53771();
                    long j = (arrayList != null || z) ? 0 : 1000;
                    AndroidUtilities.runOnUIThread(c53771, j);
                    if (arrayList == null) {
                        return;
                    }
                }
                if (arrayList != null) {
                    ...
                    AndroidUtilities.runOnUIThread(new C53793());
            ...
            for (int a = 0; a < stickerSets[type].size(); a++) {
                ...
                if (set.set.id == stickerSet.id) {
                    ...
                    ConnectionsManager.getInstance().sendRequest(req, new RequestDelegate() {
                        ...
                        class C53812 implements Runnable {
                            C53812() {
                            }
                        ...
                        public void run(final TLObject response, TLRPC$TL_error error) {
                            ...
                            AndroidUtilities.runOnUIThread(new C53812(), 1000);
                        }
                    });
                    return;
                }
