...
class SendMessagesHelper$17 implements Runnable {
    ...
    SendMessagesHelper$17(TLRPC$BotInlineResult tLRPC$BotInlineResult, long j, HashMap hashMap, MessageObject messageObject) {
                ...
                switch (obj) {
                    ...
                    case 5:
                        ...
                        switch (obj) {
                            ...
                            case 4:
                                ...
                                attributeVideo.w = this.val$result.f12625w;
                                attributeVideo.h = this.val$result.f12624h;
                            ...
                            case 5:
                                ...
                                attributeImageSize.w = this.val$result.f12625w;
                                attributeImageSize.h = this.val$result.f12624h;
                        ...
                        if (document.thumb == null) {
                            ...
                            document.thumb.f12637w = this.val$result.f12625w;
                            document.thumb.f12636h = this.val$result.f12624h;
                    ...
                    case 6:
                        ...
                        if (photo == null) {
                            ...
                            photoSize.w = this.val$result.f12625w;
                            photoSize.h = this.val$result.f12624h;
                            photoSize.size = 1;
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            public void run() {
                if (finalDocument != null) {
                    finalDocument.caption = SendMessagesHelper$17.this.val$result.send_message.caption;
                    SendMessagesHelper.getInstance().sendMessage(finalDocument, null, finalPathFinal, SendMessagesHelper$17.this.val$dialog_id, SendMessagesHelper$17.this.val$reply_to_msg, SendMessagesHelper$17.this.val$result.send_message.reply_markup, SendMessagesHelper$17.this.val$params, 0);
                } else if (finalPhoto != null) {
                    finalPhoto.caption = SendMessagesHelper$17.this.val$result.send_message.caption;
                    SendMessagesHelper.getInstance().sendMessage(finalPhoto, SendMessagesHelper$17.this.val$result.content_url, SendMessagesHelper$17.this.val$dialog_id, SendMessagesHelper$17.this.val$reply_to_msg, SendMessagesHelper$17.this.val$result.send_message.reply_markup, SendMessagesHelper$17.this.val$params, 0);
                } else if (finalGame != null) {
                    SendMessagesHelper.getInstance().sendMessage(finalGame, SendMessagesHelper$17.this.val$dialog_id, SendMessagesHelper$17.this.val$result.send_message.reply_markup, SendMessagesHelper$17.this.val$params);
                }
            }
        });
    }
