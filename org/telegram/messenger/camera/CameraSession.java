...
public class CameraSession {
    ...
    private AutoFocusCallback autoFocusCallback = new C52271();
    protected CameraInfo cameraInfo;
    private String currentFlashMode = C1042c.jG;
    ...
    class C52271 implements AutoFocusCallback {
        C52271() {
        }
    ...
    public CameraSession(CameraInfo info, Size preview, Size picture, int format) {
        ...
        this.currentFlashMode = ApplicationLoader.applicationContext.getSharedPreferences("camera", 0).getString(this.cameraInfo.frontCamera != 0 ? "flashMode_front" : "flashMode", C1042c.jG);
