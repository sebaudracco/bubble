...
public class CameraView extends FrameLayout implements SurfaceTextureListener {
    ...
    class C52291 implements Runnable {
        C52291() {
        }
    ...
    class C52302 implements Runnable {
        C52302() {
        }
        ...
        if (cameraInfos != null) {
            ...
            if (info != null) {
                ...
                if (this.initialFrontface) {
                    ...
                    wantedWidth = SizeUtils.DEFAULT_INTERSTITIAL_HEIGHT;
                    wantedHeight = 270;
                ...
                if (this.previewSize != null && surfaceTexture != null) {
                    ...
                    CameraController.getInstance().open(this.cameraSession, surfaceTexture, new C52291(), new C52302());
                }
            }
        }
    }
