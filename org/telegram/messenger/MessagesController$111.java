...
class MessagesController$111 implements RequestDelegate {
    final /* synthetic */ MessagesController this$0;
    final /* synthetic */ int val$channelId;
    final /* synthetic */ int val$newDialogType;
    final /* synthetic */ long val$newTaskId;

    MessagesController$111(MessagesController this$0, int i, int i2, long j) {
        this.this$0 = this$0;
    ...
    public void run(TLObject response, TLRPC$TL_error error) {
        if (error == null) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                public void run() {
                    MessagesController$111.this.this$0.putUsers(res.users, false);
                    MessagesController$111.this.this$0.putChats(res.chats, false);
                }
            });
            MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable() {

                class C49752 implements Runnable {
                    C49752() {
                    }
                    ...
                    public void run() {
                        ...
                        if ((res instanceof TLRPC$TL_updates_channelDifference) || (res instanceof TLRPC$TL_updates_channelDifferenceEmpty)) {
                            if (!res.new_messages.isEmpty()) {
                                ...
                                dialog_id = (long) (-MessagesController$111.this.val$channelId);
                                inboxValue = (Integer) MessagesController$111.this.this$0.dialogs_read_inbox_max.get(Long.valueOf(dialog_id));
                                if (inboxValue == null) {
                                    inboxValue = Integer.valueOf(MessagesStorage.getInstance().getDialogReadMax(false, dialog_id));
                                    MessagesController$111.this.this$0.dialogs_read_inbox_max.put(Long.valueOf(dialog_id), inboxValue);
                                }
                                outboxValue = (Integer) MessagesController$111.this.this$0.dialogs_read_outbox_max.get(Long.valueOf(dialog_id));
                                if (outboxValue == null) {
                                    outboxValue = Integer.valueOf(MessagesStorage.getInstance().getDialogReadMax(true, dialog_id));
                                    MessagesController$111.this.this$0.dialogs_read_outbox_max.put(Long.valueOf(dialog_id), outboxValue);
                                }
                                for (a = 0; a < res.new_messages.size(); a++) {
                                    ...
                                    if (channelFinal == null || !channelFinal.left) {
                                        ...
                                        if (num.intValue() < message.id && !(message.action instanceof TLRPC$TL_messageActionChannelCreate)) {
                                            ...
                                            obj = new MessageObject(message, usersDict, MessagesController.access$1000(MessagesController$111.this.this$0).contains(Long.valueOf(dialog_id)));
                                            if (!obj.isOut() && obj.isUnread()) {
                                                pushMessages.add(obj);
                                            }
                                            uid = (long) (-MessagesController$111.this.val$channelId);
                                ...
                                AndroidUtilities.runOnUIThread(new Runnable() {
                                    public void run() {
                                        for (Entry<Long, ArrayList<MessageObject>> pair : messages.entrySet()) {
                                            ...
                                            MessagesController$111.this.this$0.updateInterfaceWithMessages(((Long) pair.getKey()).longValue(), value);
                                        }
                                ...
                                MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable() {
                                    ...
                                    class C49731 implements Runnable {
                                        C49731() {
                                        }
                                    ...
                                    public void run() {
                                        if (!pushMessages.isEmpty()) {
                                            AndroidUtilities.runOnUIThread(new C49731());
                                        }
                            ...
                            if (!res.other_updates.isEmpty()) {
                                MessagesController$111.this.this$0.processUpdateArray(res.other_updates, res.users, res.chats, true);
                            }
                            MessagesController.access$6200(MessagesController$111.this.this$0, MessagesController$111.this.val$channelId, 1);
                            MessagesStorage.getInstance().saveChannelPts(MessagesController$111.this.val$channelId, res.pts);
                            ...
                            for (a = 0; a < res.messages.size(); a++) {
                                ...
                                message.dialog_id = (long) (-MessagesController$111.this.val$channelId);
                            ...
                            MessagesStorage.getInstance().overwriteChannel(MessagesController$111.this.val$channelId, (TLRPC$TL_updates_channelDifferenceTooLong) res, MessagesController$111.this.val$newDialogType);
                        }
                        MessagesController.access$1500(MessagesController$111.this.this$0).remove(Integer.valueOf(MessagesController$111.this.val$channelId));
                        MessagesController.access$1600(MessagesController$111.this.this$0).put(Integer.valueOf(MessagesController$111.this.val$channelId), Integer.valueOf(res.pts));
                        if ((res.flags & 2) != 0) {
                            MessagesController.access$1700(MessagesController$111.this.this$0).put(MessagesController$111.this.val$channelId, ((int) (System.currentTimeMillis() / 1000)) + res.timeout);
                        }
                        if (!res.isFinal) {
                            MessagesController.access$4800(MessagesController$111.this.this$0, MessagesController$111.this.val$channelId);
                        }
                        FileLog.e("received channel difference with pts = " + res.pts + " channelId = " + MessagesController$111.this.val$channelId);
                        ...
                        if (MessagesController$111.this.val$newTaskId != 0) {
                            MessagesStorage.getInstance().removePendingTask(MessagesController$111.this.val$newTaskId);
                        }
                    }
                }
                ...
                public void run() {
                    if (!msgUpdates.isEmpty()) {
                        ...
                        while (it.hasNext()) {
                            ...
                            long[] ids = MessagesStorage.getInstance().updateMessageStateAndId(update.random_id, null, update.id, 0, false, MessagesController$111.this.val$channelId);
                            if (ids != null) {
                    ...
                    Utilities.stageQueue.postRunnable(new C49752());
                }
            });
            return;
        }
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            public void run() {
                MessagesController.access$2500(MessagesController$111.this.this$0, tLRPC$TL_error.text, MessagesController$111.this.val$channelId);
            }
        });
