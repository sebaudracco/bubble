            ...
            public void run() {
                ...
                if (arrayList != null) {
                    ...
                    if (!messagesRes.messages.isEmpty()) {
                        ...
                        NotificationCenter.getInstance().postNotificationName(NotificationCenter.replaceMessagesObjects, Long.valueOf(MessagesController$59.this.val$dialog_id), arrayList);
                    }
                }
            }
        });
