...
class MediaController$28 implements Runnable {
    ...
    class C49631 implements Comparator<MediaController$PhotoEntry> {
        C49631() {
        }
    ...
    public void run() {
        ...
        if (VERSION.SDK_INT < 23 || (VERSION.SDK_INT >= 23 && ApplicationLoader.applicationContext.checkSelfPermission("android.permission.READ_EXTERNAL_STORAGE") == 0)) {
            cursor = Media.query(ApplicationLoader.applicationContext.getContentResolver(), Media.EXTERNAL_CONTENT_URI, MediaController.access$7200(), null, null, "datetaken DESC");
            if (cursor != null) {
        ...
        if (cursor != null) {
            ...
            if (VERSION.SDK_INT < 23 || (VERSION.SDK_INT >= 23 && ApplicationLoader.applicationContext.checkSelfPermission("android.permission.READ_EXTERNAL_STORAGE") == 0)) {
                cursor = Media.query(ApplicationLoader.applicationContext.getContentResolver(), Video.Media.EXTERNAL_CONTENT_URI, MediaController.access$7300(), null, null, "datetaken DESC");
                if (cursor != null) {
                    imageIdColumn = cursor.getColumnIndex("_id");
                    bucketIdColumn = cursor.getColumnIndex("bucket_id");
                    bucketNameColumn = cursor.getColumnIndex("bucket_display_name");
            ...
            for (a = 0; a < mediaAlbumsSorted.size(); a++) {
                Collections.sort(((MediaController$AlbumEntry) mediaAlbumsSorted.get(a)).photos, new C49631());
            }
            MediaController.access$7400(this.val$guid, mediaAlbumsSorted, photoAlbumsSorted, num, mediaController$AlbumEntry3, mediaController$AlbumEntry2, 0);
        }
        mediaCameraAlbumId = num;
        allMediaAlbum = mediaController$AlbumEntry3;
        try {
