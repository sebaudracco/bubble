...
class SendMessagesHelper$4 implements RequestDelegate {
    ...
    SendMessagesHelper$4(SendMessagesHelper this$0, long j, boolean z, boolean z2, HashMap hashMap, ArrayList arrayList, ArrayList arrayList2, TLRPC$Peer tLRPC$Peer, TLRPC$TL_messages_forwardMessages tLRPC$TL_messages_forwardMessages) {
        this.this$0 = this$0;
        this.val$peer = j;
    ...
    public void run(TLObject response, TLRPC$TL_error error) {
        ...
        if (error == null) {
                        ...
                        if (newMsgObj != null) {
                            ...
                            if (index != -1) {
                                ...
                                MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable() {
                                    ...
                                    class C51861 implements Runnable {
                                        C51861() {
                                        }
                                        ...
                                        public void run() {
                                            ...
                                            NotificationCenter.getInstance().postNotificationName(NotificationCenter.messageReceivedByServer, Integer.valueOf(oldId), Integer.valueOf(message.id), message, Long.valueOf(SendMessagesHelper$4.this.val$peer));
                                            SendMessagesHelper$4.this.this$0.processSentMessage(oldId);
                                            SendMessagesHelper$4.this.this$0.removeFromSendingMessages(oldId);
                                        }
                                    }

                                    public void run() {
                                        MessagesStorage.getInstance().updateMessageStateAndId(newMsgObj.random_id, Integer.valueOf(oldId), newMsgObj.id, 0, false, SendMessagesHelper$4.this.val$to_id.channel_id);
                                        MessagesStorage.getInstance().putMessages(sentMessages, true, false, false, 0);
                                        AndroidUtilities.runOnUIThread(new C51861());
                                    }
                                });
                            }
                        }
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                public void run() {
                    AlertsCreator.processError(tLRPC$TL_error, null, SendMessagesHelper$4.this.val$req, new Object[0]);
                }
            });
        }
        for (a = 0; a < this.val$newMsgObjArr.size(); a++) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                public void run() {
                    ...
                    SendMessagesHelper$4.this.this$0.processSentMessage(newMsgObj.id);
                    SendMessagesHelper$4.this.this$0.removeFromSendingMessages(newMsgObj.id);
                }
            });
        }
    }
