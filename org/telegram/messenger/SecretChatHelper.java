...
public class SecretChatHelper {
    ...
    class C51568 implements Comparator<TL_decryptedMessageHolder> {
        C51568() {
        }
    ...
    private void updateMediaPaths(MessageObject newMsgObj, TLRPC$EncryptedFile file, TLRPC$DecryptedMessage decryptedMessage, String originalPath) {
        ...
        if ((newMsg.media instanceof TLRPC$TL_messageMediaPhoto) && newMsg.media.photo != null) {
            ...
            String fileName = size.location.volume_id + BridgeUtil.UNDERLINE_STR + size.location.local_id;
            ...
            String fileName2 = size.location.volume_id + BridgeUtil.UNDERLINE_STR + size.location.local_id;
    ...
    protected void performSendEncryptedRequest(TLRPC$DecryptedMessage req, TLRPC$Message newMsgObj, TLRPC$EncryptedChat chat, TLRPC$InputEncryptedFile encryptedFile, String originalPath, MessageObject newMsg) {
        if (req != null && chat.auth_key != null && !(chat instanceof TLRPC$TL_encryptedChatRequested) && !(chat instanceof TLRPC$TL_encryptedChatWaiting)) {
            ...
            Utilities.stageQueue.postRunnable(new Runnable() {
                ...
                class C51471 implements RequestDelegate {

                    class C51462 implements Runnable {
                        C51462() {
                        }

                        public void run() {
                            tLRPC$Message.send_state = 2;
                            NotificationCenter.getInstance().postNotificationName(NotificationCenter.messageSendError, Integer.valueOf(tLRPC$Message.id));
                    ...
                    public void run(TLObject response, TLRPC$TL_error error) {
                        ...
                        if (error == null) {
                            ...
                            MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable() {
                                ...
                                class C51441 implements Runnable {
                                    C51441() {
                                    }

                                    public void run() {
                                        tLRPC$Message.send_state = 0;
                                        NotificationCenter.getInstance().postNotificationName(NotificationCenter.messageReceivedByServer, Integer.valueOf(tLRPC$Message.id), Integer.valueOf(tLRPC$Message.id), tLRPC$Message, Long.valueOf(tLRPC$Message.dialog_id));
                                        SendMessagesHelper.getInstance().processSentMessage(tLRPC$Message.id);
                                        if (MessageObject.isVideoMessage(tLRPC$Message) || MessageObject.isNewGifMessage(tLRPC$Message) || MessageObject.isRoundVideoMessage(tLRPC$Message)) {
                                ...
                                public void run() {
                                    ...
                                    AndroidUtilities.runOnUIThread(new C51441());
                                }
                            });
                            return;
                        }
                        MessagesStorage.getInstance().markMessageAsSendError(tLRPC$Message);
                        AndroidUtilities.runOnUIThread(new C51462());
                    }
                }
                ...
                public void run() {
                    try {
                        ...
                        ConnectionsManager.getInstance().sendRequest(reqToSend, new C51471(), 64);
                    } catch (Exception e) {
                        FileLog.e(e);
                    }
                }
        ...
        if (object != null) {
            ...
            if (object instanceof TLRPC$TL_decryptedMessage) {
                ...
                if (decryptedMessage.media == null || (decryptedMessage.media instanceof TLRPC$TL_decryptedMessageMediaEmpty)) {
                    ...
                    if (thumb != null && thumb.length != 0 && thumb.length <= OneAudience.VERSION_CODE && decryptedMessage.media.thumb_w <= 100 && decryptedMessage.media.thumb_h <= 100) {
                    ...
                    big.w = decryptedMessage.media.f12628w;
                    big.h = decryptedMessage.media.f12627h;
                    big.type = "x";
                    big.size = file.size;
                    ...
                    if (thumb == null || thumb.length == 0 || thumb.length > OneAudience.VERSION_CODE || decryptedMessage.media.thumb_w > 100 || decryptedMessage.media.thumb_h > 100) {
                        ...
                        newMessage.media.document.thumb.f12637w = decryptedMessage.media.thumb_w;
                        newMessage.media.document.thumb.f12636h = decryptedMessage.media.thumb_h;
                        newMessage.media.document.thumb.type = "s";
                        newMessage.media.document.thumb.location = new TLRPC$TL_fileLocationUnavailable();
                    }
                    TLRPC$TL_documentAttributeVideo attributeVideo = new TLRPC$TL_documentAttributeVideo();
                    attributeVideo.w = decryptedMessage.media.f12628w;
                    attributeVideo.h = decryptedMessage.media.f12627h;
                ...
                if ((serviceMessage.action instanceof TLRPC$TL_decryptedMessageActionSetMessageTTL) || (serviceMessage.action instanceof TLRPC$TL_decryptedMessageActionScreenshotMessages)) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        ...
                        class C51511 implements Runnable {

                            class C51501 implements Runnable {
                                C51501() {
                                }
                            ...
                            public void run() {
                                AndroidUtilities.runOnUIThread(new C51501());
                            }
                        }
                        ...
                        public void run() {
                            ...
                            MessagesStorage.getInstance().getStorageQueue().postRunnable(new C51511());
    ...
    private void resendMessages(final int startSeq, final int endSeq, final TLRPC$EncryptedChat encryptedChat) {
        if (encryptedChat != null && endSeq - startSeq >= 0) {
            MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable() {
                ...
                class C51531 implements Comparator<TLRPC$Message> {
                    C51531() {
                    }
                ...
                public void run() {
                    try {
                        ...
                        if (!exists) {
                            ...
                            Collections.sort(messages, new C51531());
    ...
    public void checkSecretHoles(TLRPC$EncryptedChat chat, ArrayList<TLRPC$Message> messages) {
        ...
        if (holes != null) {
            Collections.sort(holes, new C51568());
    ...
    public void acceptSecretChat(final TLRPC$EncryptedChat encryptedChat) {
        if (this.acceptingChats.get(Integer.valueOf(encryptedChat.id)) == null) {
            ...
            ConnectionsManager.getInstance().sendRequest(req, new RequestDelegate() {
                ...
                class C51341 implements RequestDelegate {
                    C51341() {
                    }
                ...
                public void run(TLObject response, TLRPC$TL_error error) {
                    if (error == null) {
                        ...
                        if (response instanceof TLRPC$TL_messages_dhConfig) {
                            if (Utilities.isGoodPrime(res.f12645p, res.f12644g)) {
                                MessagesStorage.secretPBytes = res.f12645p;
                                MessagesStorage.secretG = res.f12644g;
                        ...
                        if (Utilities.isGoodGaAndGb(g_a, p)) {
                            ...
                            ConnectionsManager.getInstance().sendRequest(req2, new C51341());
                            return;
                        }
                        SecretChatHelper.this.acceptingChats.remove(Integer.valueOf(encryptedChat.id));
                        SecretChatHelper.this.declineSecretChat(encryptedChat.id);
    ...
    public void startSecretChat(final Context context, final User user) {
        if (user != null && context != null) {
            ...
            final int reqId = ConnectionsManager.getInstance().sendRequest(req, new RequestDelegate() {
                ...
                class C51351 implements Runnable {
                    C51351() {
                    }
                ...
                class C51403 implements Runnable {
                    C51403() {
                    }
                    ...
                    if (error == null) {
                        ...
                        if (response instanceof TLRPC$TL_messages_dhConfig) {
                            if (Utilities.isGoodPrime(res.f12645p, res.f12644g)) {
                                ...
                                AndroidUtilities.runOnUIThread(new C51351());
                                return;
                            }
                        }
                                ...
                                if (error == null) {
                                    AndroidUtilities.runOnUIThread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            Utilities.stageQueue.postRunnable(new C51361());
                                        }
                                    });
                                    return;
                                }
                                SecretChatHelper.this.delayedEncryptedChatUpdates.clear();
                                AndroidUtilities.runOnUIThread(new C51382());
                            }
                        }, 2);
                        return;
                    }
                    SecretChatHelper.this.delayedEncryptedChatUpdates.clear();
                    AndroidUtilities.runOnUIThread(new C51403());
                }
            }, 2);
