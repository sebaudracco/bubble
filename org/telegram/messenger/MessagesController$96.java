...
class MessagesController$96 implements RequestDelegate {
    ...
    class C50521 implements Runnable {
        C50521() {
        }
    ...
    class C50543 implements Runnable {
        C50543() {
        }
    ...
    public void run(TLObject response, final TLRPC$TL_error error) {
        if (this.val$isChannel && (this.val$inputUser instanceof TLRPC$TL_inputUserSelf)) {
            AndroidUtilities.runOnUIThread(new C50521());
        }
        if (error != null) {
        ...
        if (this.val$isChannel) {
            ...
            AndroidUtilities.runOnUIThread(new C50543(), 1000);
        }
        if (this.val$isChannel && (this.val$inputUser instanceof TLRPC$TL_inputUserSelf)) {
