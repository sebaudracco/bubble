...
public class NativeCrashManager {
    ...
    static class C50982 implements FilenameFilter {
        C50982() {
        }
    ...
    public static String createLogFile() {
        ...
        try {
            ...
            BufferedWriter write = new BufferedWriter(new FileWriter(Constants.FILES_PATH + BridgeUtil.SPLIT_MARK + filename + ".faketrace"));
