...
class MessagesController$112 implements RequestDelegate {
    ...
    MessagesController$112(MessagesController this$0, int i, int i2) {
        this.this$0 = this$0;
        this.val$date = i;
        this.val$qts = i2;
    }
        ...
        if (error == null) {
            ...
            if (res instanceof TLRPC$TL_updates_differenceTooLong) {
                AndroidUtilities.runOnUIThread(new Runnable() {
                    public void run() {
                        MessagesController.access$2800(MessagesController$112.this.this$0).clear();
                        MessagesController.access$2400(MessagesController$112.this.this$0).clear();
                        MessagesController.access$5000(MessagesController$112.this.this$0, true, MessagesStorage.lastSeqValue, res.pts, MessagesController$112.this.val$date, MessagesController$112.this.val$qts);
                    }
                });
                return;
            }
            ...
            MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable() {
                ...
                class C49842 implements Runnable {
                    C49842() {
                    }
                    ...
                    public void run() {
                            ...
                            for (a = 0; a < res.new_messages.size(); a++) {
                                ...
                                if (((int) message.dialog_id) != 0) {
                                    ...
                                    if ((message.action instanceof TLRPC$TL_messageActionChatMigrateTo) || (message.action instanceof TLRPC$TL_messageActionChannelCreate)) {
                                        ...
                                        boolean z;
                                        ConcurrentHashMap<Long, Integer> read_max = message.out ? MessagesController$112.this.this$0.dialogs_read_outbox_max : MessagesController$112.this.this$0.dialogs_read_inbox_max;
                                ...
                                MessageObject obj = new MessageObject(message, usersDict, chatsDict, MessagesController.access$1000(MessagesController$112.this.this$0).contains(Long.valueOf(message.dialog_id)));
                            ...
                            MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable() {
                                ...
                                public void run() {
                                    if (!pushMessages.isEmpty()) {
                                        AndroidUtilities.runOnUIThread(new C49821());
                                    }
                        ...
                        if (res instanceof TLRPC$TL_updates_difference) {
                            MessagesController$112.this.this$0.gettingDifference = false;
                            ...
                            for (a = 0; a < 3; a++) {
                                MessagesController.access$6000(MessagesController$112.this.this$0, a, 1);
                            }
                ...
                public void run() {
                    ...
                    Utilities.stageQueue.postRunnable(new C49842());
                }
            });
            return;
        }
