...
public class MediaController implements OnAudioFocusChangeListener, NotificationCenter$NotificationCenterDelegate, SensorEventListener {
    ...
    private Runnable recordRunnable = new 1(this);
    ...
    public static void checkGallery() {
        if (VERSION.SDK_INT >= 24 && allPhotosAlbumEntry != null) {
            Utilities.globalQueue.postRunnable(new 2(allPhotosAlbumEntry.photos.size()), Reveal.CHECK_DELAY);
        }
    }
    ...
    public MediaController() {
        ...
        try {
            ...
            for (a = 0; a < 3; a++) {
                this.freePlayerBuffers.add(new AudioBuffer(this, this.playerBufferSize));
            }
        } catch (Throwable e) {
            FileLog.m4944e(e);
        }
        try {
            ...
            if (this.linearSensor == null || this.gravitySensor == null) {
                FileLog.m4942e("gravity or linear sensor not found");
        ...
        ApplicationLoader.applicationContext.registerReceiver(new 4(this), new IntentFilter("android.net.conn.CONNECTIVITY_CHANGE"));
        if (UserConfig.isClientActivated()) {
            checkAutodownloadSettings();
        }
        this.mediaProjections = new String[]{"_data", "_display_name", "bucket_display_name", "datetaken", "title", "width", "height"};
        try {
            ApplicationLoader.applicationContext.getContentResolver().registerContentObserver(Media.EXTERNAL_CONTENT_URI, true, new GalleryObserverExternal(this));
        } catch (Throwable e22) {
            FileLog.m4944e(e22);
        }
        try {
            ApplicationLoader.applicationContext.getContentResolver().registerContentObserver(Media.INTERNAL_CONTENT_URI, true, new GalleryObserverInternal(this));
        } catch (Throwable e222) {
            FileLog.m4944e(e222);
        }
        try {
            ApplicationLoader.applicationContext.getContentResolver().registerContentObserver(Video.Media.EXTERNAL_CONTENT_URI, true, new GalleryObserverExternal(this));
        } catch (Throwable e2222) {
            FileLog.m4944e(e2222);
        }
        try {
            ApplicationLoader.applicationContext.getContentResolver().registerContentObserver(Video.Media.INTERNAL_CONTENT_URI, true, new GalleryObserverInternal(this));
        } catch (Throwable e22222) {
            FileLog.m4944e(e22222);
        }
        try {
            PhoneStateListener phoneStateListener = new 5(this);
    ...
    private void startProgressTimer(MessageObject currentPlayingMessageObject) {
        synchronized (this.progressTimerSync) {
            ...
            this.progressTimer.schedule(new 6(this, currentPlayingMessageObject), 0, 17);
        }
    }
    ...
    public void startMediaObserver() {
        ...
        try {
            if (this.internalObserver == null) {
                ...
                ContentObserver externalObserver = new ExternalObserver(this);
        ...
        try {
            if (this.externalObserver == null) {
                ...
                externalObserver = new InternalObserver(this);
    ...
    public void startSmsObserver() {
        try {
            if (this.smsObserver == null) {
                ...
                ContentObserver smsObserver = new SmsObserver(this);
                this.smsObserver = smsObserver;
                contentResolver.registerContentObserver(parse, false, smsObserver);
            }
            AndroidUtilities.runOnUIThread(new 7(this), 300000);
        } catch (Throwable e) {
            FileLog.m4944e(e);
        }
    }
    ...
    private void processMediaObserver(Uri uri) {
        try {
            ...
            if (!screenshotDates.isEmpty()) {
                AndroidUtilities.runOnUIThread(new 8(this, screenshotDates));
            }
        } catch (Throwable e2) {
            FileLog.m4944e(e2);
        }
        ...
        if (dates != null && !dates.isEmpty() && this.lastChatEnterTime != 0) {
            if (this.lastUser != null || (this.lastSecretChat instanceof TL_encryptedChat)) {
                ...
                for (int a = 0; a < dates.size(); a++) {
                    ...
                    if ((this.lastMediaCheckTime == 0 || date.longValue() > this.lastMediaCheckTime) && date.longValue() >= this.lastChatEnterTime && (this.lastChatLeaveTime == 0 || date.longValue() <= this.lastChatLeaveTime + Reveal.CHECK_DELAY)) {
    ...
    private void checkDecoderQueue() {
        this.fileDecodingQueue.postRunnable(new 9(this));
    }

    private void checkPlayerQueue() {
        this.playerQueue.postRunnable(new 10(this));
    }
    ...
    public void onSensorChanged(SensorEvent event) {
        if (this.sensorsStarted && VoIPService.getSharedInstance() == null) {
            if (event.sensor == this.proximitySensor) {
                FileLog.m4942e("proximity changed to " + event.values[0]);
                ...
                if (this.lastTimestamp == 0) {
                    ...
                    alpha = MoPubAdapter.DEFAULT_MOPUB_IMAGE_SCALE / (MoPubAdapter.DEFAULT_MOPUB_IMAGE_SCALE + (((double) (event.timestamp - this.lastTimestamp)) / 1.0E9d));
                }
                this.lastTimestamp = event.timestamp;
                this.gravity[0] = (float) ((((double) this.gravity[0]) * alpha) + ((MoPubAdapter.DEFAULT_MOPUB_IMAGE_SCALE - alpha) * ((double) event.values[0])));
                this.gravity[1] = (float) ((((double) this.gravity[1]) * alpha) + ((MoPubAdapter.DEFAULT_MOPUB_IMAGE_SCALE - alpha) * ((double) event.values[1])));
                this.gravity[2] = (float) ((((double) this.gravity[2]) * alpha) + ((MoPubAdapter.DEFAULT_MOPUB_IMAGE_SCALE - alpha) * ((double) event.values[2])));
            ...
            if (event.sensor == this.linearSensor || event.sensor == this.gravitySensor || event.sensor == this.accelerometerSensor) {
                ...
                if (this.raisedToBack != 6) {
                    ...
                    } else if (val <= CtaButton.TEXT_SIZE_SP || this.raisedToBack != 0) {
                        if (val < CtaButton.TEXT_SIZE_SP) {
                            this.countLess++;
                        }
                        if (!(this.countLess != 10 && this.raisedToTop == 6 && this.raisedToBack == 0)) {
                            this.raisedToBack = 0;
            ...
            if (this.raisedToBack == 6 && this.accelerometerVertical && this.proximityTouched && !NotificationsController.getInstance().audioManager.isWiredHeadsetOn()) {
                FileLog.m4942e("sensor values reached");
                ...
                if (this.playingMessageObject != null && ((this.playingMessageObject.isVoice() || this.playingMessageObject.isRoundVideo()) && !this.useFrontSpeaker)) {
                    FileLog.m4942e("start listen by proximity only");
                    if (!(!this.proximityHasDifferentValues || this.proximityWakeLock == null || this.proximityWakeLock.isHeld())) {
                        this.proximityWakeLock.acquire();
                    }
                    setUseFrontSpeaker(true);
    ...
    private void startAudioAgain(boolean paused) {
        ...
        if (this.playingMessageObject != null) {
            ...
            if (post) {
                AndroidUtilities.runOnUIThread(new 11(this, currentMessageObject), 100);
            } else {
    ...
    public void startRaiseToEarSensors(ChatActivity chatActivity) {
        ...
        if ((this.accelerometerSensor != null || (this.gravitySensor != null && this.linearAcceleration != null)) && this.proximitySensor != null) {
            ...
            if (!this.sensorsStarted) {
                ...
                this.countLess = 0;
                this.raisedToBack = 0;
                Utilities.globalQueue.postRunnable(new 12(this));
    ...
    public void stopRaiseToEarSensors(ChatActivity chatActivity) {
        if (this.ignoreOnPause) {
            ...
            if ((this.accelerometerSensor != null || (this.gravitySensor != null && this.linearAcceleration != null)) && this.proximitySensor != null && this.raiseChat == chatActivity) {
                ...
                this.raiseToEarRecord = false;
                this.useFrontSpeaker = false;
                Utilities.globalQueue.postRunnable(new 13(this));
                if (this.proximityHasDifferentValues && this.proximityWakeLock != null && this.proximityWakeLock.isHeld()) {
                    this.proximityWakeLock.release();
                }
            }
    ...
    public void cleanupPlayer(boolean notify, boolean stopService, boolean byVoiceEnd) {
        ...
        if (this.playingMessageObject != null) {
            ...
            NotificationCenter.getInstance().postNotificationName(NotificationCenter.messagePlayingProgressDidChanged, new Object[]{Integer.valueOf(this.playingMessageObject.getId()), Integer.valueOf(0)});
            ...
            if (notify) {
                ...
                if (this.voiceMessagesPlaylist != null) {
                    ...
                    NotificationCenter.getInstance().postNotificationName(NotificationCenter.messagePlayingDidReset, new Object[]{Integer.valueOf(lastFile.getId()), Boolean.valueOf(stopService)});
    ...
    private void seekOpusPlayer(float progress) {
        if (progress != 1.0f) {
            ...
            this.audioTrackPlayer.flush();
            this.fileDecodingQueue.postRunnable(new 14(this, progress));
        }
    }
    ...
    private void playNextMessageWithoutOrder(boolean byStop) {
        ...
        if (last && byStop && this.repeatMode == 0 && !this.forceLoopCurrentPlaylist) {
            if (this.audioPlayer != null || this.audioTrackPlayer != null || this.videoPlayer != null) {
                ...
                this.playingMessageObject.audioProgressSec = 0;
                NotificationCenter.getInstance().postNotificationName(NotificationCenter.messagePlayingProgressDidChanged, new Object[]{Integer.valueOf(this.playingMessageObject.getId()), Integer.valueOf(0)});
                NotificationCenter.getInstance().postNotificationName(NotificationCenter.messagePlayingPlayStateChanged, new Object[]{Integer.valueOf(this.playingMessageObject.getId())});
            }
            ...
            if (visible) {
                ...
                if (this.pipRoundVideoView == null) {
                    try {
                        ...
                        this.pipRoundVideoView.show(this.baseActivity, new 15(this));
                    } catch (Exception e) {
                        this.pipRoundVideoView = null;
                    }
                }
    ...
    public boolean playMessage(MessageObject messageObject) {
        ...
        if ((this.audioTrackPlayer == null && this.audioPlayer == null && this.videoPlayer == null) || this.playingMessageObject == null || messageObject.getId() != this.playingMessageObject.getId()) {
            ...
            if (cacheFile == null || cacheFile == file || cacheFile.exists()) {
                ...
                if (messageObject.isRoundVideo()) {
                    ...
                    synchronized (this.playerObjectSync) {
                        try {
                            ...
                            this.fileDecodingQueue.postRunnable(new 18(this, result, cacheFile, semaphore));
                            semaphore.acquire();
                            if (result[0].booleanValue()) {
                                ...
                                this.audioTrackPlayer.setPlaybackPositionUpdateListener(new 19(this));
                    ...
                    try {
                        ...
                        this.audioPlayer.setOnCompletionListener(new 20(this, messageObject));
                ...
                NotificationCenter.getInstance().postNotificationName(NotificationCenter.messagePlayingDidStarted, new Object[]{messageObject});
                if (this.videoPlayer != null) {
                    try {
                    ...
                    this.fileDecodingQueue.postRunnable(new 21(this));
                }
    ...
    public void startRecording(long dialog_id, MessageObject reply_to_msg) {
        ...
        Runnable 22 = new 22(this, dialog_id, reply_to_msg);
        this.recordStartRunnable = 22;
        if (paused) {
            j = 500;
        } else {
            j = 50;
        }
        dispatchQueue.postRunnable(22, j);
    }

    public void generateWaveform(MessageObject messageObject) {
        String id = messageObject.getId() + BridgeUtil.UNDERLINE_STR + messageObject.getDialogId();
        ...
        if (!this.generatingWaveform.containsKey(id)) {
            ...
            Utilities.globalQueue.postRunnable(new 23(this, path, id));
        }
    }

    private void stopRecordingInternal(int send) {
        if (send != 0) {
            this.fileEncodingQueue.postRunnable(new 24(this, this.recordingAudio, this.recordingAudioFile, send));
        }
        try {
    ...
    public void stopRecording(int send) {
        ...
        this.recordQueue.postRunnable(new 25(this, send));
    }
                    ...
                    if (!(context == null || type == 0)) {
                        try {
                            ...
                            try {
                                ...
                                progressDialog2.setOnCancelListener(new 26(cancelled));
                                ...
                                progressDialog = progressDialog2;
                                FileLog.m4944e(e);
                                new Thread(new 27(type, name, sourceFile, cancelled, progressDialog, mime)).start();
                            }
                        } catch (Exception e3) {
                            e = e3;
                            FileLog.m4944e(e);
    ...
    public static void loadGalleryPhotosAlbums(int guid) {
        Thread thread = new Thread(new 28(guid));
    ...
    private static void broadcastNewPhotos(int guid, ArrayList<AlbumEntry> mediaAlbumsSorted, ArrayList<AlbumEntry> photoAlbumsSorted, Integer cameraAlbumIdFinal, AlbumEntry allMediaAlbumFinal, AlbumEntry allPhotosAlbumFinal, int delay) {
        ...
        Runnable 29 = new 29(guid, mediaAlbumsSorted, photoAlbumsSorted, cameraAlbumIdFinal, allMediaAlbumFinal, allPhotosAlbumFinal);
        broadcastPhotosRunnable = 29;
        AndroidUtilities.runOnUIThread(29, (long) delay);
    }
    ...
    private boolean startVideoConvertFromQueue() {
        ...
        intent.putExtra(ClientCookie.PATH_ATTR, messageObject.messageOwner.attachPath);
    ...
    private void didWriteData(MessageObject messageObject, File file, boolean last, boolean error) {
        ...
        AndroidUtilities.runOnUIThread(new 30(this, error, last, messageObject, file, firstWrite));
    }
    ...
    L_0x01b0:
        r35 = move-exception;
    L_0x01b1:
        org.telegram.messenger.FileLog.m4944e(r35);	 Catch:{ Exception -> 0x08b6, all -> 0x04d0 }
        r43 = 1;
        r16 = r86;
    L_0x01b8:
        r0 = r46;
    ...
    L_0x01fc:
        ...
        r6 = r6.append(r10);
        r6 = r6.toString();
        org.telegram.messenger.FileLog.m4942e(r6);
        r45 = r46;
    L_0x021b:
        r6 = r68.edit();
        r10 = "isPreviousOk";
    ...
    L_0x0268:
        ...
        org.telegram.messenger.FileLog.m4942e(r6);	 Catch:{ Exception -> 0x01b0, all -> 0x04d0 }
    L_0x029d:
        r6 = new java.lang.StringBuilder;	 Catch:{ Exception -> 0x01b0, all -> 0x04d0 }
        r6.<init>();	 Catch:{ Exception -> 0x01b0, all -> 0x04d0 }
        r10 = "colorFormat = ";
    ...
    L_0x04df:
        ...
        r10 = r10.append(r12);
        r10 = r10.toString();
        org.telegram.messenger.FileLog.m4942e(r10);
        throw r6;
    L_0x04fd:
    ...
    L_0x07c6:
        r35 = move-exception;
        r44 = 1;
        org.telegram.messenger.FileLog.m4944e(r35);	 Catch:{ Exception -> 0x01b0, all -> 0x04d0 }
        goto L_0x076c;
    L_0x07cd:
        r10 = 2500; // 0x9c4 float:3.503E-42 double:1.235E-320;
        r0 = r37;
    ...
    L_0x084a:
        r35 = move-exception;
        org.telegram.messenger.FileLog.m4944e(r35);
        goto L_0x01fc;
    L_0x0850:
        r35 = move-exception;
        r16 = r86;
    L_0x0853:
        r43 = 1;
        org.telegram.messenger.FileLog.m4944e(r35);	 Catch:{ all -> 0x08b3 }
