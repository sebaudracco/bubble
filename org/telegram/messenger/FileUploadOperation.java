...
public class FileUploadOperation {
    ...
    class C48741 implements Runnable {
        C48741() {
        }
    ...
    class C48752 implements Runnable {
        C48752() {
        }
    ...
    class C48795 implements WriteToSocketDelegate {

        class C48781 implements Runnable {
            C48781() {
            }
        ...
        public void run() {
            Utilities.stageQueue.postRunnable(new C48781());
        }
    }
    ...
    public void start() {
        if (this.state == 0) {
            this.state = 1;
            Utilities.stageQueue.postRunnable(new C48741());
        }
    }
    ...
    public void cancel() {
        if (this.state != 3) {
            this.state = 2;
            Utilities.stageQueue.postRunnable(new C48752());
        ...
        if (this.state == 1) {
            try {
                ...
                if (currentRequestBytes != -1) {
                            ...
                            if (response instanceof TLRPC$TL_boolTrue) {
                                ...
                                if (FileUploadOperation.this.isLastPart && FileUploadOperation.this.currentUploadRequetsCount == 0 && FileUploadOperation.this.state == 1) {
                                    ...
                                    if (FileUploadOperation.this.key == null) {
                                        ...
                                        result.name = FileUploadOperation.this.uploadingFilePath.substring(FileUploadOperation.this.uploadingFilePath.lastIndexOf(BridgeUtil.SPLIT_MARK) + 1);
                    ...
                    }, null, new C48795(), 0, Integer.MAX_VALUE, ((requestNumFinal % 4) << 16) | 4, true)));
                }
            } catch (Exception e22) {
                FileLog.e(e22);
                this.delegate.didFailedUploadingFile(this);
