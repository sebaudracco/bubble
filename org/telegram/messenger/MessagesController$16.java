        ...
        if (error == null) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                public void run() {
                    ...
                    NotificationCenter.getInstance().postNotificationName(NotificationCenter.replaceMessagesObjects, Long.valueOf(MessagesController$16.this.val$dialog_id), objects);
                }
            });
        }
    }
