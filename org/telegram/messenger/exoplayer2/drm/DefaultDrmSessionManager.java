...
public class DefaultDrmSessionManager<T extends ExoMediaCrypto> implements DrmSessionManager<T>, DrmSession<T> {
    ...
    class C16821 implements Runnable {
        C16821() {
        }
    ...
    class C16832 implements Runnable {
        C16832() {
        }
    ...
    class C16843 implements Runnable {
        C16843() {
        }
    ...
    public static DefaultDrmSessionManager<FrameworkMediaCrypto> newWidevineInstance(MediaDrmCallback callback, HashMap<String, String> optionalKeyRequestParameters, Handler eventHandler, EventListener eventListener) throws UnsupportedDrmException {
        return newFrameworkInstance(C1681C.WIDEVINE_UUID, callback, optionalKeyRequestParameters, eventHandler, eventListener);
    }
    ...
    public static DefaultDrmSessionManager<FrameworkMediaCrypto> newPlayReadyInstance(MediaDrmCallback callback, String customData, Handler eventHandler, EventListener eventListener) throws UnsupportedDrmException {
        ...
        return newFrameworkInstance(C1681C.PLAYREADY_UUID, callback, optionalKeyRequestParameters, eventHandler, eventListener);
    }
    ...
    public boolean canAcquireSession(@NonNull DrmInitData drmInitData) {
        ...
        if ((C1681C.CENC_TYPE_cbc1.equals(schemeType) || C1681C.CENC_TYPE_cbcs.equals(schemeType) || C1681C.CENC_TYPE_cens.equals(schemeType)) && Util.SDK_INT < 24) {
            return false;
        }
        return true;
    }
        ...
        if (i == 1) {
            ...
            if (this.offlineLicenseKeySetId == null) {
                ...
                if (schemeData == null) {
                    ...
                    if (Util.SDK_INT < 21) {
                        byte[] psshData = PsshAtomUtil.parseSchemeSpecificData(this.schemeInitData, C1681C.WIDEVINE_UUID);
                        if (psshData != null) {
                            this.schemeInitData = psshData;
                        }
                    }
                    if (Util.SDK_INT < 26 && C1681C.CLEARKEY_UUID.equals(this.uuid) && ("video/mp4".equals(this.schemeMimeType) || "audio/mp4".equals(this.schemeMimeType))) {
                ...
                if (this.offlineLicenseKeySetId == null) {
                    ...
                    if (this.mode == 0 && licenseDurationRemainingSec <= 60) {
                        ...
                        if (this.eventHandler != null && this.eventListener != null) {
                            this.eventHandler.post(new C16821());
                            return;
                        }
                        return;
                    }
    ...
    private long getLicenseDurationRemainingSec() {
        if (!C1681C.WIDEVINE_UUID.equals(this.uuid)) {
    ...
    private void onKeyResponse(Object response) {
        ...
        try {
            if (this.mode == 3) {
                ...
                if (this.eventHandler != null && this.eventListener != null) {
                    this.eventHandler.post(new C16832());
                    return;
                }
                return;
            }
            ...
            this.state = 4;
            if (this.eventHandler != null && this.eventListener != null) {
                this.eventHandler.post(new C16843());
            }
        } catch (Exception e) {
            onKeysError(e);
        }
