...
public class SlidingPercentile {
    private static final Comparator<Sample> INDEX_COMPARATOR = new C53011();
    private static final int MAX_RECYCLED_SAMPLES = 5;
    private static final int SORT_ORDER_BY_INDEX = 1;
    private static final int SORT_ORDER_BY_VALUE = 0;
    private static final int SORT_ORDER_NONE = -1;
    private static final Comparator<Sample> VALUE_COMPARATOR = new C53022();
    ...
    static class C53011 implements Comparator<Sample> {
        C53011() {
        }
    ...
    static class C53022 implements Comparator<Sample> {
        C53022() {
        }
