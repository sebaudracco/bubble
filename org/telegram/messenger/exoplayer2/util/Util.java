...
public final class Util {
    ...
    public static String getUserAgent(Context context, String applicationName) {
        ...
        return applicationName + BridgeUtil.SPLIT_MARK + versionName + " (Linux;Android " + VERSION.RELEASE + ") " + ExoPlayerLibraryInfo.VERSION_SLASHY;
    }
    ...
    public static Point getPhysicalDisplaySize(Context context, Display display) {
        if (SDK_INT < 25 && display.getDisplayId() == 0) {
            ...
            if ("NVIDIA".equals(MANUFACTURER) && MODEL.contains("SHIELD")) {
                ...
                try {
                    Class<?> systemProperties = Class.forName(C1404b.f2144v);
