...
public interface HttpDataSource extends DataSource {
    public static final Predicate<String> REJECT_PAYWALL_TYPES = new C16921();

    static class C16921 implements Predicate<String> {
        C16921() {
        }

        public boolean evaluate(String contentType) {
            contentType = Util.toLowerInvariant(contentType);
            return (TextUtils.isEmpty(contentType) || ((contentType.contains("text") && !contentType.contains("text/vtt")) || contentType.contains("html") || contentType.contains("xml"))) ? false : true;
        }
    }
