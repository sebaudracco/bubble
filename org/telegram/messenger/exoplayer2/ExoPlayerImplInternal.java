...
final class ExoPlayerImplInternal implements Callback, MediaPeriod.Callback, InvalidationListener, Listener {
    ...
    public static final class PlaybackInfo {
        ...
        public PlaybackInfo(MediaPeriodId periodId, long startPositionUs) {
            this(periodId, startPositionUs, -9223372036854775807L);
        }
    ...
    private void doSomeWork() throws ExoPlaybackException, IOException {
        ...
        if (allRenderersEnded && ((playingPeriodDurationUs == -9223372036854775807L || playingPeriodDurationUs <= this.playbackInfo.positionUs) && this.playingPeriodHolder.info.isFinal)) {
            setState(4);
            stopRenderers();
        } else if (this.state == 2) {
    ...
    private boolean isTimelineReady(long playingPeriodDurationUs) {
        return playingPeriodDurationUs == -9223372036854775807L || this.playbackInfo.positionUs < playingPeriodDurationUs || (this.playingPeriodHolder.next != null && (this.playingPeriodHolder.next.prepared || this.playingPeriodHolder.next.info.id.isAd()));
    }
    ...
    private void handleSourceInfoRefreshed(Pair<Timeline, Object> timelineAndManifest) throws ExoPlaybackException {
        ...
        if (oldTimeline != null) {
            ...
            if (periodHolder != null || playingPeriodIndex < oldTimeline.getPeriodCount()) {
                ...
                if (this.playbackInfo.periodId.isAd()) {
                    ...
                    if (!(periodId.isAd() && periodId.adIndexInAdGroup == this.playbackInfo.periodId.adIndexInAdGroup)) {
                        this.playbackInfo = new PlaybackInfo(periodId, seekToPeriodPosition(periodId, this.playbackInfo.contentPositionUs), periodId.isAd() ? this.playbackInfo.contentPositionUs : -9223372036854775807L);
                        notifySourceInfoRefresh(manifest);
                        return;
                    }
                }
            ...
            long j2;
            defaultPosition = getPeriodPosition(0, -9223372036854775807L);
