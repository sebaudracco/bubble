...
public final class FragmentedMp4Extractor implements Extractor {
    public static final ExtractorsFactory FACTORY = new C16881();
    ...
    static class C16881 implements ExtractorsFactory {
        C16881() {
        }
    ...
    private void maybeInitExtraTracks() {
        ...
        if ((this.flags & 8) != 0 && this.cea608TrackOutputs == null) {
            this.extractorOutput.track(this.trackBundles.size() + 1, 3).format(Format.createTextSampleFormat(null, "application/cea-608", 0, null));
        ...
        for (int i = 0; i < leafChildrenSize; i++) {
            ...
            if (child.type == Atom.TYPE_pssh) {
                ...
                if (uuid == null) {
                    ...
                    schemeDatas.add(new SchemeData(uuid, null, "video/mp4", psshData));
                }
            }
        }
        if (schemeDatas == null) {
