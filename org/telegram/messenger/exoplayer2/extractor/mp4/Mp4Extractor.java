...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    public static final ExtractorsFactory FACTORY = new C16891();
    ...
    static class C16891 implements ExtractorsFactory {
        C16891() {
        }
    ...
    private void processMoovAtom(ContainerAtom moov) throws ParserException {
        ...
        for (int i = 0; i < moov.containerChildren.size(); i++) {
            ...
            if (atom.type == Atom.TYPE_trak) {
                Track track = AtomParsers.parseTrak(atom, moov.getLeafAtomOfType(Atom.TYPE_mvhd), -9223372036854775807L, null, (this.flags & 1) != 0, this.isQuickTime);
                if (track != null) {
