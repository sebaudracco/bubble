...
public final class TrackEncryptionBox {
    ...
    private static int schemeToCryptoMode(@Nullable String schemeType) {
        ...
        switch (schemeType.hashCode()) {
            case 3046605:
                if (schemeType.equals(C1681C.CENC_TYPE_cbc1)) {
                    i = 2;
                    break;
                }
                break;
            case 3046671:
                if (schemeType.equals(C1681C.CENC_TYPE_cbcs)) {
                    i = 3;
                    break;
                }
                break;
            case 3049879:
                if (schemeType.equals(C1681C.CENC_TYPE_cenc)) {
                    i = 0;
                    break;
                }
                break;
            case 3049895:
                if (schemeType.equals(C1681C.CENC_TYPE_cens)) {
                    i = 1;
                    break;
                }
                break;
