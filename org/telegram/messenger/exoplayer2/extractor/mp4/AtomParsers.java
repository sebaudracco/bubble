...
final class AtomParsers {
    ...
    public static Track parseTrak(ContainerAtom trak, LeafAtom mvhd, long duration, DrmInitData drmInitData, boolean ignoreEditLists, boolean isQuickTime) throws ParserException {
        ...
        return new Track(TkhdData.access$100(tkhdData), trackType, ((Long) mdhdData.first).longValue(), movieTimescale, durationUs, stsdData.format, stsdData.requiredSampleTransformation, stsdData.trackEncryptionBoxes, stsdData.nalUnitLengthFieldLength, editListDurations, editListMediaTimes);
    }
    ...
    static Pair<Integer, TrackEncryptionBox> parseCommonEncryptionSinfFromParent(ParsableByteArray parent, int position, int size) {
        ...
        if (!C1681C.CENC_TYPE_cenc.equals(schemeType) && !C1681C.CENC_TYPE_cbc1.equals(schemeType) && !C1681C.CENC_TYPE_cens.equals(schemeType) && !C1681C.CENC_TYPE_cbcs.equals(schemeType)) {
            return null;
        }
        boolean z2;
