...
public final class MatroskaExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new C16861();
    ...
    static class C16861 implements ExtractorsFactory {
        C16861() {
        }
    ...
    void endMasterElement(int id) throws ParserException {
        switch (id) {
            ...
            case ID_CONTENT_ENCODING /*25152*/:
                ...
                this.currentTrack.drmInitData = new DrmInitData(new SchemeData(C1681C.UUID_NIL, null, "video/webm", this.currentTrack.cryptoData.encryptionKey));
                return;
            case ID_CONTENT_ENCODINGS /*28032*/:
