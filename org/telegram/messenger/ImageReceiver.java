            ...
            if (fileLocation != null) {
                if (fileLocation instanceof TLRPC$FileLocation) {
                    ...
                    if (location2.dc_id != 0) {
                        key = location2.version == 0 ? location2.dc_id + BridgeUtil.UNDERLINE_STR + location2.id : location2.dc_id + BridgeUtil.UNDERLINE_STR + location2.id + BridgeUtil.UNDERLINE_STR + location2.version;
                    } else {
                        fileLocation = null;
                    }
                }
