...
class MessagesController$91 implements RequestDelegate {
    ...
    class C50501 implements Runnable {
        C50501() {
        }
        ...
        public void run() {
            ...
            NotificationCenter.getInstance().postNotificationName(NotificationCenter.chatInfoDidLoaded, MessagesController$91.this.val$info, Integer.valueOf(0), Boolean.valueOf(false), null);
        }
    }
    ...
    public void run(TLObject response, TLRPC$TL_error error) {
        if (response instanceof TLRPC$TL_boolTrue) {
            AndroidUtilities.runOnUIThread(new C50501());
        }
    }
}
