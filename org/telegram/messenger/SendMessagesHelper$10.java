...
class SendMessagesHelper$10 implements RequestDelegate {
    ...
    SendMessagesHelper$10(SendMessagesHelper this$0, ArrayList arrayList, ArrayList arrayList2, TLRPC$TL_messages_sendMultiMedia tLRPC$TL_messages_sendMultiMedia) {
        this.this$0 = this$0;
        ...
        AndroidUtilities.runOnUIThread(new Runnable() {
            public void run() {
                ...
                if (error == null) {
                    ...
                    for (i = 0; i < SendMessagesHelper$10.this.val$msgObjs.size(); i++) {
                        MessageObject msgObj = (MessageObject) SendMessagesHelper$10.this.val$msgObjs.get(i);
                        String originalPath = (String) SendMessagesHelper$10.this.val$originalPaths.get(i);
                        ...
                        SendMessagesHelper.access$1200(SendMessagesHelper$10.this.this$0, msgObj, message, originalPath, false);
                        if (null == null) {
                            ...
                            MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable() {
                                ...
                                class C51601 implements Runnable {
                                    C51601() {
                                    }
                                    ...
                                    public void run() {
                                        ...
                                        NotificationCenter.getInstance().postNotificationName(NotificationCenter.messageReceivedByServer, Integer.valueOf(oldId), Integer.valueOf(newMsgObj.id), newMsgObj, Long.valueOf(newMsgObj.dialog_id));
                                        SendMessagesHelper$10.this.this$0.processSentMessage(oldId);
                                        SendMessagesHelper$10.this.this$0.removeFromSendingMessages(oldId);
                                    }
                                }
                                ...
                                public void run() {
                                    ...
                                    AndroidUtilities.runOnUIThread(new C51601());
                                }
                            });
                        }
                    }
                    ...
                    AlertsCreator.processError(error, null, SendMessagesHelper$10.this.val$req, new Object[0]);
                    isSentError = true;
                }
                if (isSentError) {
                    for (i = 0; i < SendMessagesHelper$10.this.val$msgObjs.size(); i++) {
                        newMsgObj = ((MessageObject) SendMessagesHelper$10.this.val$msgObjs.get(i)).messageOwner;
                        ...
                        SendMessagesHelper$10.this.this$0.processSentMessage(newMsgObj.id);
                        SendMessagesHelper$10.this.this$0.removeFromSendingMessages(newMsgObj.id);
                    }
                }
            }
        });
