...
class MediaController$29 implements Runnable {
    ...
    public void run() {
        if (PhotoViewer.getInstance().isVisible()) {
            MediaController.access$7400(this.val$guid, this.val$mediaAlbumsSorted, this.val$photoAlbumsSorted, this.val$cameraAlbumIdFinal, this.val$allMediaAlbumFinal, this.val$allPhotosAlbumFinal, 1000);
            return;
        }
        MediaController.access$7502(null);
        ...
        NotificationCenter.getInstance().postNotificationName(NotificationCenter.albumsDidLoaded, Integer.valueOf(this.val$guid), this.val$mediaAlbumsSorted, this.val$photoAlbumsSorted, this.val$cameraAlbumIdFinal);
    }
}
