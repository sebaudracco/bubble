...
class SendMessagesHelper$16 implements Runnable {
    ...
    class C51731 implements Runnable {
        C51731() {
        }
    ...
    SendMessagesHelper$16(ArrayList arrayList, ArrayList arrayList2, String str, long j, MessageObject messageObject, ArrayList arrayList3, InputContentInfoCompat inputContentInfoCompat) {
    ...
    public void run() {
        ...
        if (error) {
            AndroidUtilities.runOnUIThread(new C51731());
        }
    }
}
