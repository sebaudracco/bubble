...
public class MessagesController implements NotificationCenter$NotificationCenterDelegate {
    ...
    private final Comparator<TL_dialog> dialogComparator = new 1(this);
    ...
    private final Comparator<Update> updatesComparator = new 2(this);
    ...
    public MessagesController() {
        ...
        AndroidUtilities.runOnUIThread(new 3(this));
        addSupportUser();
        ...
        this.callConnectTimeout = preferences.getInt("callConnectTimeout", 30000);
    ...
    public void updateConfig(TL_config config) {
        AndroidUtilities.runOnUIThread(new 4(this, config));
    }
    ...
    public void addSupportUser() {
        ...
        user.phone = "333";
        user.id = 333000;
        user.first_name = ApplicationLoader.getConfig().getAppName();
        user.last_name = "";
        user.status = null;
    ...
    public void didReceivedNotification(int id, Object... args) {
        ...
        if (id == NotificationCenter.FileDidUpload) {
            ...
            if (this.uploadingAvatar != null && this.uploadingAvatar.equals(location)) {
                ...
                req.file = file;
                ConnectionsManager.getInstance().sendRequest(req, new 5(this));
            }
    ...
    public void cleanup() {
        ...
        Utilities.stageQueue.postRunnable(new 6(this));
    ...
    public void setLastCreatedDialogId(long dialog_id, boolean set) {
        ...
        Utilities.stageQueue.postRunnable(new 8(this, set, dialog_id));
    }
    ...
    public void putUsers(ArrayList<User> users, boolean fromCache) {
        if (users != null && !users.isEmpty()) {
            ...
            if (updateStatus) {
                AndroidUtilities.runOnUIThread(new 9(this));
            }
        }
    }
                ...
                if (chat.min) {
                    ...
                    if (oldChat != null) {
                        ...
                        if (oldFlags != newFlags) {
                            AndroidUtilities.runOnUIThread(new 10(this, chat));
                        }
                    }
                    this.chats.put(Integer.valueOf(chat.id), chat);
    ...
    private void reloadDialogsReadValue(ArrayList<TL_dialog> dialogs, long did) {
        if (did != 0 || (dialogs != null && !dialogs.isEmpty())) {
            ...
            if (!req.peers.isEmpty()) {
                ConnectionsManager.getInstance().sendRequest(req, new 11(this));
            }
        }
    }
        ...
        if (this.loadingChannelAdmins.indexOfKey(chatId) < 0) {
            ...
            if (array != null) {
                ...
                for (int a = 0; a < array.size(); a++) {
                    acc = (((20261 * acc) + CacheValidityPolicy.MAX_AGE) + ((long) ((Integer) array.get(a)).intValue())) % CacheValidityPolicy.MAX_AGE;
                }
                req.hash = (int) acc;
            }
            ...
            ConnectionsManager.getInstance().sendRequest(req, new 12(this, chatId));
        }
    }
    ...
    public void processLoadedChannelAdmins(ArrayList<Integer> array, int chatId, boolean cache) {
        ...
        AndroidUtilities.runOnUIThread(new 13(this, chatId, array, cache));
    }
    ...
    public void loadFullChat(int chat_id, int classGuid, boolean force) {
        ...
        if (!this.loadingFullChats.contains(Integer.valueOf(chat_id))) {
            if (force || !loaded) {
                ...
                int reqId = ConnectionsManager.getInstance().sendRequest(request, new 14(this, chat, dialog_id, chat_id, classGuid));
                if (classGuid != 0) {
    ...
    public void loadFullUser(User user, int classGuid, boolean force) {
        if (user != null && !this.loadingFullUsers.contains(Integer.valueOf(user.id))) {
            if (force || !this.loadedFullUsers.contains(Integer.valueOf(user.id))) {
                ...
                ConnectionsManager.getInstance().bindRequestToGuid(ConnectionsManager.getInstance().sendRequest(req, new 15(this, user, classGuid)), classGuid);
            }
        }
    }
    ...
    private void reloadMessages(ArrayList<Integer> mids, long dialog_id) {
        if (!mids.isEmpty()) {
            ...
            if (!result.isEmpty()) {
                ...
                ConnectionsManager.getInstance().sendRequest(request, new 16(this, dialog_id, chat, result));
            }
        }
    }
    ...
    public void hideReportSpam(long dialogId, User currentUser, Chat currentChat) {
        if (currentUser != null || currentChat != null) {
            ...
            if (((int) dialogId) != 0) {
                ...
                ConnectionsManager.getInstance().sendRequest(req, new 17(this));
            }
        }
    }
    ...
    public void reportSpam(long dialogId, User currentUser, Chat currentChat, EncryptedChat currentEncryptedChat) {
        if (currentUser != null || currentChat != null || currentEncryptedChat != null) {
            ...
            if (((int) dialogId) != 0) {
                ...
                ConnectionsManager.getInstance().sendRequest(req, new 19(this), 2);
                ...
                ConnectionsManager.getInstance().sendRequest(req2, new 18(this), 2);
            }
        }
    }
    ...
    public void loadPeerSettings(User currentUser, Chat currentChat) {
        if (currentUser != null || currentChat != null) {
            ...
            if (!this.loadingPeerSettings.containsKey(Long.valueOf(dialogId))) {
                ...
                FileLog.m4941d("request spam button for " + dialogId);
                ...
                if (preferences.getInt("spam3_" + dialogId, 0) == 1) {
                    FileLog.m4941d("spam button already hidden for " + dialogId);
                    ...
                    ConnectionsManager.getInstance().sendRequest(req, new 20(this, dialogId));
                } else {
                    ...
                    ConnectionsManager.getInstance().sendRequest(req2, new 21(this, dialogId));
                }
            }
        }
    }
    ...
    protected void processNewChannelDifferenceParams(int pts, int pts_count, int channelId) {
        FileLog.m4942e("processNewChannelDifferenceParams pts = " + pts + " pts_count = " + pts_count + " channeldId = " + channelId);
        if (DialogObject.isChannel((TL_dialog) this.dialogs_dict.get(Long.valueOf((long) (-channelId))))) {
            ...
            if (channelPts.intValue() + pts_count == pts) {
                FileLog.m4942e("APPLY CHANNEL PTS");
                ...
                if (gettingDifferenceChannel.booleanValue() || updatesStartWaitTime == null || Math.abs(System.currentTimeMillis() - updatesStartWaitTime.longValue()) <= 1500) {
                    FileLog.m4942e("ADD CHANNEL UPDATE TO QUEUE pts = " + pts + " pts_count = " + pts_count);
    ...
    protected void processNewDifferenceParams(int seq, int pts, int date, int pts_count) {
        FileLog.m4942e("processNewDifferenceParams seq = " + seq + " pts = " + pts + " date = " + date + " pts_count = " + pts_count);
        if (pts != -1) {
            if (MessagesStorage.lastPtsValue + pts_count == pts) {
                FileLog.m4942e("APPLY PTS");
                ...
                if (this.gettingDifference || this.updatesStartWaitTimePts == 0 || Math.abs(System.currentTimeMillis() - this.updatesStartWaitTimePts) <= 1500) {
                    FileLog.m4942e("ADD UPDATE TO QUEUE pts = " + pts + " pts_count = " + pts_count);
        ...
        if (MessagesStorage.lastSeqValue + 1 == seq) {
            ...
            if (this.gettingDifference || this.updatesStartWaitTimeSeq == 0 || Math.abs(System.currentTimeMillis() - this.updatesStartWaitTimeSeq) <= 1500) {
                FileLog.m4942e("ADD UPDATE TO QUEUE seq = " + seq);
    ...
    public void didAddedNewTask(int minDate, SparseArray<ArrayList<Long>> mids) {
        Utilities.stageQueue.postRunnable(new 22(this, minDate));
        AndroidUtilities.runOnUIThread(new 23(this, mids));
    }

    public void getNewDeleteTask(ArrayList<Integer> oldTask, int channelId) {
        Utilities.stageQueue.postRunnable(new 24(this, oldTask, channelId));
    }
    ...
    private boolean checkDeletingTask(boolean runnable) {
        ...
        this.currentDeleteTaskRunnable = null;
        AndroidUtilities.runOnUIThread(new 25(this, new ArrayList(this.currentDeletingTaskMids)));
        return true;
    }

    public void processLoadedDeleteTask(int taskTime, ArrayList<Integer> messages, int channelId) {
        Utilities.stageQueue.postRunnable(new 26(this, messages, taskTime));
    }
    ...
    public void loadDialogPhotos(int did, int count, long max_id, boolean fromCache, int classGuid) {
        if (fromCache) {
            ...
            if (user != null) {
                ...
                ConnectionsManager.getInstance().bindRequestToGuid(ConnectionsManager.getInstance().sendRequest(req, new 27(this, did, count, max_id, classGuid)), classGuid);
            }
        } else if (did < 0) {
            ...
            ConnectionsManager.getInstance().bindRequestToGuid(ConnectionsManager.getInstance().sendRequest(req2, new 28(this, did, count, max_id, classGuid)), classGuid);
        }
    }
    ...
    public void blockUser(int user_id) {
        ...
        if (user != null && !this.blockedUsers.contains(Integer.valueOf(user_id))) {
            ...
            req.id = getInputUser(user);
            ConnectionsManager.getInstance().sendRequest(req, new 29(this, user));
        }
    }

    public static void setUserBannedRole(int chatId, User user, TL_channelBannedRights rights, boolean isMegagroup, BaseFragment parentFragment) {
        if (user != null && rights != null) {
            TL_channels_editBanned req = new TL_channels_editBanned();
            req.channel = getInputChannel(chatId);
            req.user_id = getInputUser(user);
            req.banned_rights = rights;
            ConnectionsManager.getInstance().sendRequest(req, new 30(chatId, parentFragment, req, isMegagroup));
        }
    }

    public static void setUserAdminRole(int chatId, User user, TL_channelAdminRights rights, boolean isMegagroup, BaseFragment parentFragment) {
        if (user != null && rights != null) {
            TL_channels_editAdmin req = new TL_channels_editAdmin();
            req.channel = getInputChannel(chatId);
            req.user_id = getInputUser(user);
            req.admin_rights = rights;
            ConnectionsManager.getInstance().sendRequest(req, new 31(chatId, parentFragment, req, isMegagroup));
        }
    }
    ...
    public void unblockUser(int user_id) {
        ...
        if (user != null) {
            ...
            req.id = getInputUser(user);
            NotificationCenter.getInstance().postNotificationName(NotificationCenter.blockedUsersDidLoaded, new Object[0]);
            ConnectionsManager.getInstance().sendRequest(req, new 32(this, user));
        }
    }
    ...
    public void getBlockedUsers(boolean cache) {
        if (UserConfig.isClientActivated() && !this.loadingBlockedUsers) {
            ...
            req.offset = 0;
            req.limit = 200;
            ConnectionsManager.getInstance().sendRequest(req, new 33(this));
        }
    }

    public void processLoadedBlockedUsers(ArrayList<Integer> ids, ArrayList<User> users, boolean cache) {
        AndroidUtilities.runOnUIThread(new 34(this, users, cache, ids));
    }
    ...
    public void deleteUserPhoto(InputPhoto photo) {
        if (photo == null) {
            ...
            if (user != null) {
                ...
                NotificationCenter.getInstance().postNotificationName(NotificationCenter.updateInterfaces, new Object[]{Integer.valueOf(UPDATE_MASK_ALL)});
                ConnectionsManager.getInstance().sendRequest(req, new 35(this));
                return;
            }
            return;
        }
        ...
        req2.id.add(photo);
        ConnectionsManager.getInstance().sendRequest(req2, new 36(this));
    }
    ...
    public void processLoadedUserPhotos(photos_Photos res, int did, int count, long max_id, boolean fromCache, int classGuid) {
        ...
        AndroidUtilities.runOnUIThread(new 37(this, res, fromCache, did, count, classGuid));
    }

    public void uploadAndApplyUserAvatar(PhotoSize bigPhoto) {
        if (bigPhoto != null) {
            this.uploadingAvatar = FileLoader.getInstance().getDirectory(4) + BridgeUtil.SPLIT_MARK + bigPhoto.location.volume_id + BridgeUtil.UNDERLINE_STR + bigPhoto.location.local_id + ".jpg";
    ...
    public void deleteMessages(ArrayList<Integer> messages, ArrayList<Long> randoms, EncryptedChat encryptedChat, int channelId, boolean forAll, long taskId, TLObject taskRequest) {
        ...
        if ((messages != null && !messages.isEmpty()) || taskRequest != null) {
            ...
            if (taskId == 0) {
                ...
                NotificationCenter.getInstance().postNotificationName(NotificationCenter.messagesDeleted, new Object[]{messages, Integer.valueOf(channelId)});
            }
            long newTaskId;
                ...
                if (taskRequest != null) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            ConnectionsManager.getInstance().sendRequest(req, new 38(this, channelId, newTaskId));
                            return;
                        }
                    } catch (Exception e3) {
                        e = e3;
            ...
            if (taskRequest != null) {
                ...
                try {
                    ...
                    try {
                        ...
                        FileLog.m4944e(e);
                        newTaskId = MessagesStorage.getInstance().createPendingTask(data);
                        ConnectionsManager.getInstance().sendRequest(req2, new 39(this, newTaskId));
                    }
                } catch (Exception e5) {
                    e = e5;
                    FileLog.m4944e(e);
    ...
    public void pinChannelMessage(Chat chat, int id, boolean notify) {
        ...
        req.id = id;
        req.silent = !notify;
        ConnectionsManager.getInstance().sendRequest(req, new 40(this));
    }
    ...
    public void deleteUserChannelHistory(Chat chat, User user, int offset) {
        ...
        req.channel = getInputChannel(chat);
        req.user_id = getInputUser(user);
        ConnectionsManager.getInstance().sendRequest(req, new 41(this, chat, user));
    }
    ...
    private void deleteDialog(long did, boolean first, int onlyHistory, int max_id) {
        ...
        if (first) {
            ...
            if (dialog != null) {
                ...
                if (onlyHistory == 0 || onlyHistory == 3) {
                    ...
                    if (this.dialogsServerOnly.remove(dialog) && DialogObject.isChannel(dialog)) {
                        Utilities.stageQueue.postRunnable(new 42(this, did));
                    }
            ...
            NotificationCenter.getInstance().postNotificationName(NotificationCenter.dialogsNeedReload, new Object[0]);
            NotificationCenter.getInstance().postNotificationName(NotificationCenter.removeAllMessagesFromDialog, new Object[]{Long.valueOf(did), Boolean.valueOf(false)});
            MessagesStorage.getInstance().getStorageQueue().postRunnable(new 43(this, did));
        }
        if (high_id != 1 && onlyHistory != 3) {
            if (lower_part != 0) {
                ...
                if (!(peer instanceof TL_inputPeerChannel)) {
                    ...
                    ConnectionsManager.getInstance().sendRequest(req, new 45(this, did, onlyHistory, max_id_delete), 64);
                    ...
                    ConnectionsManager.getInstance().sendRequest(req, new 44(this), 64);
                }
    ...
    public void saveGif(Document document) {
        ...
        req.unsave = false;
        ConnectionsManager.getInstance().sendRequest(req, new 46(this));
    }
    ...
    public void saveRecentSticker(Document document, boolean asMask) {
        ...
        req.unsave = false;
        req.attached = asMask;
        ConnectionsManager.getInstance().sendRequest(req, new 47(this));
    }
    ...
    public void loadChannelParticipants(Integer chat_id) {
        if (!this.loadingFullParticipants.contains(chat_id) && !this.loadedFullParticipants.contains(chat_id)) {
            ...
            req.offset = 0;
            req.limit = 32;
            ConnectionsManager.getInstance().sendRequest(req, new 48(this, chat_id));
        }
    }
    ...
    public void processChatInfo(int chat_id, ChatFull info, ArrayList<User> usersArr, boolean fromCache, boolean force, boolean byChannelUsers, MessageObject pinnedMessageObject) {
        ...
        if (info != null) {
            AndroidUtilities.runOnUIThread(new 49(this, usersArr, fromCache, info, byChannelUsers, pinnedMessageObject));
        }
    }
    ...
    public void updateTimerProc() {
        ...
        if (UserConfig.isClientActivated()) {
            ...
            if (ConnectionsManager.getInstance().getPauseTime() == 0 && ApplicationLoader.isScreenOn && !ApplicationLoader.mainInterfacePausedStageQueue) {
                if (ApplicationLoader.mainInterfacePausedStageQueueTime != 0 && Math.abs(ApplicationLoader.mainInterfacePausedStageQueueTime - System.currentTimeMillis()) > 1000 && this.statusSettingState != 1 && (this.lastStatusUpdateTime == 0 || Math.abs(System.currentTimeMillis() - this.lastStatusUpdateTime) >= 55000 || this.offlineSent)) {
                    ...
                    req.offline = false;
                    this.statusRequest = ConnectionsManager.getInstance().sendRequest(req, new 50(this));
                }
            } else if (!(this.statusSettingState == 2 || this.offlineSent || Math.abs(System.currentTimeMillis() - ConnectionsManager.getInstance().getPauseTime()) < Reveal.CHECK_DELAY)) {
                ...
                req = new TL_account_updateStatus();
                req.offline = true;
                this.statusRequest = ConnectionsManager.getInstance().sendRequest(req, new 51(this));
            }
            if (!this.updatesQueueChannels.isEmpty()) {
                ...
                for (a = 0; a < keys.size(); a++) {
                    ...
                    if (updatesStartWaitTime != null && updatesStartWaitTime.longValue() + 1500 < currentTime) {
                        FileLog.m4942e("QUEUE CHANNEL " + key + " UPDATES WAIT TIMEOUT - CHECK QUEUE");
            ...
            while (a < 3) {
                if (getUpdatesStartTime(a) != 0 && getUpdatesStartTime(a) + 1500 < currentTime) {
                    FileLog.m4942e(a + " QUEUE UPDATES WAIT TIMEOUT - CHECK QUEUE");
                    processUpdatesQueue(a, 0);
                }
                a++;
            }
        }
        if (this.channelViewsToSend.size() != 0 && Math.abs(System.currentTimeMillis() - this.lastViewsCheckTime) >= 5000) {
            ...
            while (a < this.channelViewsToSend.size()) {
                ...
                req2.increment = a == 0;
                ConnectionsManager.getInstance().sendRequest(req2, new 52(this, key, req2));
                a++;
            }
            this.channelViewsToSend.clear();
        }
        if (!this.onlinePrivacy.isEmpty()) {
            ...
            if (toRemove != null) {
                ...
                AndroidUtilities.runOnUIThread(new 53(this));
            }
        }
        ...
        if (!(this.printingUsers.isEmpty() && this.lastPrintingStringCount == this.printingUsers.size())) {
            ...
            if (updated) {
                AndroidUtilities.runOnUIThread(new 54(this));
            }
        }
    ...
    private void updatePrintingStrings() {
        ...
        AndroidUtilities.runOnUIThread(new 55(this, newPrintingStrings, newPrintingStringsTypes));
    }
                ...
                if (lower_part != 0) {
                    if (high_id != 1) {
                        ...
                        if (req.peer != null) {
                            ...
                            reqId = ConnectionsManager.getInstance().sendRequest(req, new 56(this, action, dialog_id), 2);
                            if (classGuid != 0) {
                                ConnectionsManager.getInstance().bindRequestToGuid(reqId, classGuid);
                            }
                        }
                    ...
                    if (chat2.auth_key != null && chat2.auth_key.length > 1 && (chat2 instanceof TL_encryptedChat)) {
                        ...
                        req2.typing = true;
                        typings.put(Long.valueOf(dialog_id), Boolean.valueOf(true));
                        reqId = ConnectionsManager.getInstance().sendRequest(req2, new 57(this, action, dialog_id), 2);
                        if (classGuid != 0) {
                            ConnectionsManager.getInstance().bindRequestToGuid(reqId, classGuid);
                        }
                    }
    ...
    public void loadMessages(long dialog_id, int count, int max_id, int offset_date, boolean fromCache, int midDate, int classGuid, int load_type, int last_message_id, boolean isChannel, int loadIndex, int first_unread, int unread_count, int last_date, boolean queryFromServer, int mentionsCount) {
        FileLog.m4942e("load messages in chat " + dialog_id + " count " + count + " max_id " + max_id + " cache " + fromCache + " mindate = " + midDate + " guid " + classGuid + " load_type " + load_type + " last_message_id " + last_message_id + " index " + loadIndex + " firstUnread " + first_unread + " unread_count " + unread_count + " last_date " + last_date + " queryFromServer " + queryFromServer);
        int lower_part = (int) dialog_id;
        ...
        ConnectionsManager.getInstance().bindRequestToGuid(ConnectionsManager.getInstance().sendRequest(req, new 58(this, count, max_id, offset_date, dialog_id, classGuid, first_unread, last_message_id, unread_count, last_date, load_type, isChannel, loadIndex, queryFromServer, mentionsCount)), classGuid);
    }
    ...
    public void reloadWebPages(long dialog_id, HashMap<String, ArrayList<MessageObject>> webpagesToReload) {
        for (Entry<String, ArrayList<MessageObject>> entry : webpagesToReload.entrySet()) {
            ...
            req.message = url;
            ConnectionsManager.getInstance().sendRequest(req, new 59(this, url, dialog_id));
        }
    }
    ...
    public void loadHintDialogs() {
        if (this.hintDialogs.isEmpty() && !TextUtils.isEmpty(this.installReferer)) {
            ...
            ConnectionsManager.getInstance().sendRequest(req, new 61(this));
        }
    }
    ...
    public void loadDialogs(int offset, int count, boolean fromCache) {
        if (!this.loadingDialogs && !this.resetingDialogs) {
            ...
            NotificationCenter.getInstance().postNotificationName(NotificationCenter.dialogsNeedReload, new Object[0]);
            FileLog.m4942e("load cacheOffset = " + offset + " count = " + count + " cache = " + fromCache);
            if (fromCache) {
            ...
            ConnectionsManager.getInstance().sendRequest(req, new 62(this, count));
        }
    }
    ...
    private void resetDialogs(boolean query, int seq, int newPts, int date, int qts) {
        if (query) {
            if (!this.resetingDialogs) {
                ...
                ConnectionsManager.getInstance().sendRequest(new TL_messages_getPinnedDialogs(), new 63(this, seq, newPts, date, qts));
                TLObject req2 = new TL_messages_getDialogs();
                req2.limit = 100;
                req2.exclude_pinned = true;
                req2.offset_peer = new TL_inputPeerEmpty();
                ConnectionsManager.getInstance().sendRequest(req2, new 64(this, seq, newPts, date, qts));
            }
    ...
    protected void completeDialogsReset(messages_Dialogs dialogsRes, int messagesCount, int seq, int newPts, int date, int qts, HashMap<Long, TL_dialog> new_dialogs_dict, HashMap<Long, MessageObject> new_dialogMessage, Message lastMessage) {
        Utilities.stageQueue.postRunnable(new 65(this, newPts, date, qts, dialogsRes, new_dialogs_dict, new_dialogMessage));
    }
    ...
    private void migrateDialogs(int offset, int offsetDate, int offsetUser, int offsetChat, int offsetChannel, long accessPeer) {
        if (!this.migratingDialogs && offset != -1) {
            ...
            FileLog.m4942e("start migrate with id " + offset + " date " + LocaleController.getInstance().formatterStats.format(((long) offsetDate) * 1000));
            if (offset == 0) {
                req.offset_peer = new TL_inputPeerEmpty();
            } else {
                if (offsetChannel != 0) {
            ...
            ConnectionsManager.getInstance().sendRequest(req, new 66(this, offset));
        }
    }
    ...
    public void processLoadedDialogs(messages_Dialogs dialogsRes, ArrayList<EncryptedChat> encChats, int offset, int count, int loadType, boolean resetEnd, boolean migrate, boolean fromCache) {
        Utilities.stageQueue.postRunnable(new 67(this, loadType, dialogsRes, resetEnd, count, offset, fromCache, migrate, encChats));
    }
    ...
    public void reloadMentionsCountForChannels(ArrayList<Integer> arrayList) {
        AndroidUtilities.runOnUIThread(new 68(this, arrayList));
    }

    public void processDialogsUpdateRead(HashMap<Long, Integer> dialogsToUpdate, HashMap<Long, Integer> dialogsMentionsToUpdate) {
        AndroidUtilities.runOnUIThread(new 69(this, dialogsToUpdate, dialogsMentionsToUpdate));
    }
                ...
                if (taskId == 0) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            FileLog.m4944e(e);
                            newTaskId = MessagesStorage.getInstance().createPendingTask(data);
                            ConnectionsManager.getInstance().sendRequest(req, new 70(this, dialog, newTaskId, lower_id));
                        }
                    } catch (Exception e3) {
                        e = e3;
                        FileLog.m4944e(e);
    ...
    public void processDialogsUpdate(messages_Dialogs dialogsRes, ArrayList<EncryptedChat> arrayList) {
        Utilities.stageQueue.postRunnable(new 71(this, dialogsRes));
    }

    public void addToViewsQueue(Message message) {
        Utilities.stageQueue.postRunnable(new 72(this, message));
    }
    ...
    public void markMentionMessageAsRead(int mid, int channelId, long did) {
        ...
        if (channelId != 0) {
            ...
            if (req.channel != null) {
                ...
                ConnectionsManager.getInstance().sendRequest(req, new 75(this));
                return;
            }
            return;
        }
        ...
        ConnectionsManager.getInstance().sendRequest(req2, new 76(this));
    }
    ...
    public void markMessageAsRead(int mid, int channelId, int ttl) {
        if (mid != 0 && ttl > 0) {
            ...
            if (channelId != 0) {
                ...
                req.channel = getInputChannel(channelId);
                req.id.add(Integer.valueOf(mid));
                ConnectionsManager.getInstance().sendRequest(req, new 77(this));
                return;
            }
            TL_messages_readMessageContents req2 = new TL_messages_readMessageContents();
            req2.id.add(Integer.valueOf(mid));
            ConnectionsManager.getInstance().sendRequest(req2, new 78(this));
        }
    }
    ...
    public void markDialogAsRead(long dialog_id, int max_id, int max_positive_id, int max_date, boolean was, boolean popup) {
        ...
        if (lower_part != 0) {
            if (max_positive_id != 0 && high_id != 1) {
                ...
                MessagesStorage.getInstance().getStorageQueue().postRunnable(new 79(this, dialog_id, popup, max_positive_id));
                if (max_positive_id != Integer.MAX_VALUE) {
                    ConnectionsManager.getInstance().sendRequest(req, new 80(this));
                }
            }
        } else if (max_date != 0) {
            EncryptedChat chat = getEncryptedChat(Integer.valueOf(high_id));
            if (chat.auth_key != null && chat.auth_key.length > 1 && (chat instanceof TL_encryptedChat)) {
                ...
                ConnectionsManager.getInstance().sendRequest(req, new 81(this));
            }
            MessagesStorage.getInstance().processPendingRead(dialog_id, (long) max_id, max_date);
            MessagesStorage.getInstance().getStorageQueue().postRunnable(new 82(this, dialog_id, max_date, popup));
            if (chat.ttl > 0 && was) {
    ...
    public int createChat(String title, ArrayList<Integer> selectedContacts, String about, int type, BaseFragment fragment) {
        ...
        if (type == 1) {
            ...
            NotificationCenter.getInstance().postNotificationName(NotificationCenter.dialogsNeedReload, new Object[0]);
            NotificationCenter.getInstance().postNotificationName(NotificationCenter.chatDidCreated, new Object[]{Integer.valueOf(chat.id)});
            return 0;
        } else if (type == 0) {
            ...
            return ConnectionsManager.getInstance().sendRequest(req, new 83(this, fragment, req), 2);
            ...
            return ConnectionsManager.getInstance().sendRequest(req, new 84(this, fragment, req), 2);
        }
    }
    ...
    public void convertToMegaGroup(Context context, int chat_id) {
        ...
        progressDialog.setButton(-2, LocaleController.getString("Cancel", R.string.Cancel), new 86(this, ConnectionsManager.getInstance().sendRequest(req, new 85(this, context, progressDialog))));
        try {
            progressDialog.show();
        } catch (Exception e) {
        }
    ...
    public void addUsersToChannel(int chat_id, ArrayList<InputUser> users, BaseFragment fragment) {
        if (users != null && !users.isEmpty()) {
            ...
            req.users = users;
            ConnectionsManager.getInstance().sendRequest(req, new 87(this, fragment, req));
        }
    }
    ...
    public void toogleChannelInvites(int chat_id, boolean enabled) {
        ...
        req.channel = getInputChannel(chat_id);
        req.enabled = enabled;
        ConnectionsManager.getInstance().sendRequest(req, new 88(this), 64);
    }
    ...
    public void toogleChannelSignatures(int chat_id, boolean enabled) {
        ...
        req.channel = getInputChannel(chat_id);
        req.enabled = enabled;
        ConnectionsManager.getInstance().sendRequest(req, new 89(this), 64);
    }
    ...
    public void toogleChannelInvitesHistory(int chat_id, boolean enabled) {
        ...
        req.channel = getInputChannel(chat_id);
        req.enabled = enabled;
        ConnectionsManager.getInstance().sendRequest(req, new 90(this), 64);
    }
    ...
    public void updateChannelAbout(int chat_id, String about, ChatFull info) {
        if (info != null) {
            ...
            req.channel = getInputChannel(chat_id);
            req.about = about;
            ConnectionsManager.getInstance().sendRequest(req, new 91(this, info, about), 64);
        }
    }
    ...
    public void updateChannelUserName(int chat_id, String userName) {
        ...
        ConnectionsManager.getInstance().sendRequest(req, new 92(this, chat_id, userName), 64);
    }
    ...
    public void sendBotStart(User user, String botHash) {
        if (user != null) {
            ...
            ConnectionsManager.getInstance().sendRequest(req, new 93(this));
        }
    }
    ...
    public void toggleAdminMode(int chat_id, boolean enabled) {
        ...
        req.chat_id = chat_id;
        req.enabled = enabled;
        ConnectionsManager.getInstance().sendRequest(req, new 94(this, chat_id));
    }
    ...
    public void toggleUserAdmin(int chat_id, int user_id, boolean admin) {
        ...
        req.is_admin = admin;
        ConnectionsManager.getInstance().sendRequest(req, new 95(this));
    }
    ...
    public void addUserToChat(int chat_id, User user, ChatFull info, int count_fwd, String botHash, BaseFragment fragment) {
        if (user != null) {
            if (chat_id > 0) {
                ...
                ConnectionsManager.getInstance().sendRequest(request, new 96(this, isChannel, inputUser, chat_id, fragment, request, isMegagroup));
                ...
                NotificationCenter.getInstance().postNotificationName(NotificationCenter.chatInfoDidLoaded, new Object[]{info, Integer.valueOf(0), Boolean.valueOf(false), null});
    ...
    public void deleteUserFromChat(int chat_id, User user, ChatFull info, boolean forceDelete) {
        if (user != null) {
            ...
            if (chat_id > 0) {
                ...
                ConnectionsManager.getInstance().sendRequest(request, new 97(this, user, chat_id, isChannel, inputUser), 64);
            } else if (info instanceof TL_chatFull) {
                chat = getChat(Integer.valueOf(chat_id));
                chat.participants_count--;
                ArrayList<Chat> chatArrayList = new ArrayList();
    ...
    public void changeChatTitle(int chat_id, String title) {
        if (chat_id > 0) {
            ...
            ConnectionsManager.getInstance().sendRequest(request, new 98(this), 64);
            return;
        }
        Chat chat = getChat(Integer.valueOf(chat_id));
        chat.title = title;
    ...
    public void changeChatAvatar(int chat_id, InputFile uploadedAvatar) {
        ...
        ConnectionsManager.getInstance().sendRequest(request, new 99(this), 64);
    }
    ...
    public void unregistedPush() {
        if (UserConfig.registeredForPush && UserConfig.pushString.length() == 0) {
            ...
            req.token_type = 2;
            ConnectionsManager.getInstance().sendRequest(req, new 100(this));
        }
    }
    ...
    public void performLogout(boolean byUser) {
        ...
        if (byUser) {
            unregistedPush();
            ConnectionsManager.getInstance().sendRequest(new TL_auth_logOut(), new 101(this));
        } else {
    ...
    public void generateUpdateMessage() {
        if (!BuildVars.DEBUG_VERSION && UserConfig.lastUpdateVersion != null && !UserConfig.lastUpdateVersion.equals(BuildVars.BUILD_VERSION_STRING)) {
            ...
            ConnectionsManager.getInstance().sendRequest(req, new 102(this));
        }
    }
    ...
    public void registerForPush(String regid) {
        if (regid != null && regid.length() != 0 && !this.registeringForPush && UserConfig.getClientUserId() != 0) {
            if (!UserConfig.registeredForPush || !regid.equals(UserConfig.pushString)) {
                ...
                req.token_type = 2;
                req.token = regid;
                ConnectionsManager.getInstance().sendRequest(req, new 103(this, regid));
            }
        }
    }
    ...
    public void loadCurrentState() {
        if (!this.updatingState) {
            ...
            ConnectionsManager.getInstance().sendRequest(new TL_updates_getState(), new 104(this));
        }
    }
    ...
    private void processChannelsUpdatesQueue(int channelId, int state) {
        ...
        if (updatesQueue != null) {
            ...
            Collections.sort(updatesQueue, new 105(this));
            ...
            while (updatesQueue.size() > 0) {
                ...
                if (updateState == 0) {
                    ...
                    if (updatesStartWaitTime == null || (!anyProceed && Math.abs(System.currentTimeMillis() - updatesStartWaitTime.longValue()) > 1500)) {
                        FileLog.m4942e("HOLE IN CHANNEL " + channelId + " UPDATES QUEUE - getChannelDifference ");
                        this.updatesStartWaitTimeChannels.remove(Integer.valueOf(channelId));
                        this.updatesQueueChannels.remove(Integer.valueOf(channelId));
                        getChannelDifference(channelId);
                        return;
                    }
                    FileLog.m4942e("HOLE IN CHANNEL " + channelId + " UPDATES QUEUE - will wait more time");
                    if (anyProceed) {
                        this.updatesStartWaitTimeChannels.put(Integer.valueOf(channelId), Long.valueOf(System.currentTimeMillis()));
                        return;
                    }
            ...
            this.updatesQueueChannels.remove(Integer.valueOf(channelId));
            this.updatesStartWaitTimeChannels.remove(Integer.valueOf(channelId));
            FileLog.m4942e("UPDATES CHANNEL " + channelId + " QUEUE PROCEED - OK");
        }
    }
    ...
    private void processUpdatesQueue(int type, int state) {
        ...
        if (type == 0) {
            ...
            Collections.sort(updatesQueue, new 106(this));
        } else if (type == 1) {
            updatesQueue = this.updatesQueuePts;
            Collections.sort(updatesQueue, new 107(this));
        } else if (type == 2) {
            updatesQueue = this.updatesQueueQts;
            Collections.sort(updatesQueue, new 108(this));
        }
        if (!(updatesQueue == null || updatesQueue.isEmpty())) {
            ...
            while (updatesQueue.size() > 0) {
                ...
                if (updateState == 0) {
                    ...
                    FileLog.m4942e("HOLE IN UPDATES QUEUE - getDifference");
                    setUpdatesStartTime(type, 0);
                    updatesQueue.clear();
                    getDifference();
                    return;
                } else {
                    FileLog.m4942e("HOLE IN UPDATES QUEUE - will wait more time");
                    if (anyProceed) {
            ...
            updatesQueue.clear();
            FileLog.m4942e("UPDATES QUEUE PROCEED - OK");
        }
        setUpdatesStartTime(type, 0);
    }
                ...
                if (taskId == 0) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            FileLog.m4944e(e);
                            newTaskId = MessagesStorage.getInstance().createPendingTask(data);
                            ConnectionsManager.getInstance().sendRequest(req, new 109(this, newTaskId, channel));
                        }
                    } catch (Exception e3) {
                        e = e3;
                        FileLog.m4944e(e);
    ...
    public void startShortPoll(int channelId, boolean stop) {
        Utilities.stageQueue.postRunnable(new 110(this, stop, channelId));
    }
                ...
                if (taskId == 0) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            FileLog.m4942e("start getChannelDifference with pts = " + channelPts + " channelId = " + channelId);
                            ConnectionsManager.getInstance().sendRequest(req, new 111(this, channelId, newDialogType, newTaskId));
                        }
                    } catch (Exception e3) {
                        e = e3;
                        FileLog.m4944e(e);
    ...
    private void checkChannelError(String text, int channelId) {
        ...
        switch (i) {
            case 0:
                NotificationCenter.getInstance().postNotificationName(NotificationCenter.chatInfoCantLoad, new Object[]{Integer.valueOf(channelId), Integer.valueOf(0)});
                return;
            case 1:
                NotificationCenter.getInstance().postNotificationName(NotificationCenter.chatInfoCantLoad, new Object[]{Integer.valueOf(channelId), Integer.valueOf(1)});
                return;
            case 2:
                NotificationCenter.getInstance().postNotificationName(NotificationCenter.chatInfoCantLoad, new Object[]{Integer.valueOf(channelId), Integer.valueOf(2)});
                return;
            default:
                return;
        }
    ...
    public void getDifference(int pts, int date, int qts, boolean slice) {
        ...
        if (MessagesStorage.lastPtsValue == 0) {
            ...
            FileLog.m4942e("start getDifference with date = " + date + " pts = " + pts + " qts = " + qts);
            ConnectionsManager.getInstance().setIsUpdating(true);
            ConnectionsManager.getInstance().sendRequest(req, new 112(this, date, qts));
        }
    }
                ...
                if (taskId == 0) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            FileLog.m4944e(e);
                            newTaskId = MessagesStorage.getInstance().createPendingTask(data);
                            ConnectionsManager.getInstance().sendRequest(req, new 113(this, newTaskId));
    ...
    public void loadPinnedDialogs(long newDialogId, ArrayList<Long> order) {
        if (!UserConfig.pinnedDialogsLoaded) {
            ConnectionsManager.getInstance().sendRequest(new TL_messages_getPinnedDialogs(), new 114(this, order, newDialogId));
        }
    }
    ...
    public void generateJoinMessage(int chat_id, boolean ignoreLeft) {
        ...
        if (chat != null && ChatObject.isChannel(chat_id)) {
            if ((!chat.left && !chat.kicked) || ignoreLeft) {
                ...
                MessagesStorage.getInstance().getStorageQueue().postRunnable(new 115(this, pushMessages));
                MessagesStorage.getInstance().putMessages(messagesArr, true, true, false, 0);
                AndroidUtilities.runOnUIThread(new 116(this, chat_id, pushMessages));
            }
        }
    }

    public void checkChannelInviter(int chat_id) {
        AndroidUtilities.runOnUIThread(new 117(this, chat_id));
    }
    ...
    public void processUpdates(Updates updates, boolean fromQueue) {
        ...
        if (updates instanceof TL_updateShort) {
            ...
            if (missingData) {
                ...
                if (updates instanceof TL_updateShortMessage) {
                    ...
                    AndroidUtilities.runOnUIThread(new 118(this, printUpdate, user_id, objArr));
                } else {
                    printUpdate = updatePrintingUsersWithNewMessages((long) (-updates.chat_id), objArr);
                    if (printUpdate) {
                        updatePrintingStrings();
                    }
                    AndroidUtilities.runOnUIThread(new 119(this, printUpdate, updates, objArr));
                }
                if (!messageObject.isOut()) {
                    MessagesStorage.getInstance().getStorageQueue().postRunnable(new 120(this, objArr));
                }
                MessagesStorage.getInstance().putMessages(arr2, false, true, false, 0);
            } else if (MessagesStorage.lastPtsValue != updates.pts) {
                FileLog.m4942e("need get diff short message, pts: " + MessagesStorage.lastPtsValue + " " + updates.pts + " count = " + updates.pts_count);
                if (this.gettingDifference || this.updatesStartWaitTimePts == 0 || Math.abs(System.currentTimeMillis() - this.updatesStartWaitTimePts) <= 1500) {
                    if (this.updatesStartWaitTimePts == 0) {
                        this.updatesStartWaitTimePts = System.currentTimeMillis();
                    }
                    FileLog.m4942e("add to queue");
                    this.updatesQueuePts.add(updates);
                } else {
                    needGetDiff = true;
                }
                ...
                for (a = 0; a < updates.updates.size(); a++) {
                    ...
                    if (update instanceof TL_updateNewChannelMessage) {
                        ...
                        if (minChannels.containsKey(Integer.valueOf(channelId))) {
                            FileLog.m4942e("need get diff because of min channel " + channelId);
                            needGetDiff = true;
                            break;
                        }
                    }
            ...
            if (!needGetDiff) {
                ...
                while (updates.updates.size() > 0) {
                    ...
                    if (getUpdateType(update) != 0) {
                        if (getUpdateType(update) != 1) {
                            ...
                            if (skipUpdate) {
                                FileLog.m4942e("need load unknown channel = " + channelId);
                                ...
                                if (processUpdateArray(updatesNew.updates, updates.users, updates.chats, false)) {
                                    ...
                                    FileLog.m4942e("need get channel diff inner TL_updates, channel_id = " + channelId);
                                ...
                                FileLog.m4942e(update + " need get channel diff, pts: " + channelPts + " " + updatesNew.pts + " count = " + updatesNew.pts_count + " channelId = " + channelId);
                                Long updatesStartWaitTime = (Long) this.updatesStartWaitTimeChannels.get(Integer.valueOf(channelId));
                                Boolean gettingDifferenceChannel = (Boolean) this.gettingDifferenceChannels.get(Integer.valueOf(channelId));
                                if (gettingDifferenceChannel == null) {
                                    gettingDifferenceChannel = Boolean.valueOf(false);
                            ...
                            if (MessagesStorage.lastQtsValue == 0 || MessagesStorage.lastQtsValue + updatesNew.updates.size() == updatesNew.pts) {
                                ...
                                FileLog.m4942e(update + " need get diff, qts: " + MessagesStorage.lastQtsValue + " " + updatesNew.pts);
                        ...
                        if (MessagesStorage.lastPtsValue + updatesNew.pts_count == updatesNew.pts) {
                            if (processUpdateArray(updatesNew.updates, updates.users, updates.chats, false)) {
                                ...
                                FileLog.m4942e("need get diff inner TL_updates, seq: " + MessagesStorage.lastSeqValue + " " + updates.seq);
                                needGetDiff = true;
                            }
                        } else if (MessagesStorage.lastPtsValue != updatesNew.pts) {
                            FileLog.m4942e(update + " need get diff, pts: " + MessagesStorage.lastPtsValue + " " + updatesNew.pts + " count = " + updatesNew.pts_count);
                ...
                if (processUpdate) {
                    ...
                    if (updates instanceof TL_updatesCombined) {
                        FileLog.m4942e("need get diff TL_updatesCombined, seq: " + MessagesStorage.lastSeqValue + " " + updates.seq_start);
                    } else {
                        FileLog.m4942e("need get diff TL_updates, seq: " + MessagesStorage.lastSeqValue + " " + updates.seq);
                    }
                    if (this.gettingDifference || this.updatesStartWaitTimeSeq == 0 || Math.abs(System.currentTimeMillis() - this.updatesStartWaitTimeSeq) <= 1500) {
                        if (this.updatesStartWaitTimeSeq == 0) {
                            this.updatesStartWaitTimeSeq = System.currentTimeMillis();
                        }
                        FileLog.m4942e("add TL_updates/Combined to queue");
            ...
            FileLog.m4942e("need get diff TL_updatesTooLong");
            needGetDiff = true;
        ...
        if (needReceivedQueue) {
            ...
            ConnectionsManager.getInstance().sendRequest(req, new 121(this));
        }
        if (updateStatus) {
            AndroidUtilities.runOnUIThread(new 122(this));
        }
        MessagesStorage.getInstance().saveDiffParams(MessagesStorage.lastSeqValue, MessagesStorage.lastPtsValue, MessagesStorage.lastDateValue, MessagesStorage.lastQtsValue);
    }
    ...
    public boolean processUpdateArray(ArrayList<Update> updates, ArrayList<User> usersArr, ArrayList<Chat> chatsArr, boolean fromGetDifference) {
        if (updates.isEmpty()) {
            if (!(usersArr == null && chatsArr == null)) {
                AndroidUtilities.runOnUIThread(new 123(this, usersArr, chatsArr));
            }
            return true;
        }
        ...
        if (!(usersArr == null && chatsArr == null)) {
            AndroidUtilities.runOnUIThread(new 124(this, usersArr, chatsArr));
        }
        int interfaceUpdateMask = 0;
        for (int c = 0; c < updates.size(); c++) {
            Iterator it;
            Update update = (Update) updates.get(c);
            FileLog.m4941d("process update " + update);
            Message message;
            int user_id;
            int count;
            ...
            if ((update instanceof TL_updateNewMessage) || (update instanceof TL_updateNewChannelMessage)) {
                if (update instanceof TL_updateNewMessage) {
                    ...
                    if (BuildVars.DEBUG_VERSION) {
                        FileLog.m4941d(update + " channelId = " + message.to_id.channel_id);
                    }
                    ...
                    if (chat_id == 0 || chat != null) {
                        ...
                        for (a = 0; a < count; a++) {
                            ...
                            if (user_id > 0) {
                                ...
                                if (user == null) {
                                    FileLog.m4941d("not found user " + user_id);
                                    return false;
                        ...
                        FileLog.m4941d("not found chat " + chat_id);
                        return false;
                    }
                }
                if (chat != null && chat.megagroup) {
                ...
                MessagesStorage.getInstance().getStorageQueue().postRunnable(new 125(this, finalUpdate));
                ...
                if (notification.popup && notification.message != null && notification.message.length() > 0) {
                    AndroidUtilities.runOnUIThread(new 126(this, notification));
                }
                ...
                if (BuildVars.DEBUG_VERSION) {
                    FileLog.m4941d(update + " channelId = " + update.channel_id);
                }
        ...
        if (!pushMessages.isEmpty()) {
            MessagesStorage.getInstance().getStorageQueue().postRunnable(new 127(this, pushMessages));
        }
        ...
        AndroidUtilities.runOnUIThread(new 128(this, interfaceUpdateMaskFinal, updatesOnMainThread, webPages, messages, editingMessages, printChangedArg, contactsIds, chatInfoToUpdate, channelViews));
        MessagesStorage.getInstance().getStorageQueue().postRunnable(new 129(this, markAsReadMessagesInbox, markAsReadMessagesOutbox, markAsReadEncrypted, markAsReadMessages, deletedMessages, clearHistoryMessages));
        if (!webPages.isEmpty()) {
        ...
        if (deletedMessages.size() != 0) {
            for (a = 0; a < deletedMessages.size(); a++) {
                ...
                MessagesStorage.getInstance().getStorageQueue().postRunnable(new 130(this, (ArrayList) deletedMessages.get(key), key));
            }
        }
        if (clearHistoryMessages.size() != 0) {
            for (a = 0; a < clearHistoryMessages.size(); a++) {
                key = clearHistoryMessages.keyAt(a);
                MessagesStorage.getInstance().getStorageQueue().postRunnable(new 131(this, key, (Integer) clearHistoryMessages.get(key)));
            }
        }
        if (!tasks.isEmpty()) {
    ...
    protected void updateInterfaceWithMessages(long uid, ArrayList<MessageObject> messages, boolean isBroadcast) {
        if (messages != null && !messages.isEmpty()) {
            ...
            NotificationCenter.getInstance().postNotificationName(NotificationCenter.didReceivedNewMessages, new Object[]{Long.valueOf(uid), messages});
            if (lastMessage != null) {
    ...
    public static boolean checkCanOpenChat(Bundle bundle, BaseFragment fragment, MessageObject originalMessage) {
        ...
        if (!(messageId == 0 || originalMessage == null || chat == null || chat.access_hash != 0)) {
            ...
            if (did != 0) {
                ...
                progressDialog.setButton(-2, LocaleController.getString("Cancel", R.string.Cancel), new 133(ConnectionsManager.getInstance().sendRequest(req, new 132(progressDialog, fragment, bundle)), fragment));
    ...
    public static void openByUserName(String username, BaseFragment fragment, int type) {
        if (username != null && fragment != null) {
            ...
            if (user != null) {
                ...
                req.username = username;
                AndroidUtilities.runOnUIThread(new 135(progressDialog, ConnectionsManager.getInstance().sendRequest(req, new 134(progressDialog, fragment, type)), fragment), 500);
            }
        }
    }
}
