...
public class NotificationsController {
    ...
    class C51181 implements Runnable {
        C51181() {
        }
    ...
    class C51192 implements Runnable {
        C51192() {
        }
    ...
    class C51225 implements Runnable {
        C51225() {
        }
        ...
        public void run() {
            try {
                if (ApplicationLoader.mainInterfacePaused) {
                    ...
                    Builder mBuilder = new Builder(ApplicationLoader.applicationContext).setContentTitle(ApplicationLoader.getConfig().getAppName()).setSmallIcon(R.drawable.notification).setAutoCancel(true).setNumber(NotificationsController.this.total_unread_count).setContentIntent(PendingIntent.getActivity(ApplicationLoader.applicationContext, 0, intent, 1073741824)).setGroup("messages").setGroupSummary(true).setColor(-13851168);
                    ...
                    if (VERSION.SDK_INT >= 21) {
                        int smallIconViewId = ApplicationLoader.applicationContext.getResources().getIdentifier("right_icon", "id", android.R.class.getPackage().getName());
                    ...
                    NotificationsController.this.notificationManager.notify(1, notification);
                }
            } catch (Exception e2) {
                FileLog.e(e2);
            }
    ...
    class C51246 implements Runnable {
        C51246() {
        }
    ...
    public NotificationsController() {
        ...
        this.notificationDelayRunnable = new C51181();
    }

    public void cleanup() {
        this.popupMessages.clear();
        this.popupReplyMessages.clear();
        this.notificationsQueue.postRunnable(new C51192());
    }
    ...
    protected void showSingleBackgroundNotification() {
        this.notificationsQueue.postRunnable(new C51225());
    }

    protected void forceShowPopupForReply() {
        this.notificationsQueue.postRunnable(new C51246());
    }
    ...
    public void removeDeletedMessagesFromNotifications(final SparseArray<ArrayList<Integer>> deletedMessages) {
        ...
        this.notificationsQueue.postRunnable(new Runnable() {
            ...
            class C51251 implements Runnable {
                C51251() {
                }
            ...
            public void run() {
                ...
                if (popupArray != null) {
                    AndroidUtilities.runOnUIThread(new C51251());
                }
    ...
    public void removeDeletedHisoryFromNotifications(final SparseArray<Integer> deletedMessages) {
        ...
        this.notificationsQueue.postRunnable(new Runnable() {
            ...
            class C51271 implements Runnable {
                C51271() {
                }
            ...
            public void run() {
                ...
                if (popupArray != null) {
                    AndroidUtilities.runOnUIThread(new C51271());
                }
                if (old_unread_count != NotificationsController.this.total_unread_count) {
                    if (NotificationsController.this.notifyCheck) {
                        NotificationsController.this.scheduleNotificationDelay(NotificationsController.this.lastOnlineFromOtherDevice > ConnectionsManager.getInstance().getCurrentTime());
    ...
    public void processReadMessages(SparseArray<Long> inbox, long dialog_id, int max_date, int max_id, boolean isPopup) {
        ...
        this.notificationsQueue.postRunnable(new Runnable() {
            ...
            class C51291 implements Runnable {
                C51291() {
                }
            ...
            public void run() {
                ...
                if (popupArray != null && oldCount != popupArray.size()) {
                    AndroidUtilities.runOnUIThread(new C51291());
                }
            }
        });
    }
    ...
    public void processDialogsUpdateRead(final HashMap<Long, Integer> dialogsToUpdate) {
        ...
        this.notificationsQueue.postRunnable(new Runnable() {
            ...
            class C51141 implements Runnable {
                C51141() {
                }
            ...
            public void run() {
                ...
                if (popupArray != null) {
                    AndroidUtilities.runOnUIThread(new C51141());
                }
                if (old_unread_count != NotificationsController.this.total_unread_count) {
                    if (NotificationsController.this.notifyCheck) {
                        NotificationsController.this.scheduleNotificationDelay(NotificationsController.this.lastOnlineFromOtherDevice > ConnectionsManager.getInstance().getCurrentTime());
    ...
    public void processLoadedUnreadMessages(final HashMap<Long, Integer> dialogs, final ArrayList<TLRPC$Message> messages, ArrayList<User> users, ArrayList<TLRPC$Chat> chats, ArrayList<TLRPC$EncryptedChat> encryptedChats) {
        ...
        this.notificationsQueue.postRunnable(new Runnable() {
            ...
            class C51151 implements Runnable {
                C51151() {
                }
            ...
            public void run() {
                ...
                if (NotificationsController.this.total_unread_count == 0) {
                    AndroidUtilities.runOnUIThread(new C51151());
                }
        ...
        if (chat_id == 0 && from_id != 0) {
            if (!ApplicationLoader.applicationContext.getSharedPreferences("Notifications", 0).getBoolean("EnablePreviewAll", true)) {
                ...
                if (messageObject.messageOwner.action instanceof TLRPC$TL_messageActionUserJoined) {
                    return LocaleController.formatString("NotificationContactJoined", R.string.NotificationContactJoined, new Object[]{name, ApplicationLoader.getConfig().getAppName()});
            ...
            try {
                if (getNotifyOverride(ApplicationLoader.applicationContext.getSharedPreferences("Notifications", 0), this.opened_dialog_id) != 2) {
                    this.notificationsQueue.postRunnable(new Runnable() {
                        ...
                        class C51161 implements OnLoadCompleteListener {
                            C51161() {
                            }
                            ...
                            if (Math.abs(System.currentTimeMillis() - NotificationsController.this.lastSoundPlay) > 500) {
                                try {
                                    if (NotificationsController.this.soundPool == null) {
                                        ...
                                        NotificationsController.this.soundPool.setOnLoadCompleteListener(new C51161());
                                    }
    ...
    private void showOrUpdateNotification(boolean notifyAboutLast) {
        ...
        try {
            ...
            if (((int) dialog_id) == 0 || this.pushDialogs.size() > 1 || AndroidUtilities.needShowPasscode(false) || UserConfig.isWaitingForPasscodeEnter) {
                name = ApplicationLoader.getConfig().getAppName();
                replace = false;
            } else if (chat != null) {
                name = chat.title;
            } else {
        ...
        if (VERSION.SDK_INT >= 18) {
            ...
            for (int b = 0; b < sortedDialogs.size(); b++) {
                ...
                if (dialog_id > 0) {
                    ...
                    dismissalID = null;
                    if (chat != null) {
                        dismissalID = "tgchat" + chat.id + BridgeUtil.UNDERLINE_STR + max_id;
                    } else if (user != null) {
                        dismissalID = "tguser" + user.id + BridgeUtil.UNDERLINE_STR + max_id;
                    }
                    ...
                    builder = new Builder(ApplicationLoader.applicationContext).setContentTitle(name).setSmallIcon(R.drawable.notification).setGroup("messages").setContentText(text.toString()).setAutoCancel(true).setNumber(messageObjects.size()).setColor(ApplicationLoader.getConfig().getDefaultTheme().getActionBarColor().intValue()).setGroupSummary(false).setWhen(((long) ((MessageObject) messageObjects.get(0)).messageOwner.date) * 1000).setStyle(messagingStyle).setContentIntent(contentIntent).extend(wearableExtender).extend(new CarExtender().setUnreadConversation(unreadConvBuilder.build())).setCategory(NotificationCompat.CATEGORY_MESSAGE);
                    if (chat == null && user != null && user.phone != null && user.phone.length() > 0) {
                    ...
                    if (photoPath == null) {
                        ...
                        if (VERSION.SDK_INT >= 21) {
                            smallIconViewId = ApplicationLoader.applicationContext.getResources().getIdentifier("right_icon", "id", android.R.class.getPackage().getName());
                            if (smallIconViewId != 0) {
                                if (notification.contentIntent != null) {
                                    notification.contentView.setViewVisibility(smallIconViewId, 4);
                                }
    ...
    public void playOutChatSound() {
        if (this.inChatSoundEnabled && !MediaController.getInstance().isRecordingAudio()) {
            ...
            this.notificationsQueue.postRunnable(new Runnable() {
                ...
                class C51171 implements OnLoadCompleteListener {
                    C51171() {
                    }
                ...
                public void run() {
                    try {
                        if (Math.abs(System.currentTimeMillis() - NotificationsController.this.lastSoundOutPlay) > 100) {
                            ...
                            if (NotificationsController.this.soundPool == null) {
                                NotificationsController.this.soundPool = new SoundPool(3, 1, 0);
                                NotificationsController.this.soundPool.setOnLoadCompleteListener(new C51171());
                            }
