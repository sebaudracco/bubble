...
public class MessagesStorage {
    ...
    class C50754 implements Runnable {
        C50754() {
        }
    ...
    class C50897 implements Runnable {
        C50897() {
        }
    ...
    public void cleanup(final boolean isLogin) {
        ...
        this.storageQueue.postRunnable(new Runnable() {
            ...
            class C50611 implements Runnable {
                C50611() {
                }
            ...
            public void run() {
                ...
                if (isLogin) {
                    Utilities.stageQueue.postRunnable(new C50611());
                }
            }
        });
    }
    ...
    private void fixNotificationSettings() {
        this.storageQueue.postRunnable(new C50754());
    }
    ...
    private void loadPendingTasks() {
        this.storageQueue.postRunnable(new C50897());
    }
    ...
    public void deleteDialog(final long did, final int messagesOnly) {
        this.storageQueue.postRunnable(new Runnable() {
            ...
            class C50641 implements Runnable {
                C50641() {
                }
            ...
            public void run() {
                try {
                    ...
                    MessagesStorage.this.database.executeFast("DELETE FROM media_holes_v2 WHERE uid = " + did).stepThis().dispose();
                    BotQuery.clearBotKeyboard(did, null);
                    AndroidUtilities.runOnUIThread(new C50641());
                } catch (Exception e22) {
                    FileLog.e(e22);
                }
            }
...
*/
    ...
    public void getMessages(long dialog_id, int count, int max_id, int offset_date, int minDate, int classGuid, int load_type, boolean isChannel, int loadIndex) {
        ...
        this.storageQueue.postRunnable(new Runnable() {
            ...
            class C50771 implements Comparator<TLRPC$Message> {
                C50771() {
                }
            ...
            public void run() {
                ...
                try {
                    ...
                    Collections.sort(res.messages, new C50771());
                    if (lower_id != 0) {
