...
public class LocationSharingService extends Service implements NotificationCenterDelegate {
    ...
    class C49461 implements Runnable {

        class C49451 implements Runnable {
            C49451() {
            }
        ...
        public void run() {
            ...
            Utilities.stageQueue.postRunnable(new C49451());
        }
    }

    class C49472 implements Runnable {
        C49472() {
        }
