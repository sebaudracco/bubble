...
class MessagesController$117 implements Runnable {
    ...
    MessagesController$117(MessagesController this$0, int i) {
        this.this$0 = this$0;
        this.val$chat_id = i;
    }
                    ...
                    if (res != null && (res.participant instanceof TLRPC$TL_channelParticipantSelf) && res.participant.inviter_id != UserConfig.getClientUserId()) {
                        if (!chat.megagroup || !MessagesStorage.getInstance().isMigratedChat(chat.id)) {
                            AndroidUtilities.runOnUIThread(new Runnable() {
                                public void run() {
                                    MessagesController$117.this.this$0.putUsers(res.users, false);
                                }
                            });
                            ...
                            message.to_id.channel_id = MessagesController$117.this.val$chat_id;
                            message.dialog_id = (long) (-MessagesController$117.this.val$chat_id);
                            ...
                            MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable() {
                                ...
                                class C49901 implements Runnable {
                                    C49901() {
                                    }
                                ...
                                public void run() {
                                    AndroidUtilities.runOnUIThread(new C49901());
                                }
                            });
                            MessagesStorage.getInstance().putMessages(messagesArr, true, true, false, 0);
                            AndroidUtilities.runOnUIThread(new Runnable() {
                                public void run() {
                                    MessagesController$117.this.this$0.updateInterfaceWithMessages((long) (-MessagesController$117.this.val$chat_id), pushMessages);
