...
class MediaController$30 implements Runnable {
    ...
    public void run() {
        if (this.val$error || this.val$last) {
            synchronized (MediaController.access$7600(this.this$0)) {
                MediaController.access$7702(this.this$0, false);
            }
            MediaController.access$7800(this.this$0).remove(this.val$messageObject);
            MediaController.access$7900(this.this$0);
        }
        if (this.val$error) {
