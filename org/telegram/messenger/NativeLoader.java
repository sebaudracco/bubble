...
public class NativeLoader {
    ...
    private static boolean loadFromZip(Context context, File destDir, File destLocalFile, String folder) {
        ...
        try {
            ...
            try {
                ZipEntry entry = zipFile2.getEntry("lib/" + folder + BridgeUtil.SPLIT_MARK + LIB_SO_NAME);
                if (entry == null) {
                    throw new Exception("Unable to find file in apk:lib/" + folder + BridgeUtil.SPLIT_MARK + LIB_NAME);
                }
    ...
    L_0x0043:
        r7 = "load normal lib";
        org.telegram.messenger.FileLog.m4941d(r7);	 Catch:{ Throwable -> 0x012b }
        r7 = "tmessages.27";
    ...
    L_0x005a:
        r4 = move-exception;
        org.telegram.messenger.FileLog.m4944e(r4);	 Catch:{ Throwable -> 0x012b }
    L_0x005e:
        r1 = r2;
    L_0x005f:
    ...
    L_0x007c:
        r7 = "Load local lib";
        org.telegram.messenger.FileLog.m4941d(r7);	 Catch:{ Error -> 0x0095 }
    ...
    L_0x009c:
        ...
        org.telegram.messenger.FileLog.m4942e(r7);	 Catch:{ Throwable -> 0x012b }
    ...
    L_0x00cb:
        r4 = move-exception;
        org.telegram.messenger.FileLog.m4944e(r4);	 Catch:{ all -> 0x00d1 }
        goto L_0x0007;
    L_0x00d1:
        r7 = move-exception;
        monitor-exit(r8);
    ...
    L_0x0104:
        ...
        org.telegram.messenger.FileLog.m4942e(r7);	 Catch:{ Exception -> 0x0122 }
        goto L_0x001a;
    L_0x0122:
        r4 = move-exception;
        org.telegram.messenger.FileLog.m4944e(r4);	 Catch:{ Throwable -> 0x012b }
