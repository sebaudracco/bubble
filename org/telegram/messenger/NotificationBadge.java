...
public class NotificationBadge {
    ...
    public static class HuaweiHomeBadger implements Badger {
        public void executeBadge(int badgeCount) {
            ...
            localBundle.putString(C1484a.f2398e, NotificationBadge.componentName.getClassName());
    ...
    public static class NewHtcHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            final Intent intent1 = new Intent("com.htc.launcher.action.SET_NOTIFICATION");
    ...
    public static class NovaHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            contentValues.put(TAG, NotificationBadge.componentName.getPackageName() + BridgeUtil.SPLIT_MARK + NotificationBadge.componentName.getClassName());
    ...
    public static class SamsungHomeBadger implements Badger {
        private static final String[] CONTENT_PROJECTION = new String[]{"_id", C1484a.f2398e};
            ...
            try {
                ...
                if (cursor != null) {
                    ...
                    while (cursor.moveToNext()) {
                        ...
                        if (entryActivityName.equals(cursor.getString(cursor.getColumnIndex(C1484a.f2398e)))) {
        ...
        private ContentValues getContentValues(ComponentName componentName, int badgeCount, boolean isInsert) {
            ...
            if (isInsert) {
                ...
                contentValues.put(C1484a.f2398e, componentName.getClassName());
            }
    ...
    public static class XiaomiHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            try {
                ...
                localIntent.putExtra("android.intent.extra.update_application_component_name", NotificationBadge.componentName.getPackageName() + BridgeUtil.SPLIT_MARK + NotificationBadge.componentName.getClassName());
