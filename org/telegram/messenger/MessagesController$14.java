        ...
        if (error == null) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                public void run() {
                    ...
                    NotificationCenter.getInstance().postNotificationName(NotificationCenter.chatInfoDidLoaded, res.full_chat, Integer.valueOf(MessagesController$14.this.val$classGuid), Boolean.valueOf(false), null);
                }
            });
            return;
        }
