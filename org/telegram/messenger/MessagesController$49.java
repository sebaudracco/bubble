...
class MessagesController$49 implements Runnable {
    ...
    public void run() {
        ...
        NotificationCenter.getInstance().postNotificationName(NotificationCenter.chatInfoDidLoaded, this.val$info, Integer.valueOf(0), Boolean.valueOf(this.val$byChannelUsers), this.val$pinnedMessageObject);
    }
}
