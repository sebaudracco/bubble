...
class MessagesController$114 implements RequestDelegate {
    ...
    MessagesController$114(MessagesController this$0, ArrayList arrayList, long j) {
        this.this$0 = this$0;
    ...
    public void run(TLObject response, TLRPC$TL_error error) {
        if (response != null) {
            ...
            MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable() {
                ...
                class C49861 implements Runnable {
                    C49861() {
                    }

                    public void run() {
                        int a;
                        MessagesController.access$5200(MessagesController$114.this.this$0, res.dialogs);
                        boolean changed = false;
                        boolean added = false;
                        int maxPinnedNum = 0;
                        HashMap<Long, Integer> oldPinnedDialogNums = new HashMap();
                        ArrayList<Long> oldPinnedOrder = new ArrayList();
                        for (a = 0; a < MessagesController$114.this.this$0.dialogs.size(); a++) {
                            TLRPC$TL_dialog dialog = (TLRPC$TL_dialog) MessagesController$114.this.this$0.dialogs.get(a);
                            if (((int) dialog.id) != 0) {
                                if (!dialog.pinned) {
                                    break;
                                }
                        ...
                        ArrayList<Long> orderArrayList = MessagesController$114.this.val$order != null ? MessagesController$114.this.val$order : newPinnedOrder;
                        ...
                        if (!res.dialogs.isEmpty()) {
                            MessagesController$114.this.this$0.putUsers(res.users, false);
                            MessagesController$114.this.this$0.putChats(res.chats, false);
                            for (a = 0; a < res.dialogs.size(); a++) {
                                dialog = (TLRPC$TL_dialog) res.dialogs.get(a);
                                Integer oldNum;
                                if (MessagesController$114.this.val$newDialogId != 0) {
                                ...
                                TLRPC$TL_dialog d = (TLRPC$TL_dialog) MessagesController$114.this.this$0.dialogs_dict.get(Long.valueOf(dialog.id));
                                if (d != null) {
                                    d.pinned = true;
                                    ...
                                    added = true;
                                    MessagesController$114.this.this$0.dialogs_dict.put(Long.valueOf(dialog.id), dialog);
                                    MessageObject messageObject = (MessageObject) new_dialogMessage.get(Long.valueOf(dialog.id));
                                    MessagesController$114.this.this$0.dialogMessage.put(Long.valueOf(dialog.id), messageObject);
                                    if (messageObject != null && messageObject.messageOwner.to_id.channel_id == 0) {
                                        MessagesController$114.this.this$0.dialogMessagesByIds.put(Integer.valueOf(messageObject.getId()), messageObject);
                                        if (messageObject.messageOwner.random_id != 0) {
                                            MessagesController$114.this.this$0.dialogMessagesByRandomIds.put(Long.valueOf(messageObject.messageOwner.random_id), messageObject);
                                        }
                                    }
                                }
                                changed = true;
                        ...
                        if (changed) {
                            if (added) {
                                MessagesController$114.this.this$0.dialogs.clear();
                                MessagesController$114.this.this$0.dialogs.addAll(MessagesController$114.this.this$0.dialogs_dict.values());
                            }
                            MessagesController$114.this.this$0.sortDialogs(null);
                ...
                public void run() {
                    AndroidUtilities.runOnUIThread(new C49861());
                }
            });
        }
    }
