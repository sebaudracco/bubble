...
class MessagesController$65 implements Runnable {
    ...
    class C50281 implements Runnable {
        C50281() {
        }
        ...
        public void run() {
            ...
            if (!(UserConfig.totalDialogsLoadCount >= HttpStatus.SC_BAD_REQUEST || UserConfig.dialogsLoadOffsetId == -1 || UserConfig.dialogsLoadOffsetId == Integer.MAX_VALUE)) {
    ...
    public void run() {
        ...
        AndroidUtilities.runOnUIThread(new C50281());
    }
}
