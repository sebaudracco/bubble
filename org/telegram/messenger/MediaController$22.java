...
class MediaController$22 implements Runnable {
    ...
    class C49552 implements Runnable {
        C49552() {
        }
    ...
    class C49563 implements Runnable {
        C49563() {
        }
    ...
    class C49574 implements Runnable {
        C49574() {
        }
    ...
    public void run() {
        if (MediaController.access$000(this.this$0) != null) {
            AndroidUtilities.runOnUIThread(new C49541());
            return;
        }
        ...
        try {
            if (MediaController.access$6700(this.this$0, MediaController.access$6600(this.this$0).getAbsolutePath()) == 0) {
                AndroidUtilities.runOnUIThread(new C49552());
                return;
            }
            ...
            AndroidUtilities.runOnUIThread(new C49574());
        } catch (Exception e) {
            FileLog.e(e);
            ...
            AndroidUtilities.runOnUIThread(new C49563());
        }
    }
}
