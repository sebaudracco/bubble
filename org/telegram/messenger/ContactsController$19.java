...
class ContactsController$19 implements Runnable {
    ...
    public void run() {
        ...
        if (!this.val$newContacts.isEmpty()) {
            ContactsController.access$1200(this.this$0, this.this$0.contacts);
            ContactsController.access$1500(this.this$0);
        }
        ...
        ContactsController.access$2000(contactsController, z);
