...
public class Track {
    ...
    class C54361 implements Comparator<SamplePresentationTime> {
        C54361() {
        }
    ...
    public Track(int id, MediaFormat format, boolean audio) {
        ...
        if (mime.equals("video/avc")) {
            ...
            if (format.containsKey(FirebaseAnalytics$Param.LEVEL)) {
                int level = format.getInteger(FirebaseAnalytics$Param.LEVEL);
                if (level == 1) {
    ...
    public void prepare() {
        ...
        Collections.sort(this.samplePresentationTimes, new C54361());
