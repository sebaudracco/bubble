...
public class Emoji {
    ...
    private static int drawImgSize = AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP);
    ...
    static class C48532 implements Comparator<String> {
        C48532() {
        }
    ...
    public static class EmojiDrawable extends Drawable {
        ...
        class C48541 implements Runnable {
            C48541() {
            }
        ...
        public void draw(Canvas canvas) {
            if (Emoji.emojiBmp[this.info.page][this.info.page2] != null) {
                ...
                Utilities.globalQueue.postRunnable(new C48541());
    ...
    public static class EmojiSpan extends ImageSpan {
        ...
        private int size = AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP);
        ...
        public EmojiSpan(EmojiDrawable d, int verticalAlignment, int s, FontMetricsInt original) {
            ...
            if (original != null) {
                ...
                if (this.size == 0) {
                    this.size = AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP);
                }
            }
        }
        ...
        public int getSize(Paint paint, CharSequence text, int start, int end, FontMetricsInt fm) {
            ...
            if (this.fontMetrics == null) {
                ...
                int w = AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
                fm.top = (-w) - offset;
                fm.bottom = w - offset;
                fm.ascent = (-w) - offset;
                fm.leading = 0;
    ...
    public static void sortEmoji() {
        ...
        Collections.sort(recentEmoji, new C48532());
