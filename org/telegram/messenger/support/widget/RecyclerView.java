...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    static final Interpolator sQuinticInterpolator = new C16973();
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new 1(this);
        ...
        private final Callback mVerticalBoundCheckCallback = new 2(this);
        private int mWidth;
    ...
    static class C16973 implements Interpolator {
        C16973() {
        }
    ...
    class C16984 implements ProcessCallback {
        C16984() {
        }
    ...
    class C16995 implements Callback {
        C16995() {
        }
    ...
    class C17006 implements Callback {
        C17006() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new 1());
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C16951();
        ...
        this.mItemAnimatorRunner = new C16962();
        this.mViewInfoProcessCallback = new C16984();
        if (attrs != null) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C16995());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C17006());
    }
