...
public class StaggeredGridLayoutManager$SavedState implements Parcelable {
    public static final Creator<StaggeredGridLayoutManager$SavedState> CREATOR = new C54211();
    ...
    static class C54211 implements Creator<StaggeredGridLayoutManager$SavedState> {
        C54211() {
        }
