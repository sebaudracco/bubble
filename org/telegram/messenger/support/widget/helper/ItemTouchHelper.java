...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C54232();
    View mOverdrawChild = null;
    int mOverdrawChildPosition = -1;
    final List<View> mPendingCleanup = new ArrayList();
    List<RecoverAnimation> mRecoverAnimations = new ArrayList();
    RecyclerView mRecyclerView;
    final Runnable mScrollRunnable = new C54221();
    ...
    class C54221 implements Runnable {
        C54221() {
        }
    ...
    class C54232 implements OnItemTouchListener {
        C54232() {
        }
    ...
    class C54265 implements ChildDrawingOrderCallback {
        C54265() {
        }
    ...
    public static abstract class Callback {
        ...
        private static final Interpolator sDragScrollInterpolator = new C54271();
        private static final Interpolator sDragViewScrollCapInterpolator = new C54282();
        private static final ItemTouchUIUtil sUICallback;
        private int mCachedMaxScrollSpeed = -1;

        static class C54271 implements Interpolator {
            C54271() {
            }
        ...
        static class C54282 implements Interpolator {
            C54282() {
            }
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP);
            }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C54265();
            }
