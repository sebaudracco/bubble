...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        if (removalsPending || movesPending || additionsPending || changesPending) {
            ...
            if (movesPending) {
                ...
                Runnable mover = new 1(this, moves);
                if (removalsPending) {
            ...
            if (changesPending) {
                ...
                Runnable changer = new 2(this, changes);
                if (removalsPending) {
            ...
            if (additionsPending) {
                ...
                Runnable adder = new 3(this, additions);
    ...
    private void animateRemoveImpl(ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration()).alpha(0.0f).setListener(new 4(this, holder, animation)).start();
    }
    ...
    void animateAddImpl(ViewHolder holder) {
        ...
        animation.alpha(1.0f).setDuration(getAddDuration()).setListener(new 5(this, holder, animation)).start();
    }
    ...
    void animateMoveImpl(ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        animation.setDuration(getMoveDuration()).setListener(new 6(this, holder, deltaX, deltaY, animation)).start();
    }
    ...
    void animateChangeImpl(ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            oldViewAnim.alpha(0.0f).setListener(new 7(this, changeInfo, oldViewAnim)).start();
        }
        if (newView != null) {
            ViewPropertyAnimatorCompat newViewAnimation = ViewCompat.animate(newView);
            this.mChangeAnimations.add(changeInfo.newHolder);
            newViewAnimation.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(1.0f).setListener(new 8(this, changeInfo, newViewAnimation, newView)).start();
        }
    }
