...
public class AsyncListUtil<T> {
    ...
    private final BackgroundCallback<T> mBackgroundCallback = new C54072();
    final BackgroundCallback<T> mBackgroundProxy;
    final DataCallback<T> mDataCallback;
    int mDisplayedGeneration = 0;
    int mItemCount = 0;
    private final MainThreadCallback<T> mMainThreadCallback = new C54061();
    ...
    class C54061 implements MainThreadCallback<T> {
        C54061() {
        }
    ...
    class C54072 implements BackgroundCallback<T> {
