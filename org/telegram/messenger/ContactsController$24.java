...
class ContactsController$24 implements RequestDelegate {
    ...
    public void run(final TLObject response, final TLRPC$TL_error error) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            public void run() {
                if (error == null) {
                    ContactsController.access$2102(ContactsController$24.this.this$0, response.days);
                    ContactsController.access$2202(ContactsController$24.this.this$0, 2);
                } else {
                    ContactsController.access$2202(ContactsController$24.this.this$0, 0);
                }
