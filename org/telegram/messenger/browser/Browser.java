...
public class Browser {
    ...
    static class C52081 implements ServiceConnectionCallback {
        C52081() {
        }
    ...
    public static void bindCustomTabsService(Activity activity) {
        ...
        if (customTabsClient == null) {
            ...
            try {
                ...
                customTabsServiceConnection = new ServiceConnection(new C52081());
                ...
                try {
                    if (uri.getHost().toLowerCase().equals("telegra.ph") || uri.toString().contains("telegram.org/faq")) {
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable() {
                            ...
                            class C52111 implements OnClickListener {
                                C52111() {
                                }
                            ...
                            public void run() {
                                if (alertDialogArr[0] != null) {
                                    try {
                                        ...
                                        alertDialogArr[0].setButton(-2, LocaleController.getString("Cancel", R.string.Cancel), new C52111());
                ...
                if (allowCustom && MediaController.getInstance().canCustomTabs() && !internalUri && !scheme.equals("tel")) {
                    ...
                    try {
                        ...
                        if (browserPackageNames != null) {
                            ...
                            a = 0;
                            while (a < allActivities.size()) {
                                if (((ResolveInfo) allActivities.get(a)).activityInfo.packageName.toLowerCase().contains(ClickType.BROWSER) || ((ResolveInfo) allActivities.get(a)).activityInfo.packageName.toLowerCase().contains("chrome")) {
                                    allActivities.remove(a);
                                    a--;
                                }
                                a++;
