            ...
            if (len > 0) {
                ...
                if (len != 0) {
                    MediaController.access$900(this.this$0).postRunnable(new Runnable() {
                        ...
                        class C49481 implements Runnable {
                            C49481() {
                            }
                        ...
                        public void run() {
                            ...
                            MediaController.access$800(MediaController$1.this.this$0).postRunnable(new C49481());
                        }
                    });
                }
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    public void run() {
                        NotificationCenter.getInstance().postNotificationName(NotificationCenter.recordProgressChanged, Long.valueOf(System.currentTimeMillis() - MediaController.access$1100(MediaController$1.this.this$0)), Double.valueOf(amplitude));
                    }
                });
                return;
            }
