...
public class VoIPService extends VoIPBaseService implements NotificationCenterDelegate {
    ...
    class C54441 implements Runnable {
        C54441() {
        }
    ...
    class C54463 implements RequestDelegate {
        C54463() {
        }
    ...
    class C54474 implements Runnable {
        C54474() {
        }
    ...
    class C54535 implements RequestDelegate {
        C54535() {
        }
                ...
                ConnectionsManager.getInstance().sendRequest(reqCall, new RequestDelegate() {
                    public void run(final TLObject response, final TLRPC$TL_error error) {
                        AndroidUtilities.runOnUIThread(new Runnable() {
                            ...
                            class C54501 implements Runnable {

                                class C54491 implements RequestDelegate {

                                    class C54481 implements Runnable {
                                        C54481() {
                                        }
                                    ...
                                    public void run(TLObject response, TLRPC$TL_error error) {
                                        ...
                                        AndroidUtilities.runOnUIThread(new C54481());
                                    }
                                }
                                ...
                                public void run() {
                                    ...
                                    ConnectionsManager.getInstance().sendRequest(req, new C54491(), 2);
                                }
                            }
                            ...
                            public void run() {
                                if (error == null) {
                                    ...
                                    VoIPService.this.timeoutRunnable = new C54501();
                                    AndroidUtilities.runOnUIThread(VoIPService.this.timeoutRunnable, (long) MessagesController.getInstance().callReceiveTimeout);
                                } else if (error.code == HttpStatus.SC_BAD_REQUEST && "PARTICIPANT_VERSION_OUTDATED".equals(error.text)) {
                                    VoIPService.this.callFailed(-1);
                                } else if (error.code == HttpStatus.SC_FORBIDDEN && "USER_PRIVACY_RESTRICTED".equals(error.text)) {
    ...
    class C54556 implements RequestDelegate {
        C54556() {
        }
    ...
    class C54567 implements OnPreparedListener {
        C54567() {
        }
    ...
    class C54578 implements Runnable {
        C54578() {
        }
    ...
    class C54609 implements RequestDelegate {

        class C54591 implements RequestDelegate {
            C54591() {
            }
        ...
        public void run(TLObject response, TLRPC$TL_error error) {
            if (error == null) {
                ...
                ConnectionsManager.getInstance().sendRequest(req, new C54591(), 2);
                return;
            }
            VoIPService.this.callFailed();
        }
        ...
        if (sharedInstance != null) {
            ...
            if (this.user == null) {
                ...
                if (this.isOutgoing) {
                    ...
                    this.delayedStartOutgoingCall = new C54441();
                    AndroidUtilities.runOnUIThread(this.delayedStartOutgoingCall, Reveal.CHECK_DELAY);
    ...
    protected void onControllerPreRelease() {
        if (this.needSendDebugLog) {
            ...
            ConnectionsManager.getInstance().sendRequest(req, new C54463());
        }
    }
    ...
    private void startOutgoingCall() {
        ...
        dispatchStateChanged(14);
        AndroidUtilities.runOnUIThread(new C54474());
        ...
        this.callReqId = ConnectionsManager.getInstance().sendRequest(req, new C54535(), 2);
    }
    ...
    private void acknowledgeCallAndStartRinging() {
        ...
        req.peer.id = this.call.id;
        req.peer.access_hash = this.call.access_hash;
        ConnectionsManager.getInstance().sendRequest(req, new C54556(), 2);
    }
    ...
    private void startRinging() {
        ...
        this.ringtonePlayer.setOnPreparedListener(new C54567());
    ...
    public void acceptIncomingCall() {
        ...
        AndroidUtilities.runOnUIThread(new C54578());
        TLRPC$TL_messages_getDhConfig req = new TLRPC$TL_messages_getDhConfig();
        req.random_length = 256;
        req.version = MessagesStorage.lastSecretVersion;
        ConnectionsManager.getInstance().sendRequest(req, new C54609());
    }
    ...
    private void showIncomingNotification() {
        ...
        startForeground(HttpStatus.SC_ACCEPTED, builder.getNotification());
    }
