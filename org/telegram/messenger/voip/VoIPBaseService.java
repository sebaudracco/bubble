...
public abstract class VoIPBaseService extends Service implements SensorEventListener, OnAudioFocusChangeListener, ConnectionStateListener {
    ...
    protected Runnable afterSoundRunnable = new C54391();
    ...
    protected BroadcastReceiver receiver = new C54402();
    ...
    class C54391 implements Runnable {
        C54391() {
        }
    ...
    class C54402 extends BroadcastReceiver {
        C54402() {
        }
    ...
    class C54413 implements Runnable {
        C54413() {
        }
    ...
    class C54424 implements Runnable {
        C54424() {
        }
    ...
    protected void showNotification(String name, TLRPC$FileLocation photo, Class<? extends Activity> activity) {
        ...
        Builder builder = new Builder(this).setContentTitle(LocaleController.getAppNameString("VoipOutgoingCall", R.string.VoipOutgoingCall)).setContentText(name).setSmallIcon(R.drawable.notification).setContentIntent(PendingIntent.getActivity(this, 0, intent, 0));
    ...
    public void onDestroy() {
        ...
        super.onDestroy();
        sharedInstance = null;
        AndroidUtilities.runOnUIThread(new C54413());
    ...
    public void onConnectionStateChanged(int newState) {
        ...
        if (newState == 3) {
            ...
            if (!this.wasEstablished) {
                ...
                AndroidUtilities.runOnUIThread(new C54424(), 5000);
                if (this.isOutgoing) {
