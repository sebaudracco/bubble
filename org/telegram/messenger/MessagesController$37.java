...
class MessagesController$37 implements Runnable {
    ...
    public void run() {
        ...
        NotificationCenter.getInstance().postNotificationName(NotificationCenter.dialogPhotosLoaded, Integer.valueOf(this.val$did), Integer.valueOf(this.val$count), Boolean.valueOf(this.val$fromCache), Integer.valueOf(this.val$classGuid), this.val$res.photos);
    }
}
