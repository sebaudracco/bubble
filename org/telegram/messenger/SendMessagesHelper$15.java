...
class SendMessagesHelper$15 implements Runnable {
    ...
    SendMessagesHelper$15(ArrayList arrayList, long j, MessageObject messageObject) {
    ...
    public void run() {
        ...
        for (int a = 0; a < size; a++) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                public void run() {
                    SendMessagesHelper.getInstance().sendMessage(documentFinal, null, messageObject.messageOwner.attachPath, SendMessagesHelper$15.this.val$dialog_id, SendMessagesHelper$15.this.val$reply_to_msg, null, params, 0);
                }
            });
        }
    }
