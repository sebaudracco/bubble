...
class ConnectionsManager$1 implements Runnable {
    ...
    class C54621 implements RequestDelegateInternal {
        C54621() {
        }
    ...
    public void run() {
        ...
        try {
            ...
            ConnectionsManager.native_sendRequest(buffer.address, new C54621(), this.val$onQuickAck, this.val$onWriteToSocket, this.val$flags, this.val$datacenterId, this.val$connetionType, this.val$immediate, this.val$requestToken);
        } catch (Exception e) {
            FileLog.e(e);
        }
    }
