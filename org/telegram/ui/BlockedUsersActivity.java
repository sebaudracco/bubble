...
public class BlockedUsersActivity extends BaseFragment implements NotificationCenterDelegate, ContactsActivityDelegate {
    ...
    class C56311 extends ActionBarMenuOnItemClick {
        C56311() {
        }
    ...
    class C56322 implements OnItemClickListener {
        C56322() {
        }
    ...
    class C56343 implements OnItemLongClickListener {

        class C56331 implements OnClickListener {
            C56331() {
            }
        ...
        public boolean onItemClick(View view, int position) {
            if (position < MessagesController.getInstance().blockedUsers.size() && BlockedUsersActivity.this.getParentActivity() != null) {
                ...
                builder.setItems(new CharSequence[]{LocaleController.getString("Unblock", R.string.Unblock)}, new C56331());
    ...
    class C56354 implements ThemeDescriptionDelegate {
        C56354() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C56311());
        ...
        this.listView.setOnItemClickListener(new C56322());
        this.listView.setOnItemLongClickListener(new C56343());
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ThemeDescriptionDelegate сellDelegate = new C56354();
