...
public class CommonGroupsActivity extends BaseFragment {
    ...
    class C59721 extends ActionBarMenuOnItemClick {
        C59721() {
        }
    ...
    class C59732 implements OnItemClickListener {
        C59732() {
        }
    ...
    class C59743 extends OnScrollListener {
        C59743() {
        }
    ...
    class C59775 implements ThemeDescriptionDelegate {
        C59775() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C59721());
        ...
        this.listView.setOnItemClickListener(new C59732());
        this.listView.setOnScrollListener(new C59743());
        if (this.loading) {
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ThemeDescriptionDelegate сellDelegate = new C59775();
