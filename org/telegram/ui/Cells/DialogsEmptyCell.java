...
public class DialogsEmptyCell extends LinearLayout {
    ...
    class C56831 implements OnTouchListener {
        C56831() {
        }
    ...
    public DialogsEmptyCell(Context context) {
        ...
        this.emptyTextView1.setTextSize(1, CloseButton.TEXT_SIZE_SP);
        ...
        this.emptyTextView2.setTextSize(1, CtaButton.TEXT_SIZE_SP);
