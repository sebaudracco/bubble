...
public class SharedLinkCell extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (description2 != null) {
            try {
                ...
                if (this.descriptionLayout != null) {
                    this.description2Y += AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
                }
        ...
        if (LocaleController.isRTL) {
            x = (MeasureSpec.getSize(widthMeasureSpec) - AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT)) - maxPhotoWidth;
        } else {
            x = AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
        }
        this.letterDrawable.setBounds(x, AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), x + maxPhotoWidth, AndroidUtilities.dp(62.0f));
        if (hasPhoto) {
            ...
            this.linkImageView.setImageCoords(x, AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), maxPhotoWidth, maxPhotoWidth);
        ...
        if (!(this.descriptionLayout2 == null || this.descriptionLayout2.getLineCount() == 0)) {
            height += this.descriptionLayout2.getLineBottom(this.descriptionLayout2.getLineCount() - 1);
            if (this.descriptionLayout != null) {
                height += AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
            }
        }
