...
public class TextDetailCell extends FrameLayout {
    ...
    public TextDetailCell(Context context) {
        ...
        addView(view, LayoutHelper.createFrame(-2, -2.0f, i, LocaleController.isRTL ? 16.0f : 71.0f, Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT, LocaleController.isRTL ? 71.0f : 16.0f, 0.0f));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (this.multiline) {
            ...
            setMeasuredDimension(MeasureSpec.getSize(widthMeasureSpec), Math.max(AndroidUtilities.dp(64.0f), (this.textView.getMeasuredHeight() + this.valueTextView.getMeasuredHeight()) + AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP)));
            return;
        }
