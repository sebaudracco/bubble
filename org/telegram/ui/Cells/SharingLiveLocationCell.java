...
public class SharingLiveLocationCell extends FrameLayout {
    ...
    public SharingLiveLocationCell(Context context, boolean distance) {
        ...
        if (distance) {
            ...
            addView(view2, LayoutHelper.createFrame(-1, CloseButton.TEXT_SIZE_SP, i2 | 48, LocaleController.isRTL ? 54.0f : 73.0f, 12.0f, LocaleController.isRTL ? 73.0f : 54.0f, 0.0f));
            ...
            addView(view2, LayoutHelper.createFrame(-1, CloseButton.TEXT_SIZE_SP, i | 48, LocaleController.isRTL ? 54.0f : 73.0f, 37.0f, LocaleController.isRTL ? 73.0f : 54.0f, 0.0f));
        } else {
            view = this.avatarImageView;
            if (LocaleController.isRTL) {
                i2 = 5;
    ...
    protected void onDraw(Canvas canvas) {
        if (this.currentInfo != null || this.liveLocation != null) {
            ...
            if (stopTime >= currentTime) {
                ...
                if (LocaleController.isRTL) {
                    this.rect.set((float) AndroidUtilities.dp(13.0f), (float) AndroidUtilities.dp(this.distanceTextView != null ? RadialCountdown.TEXT_SIZE_SP : 12.0f), (float) AndroidUtilities.dp(43.0f), (float) AndroidUtilities.dp(this.distanceTextView != null ? 48.0f : 42.0f));
                } else {
                    this.rect.set((float) (getMeasuredWidth() - AndroidUtilities.dp(43.0f)), (float) AndroidUtilities.dp(this.distanceTextView != null ? RadialCountdown.TEXT_SIZE_SP : 12.0f), (float) (getMeasuredWidth() - AndroidUtilities.dp(13.0f)), (float) AndroidUtilities.dp(this.distanceTextView != null ? 48.0f : 42.0f));
                }
