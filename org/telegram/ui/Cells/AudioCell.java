...
public class AudioCell extends FrameLayout {
    ...
    class C56781 implements OnClickListener {
        C56781() {
        }
    ...
    public AudioCell(Context context) {
        ...
        this.playButton.setOnClickListener(new C56781());
        ...
        addView(view2, LayoutHelper.createFrame(-2, -2.0f, i3 | 48, LocaleController.isRTL ? RadialCountdown.TEXT_SIZE_SP : 0.0f, 11.0f, LocaleController.isRTL ? 0.0f : RadialCountdown.TEXT_SIZE_SP, 0.0f));
        ...
        addView(view2, LayoutHelper.createFrame(22, 22.0f, i2 | 48, LocaleController.isRTL ? RadialCountdown.TEXT_SIZE_SP : 0.0f, 39.0f, LocaleController.isRTL ? 0.0f : RadialCountdown.TEXT_SIZE_SP, 0.0f));
    }
