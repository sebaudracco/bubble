...
public class CheckBoxCell extends FrameLayout {
    ...
    public CheckBoxCell(Context context, boolean alert) {
        ...
        addView(view2, LayoutHelper.createFrame(18, RadialCountdown.TEXT_SIZE_SP, i4, f, CtaButton.TEXT_SIZE_SP, (float) i3, 0.0f));
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.checkBox.measure(MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), Integer.MIN_VALUE), MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), 1073741824));
    }
