...
public class PhotoPickerSearchCell extends LinearLayout {
    ...
    class C57021 implements OnClickListener {
        C57021() {
        }
    ...
    class C57032 implements OnClickListener {
        C57032() {
        }
    ...
    private class SearchButton extends FrameLayout {
        ...
        public SearchButton(Context context) {
            ...
            this.textView2.setTextSize(1, Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
    ...
    public PhotoPickerSearchCell(Context context, boolean allowGifs) {
        ...
        searchButton.setOnClickListener(new C57021());
        ...
        searchButton.setLayoutParams(layoutParams);
        if (allowGifs) {
            searchButton.setOnClickListener(new C57032());
        } else {
