...
public class SendLocationCell extends FrameLayout {
    ...
    private Runnable invalidateRunnable = new C57041();
    private RectF rect;
    private SimpleTextView titleTextView;

    class C57041 implements Runnable {
        C57041() {
        }
    ...
    public SendLocationCell(Context context, boolean live) {
        ...
        addView(this.titleTextView, LayoutHelper.createFrame(-1, CloseButton.TEXT_SIZE_SP, (LocaleController.isRTL ? 5 : 3) | 48, LocaleController.isRTL ? 16.0f : 73.0f, 12.0f, LocaleController.isRTL ? 73.0f : 16.0f, 0.0f));
        ...
        addView(this.accurateTextView, LayoutHelper.createFrame(-1, CloseButton.TEXT_SIZE_SP, (LocaleController.isRTL ? 5 : 3) | 48, LocaleController.isRTL ? 16.0f : 73.0f, 37.0f, LocaleController.isRTL ? 73.0f : 16.0f, 0.0f));
    }
        ...
        if (currentInfo != null) {
            ...
            if (currentInfo.stopTime >= currentTime) {
                ...
                if (LocaleController.isRTL) {
                    this.rect.set((float) AndroidUtilities.dp(13.0f), (float) AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), (float) AndroidUtilities.dp(43.0f), (float) AndroidUtilities.dp(48.0f));
                } else {
                    this.rect.set((float) (getMeasuredWidth() - AndroidUtilities.dp(43.0f)), (float) AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), (float) (getMeasuredWidth() - AndroidUtilities.dp(13.0f)), (float) AndroidUtilities.dp(48.0f));
                }
