...
public class TextColorThemeCell extends FrameLayout {
    ...
    protected void onDraw(Canvas canvas) {
        if (this.currentColor != 0) {
            ...
            canvas.drawCircle(!LocaleController.isRTL ? (float) AndroidUtilities.dp(28.0f) : (float) (getMeasuredWidth() - AndroidUtilities.dp(28.0f)), (float) (getMeasuredHeight() / 2), (float) AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), colorPaint);
        }
    }
}
