...
public class FeaturedStickerSetCell extends FrameLayout {
    ...
    class C56863 extends AnimatorListenerAdapter {
        C56863() {
        }
    ...
    class C56874 extends AnimatorListenerAdapter {
        C56874() {
        }
    ...
    public FeaturedStickerSetCell(Context context) {
        ...
        addView(view, LayoutHelper.createFrame(-2, -2.0f, i, LocaleController.isRTL ? 100.0f : 71.0f, Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT, LocaleController.isRTL ? 71.0f : 100.0f, 0.0f));
        ...
        addView(view, LayoutHelper.createFrame(-2, 28.0f, i3 | 48, LocaleController.isRTL ? 14.0f : 0.0f, RadialCountdown.TEXT_SIZE_SP, LocaleController.isRTL ? 0.0f : 14.0f, 0.0f));
        ...
        if (sameSet) {
            ...
            if (z) {
                if (!wasInstalled) {
                    ...
                    this.currentAnimation.addListener(new C56863());
                ...
                this.currentAnimation.addListener(new C56874());
                this.currentAnimation.start();
                return;
            } else {
                return;
