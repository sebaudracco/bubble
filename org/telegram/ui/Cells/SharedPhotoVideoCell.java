...
public class SharedPhotoVideoCell extends FrameLayout {
    ...
    class C57061 implements OnClickListener {
        C57061() {
        }
    ...
    class C57072 implements OnLongClickListener {
        C57072() {
        }
    ...
    private class PhotoVideoView extends FrameLayout {
        ...
        public PhotoVideoView(Context context) {
            ...
            this.videoInfoContainer.addView(this.videoTextView, LayoutHelper.createFrame(-2, -2.0f, 19, RadialCountdown.TEXT_SIZE_SP, -0.7f, 0.0f, 0.0f));
    ...
    public SharedPhotoVideoCell(Context context) {
        ...
        for (int a = 0; a < 6; a++) {
            ...
            this.photoVideoViews[a].setOnClickListener(new C57061());
            this.photoVideoViews[a].setOnLongClickListener(new C57072());
        }
    }
        ...
        if (messageObject != null) {
            ...
            if (messageObject.isVideo()) {
                ...
                for (int b = 0; b < messageObject.getDocument().attributes.size(); b++) {
                    TLRPC$DocumentAttribute attribute = (TLRPC$DocumentAttribute) messageObject.getDocument().attributes.get(b);
