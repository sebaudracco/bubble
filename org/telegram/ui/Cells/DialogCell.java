...
public class DialogCell extends BaseCell {
    ...
    private int avatarTop = AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
    private TLRPC$Chat chat = null;
    private GroupCreateCheckBox checkBox;
    private int checkDrawLeft;
    private int checkDrawTop = AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP);
    ...
    public void buildLayout() {
        ...
        if (this.customDialog != null) {
            ...
            if (this.customDialog.type == 1) {
                ...
                messageString = Emoji.replaceEmoji(stringBuilder, Theme.dialogs_messagePaint.getFontMetricsInt(), AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP), false);
            } else {
        ...
        if (drawTime) {
            ...
            if (LocaleController.isRTL) {
                this.timeLeft = AndroidUtilities.dp(CtaButton.TEXT_SIZE_SP);
            } else {
                this.timeLeft = (getMeasuredWidth() - AndroidUtilities.dp(CtaButton.TEXT_SIZE_SP)) - timeWidth;
            }
        } else {
            timeWidth = 0;
        ...
        if (this.drawError) {
            ...
            if (countString != null) {
                ...
                w = this.countWidth + AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP);
                messageWidth = messageWidth2 - w;
                if (LocaleController.isRTL) {
            ...
            if (mentionString != null) {
                ...
                w = this.mentionWidth + AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP);
                messageWidth -= w;
                if (LocaleController.isRTL) {
                    this.mentionLeft = (this.countWidth != 0 ? this.countWidth + AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP) : 0) + AndroidUtilities.dp(19.0f);
                    this.messageLeft += w;
                } else {
                    this.mentionLeft = ((getMeasuredWidth() - this.mentionWidth) - AndroidUtilities.dp(19.0f)) - (this.countWidth != 0 ? this.countWidth + AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP) : 0);
                }
                this.drawMention = true;
            }
        }
