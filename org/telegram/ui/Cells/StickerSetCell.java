...
public class StickerSetCell extends FrameLayout {
    ...
    public StickerSetCell(Context context, int option) {
        ...
        addView(view, LayoutHelper.createFrame(-2, -2.0f, i, LocaleController.isRTL ? 40.0f : 71.0f, Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT, LocaleController.isRTL ? 71.0f : 40.0f, 0.0f));
    ...
    public void setText(String title, String subtitle, int icon, boolean divider) {
        ...
        if (TextUtils.isEmpty(subtitle)) {
            this.textView.setTranslationY((float) AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT));
        } else {
