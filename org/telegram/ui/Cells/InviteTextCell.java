...
public class InviteTextCell extends FrameLayout {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        viewLeft = !LocaleController.isRTL ? AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP) : (width - this.imageView.getMeasuredWidth()) - AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP);
