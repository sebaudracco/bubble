...
public class ChatActionCell extends BaseCell {
    ...
    class C56801 implements Runnable {
        C56801() {
        }
    ...
    public void setCustomDate(int date) {
        if (this.customDate != date) {
            ...
            if (this.customText == null || !TextUtils.equals(newText, this.customText)) {
                ...
                AndroidUtilities.runOnUIThread(new C56801());
            }
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (width != this.previousWidth) {
            ...
            if (this.currentMessageObject != null && this.currentMessageObject.type == 11) {
                this.imageReceiver.setImageCoords((width - AndroidUtilities.dp(64.0f)) / 2, this.textHeight + AndroidUtilities.dp(CtaButton.TEXT_SIZE_SP), AndroidUtilities.dp(64.0f), AndroidUtilities.dp(64.0f));
            }
        }
    ...
    private int findMaxWidthAroundLine(int line) {
        ...
        for (a = line + 1; a < count; a++) {
            ...
            if (Math.abs(w - width) >= AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT)) {
                break;
            }
