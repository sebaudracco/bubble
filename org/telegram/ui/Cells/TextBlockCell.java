...
public class TextBlockCell extends FrameLayout {
    ...
    public TextBlockCell(Context context) {
        ...
        addView(view, LayoutHelper.createFrame(-1, -2.0f, i2 | 48, 17.0f, Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT, 17.0f, Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT));
    }
