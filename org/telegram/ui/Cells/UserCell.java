...
public class UserCell extends FrameLayout {
    ...
    public UserCell(Context context, int padding, int checkbox, boolean admin) {
        ...
        addView(view, LayoutHelper.createFrame(-1, CloseButton.TEXT_SIZE_SP, i, f, 11.5f, f2, 0.0f));
        this.statusTextView = new SimpleTextView(context);
        this.statusTextView.setTextSize(14);
        this.statusTextView.setGravity((LocaleController.isRTL ? 5 : 3) | 48);
        addView(this.statusTextView, LayoutHelper.createFrame(-1, CloseButton.TEXT_SIZE_SP, (LocaleController.isRTL ? 5 : 3) | 48, LocaleController.isRTL ? 28.0f : (float) (padding + 68), 34.5f, LocaleController.isRTL ? (float) (padding + 68) : 28.0f, 0.0f));
        ...
        if (checkbox == 2) {
            ...
            addView(this.checkBoxBig, LayoutHelper.createFrame(18, RadialCountdown.TEXT_SIZE_SP, (LocaleController.isRTL ? 3 : 5) | 16, LocaleController.isRTL ? 19.0f : 0.0f, 0.0f, LocaleController.isRTL ? 0.0f : 19.0f, 0.0f));
        } else if (checkbox == 1) {
