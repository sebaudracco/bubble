    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (w == 0 || h == 0) {
            if (this.currentPhotoObject != null) {
                ...
                w = this.currentPhotoObject.f12637w;
                h = this.currentPhotoObject.f12636h;
            } else if (this.inlineResult != null) {
                w = this.inlineResult.f12625w;
                h = this.inlineResult.f12624h;
            }
        }
        if (w == 0 || h == 0) {
