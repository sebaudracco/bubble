...
public class InviteUserCell extends FrameLayout {
    ...
    public InviteUserCell(Context context, boolean needCheck) {
        ...
        addView(view, LayoutHelper.createFrame(-1, CloseButton.TEXT_SIZE_SP, i2 | 48, LocaleController.isRTL ? 28.0f : 72.0f, 14.0f, LocaleController.isRTL ? 72.0f : 28.0f, 0.0f));
        ...
        addView(view, LayoutHelper.createFrame(-1, CloseButton.TEXT_SIZE_SP, i2 | 48, LocaleController.isRTL ? 28.0f : 72.0f, 39.0f, LocaleController.isRTL ? 72.0f : 28.0f, 0.0f));
        if (needCheck) {
    ...
    public void update(int mask) {
        if (this.currentContact != null) {
            ...
            if (this.currentContact.imported > 0) {
                this.statusTextView.setText(LocaleController.formatPluralString("TelegramContacts", this.currentContact.imported, new Object[]{ApplicationLoader.getConfig().getAppName()}));
            } else {
