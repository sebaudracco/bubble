...
public class MentionCell extends LinearLayout {
    ...
    public MentionCell(Context context) {
        ...
        this.nameTextView.setTextSize(1, CtaButton.TEXT_SIZE_SP);
        ...
        this.usernameTextView.setTextSize(1, CtaButton.TEXT_SIZE_SP);
    ...
    public void setEmojiSuggestion(EmojiSuggestion suggestion) {
        ...
        this.nameTextView.setText(Emoji.replaceEmoji(stringBuilder, this.nameTextView.getPaint().getFontMetricsInt(), AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP), false));
    }
    ...
    public void setBotCommand(String command, String help, User user) {
        ...
        this.usernameTextView.setText(Emoji.replaceEmoji(help, this.usernameTextView.getPaint().getFontMetricsInt(), AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP), false));
    }
