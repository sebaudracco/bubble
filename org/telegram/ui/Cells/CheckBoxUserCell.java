...
public class CheckBoxUserCell extends FrameLayout {
    ...
    public CheckBoxUserCell(Context context, boolean alert) {
        ...
        addView(this.checkBox, LayoutHelper.createFrame(18, RadialCountdown.TEXT_SIZE_SP, (LocaleController.isRTL ? 5 : 3) | 48, (float) (LocaleController.isRTL ? 0 : 17), CtaButton.TEXT_SIZE_SP, (float) (LocaleController.isRTL ? 17 : 0), 0.0f));
    }
