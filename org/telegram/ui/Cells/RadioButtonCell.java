...
public class RadioButtonCell extends FrameLayout {
    ...
    public RadioButtonCell(Context context) {
        ...
        this.radioButton.setSize(AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP));
        this.radioButton.setColor(Theme.getColor(Theme.key_radioBackground), Theme.getColor(Theme.key_radioBackgroundChecked));
        addView(this.radioButton, LayoutHelper.createFrame(22, 22.0f, (LocaleController.isRTL ? 5 : 3) | 48, (float) (LocaleController.isRTL ? 0 : 18), Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT, (float) (LocaleController.isRTL ? 18 : 0), 0.0f));
        ...
        addView(view, LayoutHelper.createFrame(-2, -2.0f, i2 | 48, (float) (LocaleController.isRTL ? 17 : 51), Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT, (float) (LocaleController.isRTL ? 51 : 17), 0.0f));
