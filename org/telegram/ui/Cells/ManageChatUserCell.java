...
public class ManageChatUserCell extends FrameLayout {
    ...
    class C56901 implements OnClickListener {
        C56901() {
        }
    ...
    public ManageChatUserCell(Context context, int padding, boolean needOption) {
        ...
        addView(view, LayoutHelper.createFrame(-1, CloseButton.TEXT_SIZE_SP, i2 | 48, LocaleController.isRTL ? 46.0f : (float) (padding + 68), 11.5f, LocaleController.isRTL ? (float) (padding + 68) : 46.0f, 0.0f));
        ...
        addView(view, LayoutHelper.createFrame(-1, CloseButton.TEXT_SIZE_SP, i2 | 48, LocaleController.isRTL ? 28.0f : (float) (padding + 68), 34.5f, LocaleController.isRTL ? (float) (padding + 68) : 28.0f, 0.0f));
        if (needOption) {
            ...
            this.optionsButton.setOnClickListener(new C56901());
        }
    }
