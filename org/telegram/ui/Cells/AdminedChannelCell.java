...
public class AdminedChannelCell extends FrameLayout {
    ...
    public AdminedChannelCell(Context context, OnClickListener onClickListener) {
        ...
        addView(this.nameTextView, LayoutHelper.createFrame(-1, CloseButton.TEXT_SIZE_SP, (LocaleController.isRTL ? 5 : 3) | 48, LocaleController.isRTL ? 62.0f : 73.0f, 15.5f, LocaleController.isRTL ? 73.0f : 62.0f, 0.0f));
        ...
        addView(this.statusTextView, LayoutHelper.createFrame(-1, CloseButton.TEXT_SIZE_SP, (LocaleController.isRTL ? 5 : 3) | 48, LocaleController.isRTL ? 62.0f : 73.0f, 38.5f, LocaleController.isRTL ? 73.0f : 62.0f, 0.0f));
    ...
    public void setChannel(TLRPC$Chat channel, boolean last) {
        ...
        String url = MessagesController.getInstance().linkPrefix + BridgeUtil.SPLIT_MARK;
