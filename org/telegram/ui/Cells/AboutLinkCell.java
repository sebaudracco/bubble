...
public class AboutLinkCell extends FrameLayout {
    ...
    public void setTextAndIcon(String text, int resId, boolean parseLinks) {
        if (!TextUtils.isEmpty(text)) {
            if (text == null || this.oldText == null || !text.equals(this.oldText)) {
                ...
                Emoji.replaceEmoji(this.stringBuilder, Theme.profile_aboutTextPaint.getFontMetricsInt(), AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP), false);
                requestLayout();
                if (resId == 0) {
                ...
                if (event.getAction() == 0) {
                    ...
                    try {
                        if (this.pressedLink instanceof URLSpanNoUnderline) {
                            ...
                            if ((url.startsWith("@") || url.startsWith("#") || url.startsWith(BridgeUtil.SPLIT_MARK)) && this.delegate != null) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        super.onMeasure(MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(widthMeasureSpec), 1073741824), MeasureSpec.makeMeasureSpec((this.textLayout != null ? this.textLayout.getHeight() : AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP)) + AndroidUtilities.dp(16.0f), 1073741824));
    }
