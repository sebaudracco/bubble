...
public class ChatMessageCell extends BaseCell implements SeekBarDelegate, ImageReceiverDelegate, MediaController$FileDownloadProgressListener {
    ...
    private Runnable invalidateRunnable = new C56811();
    ...
    class C56811 implements Runnable {
        C56811() {
        }
    ...
    private boolean checkGameMotionEvent(MotionEvent event) {
        ...
        if (event.getAction() == 0) {
            if (this.drawPhotoImage && this.photoImage.isInsideImage((float) x, (float) y)) {
                ...
                try {
                    x -= (this.textX + AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT)) + this.descriptionX;
            ...
            if (y <= AndroidUtilities.dp((float) ((this.drawInstantView ? 46 : 0) + 8)) + (this.linkPreviewHeight + (this.textY + this.currentMessageObject.textHeight))) {
                ...
                if (event.getAction() == 0) {
                    if (this.descriptionLayout != null && y >= this.descriptionY) {
                        try {
                            int checkX = x - ((this.textX + AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT)) + this.descriptionX);
    ...
    private boolean checkOtherButtonMotionEvent(MotionEvent event) {
        ...
        if (event.getAction() == 0) {
            ...
            } else if (x >= this.otherX - AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP) && x <= this.otherX + AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP) && y >= this.otherY - AndroidUtilities.dp(4.0f) && y <= this.otherY + AndroidUtilities.dp(BitmapDescriptorFactory.HUE_ORANGE)) {
                this.otherPressed = true;
                result = true;
                invalidate();
            }
    ...
    private boolean checkBotButtonMotionEvent(MotionEvent event) {
        ...
        if (event.getAction() == 0) {
            ...
            if (this.currentMessageObject.isOutOwner()) {
                addX = (getMeasuredWidth() - this.widthForButtons) - AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
            } else {
            ...
            while (a < this.botButtons.size()) {
                BotButton button = (BotButton) this.botButtons.get(a);
                int y2 = (button.f12652y + this.layoutHeight) - AndroidUtilities.dp(2.0f);
                if (x < button.f12651x + addX || x > (button.f12651x + addX) + button.width || y < y2 || y > button.height + y2) {
                    a++;
                } else {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() != 0) {
            ...
            if (this.avatarPressed) {
                ...
                if (event.getAction() == 1) {
                    ...
                    if (!this.drawForwardedName || this.forwardedNameLayout[0] == null) {
                        if (x >= this.nameX + ((float) this.viaNameWidth) && x <= (this.nameX + ((float) this.viaNameWidth)) + ((float) this.viaWidth) && y >= this.nameY - ((float) AndroidUtilities.dp(4.0f)) && y <= this.nameY + ((float) AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP))) {
                            return result;
                        }
                        this.forwardBotPressed = false;
                        return result;
            ...
            if (this.isAvatarVisible && this.avatarImage.isInsideImage(x, ((float) getTop()) + y)) {
                ...
                result = true;
            } else if (this.drawNameLayout && this.nameLayout != null && this.viaWidth != 0 && x >= this.nameX + ((float) this.viaNameWidth) && x <= (this.nameX + ((float) this.viaNameWidth)) + ((float) this.viaWidth) && y >= this.nameY - ((float) AndroidUtilities.dp(4.0f)) && y <= this.nameY + ((float) AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP))) {
                this.forwardBotPressed = true;
                result = true;
    ...
    private boolean isPhotoDataChanged(MessageObject object) {
        ...
        if (object.type == 4) {
            ...
            if (object.messageOwner.media instanceof TLRPC$TL_messageMediaGeoLive) {
                ...
                lat = ((1.5707963267948966d - (2.0d * Math.atan(Math.exp((((double) (Math.round(((double) 268435456) - ((Math.log((MoPubAdapter.DEFAULT_MOPUB_IMAGE_SCALE + Math.sin((3.141592653589793d * lat) / 180.0d)) / (MoPubAdapter.DEFAULT_MOPUB_IMAGE_SCALE - Math.sin((3.141592653589793d * lat) / 180.0d))) * rad) / 2.0d)) - ((long) (AndroidUtilities.dp(10.3f) << 6)))) - ((double) 268435456)) / rad)))) * 180.0d) / 3.141592653589793d;
    ...
    protected void onLongPress() {
        ...
        if (this.pressedLink instanceof URLSpanNoUnderline) {
            if (this.pressedLink.getURL().startsWith(BridgeUtil.SPLIT_MARK)) {
                this.delegate.didPressedUrl(this.currentMessageObject, this.pressedLink, true);
                return;
            }
    ...
    public void setHighlighted(boolean value) {
        if (this.isHighlighted != value) {
            ...
            if (!this.isHighlighted) {
                this.lastHighlightProgressTime = System.currentTimeMillis();
                this.isHighlightedAnimated = true;
                this.highlightProgress = HttpStatus.SC_MULTIPLE_CHOICES;
            }
            updateRadialProgressBackground(true);
            if (this.useSeekBarWaweform) {
                this.seekBarWaveform.setSelected(isDrawSelectedBackground());
    ...
    private int createDocumentLayout(int maxWidth, MessageObject messageObject) {
        ...
        if (MessageObject.isVoiceDocument(this.documentAttach)) {
            ...
            this.availableTimeWidth = maxWidth - AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP);
            measureTime(messageObject);
            int minSize = AndroidUtilities.dp(174.0f) + this.timeWidth;
            if (!this.hasLinkPreview) {
                this.backgroundWidth = Math.min(maxWidth, (AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT) * duration) + minSize);
            }
            ...
            try {
                if (this.infoWidth < 0) {
                    this.infoWidth = AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
                }
    ...
    L_0x0940:
        r4 = "Of";
        r6 = 2131559583; // 0x7f0d049f float:1.8744514E38 double:1.053130362E-314;
        r8 = 2;
    ...
    L_0x0fa2:
        r4 = "PaymentReceipt";
        r6 = 2131559679; // 0x7f0d04ff float:1.8744709E38 double:1.0531304095E-314;
    ...
    L_0x10ca:
        r4 = "OpenChannel";
        r6 = 2131559601; // 0x7f0d04b1 float:1.874455E38 double:1.053130371E-314;
    ...
    L_0x1ac5:
        r4 = "AttachGame";
        r6 = 2131558558; // 0x7f0d009e float:1.8742435E38 double:1.0531298556E-314;
        r4 = org.telegram.messenger.LocaleController.getString(r4, r6);
        r5 = r4.toUpperCase();
    ...
    L_0x1b34:
        ...
        r6 = 2131559697; // 0x7f0d0511 float:1.8744745E38 double:1.0531304183E-314;
        r4 = org.telegram.messenger.LocaleController.getString(r4, r6);
        r5 = r4.toUpperCase();
        goto L_0x0fb0;
    L_0x1b44:
        r4 = "PaymentInvoice";
        r6 = 2131559666; // 0x7f0d04f2 float:1.8744682E38 double:1.053130403E-314;
        r4 = org.telegram.messenger.LocaleController.getString(r4, r6);
        r5 = r4.toUpperCase();
        goto L_0x0fb0;
    L_0x1b54:
    ...
    L_0x1b73:
        r4 = "OpenGroup";
        r6 = 2131559602; // 0x7f0d04b2 float:1.8744553E38 double:1.0531303714E-314;
        r5 = org.telegram.messenger.LocaleController.getString(r4, r6);
        goto L_0x10d4;
    L_0x1b7f:
        r4 = "InstantView";
        r6 = 2131559225; // 0x7f0d0339 float:1.8743788E38 double:1.053130185E-314;
        r5 = org.telegram.messenger.LocaleController.getString(r4, r6);
        goto L_0x10d4;
    L_0x1b8b:
        r4 = 0;
    ...
    L_0x1c41:
        ...
        r6 = 2131558633; // 0x7f0d00e9 float:1.8742587E38 double:1.0531298927E-314;
    ...
    L_0x1d25:
        ...
        r6 = 2131558632; // 0x7f0d00e8 float:1.8742585E38 double:1.053129892E-314;
        r128 = org.telegram.messenger.LocaleController.getString(r4, r6);
        goto L_0x1c4b;
    L_0x1d31:
    ...
    L_0x1d33:
        ...
        r6 = 2131558631; // 0x7f0d00e7 float:1.8742583E38 double:1.0531298917E-314;
        r128 = org.telegram.messenger.LocaleController.getString(r4, r6);
        goto L_0x1c4b;
    L_0x1d3f:
        r0 = r56;
    ...
    L_0x1d47:
        ...
        r6 = 2131558630; // 0x7f0d00e6 float:1.8742581E38 double:1.053129891E-314;
        r128 = org.telegram.messenger.LocaleController.getString(r4, r6);
        goto L_0x1c4b;
    L_0x1d53:
        r4 = "CallMessageIncoming";
        r6 = 2131558629; // 0x7f0d00e5 float:1.874258E38 double:1.0531298907E-314;
        r128 = org.telegram.messenger.LocaleController.getString(r4, r6);
        goto L_0x1c4b;
    L_0x1d5f:
        r0 = r147;
    ...
    L_0x1f92:
        r4 = "NumberUnknown";
        r6 = 2131559581; // 0x7f0d049d float:1.874451E38 double:1.053130361E-314;
    ...
    L_0x2562:
        ...
        r6 = 2131558562; // 0x7f0d00a2 float:1.8742443E38 double:1.0531298576E-314;
    ...
    L_0x30df:
        ...
        r8 = 2131231335; // 0x7f080267 float:1.8078748E38 double:1.052968186E-314;
        ...
        if (this.currentMessageObject != null) {
            if (changed || !this.wasLayout) {
                ...
                if (this.timeTextWidth < 0) {
                    this.timeTextWidth = AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
                }
            ...
            if (this.currentMessageObject.type == 0) {
                this.textY = AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT) + this.namesOffset;
            }
            if (this.currentMessageObject.isRoundVideo()) {
            ...
            if (this.documentAttachType == 3) {
                ...
                if (this.hasLinkPreview) {
                    this.seekBarX += AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
                    this.buttonX += AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
                    this.timeAudioX += AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
                }
                ...
                this.buttonY = (AndroidUtilities.dp(13.0f) + this.namesOffset) + this.mediaOffsetY;
                this.radialProgress.setProgressRect(this.buttonX, this.buttonY, this.buttonX + AndroidUtilities.dp(44.0f), this.buttonY + AndroidUtilities.dp(44.0f));
                this.photoImage.setImageCoords(this.buttonX - AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), this.buttonY - AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), this.photoImage.getImageWidth(), this.photoImage.getImageHeight());
            } else if (this.currentMessageObject.type == 12) {
                if (this.currentMessageObject.isOutOwner()) {
                ...
                if (this.currentMessageObject.type == 0 && (this.hasLinkPreview || this.hasGamePreview || this.hasInvoicePreview)) {
                    int linkX;
                    if (this.hasGamePreview) {
                        linkX = this.textX - AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
                    ...
                    if (this.isSmallImage) {
                        ...
                        x = linkX + (this.hasInvoicePreview ? -AndroidUtilities.dp(6.3f) : AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT));
                    }
                } else if (!this.currentMessageObject.isOutOwner()) {
                    if (this.isChat && this.isAvatarVisible) {
                        x = AndroidUtilities.dp(63.0f);
                    } else {
                        x = AndroidUtilities.dp(CtaButton.TEXT_SIZE_SP);
                    }
                    if (!(this.currentPosition == null || this.currentPosition.edge)) {
                        x -= AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
                    }
    ...
    private void drawContent(Canvas canvas) {
            ...
            if (this.hasLinkPreview || this.hasGamePreview || this.hasInvoicePreview) {
                ...
                if (this.siteNameLayout != null) {
                    ...
                    if (this.hasInvoicePreview) {
                        ...
                        i = AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
                    }
                ...
                if (this.drawPhotoImage && this.drawInstantView) {
                    ...
                    this.photoImage.setImageCoords(AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT) + linkX, linkPreviewY, this.photoImage.getImageWidth(), this.photoImage.getImageHeight());
                ...
                if (this.titleLayout != null) {
                    ...
                    canvas.save();
                    canvas.translate((float) ((AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT) + linkX) + this.titleX), (float) (linkPreviewY - AndroidUtilities.dp(3.0f)));
                ...
                if (this.authorLayout != null) {
                    ...
                    canvas.save();
                    canvas.translate((float) ((AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT) + linkX) + this.authorX), (float) (linkPreviewY - AndroidUtilities.dp(3.0f)));
                ...
                if (this.descriptionLayout != null) {
                    ...
                    canvas.save();
                    canvas.translate((float) (((this.hasInvoicePreview ? 0 : AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT)) + linkX) + this.descriptionX), (float) this.descriptionY);
                ...
                if (this.drawInstantView) {
                    ...
                    int instantY = (this.linkPreviewHeight + startY) + AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
                    ...
                    if (this.drawInstantViewType == 0) {
                        setDrawableBounds(instantDrawable, (this.instantTextX + linkX) - AndroidUtilities.dp(CtaButton.TEXT_SIZE_SP), instantY + AndroidUtilities.dp(11.5f), AndroidUtilities.dp(9.0f), AndroidUtilities.dp(13.0f));
        ...
        if (this.buttonState == -1 && this.currentMessageObject.isSecretPhoto() && !MediaController.getInstance().isPlayingMessage(this.currentMessageObject) && this.photoImage.getVisible()) {
            ...
            if (this.currentMessageObject.messageOwner.destroyTime != 0) {
                if (!this.currentMessageObject.isOutOwner()) {
                    ...
                    canvas.drawArc(this.deleteProgressRect, RadialCountdown.START_ANGLE, -360.0f * progress, true, Theme.chat_deleteProgressPaint);
                    if (progress != 0.0f) {
        ...
        if (this.documentAttachType == 2 || this.currentMessageObject.type == 8) {
            ...
            if (this.durationLayout != null) {
                ...
                if (playing) {
                    ...
                    canvas.drawArc(this.rect, RadialCountdown.START_ANGLE, 360.0f * this.currentMessageObject.audioProgress, false, Theme.chat_radialProgressPaint);
                }
                if (this.documentAttachType == 7) {
                    x1 = this.backgroundDrawableLeft + AndroidUtilities.dp(this.currentMessageObject.isOutOwner() ? 12.0f : RadialCountdown.TEXT_SIZE_SP);
            ...
            if (this.docTitleLayout != null) {
                ...
                if (this.currentMessageObject.messageOwner.media instanceof TLRPC$TL_messageMediaGeoLive) {
                    ...
                    if (!this.locationExpired) {
                        ...
                        this.rect.set((float) (this.photoImage.getImageX2() - AndroidUtilities.dp(43.0f)), (float) (cy - AndroidUtilities.dp(CtaButton.TEXT_SIZE_SP)), (float) (this.photoImage.getImageX2() - AndroidUtilities.dp(13.0f)), (float) (AndroidUtilities.dp(CtaButton.TEXT_SIZE_SP) + cy));
                        if (this.currentMessageObject.isOutOwner()) {
                        ...
                        canvas.drawCircle(this.rect.centerX(), this.rect.centerY(), (float) AndroidUtilities.dp(CtaButton.TEXT_SIZE_SP), Theme.chat_radialProgress2Paint);
                        Theme.chat_radialProgress2Paint.setAlpha(255);
                        canvas.drawArc(this.rect, RadialCountdown.START_ANGLE, -360.0f * progress, false, Theme.chat_radialProgress2Paint);
                        ...
                        canvas.save();
                        canvas.translate((float) (this.photoImage.getImageX() + AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT)), (float) (this.photoImage.getImageY2() + AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT)));
                    ...
                    canvas.save();
                    canvas.translate((float) (((this.docTitleOffsetX + this.photoImage.getImageX()) + this.photoImage.getImageWidth()) + AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT)), (float) (this.photoImage.getImageY() + AndroidUtilities.dp(8.0f)));
                    this.docTitleLayout.draw(canvas);
                    canvas.restore();
                    if (this.infoLayout != null) {
                        canvas.save();
                        canvas.translate((float) ((this.photoImage.getImageX() + this.photoImage.getImageWidth()) + AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT)), (float) ((this.photoImage.getImageY() + this.docTitleLayout.getLineBottom(this.docTitleLayout.getLineCount() - 1)) + AndroidUtilities.dp(13.0f)));
                        this.infoLayout.draw(canvas);
                        canvas.restore();
                    }
                }
        ...
        if (this.hasOldCaptionPreview) {
            ...
            startY = ((this.totalHeight - AndroidUtilities.dp(this.drawPinnedTop ? 9.0f : Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT)) - this.linkPreviewHeight) - AndroidUtilities.dp(8.0f);
            linkPreviewY = startY;
            Theme.chat_replyLinePaint.setColor(Theme.getColor(this.currentMessageObject.isOutOwner() ? Theme.key_chat_outPreviewLine : Theme.key_chat_inPreviewLine));
            ...
            if (this.siteNameLayout != null) {
                Theme.chat_replyNamePaint.setColor(Theme.getColor(this.currentMessageObject.isOutOwner() ? Theme.key_chat_outSiteNameText : Theme.key_chat_inSiteNameText));
                canvas.save();
                canvas.translate((float) ((this.hasInvoicePreview ? 0 : AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT)) + linkX), (float) (linkPreviewY - AndroidUtilities.dp(3.0f)));
                this.siteNameLayout.draw(canvas);
                canvas.restore();
                linkPreviewY += this.siteNameLayout.getLineBottom(this.siteNameLayout.getLineCount() - 1);
            }
            ...
            if (this.descriptionLayout != null) {
                ...
                this.descriptionY = linkPreviewY - AndroidUtilities.dp(3.0f);
                canvas.save();
                canvas.translate((float) ((AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT) + linkX) + this.descriptionX), (float) this.descriptionY);
                this.descriptionLayout.draw(canvas);
                canvas.restore();
            }
            this.drawTime = true;
        ...
        if (this.documentAttachType == 1) {
            ...
            if (this.drawPhotoImage) {
                ...
                x = (this.photoImage.getImageX() + this.photoImage.getImageWidth()) + AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
        ...
        if (!this.botButtons.isEmpty()) {
            ...
            while (a < this.botButtons.size()) {
                BotButton button = (BotButton) this.botButtons.get(a);
                y = (button.f12652y + this.layoutHeight) - AndroidUtilities.dp(2.0f);
                Theme.chat_systemDrawable.setColorFilter(a == this.pressedBotButton ? Theme.colorPressedFilter : Theme.colorFilter);
                Theme.chat_systemDrawable.setBounds(button.f12651x + addX, y, (button.f12651x + addX) + button.width, button.height + y);
                Theme.chat_systemDrawable.draw(canvas);
                canvas.save();
                canvas.translate((float) ((button.f12651x + addX) + AndroidUtilities.dp(5.0f)), (float) (((AndroidUtilities.dp(44.0f) - button.title.getLineBottom(button.title.getLineCount() - 1)) / 2) + y));
                button.title.draw(canvas);
                canvas.restore();
                if (button.button instanceof TLRPC$TL_keyboardButtonUrl) {
                    setDrawableBounds(Theme.chat_botLinkDrawalbe, (((button.f12651x + button.width) - AndroidUtilities.dp(3.0f)) - Theme.chat_botLinkDrawalbe.getIntrinsicWidth()) + addX, AndroidUtilities.dp(3.0f) + y);
                    Theme.chat_botLinkDrawalbe.draw(canvas);
                } else if (button.button instanceof TLRPC$TL_keyboardButtonSwitchInline) {
                    setDrawableBounds(Theme.chat_botInlineDrawable, (((button.f12651x + button.width) - AndroidUtilities.dp(3.0f)) - Theme.chat_botInlineDrawable.getIntrinsicWidth()) + addX, AndroidUtilities.dp(3.0f) + y);
                    ...
                    if (drawProgress || !(drawProgress || button.progressAlpha == 0.0f)) {
                        ...
                        x = ((button.f12651x + button.width) - AndroidUtilities.dp(12.0f)) + addX;
    ...
    private void measureTime(MessageObject messageObject) {
        ...
        if ((messageObject.messageOwner.flags & 1024) != 0) {
            ...
            this.timeWidth += (this.viewsTextWidth + Theme.chat_msgInViewsDrawable.getIntrinsicWidth()) + AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
        }
        if (signString != null) {
            ...
            if (messageObject.isOutOwner()) {
                if (messageObject.type == 5) {
                    widthForSign -= AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP);
                } else {
    ...
    private void setMessageObjectInternal(MessageObject messageObject) {
        ...
        if (this.drawForwardedName && messageObject.needDrawForwarded() && (this.currentPosition == null || this.currentPosition.minY == (byte) 0)) {
            ...
            if (!(this.currentForwardUser == null && this.currentForwardChannel == null)) {
                ...
                String fromString = LocaleController.getString(HttpHeaders.FROM, R.string.From);
        ...
        if (messageObject.hasValidReplyMessageObject() && (this.currentPosition == null || this.currentPosition.minY == (byte) 0)) {
            ...
            if (!(messageObject.type == 13 || messageObject.type == 5)) {
                maxWidth -= AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
            }
            ...
            if (this.wasLayout) {
                ...
                if (this.currentMessageObject.isOutOwner()) {
                    ...
                    if (!(this.currentMessagesGroup == null || this.currentPosition.edge)) {
                        this.backgroundDrawableRight += AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
                    }
                    ...
                    if (this.currentMessagesGroup != null) {
                        if (!this.currentPosition.edge) {
                            this.backgroundDrawableLeft -= AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
                            this.backgroundDrawableRight += AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
                        }
                        if (this.currentPosition.leftSpanOffset != 0) {
                    ...
                    if (this.currentPosition != null) {
                        ...
                        if ((this.currentPosition.flags & 8) == 0) {
                            additionalBottom += AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
                        }
                    }
                    if (this.drawPinnedBottom && this.drawPinnedTop) {
                        offsetBottom = 0;
                ...
                if (this.drawBackground && this.currentBackgroundDrawable != null) {
                    if (this.isHighlightedAnimated) {
                        ...
                        if (this.highlightProgress >= HttpStatus.SC_MULTIPLE_CHOICES) {
                            alpha = 1.0f;
                        } else {
        ...
        if (this.replyNameLayout != null) {
            if (this.currentMessageObject.type == 13 || this.currentMessageObject.type == 5) {
                ...
                if (this.currentMessageObject.isOutOwner()) {
                    ...
                    if (this.mediaBackground) {
                        ...
                        f = (this.mediaBackground || !this.drawPinnedBottom) ? RadialCountdown.TEXT_SIZE_SP : 12.0f;
            ...
            if (this.currentPosition == null || (this.currentPosition.minY == (byte) 0 && this.currentPosition.minX == (byte) 0)) {
                ...
                if (this.needReplyImage) {
                    this.replyImageReceiver.setImageCoords(this.replyStartX + AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), this.replyStartY, AndroidUtilities.dp(35.0f), AndroidUtilities.dp(35.0f));
    ...
    public void drawCaptionLayout(Canvas canvas) {
        ...
        if (this.captionLayout != null) {
            ...
            if (this.currentMessageObject.type == 1 || this.documentAttachType == 4 || this.currentMessageObject.type == 8) {
                ...
                imageX = (((this.totalHeight - this.captionHeight) - AndroidUtilities.dp(this.drawPinnedTop ? 9.0f : Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT)) - this.linkPreviewHeight) - AndroidUtilities.dp(17.0f);
                ...
                if (!this.drawPinnedTop) {
                    f2 = Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT;
                }
                ...
                if (!isBroadcast) {
                    ...
                    if (drawCheck1) {
                        if (!this.mediaBackground || this.captionLayout != null) {
                            ...
                            setDrawableBounds(drawable, (this.layoutWidth - AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP)) - drawable.getIntrinsicWidth(), (this.layoutHeight - AndroidUtilities.dp(8.0f)) - drawable.getIntrinsicHeight());
                            drawable.draw(canvas);
                        } else if (this.currentMessageObject.type == 13 || this.currentMessageObject.type == 5) {
