    ...
    public void buildLayout() {
        ...
        if (this.drawCount) {
            ...
            if (dialog == null || dialog.unread_count == 0) {
                ...
                int w = this.countWidth + AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP);
        ...
        this.avatarImage.setImageCoords(avatarLeft, AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), AndroidUtilities.dp(52.0f), AndroidUtilities.dp(52.0f));
        double widthpx;
        if (LocaleController.isRTL) {
