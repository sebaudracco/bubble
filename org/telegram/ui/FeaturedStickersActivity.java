...
public class FeaturedStickersActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C64081 extends ActionBarMenuOnItemClick {
        C64081() {
        }
    ...
    class C64113 implements OnItemClickListener {
        C64113() {
        }
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        class C64151 implements OnClickListener {

            class C64142 implements DialogInterface.OnClickListener {
                C64142() {
                }
            ...
            public void onClick(final View v) {
                Builder builder = new Builder(ListAdapter.this.mContext);
                builder.setMessage(ListAdapter.this.mContext.getString(R.string.RewardedVideoStickers));
                builder.setPositiveButton(ListAdapter.this.mContext.getString(17039370), new DialogInterface.OnClickListener() {

                    class C64121 implements RewardedVideoListener {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        AppsgeyserSDK.getFastTrackAdsController().showRewardedVideo(new C64121());
                    }
                });
                builder.setNegativeButton(ListAdapter.this.mContext.getString(17039360), new C64142());
                builder.show();
            }
        }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 0:
                    ...
                    ((FeaturedStickerSetCell) view).setAddOnClickListener(new C64151());
                    break;
                case 1:
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C64081());
        ...
        this.listView.setOnItemClickListener(new C64113());
