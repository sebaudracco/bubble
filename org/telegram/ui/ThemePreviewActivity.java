...
public class ThemePreviewActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C68981 extends ActionBarMenuItemSearchListener {
        C68981() {
        }
    ...
    class C69003 extends ViewOutlineProvider {
        C69003() {
        }
    ...
    class C69025 implements OnPageChangeListener {
        C69025() {
        }
    ...
    class C69036 extends PagerAdapter {
        C69036() {
        }
    ...
    class C69058 implements OnClickListener {
        C69058() {
        }
    ...
    class C69069 implements OnClickListener {
        C69069() {
        }
    ...
    public class MessagesAdapter extends SelectionAdapter {
        ...
        class C69071 implements ChatMessageCellDelegate {
            C69071() {
            }
        ...
        class C69082 implements ChatActionCellDelegate {
            C69082() {
            }
        ...
        public MessagesAdapter(Context context) {
            ...
            photoSize.size = 0;
            photoSize.w = HttpStatus.SC_INTERNAL_SERVER_ERROR;
            photoSize.h = HttpStatus.SC_MOVED_TEMPORARILY;
            photoSize.type = "s";
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
            ...
            if (viewType == 0) {
                ...
                ((ChatMessageCell) view).setDelegate(new C69071());
            } else if (viewType == 1) {
                view = new ChatActionCell(this.mContext);
                ((ChatActionCell) view).setDelegate(new C69082());
            }
            view.setLayoutParams(new LayoutParams(-1, -2));
            return new Holder(view);
        }
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            if (view instanceof ChatMessageCell) {
                ...
                if ((message.messageOwner.reply_markup instanceof TL_replyInlineMarkup) || nextType != holder.getItemViewType()) {
                    ...
                    pinnedBotton = nextMessage.isOutOwner() == message.isOutOwner() && Math.abs(nextMessage.messageOwner.date - message.messageOwner.date) <= HttpStatus.SC_MULTIPLE_CHOICES;
                }
                if (prevType == holder.getItemViewType()) {
                    MessageObject prevMessage = (MessageObject) this.messages.get(position + 1);
                    pinnedTop = !(prevMessage.messageOwner.reply_markup instanceof TL_replyInlineMarkup) && prevMessage.isOutOwner() == message.isOutOwner() && Math.abs(prevMessage.messageOwner.date - message.messageOwner.date) <= HttpStatus.SC_MULTIPLE_CHOICES;
                } else {
                    pinnedTop = false;
                }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.createMenu().addItem(0, R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new C68981()).getSearchField().setHint(LocaleController.getString("Search", R.string.Search));
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            this.floatingButton.setOutlineProvider(new C69003());
        }
        ...
        viewPager.addOnPageChangeListener(new C69025());
        viewPager.setAdapter(new C69036());
        ...
        cancelButton.setOnClickListener(new C69058());
        ...
        doneButton.setOnClickListener(new C69069());
