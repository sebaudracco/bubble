...
public class GroupCreateActivity extends BaseFragment implements NotificationCenterDelegate, OnClickListener {
    ...
    class C64161 extends ActionBarMenuOnItemClick {
        C64161() {
        }
    ...
    class C64205 implements Callback {
        C64205() {
        }
    ...
    class C64216 implements OnEditorActionListener {
        C64216() {
        }
    ...
    class C64227 implements OnKeyListener {
    ...
    class C64238 implements TextWatcher {
        C64238() {
        }
    ...
    class C64249 implements OnItemClickListener {
        C64249() {
        }
    ...
    public class GroupCreateAdapter extends FastScrollAdapter {
        ...
        public void searchDialogs(final String query) {
            ...
            this.searchTimer.schedule(new TimerTask() {
                ...
                class C64271 implements Runnable {

                    class C64261 implements Runnable {
                        C64261() {
                        }
                    ...
                    public void run() {
                        ...
                        Utilities.searchQueue.postRunnable(new C64261());
                    }
                }
                ...
                public void run() {
                    ...
                    AndroidUtilities.runOnUIThread(new C64271());
                }
            }, 200, 300);
        }
    ...
    private class SpansContainer extends ViewGroup {
        ...
        public void addSpan(GroupCreateSpan span) {
            ...
            this.currentAnimation.addListener(new C64301());
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C64161());
        ...
        this.scrollView = new ScrollView(context) {
            public boolean requestChildRectangleOnScreen(View child, Rect rectangle, boolean immediate) {
                ...
                rectangle.top += GroupCreateActivity.this.fieldY + AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP);
        ...
        this.editText.setCustomSelectionActionModeCallback(new C64205());
        this.editText.setOnEditorActionListener(new C64216());
        this.editText.setOnKeyListener(new C64227());
        this.editText.addTextChangedListener(new C64238());
        ...
        this.listView.setOnItemClickListener(new C64249());
