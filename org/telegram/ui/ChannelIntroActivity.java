...
public class ChannelIntroActivity extends BaseFragment {
    ...
    class C58561 extends ActionBarMenuOnItemClick {
        C58561() {
        }
    ...
    class C58583 implements OnTouchListener {
        C58583() {
        }
    ...
    class C58594 implements OnClickListener {
        C58594() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C58561());
        ...
        viewGroup.setOnTouchListener(new C58583());
        ...
        this.createChannelText.setOnClickListener(new C58594());
