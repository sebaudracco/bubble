...
public class VoIPActivity extends Activity implements StateListener, NotificationCenterDelegate {
    ...
    class C69331 implements ImageReceiverDelegate {
        C69331() {
        }
    ...
    class C69392 implements OnClickListener {
    ...
    class C69413 implements OnClickListener {

        class C69401 implements Runnable {
            C69401() {
            }
        ...
        public void onClick(View v) {
            ...
            if (VoIPActivity.this.retrying) {
                ...
                VoIPActivity.this.endBtn.postDelayed(new C69401(), 100);
            } else if (VoIPService.getSharedInstance() != null) {
    ...
    class C69434 implements OnClickListener {

        class C69421 implements DialogInterface.OnClickListener {
            C69421() {
            }

            public void onClick(DialogInterface dialog, int which) {
                AudioManager am = (AudioManager) VoIPActivity.this.getSystemService("audio");
    ...
    class C69445 implements OnClickListener {
        C69445() {
        }
    ...
    class C69456 implements OnClickListener {
        C69456() {
        }
    ...
    class C69487 implements Listener {

        class C69461 extends AnimatorListenerAdapter {
            C69461() {
            }
        ...
        class C69472 extends AnimatorListenerAdapter {
            C69472() {
            }
    ...
    class C69518 implements Listener {

        class C69491 extends AnimatorListenerAdapter {
            C69491() {
            }
        ...
        class C69502 extends AnimatorListenerAdapter {
            C69502() {
            }
    ...
    class C69529 implements OnClickListener {
        C69529() {
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (this.user.photo != null) {
            this.photoView.getImageReceiver().setDelegate(new C69331());
        ...
        this.nameText.setOnClickListener(new C69392());
        this.endBtn.setOnClickListener(new C69413());
        this.spkToggle.setOnClickListener(new C69434());
        this.micToggle.setOnClickListener(new C69445());
        this.chatBtn.setOnClickListener(new C69456());
        ...
        this.acceptSwipe.setListener(new C69487());
        this.declineSwipe.setListener(new C69518());
        this.cancelBtn.setOnClickListener(new C69529());
    ...
    private View createContentView() {
        ...
        branding.setText(LocaleController.getAppNameString("VoipInCallBranding", R.string.VoipInCallBranding));
        Drawable logo = getResources().getDrawable(R.drawable.app_icon).mutate();
        logo.setAlpha(HttpStatus.SC_NO_CONTENT);
        logo.setBounds(0, 0, AndroidUtilities.dp(CtaButton.TEXT_SIZE_SP), AndroidUtilities.dp(CtaButton.TEXT_SIZE_SP));
        ...
        frameLayout.addView(branding, LayoutHelper.createFrame(-2, -2.0f, (LocaleController.isRTL ? 5 : 3) | 48, RadialCountdown.TEXT_SIZE_SP, RadialCountdown.TEXT_SIZE_SP, RadialCountdown.TEXT_SIZE_SP, 0.0f));
        ...
        frameLayout.addView(anonymousClass10, LayoutHelper.createFrame(-1, -2.0f, 51, RadialCountdown.TEXT_SIZE_SP, 43.0f, RadialCountdown.TEXT_SIZE_SP, 0.0f));
        anonymousClass10 = new TextView(this);
        ...
        anonymousClass10.setShadowLayer((float) AndroidUtilities.dp(3.0f), 0.0f, (float) AndroidUtilities.dp(0.6666667f), 1275068416);
        anonymousClass10.setTextSize(1, CtaButton.TEXT_SIZE_SP);
        anonymousClass10.setGravity(LocaleController.isRTL ? 5 : 3);
        this.stateText = anonymousClass10;
        frameLayout.addView(anonymousClass10, LayoutHelper.createFrame(-1, -2.0f, 51, RadialCountdown.TEXT_SIZE_SP, 98.0f, RadialCountdown.TEXT_SIZE_SP, 0.0f));
        ...
        micIcon.setAlpha(HttpStatus.SC_NO_CONTENT);
        anonymousClass10.setImageDrawable(micIcon);
        anonymousClass10.setScaleType(ScaleType.CENTER);
        this.micToggle = anonymousClass10;
        frameLayout.addView(anonymousClass10, LayoutHelper.createFrame(38, 38.0f, 83, 16.0f, 0.0f, 0.0f, Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT));
        anonymousClass10 = new CheckableImageView(this);
        anonymousClass10.setBackgroundResource(R.drawable.bg_voip_icon_btn);
        Drawable speakerIcon = getResources().getDrawable(R.drawable.ic_volume_up_white_24dp).mutate();
        speakerIcon.setAlpha(HttpStatus.SC_NO_CONTENT);
        anonymousClass10.setImageDrawable(speakerIcon);
        anonymousClass10.setScaleType(ScaleType.CENTER);
        this.spkToggle = anonymousClass10;
        frameLayout.addView(anonymousClass10, LayoutHelper.createFrame(38, 38.0f, 85, 0.0f, 0.0f, 16.0f, Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT));
        ...
        chatIcon.setAlpha(HttpStatus.SC_NO_CONTENT);
        anonymousClass10.setImageDrawable(chatIcon);
        anonymousClass10.setScaleType(ScaleType.CENTER);
        this.chatBtn = anonymousClass10;
        frameLayout.addView(anonymousClass10, LayoutHelper.createFrame(38, 38.0f, 81, 0.0f, 0.0f, 0.0f, Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT));
        ...
        frameLayout.addView(anonymousClass10, LayoutHelper.createFrame(-1, -2.0f, 80, CloseButton.TEXT_SIZE_SP, 0.0f, CloseButton.TEXT_SIZE_SP, 68.0f));
        ...
        frameLayout.addView(acceptBtn, LayoutHelper.createFrame(78, 78.0f, 83, CloseButton.TEXT_SIZE_SP, 0.0f, 0.0f, 68.0f));
        anonymousClass10 = new ImageView(this);
        ...
        frameLayout.addView(anonymousClass10, LayoutHelper.createFrame(78, 78.0f, 85, 0.0f, 0.0f, CloseButton.TEXT_SIZE_SP, 68.0f));
        ...
        this.emojiWrap.setPadding(AndroidUtilities.dp(14.0f), AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), AndroidUtilities.dp(14.0f), AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT));
        int i = 0;
        while (i < 4) {
            anonymousClass10 = new ImageView(this);
        ...
        this.emojiWrap.setOnLongClickListener(new OnLongClickListener() {
            ...
            class C69311 implements Runnable {
                C69311() {
                }
            ...
            public boolean onLongClick(View v) {
                ...
                if (VoIPActivity.this.emojiTooltipVisible) {
                    VoIPActivity.this.hintTextView.postDelayed(VoIPActivity.this.tooltipHider = new C69311(), 5000);
                }
                return true;
            }
        });
        ...
        frameLayout.addView(this.emojiExpandedText, LayoutHelper.createFrame(-1, -2.0f, 17, Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT, 32.0f, Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT, 0.0f));
        ...
        this.hintTextView.setPadding(AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT));
        ...
        frameLayout.addView(this.hintTextView, LayoutHelper.createFrame(-2, -2.0f, 53, 0.0f, 42.0f, Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT, 0.0f));
        int ellMaxAlpha = this.stateText.getPaint().getAlpha();
        this.ellAnimator = new AnimatorSet();
        AnimatorSet animatorSet = this.ellAnimator;
        r38 = new Animator[6];
        r38[0] = createAlphaAnimator(this.ellSpans[0], 0, ellMaxAlpha, 0, HttpStatus.SC_MULTIPLE_CHOICES);
        r38[1] = createAlphaAnimator(this.ellSpans[1], 0, ellMaxAlpha, 150, HttpStatus.SC_MULTIPLE_CHOICES);
        r38[2] = createAlphaAnimator(this.ellSpans[2], 0, ellMaxAlpha, HttpStatus.SC_MULTIPLE_CHOICES, HttpStatus.SC_MULTIPLE_CHOICES);
        r38[3] = createAlphaAnimator(this.ellSpans[0], ellMaxAlpha, 0, 1000, HttpStatus.SC_BAD_REQUEST);
        r38[4] = createAlphaAnimator(this.ellSpans[1], ellMaxAlpha, 0, 1000, HttpStatus.SC_BAD_REQUEST);
        r38[5] = createAlphaAnimator(this.ellSpans[2], ellMaxAlpha, 0, 1000, HttpStatus.SC_BAD_REQUEST);
        animatorSet.playTogether(r38);
        this.ellAnimator.addListener(new AnimatorListenerAdapter() {
            private Runnable restarter = new C69321();

            class C69321 implements Runnable {
                C69321() {
                }
    ...
    private void showDebugAlert() {
        if (VoIPService.getSharedInstance() != null) {
            ...
            title.setTextSize(1, CtaButton.TEXT_SIZE_SP);
            ...
            closeBtn.setTextSize(1, CtaButton.TEXT_SIZE_SP);
            closeBtn.setText(LocaleController.getString(HTTP.CONN_CLOSE, R.string.Close));
    ...
    private void callAccepted() {
        ...
        if (this.didAcceptFromHere) {
            ...
            if (VERSION.SDK_INT >= 21) {
                colorAnim = ObjectAnimator.ofArgb(this.endBtnBg, "color", new int[]{-12207027, -1696188});
            } else {
                colorAnim = ObjectAnimator.ofInt(this.endBtnBg, "color", new int[]{-12207027, -1696188});
    ...
    private void showRetry() {
        ...
        AnimatorSet set = new AnimatorSet();
        if (VERSION.SDK_INT >= 21) {
            colorAnim = ObjectAnimator.ofArgb(this.endBtnBg, "color", new int[]{-1696188, -12207027});
        } else {
            colorAnim = ObjectAnimator.ofInt(this.endBtnBg, "color", new int[]{-1696188, -12207027});
            colorAnim.setEvaluator(new ArgbEvaluator());
        }
        r2 = new Animator[7];
    ...
    public void onStateChanged(final int state) {
        ...
        runOnUiThread(new Runnable() {
            ...
            class C69341 implements Runnable {
                C69341() {
                }
            ...
            class C69352 implements Runnable {
                C69352() {
                }
            ...
            class C69363 implements Runnable {
                C69363() {
                }
            ...
            class C69374 implements Runnable {
                C69374() {
                }
            ...
            public void run() {
                ...
                if (VoIPActivity.this.firstStateChange) {
                    ...
                    if (VoIPActivity.this.isIncomingWaiting = state == 15) {
                        ...
                        VoIPActivity.this.spkToggle.setVisibility(8);
                        VoIPActivity.this.chatBtn.setVisibility(8);
                        AndroidUtilities.runOnUIThread(new C69341(), 500);
                ...
                if (state == 15) {
                    ...
                    VoIPActivity.this.stateText.postDelayed(new C69352(), 200);
                } else if (state == 17) {
                    ...
                    if (!wasFirstStateChange && state == 3) {
                        ...
                        if (count < 3) {
                            ...
                            VoIPActivity.this.hintTextView.postDelayed(VoIPActivity.this.tooltipHider = new C69363(), 5000);
                    ...
                    if (lastError == 1) {
                        ...
                        VoIPActivity.this.stateText.postDelayed(new C69374(), 1000);
                    }
                }
    ...
    private void updateBlurredPhotos(final Bitmap src) {
        new Thread(new Runnable() {
            ...
            class C69381 implements Runnable {
                C69381() {
                }
            ...
            public void run() {
                ...
                VoIPActivity.this.runOnUiThread(new C69381());
            }
        }).start();
    }
}
