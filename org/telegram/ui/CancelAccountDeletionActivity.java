...
public class CancelAccountDeletionActivity extends BaseFragment {
    ...
    class C56601 extends ActionBarMenuOnItemClick {
        C56601() {
        }
    ...
    public class LoginActivitySmsView extends SlideView implements NotificationCenterDelegate {
        ...
        class C56685 extends TimerTask {

            class C56671 implements Runnable {
                C56671() {
                }
            ...
            public void run() {
                ...
                AndroidUtilities.runOnUIThread(new C56671());
            }
        }

        class C56726 extends TimerTask {

            class C56711 implements Runnable {

                class C56701 implements RequestDelegate {
                    C56701() {
                    }
                ...
                public void run() {
                    ...
                    if (LoginActivitySmsView.this.currentType == 3) {
                        ...
                        if (LoginActivitySmsView.this.nextType == 4) {
                            ...
                            ConnectionsManager.getInstance().sendRequest(req, new C56701(), 2);
            ...
            public void run() {
                if (LoginActivitySmsView.this.timeTimer != null) {
                    ...
                    AndroidUtilities.runOnUIThread(new C56711());
                }
            }
        }
        ...
        public void setParams(Bundle params, boolean restore) {
            if (params != null) {
                ...
                if (this.phone != null) {
                    ...
                    this.confirmTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("CancelAccountResetInfo", R.string.CancelAccountResetInfo, new Object[]{PhoneFormat.getInstance().format(Marker.ANY_NON_NULL_MARKER + number), ApplicationLoader.getConfig().getAppName()})));
                    if (this.currentType != 3) {
        ...
        private void createCodeTimer() {
            if (this.codeTimer == null) {
                ...
                this.codeTimer.schedule(new C56685(), 0, 1000);
            }
        }
        ...
        private void createTimer() {
            if (this.timeTimer == null) {
                ...
                this.timeTimer.schedule(new C56726(), 0, 1000);
            }
        }
                    ...
                    public void run(TLObject response, final TLRPC$TL_error error) {
                        AndroidUtilities.runOnUIThread(new Runnable() {
                            public void run() {
                                ...
                                LoginActivitySmsView.this.nextPressed = false;
                                if (error == null) {
                                    CancelAccountDeletionActivity.this.errorDialog = AlertsCreator.showSimpleAlert(CancelAccountDeletionActivity.this, LocaleController.formatString("CancelLinkSuccess", R.string.CancelLinkSuccess, new Object[]{PhoneFormat.getInstance().format(Marker.ANY_NON_NULL_MARKER + LoginActivitySmsView.this.phone)}));
                                    return;
                                }
                                LoginActivitySmsView.this.lastError = error.text;
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C56601());
