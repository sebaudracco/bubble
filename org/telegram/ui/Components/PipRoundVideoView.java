...
public class PipRoundVideoView implements NotificationCenterDelegate {
    ...
    class C62243 extends ViewOutlineProvider {
        C62243() {
        }
    ...
    class C62265 extends AnimatorListenerAdapter {
        C62265() {
        }
    ...
    class C62287 extends AnimatorListenerAdapter {
        C62287() {
        }
                    ...
                    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
                        ...
                        if (child == PipRoundVideoView.this.textureView) {
                            ...
                            if (currentMessageObject != null) {
                                ...
                                canvas.drawArc(PipRoundVideoView.this.rect, RadialCountdown.START_ANGLE, currentMessageObject.audioProgress * 360.0f, false, Theme.chat_radialProgressPaint);
                            }
                        }
                        return result;
                    }
                };
                this.aspectRatioFrameLayout.setOutlineProvider(new C62243());
    ...
    public void showTemporary(boolean show) {
        ...
        this.hideShowAnimation.addListener(new C62265());
    ...
    private void animateToBoundsMaybe() {
        ...
        if (animators != null) {
            ...
            if (slideOut) {
                ...
                animatorSet.addListener(new C62287());
            }
