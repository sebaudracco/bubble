...
public class PickerBottomLayoutViewer extends FrameLayout {
    ...
    public PickerBottomLayoutViewer(Context context, boolean darkTheme) {
        ...
        this.cancelButton.setPadding(AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP), 0, AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP), 0);
        ...
        this.doneButton.setPadding(AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP), 0, AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP), 0);
