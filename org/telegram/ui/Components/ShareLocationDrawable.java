    ...
    public void draw(Canvas canvas) {
        ...
        for (int a = 0; a < 2; a++) {
            if (this.progress[a] >= 0.0f) {
                ...
                int h = AndroidUtilities.dp((this.isSmall ? 6.5f : RadialCountdown.TEXT_SIZE_SP) * scale);
                int tx = AndroidUtilities.dp((this.isSmall ? 6.0f : CtaButton.TEXT_SIZE_SP) * this.progress[a]);
