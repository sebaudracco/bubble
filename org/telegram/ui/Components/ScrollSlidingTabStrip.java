...
public class ScrollSlidingTabStrip extends HorizontalScrollView {
    ...
    public TextView addIconTabWithCounter(Drawable drawable) {
        ...
        textView.setMinWidth(AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP));
        textView.setPadding(AndroidUtilities.dp(5.0f), 0, AndroidUtilities.dp(5.0f), AndroidUtilities.dp(1.0f));
        tab.addView(textView, LayoutHelper.createFrame(-2, RadialCountdown.TEXT_SIZE_SP, 51, 26.0f, 6.0f, 0.0f, 0.0f));
        return textView;
    }
    ...
    public void addStickerTab(TLRPC$Chat chat) {
        ...
        imageView.setRoundRadius(AndroidUtilities.dp(CtaButton.TEXT_SIZE_SP));
        TLObject photo = null;
