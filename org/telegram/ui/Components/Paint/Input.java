...
public class Input {
    ...
    public void process(MotionEvent event) {
        ...
        Point location = new Point((double) this.tempPoint[0], (double) this.tempPoint[1], MoPubAdapter.DEFAULT_MOPUB_IMAGE_SCALE);
        switch (action) {
            case 0:
            case 2:
    ...
    private Point smoothPoint(Point midPoint1, Point midPoint2, Point prev1, float t) {
        ...
        return new Point(((midPoint1.f12660x * a1) + (prev1.f12660x * a2)) + (midPoint2.f12660x * a3), ((midPoint1.f12661y * a1) + (prev1.f12661y * a2)) + (midPoint2.f12661y * a3), MoPubAdapter.DEFAULT_MOPUB_IMAGE_SCALE);
    }
    ...
    private void paintPath(final Path path) {
        ...
        this.renderView.getPainting().paintStroke(path, this.clearBuffer, new Runnable() {
            ...
            public void run() {
                AndroidUtilities.runOnUIThread(new C61421());
            }
        });
    }
}
