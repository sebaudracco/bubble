...
public class PhotoFace {
    ...
    public PhotoFace(Face face, Bitmap sourceBitmap, Size targetSize, boolean sideward) {
        ...
        if (!(leftEyePoint == null || rightEyePoint == null)) {
            this.eyesCenterPoint = new Point((0.5f * leftEyePoint.f12664x) + (0.5f * rightEyePoint.f12664x), (0.5f * leftEyePoint.f12665y) + (0.5f * rightEyePoint.f12665y));
            this.eyesDistance = (float) Math.hypot((double) (rightEyePoint.f12664x - leftEyePoint.f12664x), (double) (rightEyePoint.f12665y - leftEyePoint.f12665y));
            this.angle = (float) Math.toDegrees(3.141592653589793d + Math.atan2((double) (rightEyePoint.f12665y - leftEyePoint.f12665y), (double) (rightEyePoint.f12664x - leftEyePoint.f12664x)));
            ...
            this.foreheadPoint = new Point(this.eyesCenterPoint.f12664x + (((float) Math.cos((double) upAngle)) * foreheadHeight), this.eyesCenterPoint.f12665y + (((float) Math.sin((double) upAngle)) * foreheadHeight));
        }
        if (leftMouthPoint != null && rightMouthPoint != null) {
            this.mouthPoint = new Point((0.5f * leftMouthPoint.f12664x) + (0.5f * rightMouthPoint.f12664x), (0.5f * leftMouthPoint.f12665y) + (0.5f * rightMouthPoint.f12665y));
            float chinDepth = 0.7f * this.eyesDistance;
            float downAngle = (float) Math.toRadians((double) (this.angle + 90.0f));
            this.chinPoint = new Point(this.mouthPoint.f12664x + (((float) Math.cos((double) downAngle)) * chinDepth), this.mouthPoint.f12665y + (((float) Math.sin((double) downAngle)) * chinDepth));
        }
    }
