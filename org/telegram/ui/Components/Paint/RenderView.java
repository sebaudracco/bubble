...
public class RenderView extends TextureView {
    ...
    class C61521 implements SurfaceTextureListener {

        class C61501 implements Runnable {
            C61501() {
            }
        ...
        class C61512 implements Runnable {
            C61512() {
            }
        ...
        public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int width, int height) {
            if (RenderView.this.internal != null) {
                ...
                RenderView.this.updateTransform();
                RenderView.this.internal.requestRender();
                RenderView.this.internal.postRunnable(new C61501());
            }
        }

        public boolean onSurfaceTextureDestroyed(SurfaceTexture surface) {
            if (!(RenderView.this.internal == null || RenderView.this.shuttingDown)) {
                RenderView.this.painting.onPause(new C61512());
            }
            return true;
        }
    ...
    class C61532 implements PaintingDelegate {
        C61532() {
        }
    ...
    class C61543 implements Runnable {
        C61543() {
        }
    ...
    private class CanvasInternal extends DispatchQueue {
        ...
        private Runnable drawRunnable = new C61571();
        private EGL10 egl10;
        ...
        class C61571 implements Runnable {
            ...
            public void run() {
                if (CanvasInternal.this.initialized && !RenderView.this.shuttingDown) {
                    ...
                    if (!CanvasInternal.this.ready) {
                        RenderView.this.queue.postRunnable(new C61561(), 200);
                    }
                }
            }
        }

        class C61582 implements Runnable {
            C61582() {
            }
        ...
        class C61593 implements Runnable {
            C61593() {
            }
        ...
        class C61604 implements Runnable {
            C61604() {
            }
        ...
        public void scheduleRedraw() {
            ...
            this.scheduledRunnable = new C61593();
    ...
    public RenderView(Context context, Painting paint, Bitmap b, int rotation) {
        ...
        setSurfaceTextureListener(new C61521());
        this.painting.setDelegate(new C61532());
    }
