...
public class ColorPicker extends FrameLayout {
    ...
    class C61642 implements OnClickListener {
        C61642() {
        }
    ...
    public ColorPicker(Context context) {
        ...
        this.settingsButton.setOnClickListener(new C61631());
        ...
        this.undoButton.setOnClickListener(new C61642());
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (!this.interacting && y < ((float) (-AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT)))) {
            return false;
        }
        ...
        if (action == 3 || action == 1 || action == 6) {
            ...
            if (y < ((float) (-AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT)))) {
                this.changingWeight = true;
                setWeight(Math.max(0.0f, Math.min(1.0f, ((-y) - ((float) AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT))) / ((float) AndroidUtilities.dp(190.0f)))));
            }
            if (this.delegate != null) {
