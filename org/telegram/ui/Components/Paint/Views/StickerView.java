...
public class StickerView extends EntityView {
    ...
    public class StickerViewSelectionView extends SelectionView {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            float inset = (radius + ((float) AndroidUtilities.dp(1.0f))) + ((float) AndroidUtilities.dp(CtaButton.TEXT_SIZE_SP));
        ...
        for (int a = 0; a < sticker.attributes.size(); a++) {
            ...
            if (attribute instanceof TLRPC$TL_documentAttributeSticker) {
                if (attribute.mask_coords != null) {
                    this.anchor = attribute.mask_coords.f12641n;
                }
    ...
    protected void updatePosition() {
        ...
        setX(this.position.f12664x - (this.baseSize.width / 2.0f));
    ...
    protected Rect getSelectionBounds() {
        ...
        return new Rect((this.position.f12664x - (side / 2.0f)) * scale, (this.position.f12665y - (side / 2.0f)) * scale, side * scale, side * scale);
    }
