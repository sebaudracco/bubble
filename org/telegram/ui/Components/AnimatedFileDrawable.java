...
public class AnimatedFileDrawable extends BitmapDrawable implements Animatable {
    ...
    private Runnable loadFrameRunnable = new C59953();
    private Runnable loadFrameTask;
    protected final Runnable mInvalidateTask = new C59931();
    private final Runnable mStartTask = new C59964();
    ...
    private Runnable uiRunnable = new C59942();

    class C59931 implements Runnable {
        C59931() {
        }
    ...
    class C59942 implements Runnable {
        C59942() {
        }
    ...
    class C59953 implements Runnable {
        C59953() {
        }
    ...
    class C59964 implements Runnable {
        C59964() {
        }
