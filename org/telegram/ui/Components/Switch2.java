...
public class Switch2 extends View {
    ...
    protected void onDraw(Canvas canvas) {
        if (getVisibility() == 0) {
            ...
            int thumb = AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP);
            ...
            canvas.drawCircle((float) tx, (float) ty, (float) AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), this.paint);
