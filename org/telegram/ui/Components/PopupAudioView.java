...
public class PopupAudioView extends BaseCell implements SeekBarDelegate, MediaController$FileDownloadProgressListener {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        if (this.currentMessageObject != null) {
            ...
            this.buttonY = AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
            updateProgress();
        ...
        if (this.currentMessageObject != null) {
            if (this.wasLayout) {
                ...
                if (this.currentMessageObject != null) {
                    ...
                    canvas.save();
                    canvas.translate((float) this.timeX, (float) AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP));
