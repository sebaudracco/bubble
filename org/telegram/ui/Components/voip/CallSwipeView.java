...
public class CallSwipeView extends View {
    ...
    class C63351 extends AnimatorListenerAdapter {
        private Runnable restarter = new C63341();
        private long startTime;

        class C63341 implements Runnable {
            C63341() {
            }
    ...
    private void init() {
        ...
        this.arrowAnim.addListener(new C63351());
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.save();
        if (this.dragFromRight) {
            canvas.translate((float) ((getWidth() - getHeight()) - AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP)), (float) (getHeight() / 2));
        } else {
