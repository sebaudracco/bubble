...
public class VideoTimelinePlayView extends View {
    ...
    class C63151 extends AsyncTask<Integer, Integer, Bitmap> {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int endX = ((int) (((float) width) * this.progressRight)) + AndroidUtilities.dp(16.0f);
        canvas.save();
        canvas.clipRect(AndroidUtilities.dp(16.0f), AndroidUtilities.dp(4.0f), AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP) + width, AndroidUtilities.dp(48.0f));
        ...
        this.drawableLeft.setBounds(startX - AndroidUtilities.dp(8.0f), AndroidUtilities.dp(4.0f) + ((AndroidUtilities.dp(44.0f) - AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP)) / 2), AndroidUtilities.dp(2.0f) + startX, ((AndroidUtilities.dp(44.0f) - AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP)) / 2) + AndroidUtilities.dp(22.0f));
        ...
        canvas.drawRoundRect(this.rect3, (float) AndroidUtilities.dp(2.0f), (float) AndroidUtilities.dp(2.0f), this.paint);
        this.drawableRight.setBounds(AndroidUtilities.dp(2.0f) + endX, AndroidUtilities.dp(4.0f) + ((AndroidUtilities.dp(44.0f) - AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP)) / 2), AndroidUtilities.dp(12.0f) + endX, ((AndroidUtilities.dp(44.0f) - AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP)) / 2) + AndroidUtilities.dp(22.0f));
        this.drawableRight.draw(canvas);
        float cx = ((float) AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP)) + (((float) width) * (this.progressLeft + ((this.progressRight - this.progressLeft) * this.playProgress)));
