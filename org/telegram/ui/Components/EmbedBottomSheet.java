...
public class EmbedBottomSheet extends BottomSheet {
    ...
    class C60681 implements OnShowListener {

        class C60661 implements OnPreDrawListener {
            C60661() {
            }
        ...
        public void onShow(DialogInterface dialog) {
            if (EmbedBottomSheet.this.pipVideoView != null && EmbedBottomSheet.this.videoView.isInline()) {
                EmbedBottomSheet.this.videoView.getViewTreeObserver().addOnPreDrawListener(new C60661());
            }
        }
    }

    class C60692 implements OnTouchListener {
        C60692() {
        }
    ...
    class C60714 implements OnTouchListener {
        C60714() {
        }
    ...
    class C60736 extends WebChromeClient {
        C60736() {
        }
    ...
    class C60747 extends WebViewClient {
        C60747() {
        }
    ...
    class C60758 implements OnClickListener {
        C60758() {
        }
    ...
    class C60789 implements WebPlayerViewDelegate {

        class C60772 extends AnimatorListenerAdapter {
            C60772() {
            }
        ...
        public void prepareToSwitchInlineMode(boolean inline, Runnable switchInlineModeRunnable, float aspectRatio, boolean animated) {
            if (inline) {
                ...
                if (EmbedBottomSheet.this.fullscreenVideoContainer.getVisibility() == 0) {
                    EmbedBottomSheet.this.containerView.setTranslationY((float) (EmbedBottomSheet.this.containerView.getMeasuredHeight() + AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT)));
                ...
                if (animated) {
                    ...
                    if (VERSION.SDK_INT >= 21) {
                        rect.f12667y += (float) AndroidUtilities.statusBarHeight;
                    }
                    ...
                    r9[2] = ObjectAnimator.ofFloat(textureImageView, "translationX", new float[]{rect.f12666x});
                    r9[3] = ObjectAnimator.ofFloat(textureImageView, "translationY", new float[]{rect.f12667y});
                    ...
                    r9[6] = ObjectAnimator.ofFloat(textureView, "translationX", new float[]{rect.f12666x});
                    r9[7] = ObjectAnimator.ofFloat(textureView, "translationY", new float[]{rect.f12667y});
                    r9[8] = ObjectAnimator.ofFloat(EmbedBottomSheet.this.containerView, "translationY", new float[]{(float) (EmbedBottomSheet.this.containerView.getMeasuredHeight() + AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT))});
            ...
            if (animated) {
                ...
                textureImageView.setTranslationX(rect.f12666x);
                textureImageView.setTranslationY(rect.f12667y);
                textureView.setScaleX(scale);
                textureView.setScaleY(scale);
                textureView.setTranslationX(rect.f12666x);
                textureView.setTranslationY(rect.f12667y);
            } else {
        ...
        public TextureView onSwitchInlineMode(View controlsView, boolean inline, float aspectRatio, int rotation, boolean animated) {
            ...
            if (animated) {
                ...
                animatorSet.setInterpolator(new DecelerateInterpolator());
                animatorSet.setDuration(250);
                animatorSet.addListener(new C60772());
                animatorSet.start();
            } else {
    ...
    private EmbedBottomSheet(Context context, String title, String description, String originalUrl, String url, int w, int h) {
        ...
        this.onShowListener = new C60681();
        this.fullWidth = true;
        ...
        this.fullscreenVideoContainer.setOnTouchListener(new C60692());
        ...
        this.containerLayout.setOnTouchListener(new C60714());
        ...
        this.webView.setWebChromeClient(new C60736());
        this.webView.setWebViewClient(new C60747());
        ...
        this.youtubeLogoImage.setOnClickListener(new C60758());
        this.videoView = new WebPlayerView(context, true, false, new C60789());
        ...
        if (this.hasDescription) {
            ...
            textView.setPadding(AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), 0, AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), 0);
        ...
        textView.setPadding(AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), 0, AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), 0);
        textView.setText(LocaleController.getString(HTTP.CONN_CLOSE, R.string.Close).toUpperCase());
        textView.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        ...
        this.pipButton.setOnClickListener(new OnClickListener() {
            ...
            class C60671 extends AnimatorListenerAdapter {
                C60671() {
                }
            ...
            public void onClick(View v) {
                if (EmbedBottomSheet.this.checkInlinePermissions() && EmbedBottomSheet.this.progressBar.getVisibility() != 0) {
                    ...
                    if (false) {
                        ...
                        animatorSet.setInterpolator(new DecelerateInterpolator());
                        animatorSet.setDuration(250);
                        animatorSet.addListener(new C60671());
                        animatorSet.start();
                    } else {
                        EmbedBottomSheet.this.containerView.setTranslationY(0.0f);
                    }
        ...
        OnClickListener copyClickListener = new OnClickListener() {
            public void onClick(View v) {
                try {
                    ((ClipboardManager) ApplicationLoader.applicationContext.getSystemService("clipboard")).setPrimaryClip(ClipData.newPlainText(PlusShare.KEY_CALL_TO_ACTION_LABEL, EmbedBottomSheet.this.openUrl));
                } catch (Exception e) {
                    FileLog.e(e);
                }
        ...
        this.copyTextButton.setPadding(AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), 0, AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), 0);
        ...
        this.openInButton.setPadding(AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), 0, AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), 0);
                    ...
                    if (EmbedBottomSheet.this.videoView.getYoutubeId() != null) {
                        ...
                        if (EmbedBottomSheet.this.openUrl != null) {
                            try {
                                ...
                                if (t != null) {
                                    if (t.contains(RequestParams.f9036M)) {
                                        String[] arg = t.split(RequestParams.f9036M);
                        ...
                        EmbedBottomSheet.this.webView.loadDataWithBaseURL("https://www.youtube.com", String.format("<!DOCTYPE html><html><head><style>body { margin: 0; width:100%%; height:100%%;  background-color:#000; }html { width:100%%; height:100%%; background-color:#000; }.embed-container iframe,.embed-container object,   .embed-container embed {       position: absolute;       top: 0;       left: 0;       width: 100%% !important;       height: 100%% !important;   }   </style></head><body>   <div class=\"embed-container\">       <div id=\"player\"></div>   </div>   <script src=\"https://www.youtube.com/iframe_api\"></script>   <script>   var player;   var observer;   var videoEl;   var playing;   var posted = false;   YT.ready(function() {       player = new YT.Player(\"player\", {                              \"width\" : \"100%%\",                              \"events\" : {                              \"onReady\" : \"onReady\",                              \"onError\" : \"onError\",                              },                              \"videoId\" : \"%1$s\",                              \"height\" : \"100%%\",                              \"playerVars\" : {                              \"start\" : %2$d,                              \"rel\" : 0,                              \"showinfo\" : 0,                              \"modestbranding\" : 1,                              \"iv_load_policy\" : 3,                              \"autohide\" : 1,                              \"autoplay\" : 1,                              \"cc_load_policy\" : 1,                              \"playsinline\" : 1,                              \"controls\" : 1                              }                            });        player.setSize(window.innerWidth, window.innerHeight);    });    function hideControls() {        playing = !videoEl.paused;       videoEl.controls = 0;       observer.observe(videoEl, {attributes: true});    }    function showControls() {        playing = !videoEl.paused;       observer.disconnect();       videoEl.controls = 1;    }    function onError(event) {       if (!posted) {            if (window.YoutubeProxy !== undefined) {                   YoutubeProxy.postEvent(\"loaded\", null);             }            posted = true;       }    }    function onReady(event) {       player.playVideo();       videoEl = player.getIframe().contentDocument.getElementsByTagName('video')[0];\n       videoEl.addEventListener(\"canplay\", function() {            if (playing) {               videoEl.play();            }       }, true);       videoEl.addEventListener(\"timeupdate\", function() {            if (!posted && videoEl.currentTime > 0) {               if (window.YoutubeProxy !== undefined) {                   YoutubeProxy.postEvent(\"loaded\", null);                }               posted = true;           }       }, true);       observer = new MutationObserver(function() {\n          if (videoEl.controls) {\n               videoEl.controls = 0;\n          }       });\n    }    window.onresize = function() {        player.setSize(window.innerWidth, window.innerHeight);    }    </script></body></html>", new Object[]{currentYoutubeId, Integer.valueOf(seekToTime)}), AudienceNetworkActivity.WEBVIEW_MIME_TYPE, "UTF-8", "http://youtube.com");
                        return;
                    }
                    EmbedBottomSheet.this.webView.loadUrl(EmbedBottomSheet.this.embedUrl, args);
                } catch (Exception e2) {
        ...
        this.orientationEventListener = new OrientationEventListener(ApplicationLoader.applicationContext) {
            public void onOrientationChanged(int orientation) {
                ...
                if (orientation >= 240 && orientation <= HttpStatus.SC_MULTIPLE_CHOICES) {
    ...
    private void runJsCode(String code) {
        ...
        try {
            this.webView.loadUrl(BridgeUtil.JAVASCRIPT_STR + code);
        } catch (Exception e) {
            FileLog.e(e);
        }
    }
    ...
    public boolean checkInlinePermissions() {
        ...
        if (VERSION.SDK_INT < 23 || android.provider.Settings.canDrawOverlays(this.parentActivity)) {
            return true;
        }
        new Builder(this.parentActivity).setTitle(ApplicationLoader.getConfig().getAppName()).setMessage(LocaleController.getAppNameString("PermissionDrawAboveOtherApps", R.string.PermissionDrawAboveOtherApps)).setPositiveButton(LocaleController.getString("PermissionOpenSettings", R.string.PermissionOpenSettings), new DialogInterface.OnClickListener() {
            @TargetApi(23)
    ...
    protected boolean onCustomMeasure(View view, int width, int height) {
        if (view == this.videoView.getControlsView()) {
            ...
            layoutParams.height = (this.videoView.isInFullscreen() ? 0 : AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT)) + this.videoView.getAspectRatioView().getMeasuredHeight();
        }
        return false;
    }
