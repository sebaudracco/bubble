...
public class CropRotationWheel extends FrameLayout {
    ...
    class C60561 implements OnClickListener {
        C60561() {
        }
    ...
    class C60572 implements OnClickListener {
        C60572() {
        }
    ...
    public CropRotationWheel(Context context) {
        ...
        this.aspectRatioButton.setOnClickListener(new C60561());
        ...
        this.rotation90Button.setOnClickListener(new C60572());
