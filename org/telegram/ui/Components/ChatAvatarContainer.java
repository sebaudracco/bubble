...
public class ChatAvatarContainer extends FrameLayout implements NotificationCenterDelegate {
    ...
    class C60491 implements OnClickListener {
        C60491() {
        }
    ...
    class C60502 implements OnClickListener {
        C60502() {
        }
    ...
    public ChatAvatarContainer(Context context, ChatActivity chatActivity, boolean needTime) {
        ...
        if (needTime) {
            ...
            this.timeItem.setPadding(AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), AndroidUtilities.dp(5.0f), AndroidUtilities.dp(5.0f));
            ...
            this.timeItem.setOnClickListener(new C60491());
        }
        if (this.parentFragment != null) {
            setOnClickListener(new C60502());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.subtitleTextView.measure(MeasureSpec.makeMeasureSpec(availableWidth, Integer.MIN_VALUE), MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP), Integer.MIN_VALUE));
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (this.timeItem != null) {
            this.timeItem.layout(AndroidUtilities.dp(24.0f), AndroidUtilities.dp(CtaButton.TEXT_SIZE_SP) + viewTop, AndroidUtilities.dp(58.0f), AndroidUtilities.dp(49.0f) + viewTop);
        }
