...
public class VideoTimelineView extends View {
    ...
    class C63161 extends AsyncTask<Integer, Integer, Bitmap> {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int endX = ((int) (((float) width) * this.progressRight)) + AndroidUtilities.dp(16.0f);
        canvas.save();
        canvas.clipRect(AndroidUtilities.dp(16.0f), 0, AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP) + width, getMeasuredHeight());
