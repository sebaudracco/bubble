...
public class PasscodeView extends FrameLayout {
    ...
    class C61671 implements OnEditorActionListener {
        C61671() {
        }
    ...
    class C61682 implements TextWatcher {
        C61682() {
        }
    ...
    class C61693 implements Callback {
        C61693() {
        }
    ...
    class C61704 implements OnClickListener {
        C61704() {
        }
    ...
    class C61715 implements OnLongClickListener {
        C61715() {
        }
    ...
    class C61726 implements OnClickListener {
        C61726() {
        }
        ...
        public void onClick(View v) {
            switch (((Integer) v.getTag()).intValue()) {
                case 0:
                    PasscodeView.this.passwordEditText2.appendCharacter(SchemaSymbols.ATTVAL_FALSE_0);
                    break;
                case 1:
                    PasscodeView.this.passwordEditText2.appendCharacter(SchemaSymbols.ATTVAL_TRUE_1);
                    break;
                case 2:
    ...
    class C61737 extends AnimatorListenerAdapter {
        C61737() {
        }
    ...
    class C61759 implements Runnable {
        C61759() {
        }
    ...
    private class AnimatingTextView extends FrameLayout {
        ...
        class C61782 extends AnimatorListenerAdapter {
            C61782() {
            }
        ...
        class C61793 extends AnimatorListenerAdapter {
            C61793() {
            }
        ...
        class C61804 extends AnimatorListenerAdapter {
            C61804() {
            }
        ...
        private int getXForTextView(int pos) {
            return (((getMeasuredWidth() - (this.stringBuilder.length() * AndroidUtilities.dp(BitmapDescriptorFactory.HUE_ORANGE))) / 2) + (AndroidUtilities.dp(BitmapDescriptorFactory.HUE_ORANGE) * pos)) - AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
        }
        ...
        public void appendCharacter(String c) {
            if (this.stringBuilder.length() != 4) {
                ...
                animators.add(ObjectAnimator.ofFloat(textView, "translationY", new float[]{(float) AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP), 0.0f}));
                ...
                this.dotRunnable = new Runnable() {
                    ...
                    class C61761 extends AnimatorListenerAdapter {
                        C61761() {
                        }
                    ...
                    public void run() {
                        if (AnimatingTextView.this.dotRunnable == this) {
                            ...
                            AnimatingTextView.this.currentAnimation.addListener(new C61761());
                ...
                this.currentAnimation.addListener(new C61782());
        ...
        public void eraseLastCharacter() {
            if (this.stringBuilder.length() != 0) {
                ...
                this.currentAnimation.setDuration(150);
                this.currentAnimation.playTogether(animators);
                this.currentAnimation.addListener(new C61793());
                this.currentAnimation.start();
            }
        }
        ...
        private void eraseAllCharacters(boolean animated) {
            if (this.stringBuilder.length() != 0) {
                ...
                if (animated) {
                    ...
                    this.currentAnimation.setDuration(150);
                    this.currentAnimation.playTogether(animators);
                    this.currentAnimation.addListener(new C61804());
                    this.currentAnimation.start();
                    return;
                }
                for (a = 0; a < 4; a++) {
    ...
    public PasscodeView(Context context) {
        ...
        this.passwordEditText.setOnEditorActionListener(new C61671());
        this.passwordEditText.addTextChangedListener(new C61682());
        this.passwordEditText.setCustomSelectionActionModeCallback(new C61693());
        ...
        layoutParams.rightMargin = AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT);
        layoutParams.gravity = 85;
        this.checkImage.setLayoutParams(layoutParams);
        this.checkImage.setOnClickListener(new C61704());
        ...
        layoutParams.leftMargin = AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP);
        layoutParams.rightMargin = AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP);
        ...
        for (a = 0; a < 10; a++) {
            ...
            layoutParams = (LayoutParams) textView.getLayoutParams();
            layoutParams.width = AndroidUtilities.dp(50.0f);
            layoutParams.height = AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP);
            layoutParams.gravity = 51;
            textView.setLayoutParams(layoutParams);
            switch (a) {
                case 0:
        ...
        for (a = 0; a < 11; a++) {
            ...
            if (a == 10) {
                frameLayout.setOnLongClickListener(new C61715());
            }
            frameLayout.setOnClickListener(new C61726());
    ...
    private void processDone(boolean fingerprint) {
        ...
        r2 = new Animator[2];
        r2[0] = ObjectAnimator.ofFloat(this, "translationY", new float[]{(float) AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP)});
        r2[1] = ObjectAnimator.ofFloat(this, "alpha", new float[]{(float) AndroidUtilities.dp(0.0f)});
        AnimatorSet.playTogether(r2);
        AnimatorSet.addListener(new C61737());
        AnimatorSet.start();
    ...
    public void onResume() {
        if (UserConfig.passcodeType == 1) {
            ...
            AndroidUtilities.runOnUIThread(new C61759(), 200);
        }
        checkFingerprint();
    }
