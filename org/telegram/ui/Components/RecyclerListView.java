...
public class RecyclerListView extends RecyclerView {
    ...
    private AdapterDataObserver observer = new C62361();
    ...
    class C62372 extends OnScrollListener {
    ...
    private class FastScroll extends View {
        ...
        public FastScroll(Context context) {
            ...
            this.scrollX = LocaleController.isRTL ? AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT) : AndroidUtilities.dp(117.0f);
            updateColors();
        }
                        ...
                        if (newLetter == null) {
                            ...
                            if (this.letterLayout.getLineCount() > 0) {
                                ...
                                if (LocaleController.isRTL) {
                                    this.textX = (((float) AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT)) + ((((float) AndroidUtilities.dp(88.0f)) - this.letterLayout.getLineWidth(0)) / 2.0f)) - this.letterLayout.getLineLeft(0);
                                } else {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (this.pressed || this.bubbleProgress != 0.0f) {
                ...
                canvas.translate((float) AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), (float) y);
                ...
                if ((LocaleController.isRTL && !(this.radii[0] == raduisTop && this.radii[6] == raduisBottom)) || !(LocaleController.isRTL || (this.radii[2] == raduisTop && this.radii[4] == raduisBottom))) {
                    ...
                    this.path.reset();
                    this.rect.set(LocaleController.isRTL ? (float) AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT) : 0.0f, 0.0f, (float) AndroidUtilities.dp(LocaleController.isRTL ? 98.0f : 88.0f), (float) AndroidUtilities.dp(88.0f));
    ...
    private class RecyclerListViewItemClickListener implements OnItemTouchListener {
        ...
        class C62402 implements Runnable {
            C62402() {
            }
        ...
        public boolean onInterceptTouchEvent(RecyclerView view, MotionEvent event) {
            ...
            if (action == 0 || action == 5) {
                if (!(RecyclerListView.this.interceptedByChild || RecyclerListView.this.currentChildView == null)) {
                    RecyclerListView.this.selectChildRunnable = new C62402();
    ...
    public RecyclerListView(Context context) {
        ...
        super.setOnScrollListener(new C62372());
