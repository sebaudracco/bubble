...
public class RoundVideoPlayingDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        int y = getBounds().top;
        for (int a = 0; a < 3; a++) {
            canvas.drawRect((float) (AndroidUtilities.dp(2.0f) + x), (float) (AndroidUtilities.dp((this.progress1 * 7.0f) + 2.0f) + y), (float) (AndroidUtilities.dp(4.0f) + x), (float) (AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT) + y), this.paint);
            canvas.drawRect((float) (AndroidUtilities.dp(5.0f) + x), (float) (AndroidUtilities.dp((this.progress2 * 7.0f) + 2.0f) + y), (float) (AndroidUtilities.dp(7.0f) + x), (float) (AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT) + y), this.paint);
            canvas.drawRect((float) (AndroidUtilities.dp(8.0f) + x), (float) (AndroidUtilities.dp((this.progress3 * 7.0f) + 2.0f) + y), (float) (AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT) + x), (float) (AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT) + y), this.paint);
        }
        if (this.started) {
            update();
        }
