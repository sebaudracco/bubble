...
public class SharingLocationsAlert extends BottomSheet implements NotificationCenterDelegate {
    ...
    class C62613 extends OnScrollListener {
        C62613() {
        }
    ...
    class C62624 implements OnItemClickListener {
        C62624() {
        }
    ...
    class C62635 implements OnClickListener {
        C62635() {
        }
    ...
    class C62646 implements OnClickListener {
        C62646() {
        }
    ...
    public SharingLocationsAlert(Context context, SharingLocationsAlertDelegate sharingLocationsAlertDelegate) {
        ...
        this.listView.setOnScrollListener(new C62613());
        this.listView.setOnItemClickListener(new C62624());
        ...
        pickerBottomLayout.cancelButton.setPadding(AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), 0, AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), 0);
        ...
        pickerBottomLayout.cancelButton.setOnClickListener(new C62635());
        pickerBottomLayout.doneButtonTextView.setTextColor(Theme.getColor(Theme.key_dialogTextBlue2));
        pickerBottomLayout.doneButtonTextView.setText(LocaleController.getString(HTTP.CONN_CLOSE, R.string.Close).toUpperCase());
        pickerBottomLayout.doneButton.setPadding(AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), 0, AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), 0);
        pickerBottomLayout.doneButton.setOnClickListener(new C62646());
