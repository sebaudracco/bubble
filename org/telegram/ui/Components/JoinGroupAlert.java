...
public class JoinGroupAlert extends BottomSheet {
    ...
    class C61331 implements OnClickListener {
        C61331() {
        }
    ...
    class C61362 implements OnClickListener {
        C61362() {
        }
    ...
    public JoinGroupAlert(Context context, TLRPC$ChatInvite invite, String group, BaseFragment parentFragment) {
        ...
        pickerBottomLayout.cancelButton.setOnClickListener(new C61331());
        ...
        pickerBottomLayout.doneButton.setOnClickListener(new C61362());
    }
}
