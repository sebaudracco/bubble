...
public class CheckBox extends View {
    ...
    class C60511 extends AnimatorListenerAdapter {
        C60511() {
        }
    ...
    public CheckBox(Context context, int resId) {
        ...
        if (paint == null) {
            ...
            textPaint.setTextSize((float) AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP));
    ...
    private void animateToCheckedState(boolean newCheckedState) {
        ...
        this.checkAnimator.addListener(new C60511());
