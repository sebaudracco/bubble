...
public class PhotoCropView extends FrameLayout {
    ...
    class C61811 implements CropViewListener {
        C61811() {
        }
    ...
    class C61822 implements RotationWheelListener {
        C61822() {
        }
    ...
    class C61833 implements Runnable {
        C61833() {
        }
    ...
    public void setBitmap(Bitmap bitmap, int rotation, boolean freeform) {
        ...
        if (this.cropView == null) {
            ...
            this.cropView.setListener(new C61811());
            ...
            this.wheelView.setListener(new C61822());
    ...
    public void startAnimationRunnable() {
        if (this.animationRunnable == null) {
            this.animationRunnable = new C61833();
