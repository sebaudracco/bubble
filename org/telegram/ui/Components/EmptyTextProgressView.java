...
public class EmptyTextProgressView extends FrameLayout {
    ...
    class C61011 implements OnTouchListener {
        C61011() {
        }
    ...
    public EmptyTextProgressView(Context context) {
        ...
        this.textView.setTextSize(1, CloseButton.TEXT_SIZE_SP);
        this.textView.setTextColor(Theme.getColor(Theme.key_emptyListPlaceholder));
        this.textView.setGravity(17);
        this.textView.setVisibility(4);
        this.textView.setPadding(AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP), 0, AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP), 0);
