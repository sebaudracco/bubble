...
public class StickersAlert extends BottomSheet implements NotificationCenterDelegate {
    ...
    class C62852 implements RequestDelegate {
        C62852() {
        }
    ...
    class C62885 extends SpanSizeLookup {
        C62885() {
        }
    ...
    class C62896 extends ItemDecoration {
        C62896() {
        }
    ...
    class C62907 implements OnTouchListener {
        C62907() {
        }
    ...
    class C62918 extends OnScrollListener {
        C62918() {
        }
    ...
    class C62929 implements OnItemClickListener {
        C62929() {
        }
    ...
    private void loadStickerSet() {
        if (this.inputStickerSet != null) {
            ...
            if (this.stickerSet == null) {
                ...
                ConnectionsManager.getInstance().sendRequest(req, new C62852());
    ...
    private void init(Context context) {
        ...
        this.containerView = new FrameLayout(context) {
            ...
            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                if (StickersAlert.this.gridView.getPaddingTop() != padding) {
                    ...
                    StickersAlert.this.gridView.setPadding(AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), padding, AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), 0);
        ...
        this.layoutManager.setSpanSizeLookup(new C62885());
        ...
        this.gridView.addItemDecoration(new C62896());
        this.gridView.setPadding(AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), 0, AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), 0);
        this.gridView.setClipToPadding(false);
        this.gridView.setEnabled(true);
        this.gridView.setGlowColor(Theme.getColor(Theme.key_dialogScrollGlow));
        this.gridView.setOnTouchListener(new C62907());
        this.gridView.setOnScrollListener(new C62918());
        this.stickersOnItemClickListener = new C62929();
        ...
        this.titleTextView.setTextSize(1, CloseButton.TEXT_SIZE_SP);
        ...
        this.titleTextView.setPadding(AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), 0, AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), 0);
        ...
        this.pickerBottomLayout.cancelButton.setPadding(AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), 0, AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), 0);
        this.pickerBottomLayout.cancelButton.setTextColor(Theme.getColor(Theme.key_dialogTextBlue2));
        this.pickerBottomLayout.cancelButton.setText(LocaleController.getString(HTTP.CONN_CLOSE, R.string.Close).toUpperCase());
        this.pickerBottomLayout.cancelButton.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                StickersAlert.this.dismiss();
            }
        });
        this.pickerBottomLayout.doneButton.setPadding(AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), 0, AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), 0);
    ...
    private void updateSendButton() {
        ...
        if (this.delegate == null || (this.stickerSet != null && this.stickerSet.set.masks)) {
            this.previewSendButton.setText(LocaleController.getString(HTTP.CONN_CLOSE, R.string.Close).toUpperCase());
            ...
            if (this.stickerSet != null) {
                ...
                if (this.stickerSet.set != null || !StickersQuery.isStickerPackInstalled(this.stickerSet.set.id)) {
                    OnClickListener anonymousClass18 = new OnClickListener() {
                        ...
                        class C62801 implements DialogInterface.OnClickListener {

                            class C62791 implements RewardedVideoListener {
                                ...
                                public void onVideoClosed() {
                                    if (this.isVideoFinished) {
                                        StickersAlert.this.addStickerSetAfterRewardedVideo();
                                    }
                                }
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                                AppsgeyserSDK.getFastTrackAdsController().showRewardedVideo(new C62791());
                            }
                        }

                        class C62812 implements DialogInterface.OnClickListener {
                            C62812() {
                            }
                        ...
                        public void onClick(View v) {
                            Builder builder = new Builder(StickersAlert.this.getContext());
                            builder.setMessage(StickersAlert.this.getContext().getString(R.string.RewardedVideoStickers));
                            builder.setPositiveButton(StickersAlert.this.getContext().getString(17039370), new C62801());
                            builder.setNegativeButton(StickersAlert.this.getContext().getString(17039360), new C62812());
                            builder.show();
                        }
                    };
    ...
    private void addStickerSetAfterRewardedVideo() {
        dismiss();
