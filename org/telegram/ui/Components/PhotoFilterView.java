...
public class PhotoFilterView extends FrameLayout {
    ...
    class C61861 implements SurfaceTextureListener {

        class C61851 implements Runnable {
            C61851() {
            }
        ...
        public void onSurfaceTextureSizeChanged(SurfaceTexture surface, int width, int height) {
            if (PhotoFilterView.this.eglThread != null) {
                PhotoFilterView.this.eglThread.setSurfaceTextureSize(width, height);
                PhotoFilterView.this.eglThread.requestRender(false, true);
                PhotoFilterView.this.eglThread.postRunnable(new C61851());
            }
        }
    ...
    class C61872 implements PhotoFilterLinearBlurControlDelegate {
        C61872() {
        }
    ...
    class C61883 implements PhotoFilterCurvesControlDelegate {
        C61883() {
        }
    ...
    class C61894 implements OnClickListener {
        C61894() {
        }
    ...
    class C61905 implements OnClickListener {
        C61905() {
        }
    ...
    class C61916 implements OnClickListener {
        C61916() {
        }
    ...
    class C61927 implements OnClickListener {
        C61927() {
        }
    ...
    class C61938 implements OnClickListener {
        C61938() {
        }
    ...
    class C61949 implements OnClickListener {
        C61949() {
        }
    ...
    public static class CurvesValue {
        ...
        public boolean isDefault() {
            return ((double) Math.abs(this.blacksLevel - 0.0f)) < PathInterpolatorCompat.EPSILON && ((double) Math.abs(this.shadowsLevel - 25.0f)) < PathInterpolatorCompat.EPSILON && ((double) Math.abs(this.midtonesLevel - 50.0f)) < PathInterpolatorCompat.EPSILON && ((double) Math.abs(this.highlightsLevel - 75.0f)) < PathInterpolatorCompat.EPSILON && ((double) Math.abs(this.whitesLevel - 100.0f)) < PathInterpolatorCompat.EPSILON;
        }
    }
    ...
    public class EGLThread extends DispatchQueue {
        ...
        private Runnable drawRunnable = new C61951();
        private EGL10 egl10;
        ...
        class C61951 implements Runnable {
            C61951() {
            }
        ...
        class C61973 implements Runnable {
            C61973() {
            }
        ...
        private boolean drawBlurPass() {
            ...
            if (PhotoFilterView.this.blurType == 1) {
                ...
                GLES20.glUniform2f(this.radialBlurExcludePointHandle, PhotoFilterView.this.blurExcludePoint.f12664x, PhotoFilterView.this.blurExcludePoint.f12665y);
                ...
                GLES20.glUniform2f(this.linearBlurExcludePointHandle, PhotoFilterView.this.blurExcludePoint.f12664x, PhotoFilterView.this.blurExcludePoint.f12665y);
    ...
    public class ToolsAdapter extends SelectionAdapter {
        ...
        class C61991 implements PhotoEditorSeekBarDelegate {
            C61991() {
            }
        ...
        class C62002 implements OnClickListener {
            C62002() {
            }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                view = cell;
                cell.setSeekBarDelegate(new C61991());
            } else {
                view = new PhotoEditRadioCell(this.mContext);
                view.setOnClickListener(new C62002());
            }
    ...
    public PhotoFilterView(Context context, Bitmap bitmap, int rotation, MediaController$SavedFilterState state) {
        ...
        this.textureView.setSurfaceTextureListener(new C61861());
        ...
        this.blurControl.setDelegate(new C61872());
        this.curvesControl = new PhotoFilterCurvesControl(context, this.curvesToolValue);
        this.curvesControl.setDelegate(new C61883());
        ...
        this.tuneItem.setOnClickListener(new C61894());
        ...
        this.blurItem.setOnClickListener(new C61905());
        ...
        this.curveItem.setOnClickListener(new C61916());
        ...
        while (a < 4) {
            ...
            this.curveRadioButton[a].setSize(AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP));
            ...
            frameLayout1.setOnClickListener(new C61927());
            a++;
        }
        this.blurLayout = new FrameLayout(context);
        this.blurLayout.setVisibility(4);
        this.toolsView.addView(this.blurLayout, LayoutHelper.createFrame(PDUiBeacon.Radius, BitmapDescriptorFactory.HUE_YELLOW, 1, 0.0f, 40.0f, 0.0f, 0.0f));
        ...
        this.blurOffButton.setOnClickListener(new C61938());
        ...
        this.blurRadialButton.setOnClickListener(new C61949());
