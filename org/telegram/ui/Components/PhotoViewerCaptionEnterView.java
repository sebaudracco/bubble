...
public class PhotoViewerCaptionEnterView extends FrameLayout implements NotificationCenterDelegate, SizeNotifierFrameLayoutPhotoDelegate {
    ...
    class C62131 implements OnClickListener {
        C62131() {
        }
    ...
    class C62153 implements Callback {
        C62153() {
        }
    ...
    class C62164 implements Callback {
        C62164() {
        }
    ...
    class C62175 implements OnKeyListener {
        C62175() {
        }
    ...
    class C62186 implements OnClickListener {
        C62186() {
        }
    ...
    class C62197 implements TextWatcher {
        ...
        public void afterTextChanged(Editable editable) {
            if (!PhotoViewerCaptionEnterView.this.innerTextChange && this.processChange) {
                ...
                Emoji.replaceEmoji(editable, PhotoViewerCaptionEnterView.this.messageEditText.getPaint().getFontMetricsInt(), AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP), false);
                this.processChange = false;
            }
        }
    }

    class C62208 implements OnClickListener {
        C62208() {
        }
    ...
    class C62219 implements Listener {
        C62219() {
        }
        ...
        public void onEmojiSelected(String symbol) {
            if (PhotoViewerCaptionEnterView.this.messageEditText.length() + symbol.length() <= 200) {
                ...
                try {
                    ...
                    CharSequence localCharSequence = Emoji.replaceEmoji(symbol, PhotoViewerCaptionEnterView.this.messageEditText.getPaint().getFontMetricsInt(), AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP), false);
    ...
    public PhotoViewerCaptionEnterView(Context context, SizeNotifierFrameLayoutPhoto parent, View window) {
        ...
        this.emojiButton.setOnClickListener(new C62131());
        ...
        if (VERSION.SDK_INT >= 23 && this.windowView != null) {
            this.messageEditText.setCustomSelectionActionModeCallback(new C62153());
            this.messageEditText.setCustomInsertionActionModeCallback(new C62164());
        }
        ...
        this.messageEditText.setCursorSize(AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP));
        ...
        this.messageEditText.setOnKeyListener(new C62175());
        this.messageEditText.setOnClickListener(new C62186());
        this.messageEditText.addTextChangedListener(new C62197());
        ...
        doneButton.setOnClickListener(new C62208());
    }
    ...
    private void createEmojiView() {
        if (this.emojiView == null) {
            ...
            this.emojiView.setListener(new C62219());
