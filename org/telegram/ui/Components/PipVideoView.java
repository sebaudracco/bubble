...
public class PipVideoView {
    ...
    class C62302 extends AnimatorListenerAdapter {
        C62302() {
        }
    ...
    private class MiniControlsView extends FrameLayout {
        ...
        private Runnable hideRunnable = new C62311();
        private ImageView inlineButton;
        private boolean isVisible = true;

        class C62311 implements Runnable {
            C62311() {
            }
        ...
        class C62333 extends AnimatorListenerAdapter {
            C62333() {
            }
        ...
        class C62344 extends AnimatorListenerAdapter {
            C62344() {
            }
            ...
            if (this.isVisible != value) {
                ...
                if (this.isVisible) {
                    if (animated) {
                        ...
                        this.currentAnimation.addListener(new C62333());
                    ...
                    animatorSet.playTogether(animatorArr);
                    this.currentAnimation.setDuration(150);
                    this.currentAnimation.addListener(new C62344());
                    this.currentAnimation.start();
                } else {
                    setAlpha(0.0f);
                }
    ...
    private void animateToBoundsMaybe() {
        ...
        if (animators != null) {
            ...
            if (slideOut) {
                ...
                animatorSet.addListener(new C62302());
            }
