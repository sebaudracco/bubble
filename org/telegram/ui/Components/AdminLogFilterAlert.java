...
public class AdminLogFilterAlert extends BottomSheet {
    ...
    class C59803 extends OnScrollListener {
        C59803() {
        }
    ...
    class C59814 implements OnItemClickListener {
        C59814() {
        }
    ...
    class C59825 implements OnClickListener {
        C59825() {
        }
    ...
    public AdminLogFilterAlert(Context context, TLRPC$TL_channelAdminLogEventsFilter filter, HashMap<Integer, User> admins, boolean megagroup) {
        ...
        this.containerView = new FrameLayout(context) {
            ...
            protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
                ...
                if (AdminLogFilterAlert.this.currentAdmins != null) {
                    contentSize += ((AdminLogFilterAlert.this.currentAdmins.size() + 1) * AndroidUtilities.dp(48.0f)) + AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP);
                }
        ...
        this.listView.setOnScrollListener(new C59803());
        this.listView.setOnItemClickListener(new C59814());
        ...
        this.saveButton.setOnClickListener(new C59825());
