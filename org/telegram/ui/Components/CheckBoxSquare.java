...
public class CheckBoxSquare extends View {
    ...
    private Bitmap drawBitmap = Bitmap.createBitmap(AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), Config.ARGB_4444);
    ...
    protected void onDraw(Canvas canvas) {
        if (getVisibility() == 0) {
            ...
            this.rectF.set(bounce, bounce, ((float) AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP)) - bounce, ((float) AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP)) - bounce);
