...
public class StickerMasksView extends FrameLayout implements NotificationCenterDelegate {
    ...
    class C62712 extends SpanSizeLookup {
        C62712() {
        }
    ...
    class C62723 implements OnTouchListener {
        C62723() {
        }
    ...
    class C62734 implements OnItemClickListener {
        C62734() {
        }
    ...
    class C62745 implements ScrollSlidingTabStripDelegate {
        C62745() {
        }
    ...
    class C62756 extends OnScrollListener {
        C62756() {
        }
    ...
    class C62767 implements Runnable {
        C62767() {
        }
    ...
    public StickerMasksView(Context context) {
        ...
        this.stickersLayoutManager.setSpanSizeLookup(new C62712());
        ...
        this.stickersGridView.setOnTouchListener(new C62723());
        this.stickersOnItemClickListener = new C62734();
        ...
        updateStickerTabs();
        this.scrollSlidingTabStrip.setDelegate(new C62745());
        this.stickersGridView.setOnScrollListener(new C62756());
    }
    ...
    protected void onAttachedToWindow() {
        ...
        AndroidUtilities.runOnUIThread(new C62767());
    }
