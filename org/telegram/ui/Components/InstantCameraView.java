...
public class InstantCameraView extends FrameLayout implements NotificationCenterDelegate {
    ...
    private Runnable timerRunnable = new C61161();
    ...
    class C61182 implements OnTouchListener {

        class C61171 extends AnimatorListenerAdapter {
            C61171() {
            }
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (event.getAction() == 0 && InstantCameraView.this.baseFragment != null) {
                if (InstantCameraView.this.videoPlayer != null) {
                    ...
                    InstantCameraView.this.muteAnimation.addListener(new C61171());
    ...
    class C61215 extends ViewOutlineProvider {
        C61215() {
        }
    ...
    class C61247 implements OnClickListener {

        class C61231 extends AnimatorListenerAdapter {
            C61231() {
            }
        ...
        public void onClick(View v) {
            if (InstantCameraView.this.cameraReady && InstantCameraView.this.cameraSession != null && InstantCameraView.this.cameraSession.isInitied() && InstantCameraView.this.cameraThread != null) {
                ...
                animator.addListener(new C61231());
                animator.start();
            }
        }
    }

    class C61258 implements SurfaceTextureListener {
        C61258() {
        }
    ...
    class C61269 extends AnimatorListenerAdapter {
        C61269() {
        }
    ...
    public class CameraGLThread extends DispatchQueue {
        ...
        class C61271 implements OnFrameAvailableListener {
            C61271() {
            }
        ...
        class C61282 implements OnFrameAvailableListener {
            C61282() {
            }
                ...
                if (!this.egl10.eglChooseConfig(this.eglDisplay, new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 0, 12325, 0, 12326, 0, 12344}, configs, 1, configsCount)) {
                    ...
                    if (this.eglContext == null) {
                        ...
                        if (this.egl10.eglMakeCurrent(this.eglDisplay, this.eglSurface, this.eglSurface, this.eglContext)) {
                            ...
                            this.cameraSurface.setOnFrameAvailableListener(new C61271());
            ...
            switch (inputMessage.what) {
                ...
                case 2:
                    if (this.egl10.eglMakeCurrent(this.eglDisplay, this.eglSurface, this.eglSurface, this.eglContext)) {
                        ...
                        GLES20.glTexParameteri(36197, 10243, 33071);
                        this.cameraSurface = new SurfaceTexture(InstantCameraView.this.cameraTexture[0]);
                        this.cameraSurface.setOnFrameAvailableListener(new C61282());
                        InstantCameraView.this.createCamera(this.cameraSurface);
                        return;
                    }
                    FileLog.e("eglMakeCurrent failed " + GLUtils.getEGLErrorString(this.egl10.eglGetError()));
    ...
    private class VideoRecorder implements Runnable {
        ...
        class C61291 implements Runnable {
            C61291() {
            }
        ...
        class C61323 implements Runnable {
            C61323() {
            }
        ...
        private VideoRecorder() {
            ...
            this.recorderRunnable = new C61291();
        }
        ...
        private void handleStopRecording(final int send) {
            ...
            if (send != 0) {
                AndroidUtilities.runOnUIThread(new Runnable() {
                    ...
                    class C61301 implements VideoPlayerDelegate {
                        C61301() {
                        }
                    ...
                    public void run() {
                        ...
                        if (send == 1) {
                            ...
                            InstantCameraView.this.videoPlayer.setDelegate(new C61301());
                            ...
                            NotificationCenter.getInstance().postNotificationName(NotificationCenter.audioDidSent, InstantCameraView.this.videoEditedInfo, VideoRecorder.this.videoFile.getAbsolutePath());
                        }
        ...
        private void prepareEncoder() {
            try {
                ...
                AndroidUtilities.runOnUIThread(new C61323());
                if (this.eglDisplay != EGL14.EGL_NO_DISPLAY) {
    ...
    public InstantCameraView(Context context, ChatActivity parentFragment) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            this.cameraContainer.setOutlineProvider(new C61215());
        ...
        addView(this.switchCameraButton, LayoutHelper.createFrame(48, 48.0f, 83, CloseButton.TEXT_SIZE_SP, 0.0f, 0.0f, 14.0f));
        this.switchCameraButton.setOnClickListener(new C61247());
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.progress != 0.0f) {
            canvas.drawArc(this.rect, RadialCountdown.START_ANGLE, this.progress * 360.0f, false, this.paint);
        }
    ...
    public void showCamera() {
        if (this.textureView == null) {
            ...
            if (initCamera()) {
                ...
                this.textureView.setSurfaceTextureListener(new C61258());
    ...
    public void startAnimation(boolean open) {
        ...
        if (!open) {
            this.animatorSet.addListener(new C61269());
        }
    ...
    private boolean initCamera() {
        ...
        this.previewSize = CameraController.chooseOptimalSize(previewSizes, SizeUtils.DEFAULT_INTERSTITIAL_HEIGHT, 270, this.aspectRatio);
        this.pictureSize = CameraController.chooseOptimalSize(pictureSizes, SizeUtils.DEFAULT_INTERSTITIAL_HEIGHT, 270, this.aspectRatio);
    ...
    private void createCamera(final SurfaceTexture surfaceTexture) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            ...
            class C61131 implements Runnable {
                C61131() {
                }
            ...
            class C61142 implements Runnable {
                C61142() {
                }
            ...
            public void run() {
                if (InstantCameraView.this.cameraThread != null) {
                    ...
                    InstantCameraView.this.cameraThread.setCurrentSession(InstantCameraView.this.cameraSession);
                    CameraController.getInstance().openRound(InstantCameraView.this.cameraSession, surfaceTexture, new C61131(), new C61142());
                }
            }
        });
    }
    ...
    private void startProgressTimer() {
        ...
        this.progressTimer.schedule(new TimerTask() {
            ...
            class C61151 implements Runnable {
                C61151() {
                }
            ...
            public void run() {
                AndroidUtilities.runOnUIThread(new C61151());
            }
        }, 0, 17);
    }
