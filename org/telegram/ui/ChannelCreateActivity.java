...
public class ChannelCreateActivity extends BaseFragment implements NotificationCenterDelegate, AvatarUpdaterDelegate {
    ...
    class C58071 implements RequestDelegate {
        C58071() {
        }
    ...
    class C58102 extends ActionBarMenuOnItemClick {

        class C58081 implements OnClickListener {
            C58081() {
            }
                ...
                if (ChannelCreateActivity.this.currentStep == 0) {
                    if (!ChannelCreateActivity.this.donePressed) {
                        ...
                        if (ChannelCreateActivity.this.avatarUpdater.uploadingAvatar != null) {
                            ...
                            ChannelCreateActivity.this.progressDialog.setButton(-2, LocaleController.getString("Cancel", R.string.Cancel), new C58081());
                    ...
                    if (!ChannelCreateActivity.this.isPrivate) {
                        if (ChannelCreateActivity.this.nameTextView.length() == 0) {
                            ...
                            builder.setPositiveButton(LocaleController.getString(HTTP.CONN_CLOSE, R.string.Close), null);
    ...
    class C58123 implements View.OnClickListener {

        class C58111 implements OnClickListener {
            C58111() {
            }
    ...
    class C58145 implements OnEditorActionListener {
        C58145() {
        }
    ...
    class C58156 implements TextWatcher {
        C58156() {
        }
    ...
    class C58167 implements View.OnClickListener {
        C58167() {
        }
    ...
    class C58178 implements View.OnClickListener {
        C58178() {
        }
    ...
    class C58189 implements TextWatcher {
        C58189() {
        }
    ...
    public ChannelCreateActivity(Bundle args) {
        ...
        if (this.currentStep == 0) {
            ...
            ConnectionsManager.getInstance().sendRequest(req, new C58071());
            return;
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C58102());
        ...
        if (this.currentStep == 0) {
            ...
            this.avatarImage.setOnClickListener(new C58123());
            ...
            this.nameTextView.addTextChangedListener(new C58134());
            this.descriptionTextView = new EditTextBoldCursor(context);
            this.descriptionTextView.setTextSize(1, RadialCountdown.TEXT_SIZE_SP);
            ...
            this.linearLayout.addView(this.descriptionTextView, LayoutHelper.createLinear(-1, -2, 24.0f, RadialCountdown.TEXT_SIZE_SP, 24.0f, 0.0f));
            this.descriptionTextView.setOnEditorActionListener(new C58145());
            this.descriptionTextView.addTextChangedListener(new C58156());
            ...
            this.radioButtonCell1.setOnClickListener(new C58167());
            ...
            this.radioButtonCell2.setOnClickListener(new C58178());
            ...
            this.nameTextView = new EditTextBoldCursor(context);
            this.nameTextView.setTextSize(1, RadialCountdown.TEXT_SIZE_SP);
            this.nameTextView.setHintTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteHintText));
            this.nameTextView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText));
            ...
            this.nameTextView.addTextChangedListener(new C58189());
            ...
            this.privateContainer.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    if (ChannelCreateActivity.this.invite != null) {
                        try {
                            ((ClipboardManager) ApplicationLoader.applicationContext.getSystemService("clipboard")).setPrimaryClip(ClipData.newPlainText(PlusShare.KEY_CALL_TO_ACTION_LABEL, ChannelCreateActivity.this.invite.link));
            ...
            ConnectionsManager.getInstance().sendRequest(new TLRPC$TL_channels_getAdminedPublicChannels(), new RequestDelegate() {
                public void run(final TLObject response, TLRPC$TL_error error) {
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        ...
                        class C58031 implements View.OnClickListener {
                            C58031() {
                            }
                            ...
                            public void onClick(View view) {
                                ...
                                builder.setPositiveButton(LocaleController.getString("RevokeButton", R.string.RevokeButton), new OnClickListener() {
                                    ...
                                    class C58011 implements RequestDelegate {

                                        class C58001 implements Runnable {
                                            C58001() {
                                            }
                                        ...
                                        public void run(TLObject response, TLRPC$TL_error error) {
                                            if (response instanceof TLRPC$TL_boolTrue) {
                                                AndroidUtilities.runOnUIThread(new C58001());
                                            }
                                        }
                                    }
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        ...
                                        req.username = "";
                                        ConnectionsManager.getInstance().sendRequest(req, new C58011(), 64);
                                    }
                                });
                                ChannelCreateActivity.this.showDialog(builder.create());
                            }
                        ...
                        public void run() {
                            ...
                            if (response != null && ChannelCreateActivity.this.getParentActivity() != null) {
                                ...
                                while (a < res.chats.size()) {
                                    AdminedChannelCell adminedChannelCell = new AdminedChannelCell(ChannelCreateActivity.this.getParentActivity(), new C58031());
    ...
    private boolean checkUserName(final String name) {
        ...
        if (name == null || name.length() < 5) {
            ...
            this.checkRunnable = new Runnable() {
                ...
                class C58061 implements RequestDelegate {
                    C58061() {
                    }
                ...
                public void run() {
                    ...
                    ChannelCreateActivity.this.checkReqId = ConnectionsManager.getInstance().sendRequest(req, new C58061(), 2);
                }
            };
