...
public class PhotoCropActivity extends BaseFragment {
    ...
    class C66901 extends ActionBarMenuOnItemClick {
        C66901() {
        }
    ...
    private class PhotoCropView extends FrameLayout {
        ...
        class C66911 implements OnTouchListener {
            C66911() {
            }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas2 = canvas;
            canvas2.drawRect(((float) side) + this.rectX, ((float) side) + this.rectY, ((float) AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP)) + (this.rectX + ((float) side)), ((float) (side * 3)) + this.rectY, this.circlePaint);
            canvas2 = canvas;
            canvas2.drawRect(((float) side) + this.rectX, ((float) side) + this.rectY, ((float) (side * 3)) + this.rectX, ((float) AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP)) + (this.rectY + ((float) side)), this.circlePaint);
            canvas2 = canvas;
            canvas2.drawRect(((this.rectX + this.rectSizeX) - ((float) side)) - ((float) AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP)), ((float) side) + this.rectY, (this.rectX + this.rectSizeX) - ((float) side), ((float) (side * 3)) + this.rectY, this.circlePaint);
            canvas2 = canvas;
            canvas2.drawRect((this.rectX + this.rectSizeX) - ((float) (side * 3)), ((float) side) + this.rectY, (this.rectX + this.rectSizeX) - ((float) side), ((float) AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP)) + (this.rectY + ((float) side)), this.circlePaint);
            canvas2 = canvas;
            canvas2.drawRect(((float) side) + this.rectX, ((this.rectY + this.rectSizeY) - ((float) side)) - ((float) AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP)), ((float) (side * 3)) + this.rectX, (this.rectY + this.rectSizeY) - ((float) side), this.circlePaint);
            canvas2 = canvas;
            canvas2.drawRect(((float) side) + this.rectX, (this.rectY + this.rectSizeY) - ((float) (side * 3)), ((float) AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP)) + (this.rectX + ((float) side)), (this.rectY + this.rectSizeY) - ((float) side), this.circlePaint);
            canvas.drawRect(((this.rectX + this.rectSizeX) - ((float) side)) - ((float) AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP)), (this.rectY + this.rectSizeY) - ((float) (side * 3)), (this.rectX + this.rectSizeX) - ((float) side), (this.rectY + this.rectSizeY) - ((float) side), this.circlePaint);
            canvas.drawRect((this.rectX + this.rectSizeX) - ((float) (side * 3)), ((this.rectY + this.rectSizeY) - ((float) side)) - ((float) AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP)), (this.rectX + this.rectSizeX) - ((float) side), (this.rectY + this.rectSizeY) - ((float) side), this.circlePaint);
            for (int a = 1; a < 3; a++) {
                canvas2 = canvas;
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C66901());
