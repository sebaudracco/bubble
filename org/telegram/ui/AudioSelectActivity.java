...
public class AudioSelectActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C56241 extends ActionBarMenuOnItemClick {
        C56241() {
        }
    ...
    class C56252 implements OnItemClickListener {
        C56252() {
        }
    ...
    class C56263 implements OnClickListener {
        C56263() {
        }
    ...
    class C56274 implements OnClickListener {
        C56274() {
        }
    ...
    class C56295 implements Runnable {
        C56295() {
        }
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        class C56301 implements AudioCellDelegate {
            C56301() {
            }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C56241());
        ...
        this.listView.setOnItemClickListener(new C56252());
        ...
        this.bottomLayout.cancelButton.setOnClickListener(new C56263());
        this.bottomLayout.doneButton.setOnClickListener(new C56274());
    ...
    private void loadAudio() {
        ...
        Utilities.globalQueue.postRunnable(new C56295());
    }
