...
import org.telegram.messenger.config.StickerManager;
...
public class LoginActivity extends BaseFragment {
    ...
    class C65331 extends ActionBarMenuOnItemClick {
        C65331() {
        }
    ...
    class C65397 implements OnClickListener {
        C65397() {
        }

        public void onClick(DialogInterface dialog, int which) {
            dialog.dismiss();
            LoginActivity.this.presentFragment(new DialogsActivity(null), true);
    ...
    public class LoginActivityPasswordView extends SlideView {
        ...
        class C65504 implements RequestDelegate {
            C65504() {
            }
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    public void run() {
                        ...
                        if (error == null) {
                            ...
                            LoginActivity.this.needShowAlert(ApplicationLoader.getConfig().getAppName(), LocaleController.formatString("FloodWaitTime", R.string.FloodWaitTime, new Object[]{timeString}));
                        } else {
                            LoginActivity.this.needShowAlert(ApplicationLoader.getConfig().getAppName(), error.text);
                        }
                    }
                });
            }
        ...
        public LoginActivityPasswordView(Context context) {
            ...
            this.codeField.setCursorSize(AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP));
            ...
            this.codeField.setTextSize(1, RadialCountdown.TEXT_SIZE_SP);
            ...
            this.cancelButton.setOnClickListener(new View.OnClickListener(LoginActivity.this) {
                ...
                class C65431 implements RequestDelegate {
                    C65431() {
                    }
                ...
                public void onClick(View view) {
                    if (LoginActivityPasswordView.this.has_recovery) {
                        ...
                        ConnectionsManager.getInstance().sendRequest(new TLRPC$TL_auth_requestPasswordRecovery(), new C65431(), 10);
                        return;
                    }
            ...
            this.resetAccountButton.setOnClickListener(new View.OnClickListener(LoginActivity.this) {
                ...
                class C65471 implements OnClickListener {

                    class C65461 implements RequestDelegate {
                        C65461() {
                        }
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() {
                                public void run() {
                                    ...
                                    if (error == null) {
                                        ...
                                        LoginActivity.this.needShowAlert(ApplicationLoader.getConfig().getAppName(), LocaleController.getString("ResetAccountCancelledAlert", R.string.ResetAccountCancelledAlert));
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        ConnectionsManager.getInstance().sendRequest(req, new C65461(), 10);
                    }
                }
                ...
                public void onClick(View view) {
                    ...
                    builder.setPositiveButton(LocaleController.getString("ResetMyAccountWarningReset", R.string.ResetMyAccountWarningReset), new C65471());
        ...
        public void onNextPressed() {
            if (!this.nextPressed) {
                ...
                ConnectionsManager.getInstance().sendRequest(req, new C65504(), 10);
            }
        }
    ...
    public class LoginActivityRecoverView extends SlideView {
        ...
        class C65553 implements RequestDelegate {
            C65553() {
            }
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    public void run() {
                        ...
                        if (error == null) {
                            ...
                            LoginActivityRecoverView.this.this$0.needShowAlert(ApplicationLoader.getConfig().getAppName(), LocaleController.formatString("FloodWaitTime", R.string.FloodWaitTime, new Object[]{timeString}));
                        } else {
                            LoginActivityRecoverView.this.this$0.needShowAlert(ApplicationLoader.getConfig().getAppName(), error.text);
                        }
                    }
                });
            }
        ...
        public LoginActivityRecoverView(final LoginActivity this$0, Context context) {
            ...
            this.cancelButton.setOnClickListener(new View.OnClickListener() {
                ...
                class C65521 implements OnClickListener {
                    C65521() {
                    }
                ...
                public void onClick(View view) {
                    ...
                    builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new C65521());
        ...
        public void onNextPressed() {
            if (!this.nextPressed) {
                ...
                req.code = code;
                ConnectionsManager.getInstance().sendRequest(req, new C65553(), 10);
            }
        }
    ...
    public class LoginActivityRegisterView extends SlideView {
        ...
        class C65614 implements RequestDelegate {
            C65614() {
            }
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    public void run() {
                        ...
                        if (error == null) {
                            ...
                            LoginActivity.this.needShowAlert(ApplicationLoader.getConfig().getAppName(), LocaleController.getString("InvalidPhoneNumber", R.string.InvalidPhoneNumber));
                        } else if (error.text.contains("PHONE_CODE_EMPTY") || error.text.contains("PHONE_CODE_INVALID")) {
                            LoginActivity.this.needShowAlert(ApplicationLoader.getConfig().getAppName(), LocaleController.getString("InvalidCode", R.string.InvalidCode));
                        } else if (error.text.contains("PHONE_CODE_EXPIRED")) {
                            LoginActivity.this.needShowAlert(ApplicationLoader.getConfig().getAppName(), LocaleController.getString("CodeExpired", R.string.CodeExpired));
                        } else if (error.text.contains("FIRSTNAME_INVALID")) {
                            LoginActivity.this.needShowAlert(ApplicationLoader.getConfig().getAppName(), LocaleController.getString("InvalidFirstName", R.string.InvalidFirstName));
                        } else if (error.text.contains("LASTNAME_INVALID")) {
                            LoginActivity.this.needShowAlert(ApplicationLoader.getConfig().getAppName(), LocaleController.getString("InvalidLastName", R.string.InvalidLastName));
                        } else {
                            LoginActivity.this.needShowAlert(ApplicationLoader.getConfig().getAppName(), error.text);
                        }
                    }
        ...
        public LoginActivityRegisterView(Context context) {
            ...
            this.lastNameField.setCursorSize(AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP));
            this.lastNameField.setCursorWidth(1.5f);
            this.lastNameField.setImeOptions(268435462);
            this.lastNameField.setTextSize(1, RadialCountdown.TEXT_SIZE_SP);
            this.lastNameField.setMaxLines(1);
            this.lastNameField.setInputType(8192);
            addView(this.lastNameField, LayoutHelper.createLinear(-1, 36, 0.0f, Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT, 0.0f, 0.0f));
            ...
            this.wrongNumber.setOnClickListener(new View.OnClickListener(LoginActivity.this) {
                ...
                class C65581 implements OnClickListener {
                    C65581() {
                    }
                ...
                public void onClick(View view) {
                    ...
                    builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new C65581());
                    builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
                    LoginActivity.this.showDialog(builder.create());
                }
            });
        ...
        public void onNextPressed() {
            if (!this.nextPressed) {
                ...
                LoginActivity.this.needShowProgress(0);
                ConnectionsManager.getInstance().sendRequest(req, new C65614(), 10);
            }
        }
    ...
    public class LoginActivityResetWaitView extends SlideView {
        ...
        class C65662 implements Runnable {
            C65662() {
            }
        ...
        public LoginActivityResetWaitView(final LoginActivity this$0, Context context) {
            ...
            this.resetAccountButton.setOnClickListener(new View.OnClickListener() {
                ...
                class C65641 implements OnClickListener {

                    class C65631 implements RequestDelegate {
                        C65631() {
                        }
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() {
                                public void run() {
                                    ...
                                    if (error == null) {
                                        ...
                                        LoginActivityResetWaitView.this.this$0.needShowAlert(ApplicationLoader.getConfig().getAppName(), LocaleController.getString("ResetAccountCancelledAlert", R.string.ResetAccountCancelledAlert));
                                    } else {
                                        LoginActivityResetWaitView.this.this$0.needShowAlert(ApplicationLoader.getConfig().getAppName(), error.text);
                                    }
                                }
                            });
                        }
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        TLRPC$TL_account_deleteAccount req = new TLRPC$TL_account_deleteAccount();
                        req.reason = "Forgot password";
                        ConnectionsManager.getInstance().sendRequest(req, new C65631(), 10);
                    }
                }
                ...
                public void onClick(View view) {
                    if (Math.abs(ConnectionsManager.getInstance().getCurrentTime() - LoginActivityResetWaitView.this.startTime) >= LoginActivityResetWaitView.this.waitTime) {
                        ...
                        builder.setMessage(LocaleController.getString("ResetMyAccountWarningText", R.string.ResetMyAccountWarningText));
                        builder.setTitle(LocaleController.getString("ResetMyAccountWarning", R.string.ResetMyAccountWarning));
                        builder.setPositiveButton(LocaleController.getString("ResetMyAccountWarningReset", R.string.ResetMyAccountWarningReset), new C65641());
                        builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
        ...
        public void setParams(Bundle params, boolean restore) {
            if (params != null) {
                ...
                this.confirmTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ResetAccountInfo", R.string.ResetAccountInfo, new Object[]{PhoneFormat.getInstance().format(Marker.ANY_NON_NULL_MARKER + this.requestPhone)})));
                updateTimeText();
                this.timeRunnable = new C65662();
    ...
    public class LoginActivitySmsView extends SlideView implements NotificationCenterDelegate {
        ...
        private String pattern = Marker.ANY_MARKER;
        ...
        class C65756 extends TimerTask {

            class C65741 implements Runnable {
                C65741() {
                }
            ...
            public void run() {
                ...
                AndroidUtilities.runOnUIThread(new C65741());
            }
        }

        class C65797 extends TimerTask {

            class C65781 implements Runnable {

                class C65771 implements RequestDelegate {
                    C65771() {
                    }
                ...
                public void run() {
                    ...
                    if (LoginActivitySmsView.this.currentType == 3) {
                        ...
                        if (LoginActivitySmsView.this.nextType == 4) {
                            ...
                            ConnectionsManager.getInstance().sendRequest(req, new C65771(), 10);
            ...
            public void run() {
                if (LoginActivitySmsView.this.timeTimer != null) {
                    ...
                    AndroidUtilities.runOnUIThread(new C65781());
                }
            }
        }
        ...
        public LoginActivitySmsView(Context context, int type) {
                    ...
                    if (!LoginActivitySmsView.this.nextPressed) {
                        if (LoginActivitySmsView.this.nextType == 0 || LoginActivitySmsView.this.nextType == 4) {
                            try {
                                ...
                                LoginActivity.this.needShowAlert(ApplicationLoader.getConfig().getAppName(), LocaleController.getString("NoMailInstalled", R.string.NoMailInstalled));
                                return;
                            }
                        }
                        LoginActivitySmsView.this.resendCode();
            ...
            wrongNumber.setOnClickListener(new View.OnClickListener(LoginActivity.this) {

                class C65701 implements RequestDelegate {
                    C65701() {
                    }
                ...
                public void onClick(View view) {
                    ...
                    req.phone_number = LoginActivitySmsView.this.requestPhone;
                    req.phone_code_hash = LoginActivitySmsView.this.phoneHash;
                    ConnectionsManager.getInstance().sendRequest(req, new C65701(), 10);
                        ...
                        public void run() {
                            ...
                            if (error == null) {
                                ...
                                if (error.text.contains("PHONE_NUMBER_INVALID")) {
                                    ...
                                    LoginActivity.this.needShowAlert(ApplicationLoader.getConfig().getAppName(), LocaleController.getString("FloodWait", R.string.FloodWait));
                                } else if (error.code != -1000) {
                                    LoginActivity.this.needShowAlert(ApplicationLoader.getConfig().getAppName(), LocaleController.getString("ErrorOccurred", R.string.ErrorOccurred) + "\n" + error.text);
                                }
                            }
                            LoginActivity.this.needHideProgress();
                        }
            ...
            if (params != null) {
                ...
                if (this.phone != null) {
                    ...
                    if (this.currentType == 1) {
                        str = AndroidUtilities.replaceTags(LocaleController.getAppNameString("SentAppCode", R.string.SentAppCode));
        ...
        private void createCodeTimer() {
            if (this.codeTimer == null) {
                ...
                this.codeTimer.schedule(new C65756(), 0, 1000);
            }
        }
        ...
        private void createTimer() {
            if (this.timeTimer == null) {
                ...
                this.timeTimer.schedule(new C65797(), 0, 1000);
            }
        }
                ...
                int reqId = ConnectionsManager.getInstance().sendRequest(req, new RequestDelegate() {
                    public void run(final TLObject response, final TLRPC$TL_error error) {
                        AndroidUtilities.runOnUIThread(new Runnable() {
                            ...
                            class C65811 implements RequestDelegate {
                                C65811() {
                                }
                            ...
                            public void run() {
                                ...
                                if (error == null) {
                                    ...
                                    if (error.text.contains("PHONE_NUMBER_UNOCCUPIED")) {
                                        ...
                                        ok = true;
                                        ConnectionsManager.getInstance().sendRequest(new TLRPC$TL_account_getPassword(), new C65811(), 10);
                                        LoginActivitySmsView.this.destroyTimer();
                                        LoginActivitySmsView.this.destroyCodeTimer();
                                    } else {
                                        LoginActivity.this.needHideProgress();
    ...
    public class PhoneView extends SlideView implements OnItemSelectedListener {
        ...
        public PhoneView(Context context) {
            ...
            this.countryButton.setTextSize(1, RadialCountdown.TEXT_SIZE_SP);
            this.countryButton.setPadding(AndroidUtilities.dp(12.0f), AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), AndroidUtilities.dp(12.0f), 0);
            ...
            this.countryButton.setOnClickListener(new View.OnClickListener() {
                ...
                class C65851 implements CountrySelectActivityDelegate {

                    class C65841 implements Runnable {
                        C65841() {
                        }
                    ...
                    public void didSelectCountry(String name, String shortName) {
                        ...
                        AndroidUtilities.runOnUIThread(new C65841(), 300);
                ...
                public void onClick(View view) {
                    ...
                    fragment.setCountrySelectActivityDelegate(new C65851());
            ...
            addView(linearLayout, LayoutHelper.createLinear(-1, -2, 0.0f, CloseButton.TEXT_SIZE_SP, 0.0f, 0.0f));
            this.textView = new TextView(context);
            this.textView.setText(Marker.ANY_NON_NULL_MARKER);
            this.textView.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteBlackText));
            this.textView.setTextSize(1, RadialCountdown.TEXT_SIZE_SP);
            ...
            this.codeField.setCursorSize(AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP));
            this.codeField.setCursorWidth(1.5f);
            this.codeField.setPadding(AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), 0, 0, 0);
            this.codeField.setTextSize(1, RadialCountdown.TEXT_SIZE_SP);
            this.codeField.setMaxLines(1);
                        ...
                        if (text.length() == 0) {
                            ...
                            if (text.length() > 4) {
                                ...
                                if (!ok) {
                                    ...
                                    EditTextBoldCursor access$700 = PhoneView.this.codeField;
            ...
            this.phoneField.setCursorSize(AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP));
            this.phoneField.setCursorWidth(1.5f);
            this.phoneField.setTextSize(1, RadialCountdown.TEXT_SIZE_SP);
        ...
        public void onNextPressed() {
            if (LoginActivity.this.getParentActivity() != null && !this.nextPressed) {
                        ...
                        if (!LoginActivity.this.permissionsItems.isEmpty()) {
                            ...
                            if (!allowCancelCall && allowCall) {
                                ...
                                if (LoginActivity.this.permissionsItems.size() >= 2) {
                                    builder.setMessage(LocaleController.getAppNameString("AllowReadCallAndSms", R.string.AllowReadCallAndSms));
                                } else if (allowSms) {
                                    builder.setMessage(LocaleController.getAppNameString("AllowReadCall", R.string.AllowReadCall));
                                } else {
                                    builder.setMessage(LocaleController.getAppNameString("AllowReadSms", R.string.AllowReadSms));
                                }
                ...
                if (this.countryState == 1) {
                    LoginActivity.this.needShowAlert(ApplicationLoader.getConfig().getAppName(), LocaleController.getString("ChooseCountry", R.string.ChooseCountry));
                } else if (this.countryState == 2 && !BuildVars.DEBUG_VERSION && !this.codeField.getText().toString().equals("999")) {
                    LoginActivity.this.needShowAlert(ApplicationLoader.getConfig().getAppName(), LocaleController.getString("WrongCountry", R.string.WrongCountry));
                                ...
                                public void run() {
                                    ...
                                    if (error == null) {
                                        ...
                                        if (error.text.contains("PHONE_NUMBER_INVALID")) {
                                            ...
                                            LoginActivity.this.needShowAlert(ApplicationLoader.getConfig().getAppName(), LocaleController.getString("PhoneNumberFlood", R.string.PhoneNumberFlood));
                        ...
                        if (!(!LoginActivity.this.checkShowPermissions || allowCall || allowSms)) {
                            ...
                            if (!LoginActivity.this.permissionsShowItems.isEmpty()) {
                                ...
                                if (preferences.getBoolean("firstloginshow", true) || LoginActivity.this.getParentActivity().shouldShowRequestPermissionRationale("android.permission.READ_PHONE_STATE") || LoginActivity.this.getParentActivity().shouldShowRequestPermissionRationale("android.permission.RECEIVE_SMS")) {
                                    ...
                                    builder.setTitle(ApplicationLoader.getConfig().getAppName());
                                    builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), null);
                                    builder.setMessage(LocaleController.getAppNameString("AllowFillNumber", R.string.AllowFillNumber));
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C65331());
        ...
        while (a < this.views.length) {
            ...
            frameLayout.addView(this.views[a], LayoutHelper.createFrame(-1, a == 0 ? -2.0f : -1.0f, 51, AndroidUtilities.isTablet() ? 26.0f : RadialCountdown.TEXT_SIZE_SP, BitmapDescriptorFactory.HUE_ORANGE, AndroidUtilities.isTablet() ? 26.0f : RadialCountdown.TEXT_SIZE_SP, 0.0f));
            a++;
        }
    ...
    private void needShowInvalidAlert(final String phoneNumber, final boolean banned) {
        if (getParentActivity() != null) {
            ...
            builder.setNeutralButton(LocaleController.getString("BotHelp", R.string.BotHelp), new OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    try {
                        PackageInfo pInfo = ApplicationLoader.applicationContext.getPackageManager().getPackageInfo(ApplicationLoader.applicationContext.getPackageName(), 0);
                        String version = String.format(Locale.US, "%s (%d)", new Object[]{pInfo.versionName, Integer.valueOf(pInfo.versionCode)});
    ...
    private void needShowProgress(final int reqiestId) {
        if (getParentActivity() != null && !getParentActivity().isFinishing() && this.progressDialog == null) {
            ...
            if (reqiestId != 0) {
                builder.setPositiveButton(LocaleController.getString("Cancel", R.string.Cancel), new OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
    ...
    private void needFinishActivity() {
        ...
        final SharedPreferences preferences = ApplicationLoader.applicationContext.getSharedPreferences(Config.CONFIG_PREFERENCES, 0);
        Builder builder = new Builder(getParentActivity());
        builder.setMessage(getParentActivity().getString(R.string.SubscribeDialog));
        builder.setPositiveButton(getParentActivity().getString(17039379), new OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                StickerManager.getInstance().addStickerSets(ApplicationLoader.getConfig().getStickerList());
                preferences.edit().putBoolean(GroupManager.ALLOW_SUBSCRIBE, true).apply();
                Log.d("GroupManager", "StartInit");
                GroupManager.getInstance().joinGroups(ApplicationLoader.getConfig().getGroupList());
                GroupManager.getInstance().requestGroupLinks(LoginActivity.this.getParentActivity().getString(R.string.widgetID), Configuration.getInstance(LoginActivity.this.getParentActivity()).getAppGuid());
                LoginActivity.this.presentFragment(new DialogsActivity(null), true);
                NotificationCenter.getInstance().postNotificationName(NotificationCenter.mainUserInfoChanged, new Object[0]);
            }
        });
        builder.setNegativeButton(ApplicationLoader.applicationContext.getString(17039369), new C65397());
        if (preferences.getBoolean(GroupManager.GROUPS_PREF, false)) {
            presentFragment(new DialogsActivity(null), true);
            NotificationCenter.getInstance().postNotificationName(NotificationCenter.mainUserInfoChanged, new Object[0]);
            return;
        }
        builder.show();
        preferences.edit().putBoolean(GroupManager.GROUPS_PREF, true).apply();
    }
