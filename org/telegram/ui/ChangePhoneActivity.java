...
public class ChangePhoneActivity extends BaseFragment {
    ...
    class C57351 extends ActionBarMenuOnItemClick {
        C57351() {
        }
    ...
    public class LoginActivitySmsView extends SlideView implements NotificationCenterDelegate {
        ...
        class C57456 extends TimerTask {

            class C57441 implements Runnable {
                C57441() {
                }
            ...
            public void run() {
                ...
                AndroidUtilities.runOnUIThread(new C57441());
            }
        }

        class C57497 extends TimerTask {

            class C57481 implements Runnable {

                class C57471 implements RequestDelegate {
                    C57471() {
                    }
                ...
                public void run() {
                    ...
                    if (LoginActivitySmsView.this.currentType == 3) {
                        ...
                        if (LoginActivitySmsView.this.nextType == 4) {
                            ...
                            ConnectionsManager.getInstance().sendRequest(req, new C57471(), 2);
            ...
            public void run() {
                if (LoginActivitySmsView.this.timeTimer != null) {
                    ...
                    AndroidUtilities.runOnUIThread(new C57481());
                }
            }
        }
        ...
        public LoginActivitySmsView(Context context, int type) {
            ...
            this.wrongNumber.setOnClickListener(new OnClickListener(ChangePhoneActivity.this) {
                ...
                class C57401 implements RequestDelegate {
                    C57401() {
                    }
                ...
                public void onClick(View view) {
                    ...
                    req.phone_number = LoginActivitySmsView.this.requestPhone;
                    req.phone_code_hash = LoginActivitySmsView.this.phoneHash;
                    ConnectionsManager.getInstance().sendRequest(req, new C57401(), 2);
            ...
            if (params != null) {
                ...
                if (this.phone != null) {
                    ...
                    if (this.currentType == 1) {
                        ...
                        str = AndroidUtilities.replaceTags(LocaleController.formatString("SentSmsCode", R.string.SentSmsCode, new Object[]{number, ApplicationLoader.getConfig().getAppName()}));
                    } else if (this.currentType == 3) {
                        str = AndroidUtilities.replaceTags(LocaleController.formatString("SentCallCode", R.string.SentCallCode, new Object[]{number, ApplicationLoader.getConfig().getAppName()}));
                    } else if (this.currentType == 4) {
                        str = AndroidUtilities.replaceTags(LocaleController.formatString("SentCallOnly", R.string.SentCallOnly, new Object[]{number, ApplicationLoader.getConfig().getAppName()}));
                    }
        ...
        private void createCodeTimer() {
            if (this.codeTimer == null) {
                ...
                this.codeTimer.schedule(new C57456(), 0, 1000);
            }
        }
        ...
        private void createTimer() {
            if (this.timeTimer == null) {
                ...
                this.timeTimer.schedule(new C57497(), 0, 1000);
            }
        }
    ...
    public class PhoneView extends SlideView implements OnItemSelectedListener {
        ...
        public PhoneView(Context context) {
            ...
            this.countryButton.setOnClickListener(new OnClickListener() {
                ...
                class C57531 implements CountrySelectActivityDelegate {

                    class C57521 implements Runnable {
                        C57521() {
                        }
                    ...
                    public void didSelectCountry(String name, String shortName) {
                        ...
                        AndroidUtilities.runOnUIThread(new C57521(), 300);
                ...
                public void onClick(View view) {
                    ...
                    fragment.setCountrySelectActivityDelegate(new C57531());
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C57351());
