...
public class ArchivedStickersActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C55771 extends ActionBarMenuOnItemClick {
        C55771() {
        }
    ...
    class C55792 implements OnItemClickListener {
        C55792() {
        }
    ...
    class C55803 extends OnScrollListener {
        C55803() {
        }
    ...
    class C55824 implements RequestDelegate {
        C55824() {
        }
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        class C55831 implements OnCheckedChangeListener {
            C55831() {
            }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 0:
                    ...
                    ((ArchivedStickerSetCell) view).setOnCheckClick(new C55831());
                    break;
                case 1:
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C55771());
        ...
        this.listView.setOnItemClickListener(new C55792());
        this.listView.setOnScrollListener(new C55803());
    ...
    private void getStickers() {
        if (!this.loadingStickers && !this.endReached) {
            ...
            ConnectionsManager.getInstance().bindRequestToGuid(ConnectionsManager.getInstance().sendRequest(req, new C55824()), this.classGuid);
        }
    }
