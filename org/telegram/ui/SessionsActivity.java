...
public class SessionsActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C68301 extends ActionBarMenuOnItemClick {
        C68301() {
        }
    ...
    class C68372 implements OnItemClickListener {

        class C68331 implements OnClickListener {

            class C68321 implements RequestDelegate {
                C68321() {
                }
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ConnectionsManager.getInstance().sendRequest(new TL_auth_resetAuthorizations(), new C68321());
            }
        }
        ...
        public void onItemClick(View view, final int position) {
            ...
            if (position == SessionsActivity.this.terminateAllSessionsRow) {
                if (SessionsActivity.this.getParentActivity() != null) {
                    ...
                    builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new C68331());
    ...
    class C68393 implements RequestDelegate {
        C68393() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C68301());
        ...
        this.textView2.setPadding(AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP), 0, AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP), 0);
        this.textView2.setText(LocaleController.getAppNameString("NoOtherSessionsInfo", R.string.NoOtherSessionsInfo));
        ...
        this.listView.setOnItemClickListener(new C68372());
    ...
    private void loadSessions(boolean silent) {
        if (!this.loading) {
            ...
            ConnectionsManager.getInstance().bindRequestToGuid(ConnectionsManager.getInstance().sendRequest(new TL_account_getAuthorizations(), new C68393()), this.classGuid);
        }
    }
