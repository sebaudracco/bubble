...
public class PrivacySettingsActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C67571 extends ActionBarMenuOnItemClick {
        C67571() {
        }
    ...
    class C67652 implements OnItemClickListener {

        class C67601 implements OnClickListener {
            C67601() {
            }
        ...
        class C67612 implements OnClickListener {
            C67612() {
            }
        ...
        class C67623 implements View.OnClickListener {
            C67623() {
            }
        ...
        class C67644 implements View.OnClickListener {

            class C67631 implements RequestDelegate {
                C67631() {
                }
            ...
            public void onClick(View v) {
                ...
                ConnectionsManager.getInstance().sendRequest(req, new C67631());
            }
        }
        ...
        public void onItemClick(View view, int position) {
            ...
            if (position == PrivacySettingsActivity.this.blockedRow) {
                ...
                if (PrivacySettingsActivity.this.getParentActivity() != null) {
                    ...
                    builder.setItems(new CharSequence[]{LocaleController.formatPluralString("Months", 1), LocaleController.formatPluralString("Months", 3), LocaleController.formatPluralString("Months", 6), LocaleController.formatPluralString("Years", 1)}, new C67601());
                ...
                new Builder(PrivacySettingsActivity.this.getParentActivity()).setTitle(LocaleController.getString("PrivacyCallsP2PTitle", R.string.PrivacyCallsP2PTitle)).setItems(new String[]{LocaleController.getString("LastSeenEverybody", R.string.LastSeenEverybody), LocaleController.getString("LastSeenContacts", R.string.LastSeenContacts), LocaleController.getString("LastSeenNobody", R.string.LastSeenNobody)}, new C67612()).setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null).show();
                ...
                for (int a = 0; a < 2; a++) {
                    ...
                    checkBoxCell.setOnClickListener(new C67623());
                }
                ...
                cell.setOnClickListener(new C67644());
            ...
            switch (holder.getItemViewType()) {
                ...
                case 1:
                    ...
                    if (position == PrivacySettingsActivity.this.deleteAccountDetailRow) {
                        ...
                        privacyCell.setText(LocaleController.formatString("PrivacyPaymentsClearInfo", R.string.PrivacyPaymentsClearInfo, new Object[]{ApplicationLoader.getConfig().getAppName()}));
                        Context context = this.mContext;
                        int i = (PrivacySettingsActivity.this.secretSectionRow == -1 && PrivacySettingsActivity.this.callsSectionRow == -1) ? R.drawable.greydivider_bottom : R.drawable.greydivider;
                        ...
                        privacyCell.setText(LocaleController.formatString("PrivacyCallsP2PHelp", R.string.PrivacyCallsP2PHelp, new Object[]{ApplicationLoader.getConfig().getAppName()}));
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C67571());
        ...
        this.listView.setOnItemClickListener(new C67652());
