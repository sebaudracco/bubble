...
public class NotificationsSettingsActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C66321 extends ActionBarMenuOnItemClick {
        C66321() {
        }
    ...
    class C66413 implements OnItemClickListener {

        class C66351 implements RequestDelegate {

            class C66341 implements Runnable {
                C66341() {
                }
            ...
            public void run(TLObject response, TLRPC$TL_error error) {
                AndroidUtilities.runOnUIThread(new C66341());
            }
        }
        ...
        public void onItemClick(View view, int position) {
            ...
            if (position == NotificationsSettingsActivity.this.messageAlertRow || position == NotificationsSettingsActivity.this.groupAlertRow) {
                ...
                if (!NotificationsSettingsActivity.this.reseting) {
                    ...
                    ConnectionsManager.getInstance().sendRequest(new TLRPC$TL_account_resetNotifySettings(), new C66351());
                } else {
                    return;
                }
            ...
            switch (holder.getItemViewType()) {
                ...
                case 1:
                    ...
                    if (position == NotificationsSettingsActivity.this.messageAlertRow) {
                        ...
                        checkCell.setTextAndCheck(LocaleController.formatString("ContactJoined", R.string.ContactJoined, new Object[]{ApplicationLoader.getConfig().getAppName()}), preferences.getBoolean("EnableContactJoined", true), true);
                        return;
                    } else if (position == NotificationsSettingsActivity.this.pinnedMessageRow) {
                        ...
                        checkCell.setTextAndValueAndCheck(LocaleController.getString("NotificationsServiceConnection", R.string.NotificationsServiceConnection), LocaleController.formatString("NotificationsServiceConnectionInfo", R.string.NotificationsServiceConnectionInfo, new Object[]{ApplicationLoader.getConfig().getAppName()}), preferences.getBoolean("pushConnection", true), true, true);
                        return;
                    } else if (position == NotificationsSettingsActivity.this.badgeNumberRow) {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C66321());
        ...
        this.listView.setOnItemClickListener(new C66413());
