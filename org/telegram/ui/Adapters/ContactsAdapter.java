...
public class ContactsAdapter extends SectionsAdapter {
    ...
    public Object getItem(int section, int position) {
        ...
        HashMap<String, ArrayList<TLRPC$TL_contact>> usersSectionsDict = this.onlyUsers == 2 ? ContactsController.getInstance().usersMutualSectionsDict : ContactsController.getInstance().usersSectionsDict;
        if (this.onlyUsers == 2) {
    ...
    public View getSectionHeaderView(int section, View view) {
        if (this.onlyUsers == 2) {
            HashMap<String, ArrayList<TLRPC$TL_contact>> usersSectionsDict = ContactsController.getInstance().usersMutualSectionsDict;
        } else {
