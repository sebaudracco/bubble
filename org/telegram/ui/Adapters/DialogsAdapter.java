...
public class DialogsAdapter extends SelectionAdapter {
    ...
    class C55291 implements OnClickListener {
        C55291() {
        }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            ...
            case 2:
                ...
                headerCell.addView(textView, LayoutHelper.createFrame(-1, -1.0f, i | 48, 17.0f, CtaButton.TEXT_SIZE_SP, 17.0f, 0.0f));
                textView.setOnClickListener(new C55291());
                view = headerCell;
                break;
            case 3:
