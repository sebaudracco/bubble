...
public class SearchAdapterHelper {
    ...
    class C55734 implements Runnable {

        class C55711 implements Comparator<HashtagObject> {
            C55711() {
            }
        ...
        public void run() {
            try {
                ...
                cursor.dispose();
                Collections.sort(arrayList, new C55711());
    ...
    class C55756 implements Runnable {
        C55756() {
        }
    ...
    public boolean loadRecentHashtags() {
        ...
        MessagesStorage.getInstance().getStorageQueue().postRunnable(new C55734());
        return false;
    }
    ...
    public void clearRecentHashtags() {
        this.hashtags = new ArrayList();
        this.hashtagsByText = new HashMap();
        MessagesStorage.getInstance().getStorageQueue().postRunnable(new C55756());
    }
