...
public class DialogsSearchAdapter extends SelectionAdapter {
    ...
    class C55311 implements SearchAdapterHelperDelegate {
        C55311() {
        }
    ...
    class C55363 implements Runnable {

        class C55341 implements Comparator<RecentSearchObject> {
            C55341() {
            }
        ...
        public void run() {
            try {
                ...
                Collections.sort(arrayList, new C55341());
    ...
    class C55385 implements Runnable {
        C55385() {
        }
    ...
    public DialogsSearchAdapter(Context context, int messagesSearch, int type) {
        this.searchAdapterHelper.setDelegate(new C55311());
    ...
    public void loadRecentSearch() {
        MessagesStorage.getInstance().getStorageQueue().postRunnable(new C55363());
    }
    ...
    public void clearRecentSearch() {
        ...
        notifyDataSetChanged();
        MessagesStorage.getInstance().getStorageQueue().postRunnable(new C55385());
    }
    ...
    private void searchDialogsInternal(final String query, final int searchId) {
        if (this.needMessagesSearch != 2) {
            MessagesStorage.getInstance().getStorageQueue().postRunnable(new Runnable() {
                ...
                class C55391 implements Comparator<DialogSearchResult> {
                    C55391() {
                    }
                ...
                public void run() {
                    try {
                        ...
                        Collections.sort(arrayList, new C55391());
    ...
    public void searchDialogs(final String query) {
        if (query == null || this.lastSearchText == null || !query.equals(this.lastSearchText)) {
            ...
            this.searchTimer.schedule(new TimerTask() {
                ...
                class C55421 implements Runnable {
                    C55421() {
                    }
                ...
                public void run() {
                    ...
                    AndroidUtilities.runOnUIThread(new C55421());
                }
            }, 200, 300);
        }
    }
