...
public class DrawerLayoutAdapter extends SelectionAdapter {
    ...
    private void resetItems() {
        ...
        if (UserConfig.isClientActivated()) {
            ...
            this.items.add(null);
            this.items.add(new Item(12, LocaleController.getString("Themes", R.string.Themes), R.drawable.ic_color_lens_white_24dp));
            ...
            this.items.add(new Item(9, LocaleController.formatString("TelegramFAQ", R.string.TelegramFaq, new Object[]{ApplicationLoader.getConfig().getAppName()}), R.drawable.menu_help));
        }
    }
