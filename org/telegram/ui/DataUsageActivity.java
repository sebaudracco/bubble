...
public class DataUsageActivity extends BaseFragment {
    ...
    class C63791 extends ActionBarMenuOnItemClick {
        C63791() {
        }
    ...
    class C63812 implements OnItemClickListener {

        class C63801 implements OnClickListener {
            C63801() {
            }
        ...
        public void onItemClick(View view, int position) {
            if (DataUsageActivity.this.getParentActivity() != null && position == DataUsageActivity.this.resetRow) {
                ...
                builder.setPositiveButton(LocaleController.getString("Reset", R.string.Reset), new C63801());
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C63791());
        ...
        this.listView.setOnItemClickListener(new C63812());
