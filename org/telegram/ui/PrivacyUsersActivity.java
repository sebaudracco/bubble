...
public class PrivacyUsersActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C67671 extends ActionBarMenuOnItemClick {

        class C67661 implements GroupCreateActivityDelegate {
            C67661() {
            }
        ...
        public void onItemClick(int id) {
            if (id == -1) {
                ...
                fragment.setDelegate(new C67661());
                PrivacyUsersActivity.this.presentFragment(fragment);
            }
        }
    }

    class C67682 implements OnItemClickListener {
        C67682() {
        }
    ...
    class C67703 implements OnItemLongClickListener {

        class C67691 implements OnClickListener {
            C67691() {
            }
        ...
        public boolean onItemClick(View view, int position) {
            ...
            builder.setItems(new CharSequence[]{LocaleController.getString("Delete", R.string.Delete)}, new C67691());
            PrivacyUsersActivity.this.showDialog(builder.create());
            return true;
        }
    }

    class C67714 implements ThemeDescriptionDelegate {
        C67714() {
        }
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            if (holder.getItemViewType() == 0) {
                ...
                CharSequence string = (user.phone == null || user.phone.length() == 0) ? LocaleController.getString("NumberUnknown", R.string.NumberUnknown) : PhoneFormat.getInstance().format(Marker.ANY_NON_NULL_MARKER + user.phone);
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C67671());
        ...
        this.listView.setOnItemClickListener(new C67682());
        this.listView.setOnItemLongClickListener(new C67703());
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ThemeDescriptionDelegate сellDelegate = new C67714();
