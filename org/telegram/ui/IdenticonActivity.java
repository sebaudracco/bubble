...
public class IdenticonActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C64601 extends ActionBarMenuOnItemClick {
        C64601() {
        }
    ...
    class C64612 implements OnTouchListener {
        C64612() {
        }
    ...
    class C64634 extends AnimatorListenerAdapter {
        C64634() {
        }
    ...
    class C64645 implements OnPreDrawListener {
        C64645() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C64601());
        this.fragmentView = new FrameLayout(context);
        FrameLayout parentFrameLayout = this.fragmentView;
        this.fragmentView.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundGray));
        this.fragmentView.setOnTouchListener(new C64612());
        ...
        frameLayout.setPadding(AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP), AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP), AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP), AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP));
        ...
        this.linearLayout1.setPadding(AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), 0, AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), 0);
    ...
    private void updateEmojiButton(boolean animated) {
        ...
        if (animated) {
            ...
            this.animatorSet.addListener(new C64634());
    ...
    private void fixLayout() {
        this.fragmentView.getViewTreeObserver().addOnPreDrawListener(new C64645());
    }
