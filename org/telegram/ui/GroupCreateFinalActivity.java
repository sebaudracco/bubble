...
public class GroupCreateFinalActivity extends BaseFragment implements NotificationCenterDelegate, AvatarUpdaterDelegate {
    ...
    class C64332 extends ActionBarMenuOnItemClick {
        C64332() {
        }
    ...
    class C64364 implements OnClickListener {

        class C64351 implements DialogInterface.OnClickListener {
            C64351() {
            }
    ...
    class C64386 extends OnScrollListener {
        C64386() {
        }
    ...
    class C64419 implements ThemeDescriptionDelegate {
        C64419() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C64332());
        ...
        this.avatarImage.setOnClickListener(new C64364());
        ...
        this.editText.setCursorSize(AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP));
        ...
        this.editText.addTextChangedListener(new C64375());
        ...
        this.listView.setOnScrollListener(new C64386());
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ThemeDescriptionDelegate сellDelegate = new C64419();
