...
public class WallpapersActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C69551 implements WallpaperUpdaterDelegate {
        C69551() {
        }
    ...
    class C69562 extends ActionBarMenuOnItemClick {
        C69562() {
        }
        ...
        public void onItemClick(int id) {
            if (id == -1) {
                ...
                if (wallPaper != null && wallPaper.id != 1000001 && (wallPaper instanceof TL_wallPaper)) {
                    ...
                    try {
                        done = AndroidUtilities.copyFile(new File(FileLoader.getInstance().getDirectory(4), size.location.volume_id + BridgeUtil.UNDERLINE_STR + size.location.local_id + ".jpg"), new File(ApplicationLoader.getFilesDirFixed(), "wallpaper.jpg"));
                    } catch (Exception e) {
                        done = false;
                        FileLog.e(e);
                    }
    ...
    class C69573 implements OnTouchListener {
        C69573() {
        }
    ...
    class C69584 implements OnItemClickListener {
        C69584() {
        }
    ...
    class C69605 implements RequestDelegate {
        C69605() {
        }
    ...
    public View createView(Context context) {
        ...
        this.updater = new WallpaperUpdater(getParentActivity(), new C69551());
        this.actionBar.setBackButtonImage(R.drawable.ic_ab_back);
        this.actionBar.setAllowOverlayTitle(true);
        this.actionBar.setTitle(LocaleController.getString("ChatBackground", R.string.ChatBackground));
        this.actionBar.setActionBarMenuOnItemClick(new C69562());
        ...
        this.backgroundImage.setOnTouchListener(new C69573());
        ...
        this.listView.setOnItemClickListener(new C69584());
    ...
    public void saveSelfArgs(Bundle args) {
        ...
        if (currentPicturePath != null) {
            args.putString(ClientCookie.PATH_ATTR, currentPicturePath);
        }
    }

    public void restoreSelfArgs(Bundle args) {
        this.updater.setCurrentPicturePath(args.getString(ClientCookie.PATH_ATTR));
    }
    ...
    private void processSelectedBackground() {
        if (!Theme.hasWallpaperFromTheme() || this.overrideThemeWallpaper) {
            ...
            PhotoSize size = FileLoader.getClosestPhotoSizeWithSize(wallPaper.sizes, Math.min(width, height));
            if (size != null) {
                String fileName = size.location.volume_id + BridgeUtil.UNDERLINE_STR + size.location.local_id + ".jpg";
    ...
    private void loadWallpapers() {
        ConnectionsManager.getInstance().bindRequestToGuid(ConnectionsManager.getInstance().sendRequest(new TL_account_getWallPapers(), new C69605()), this.classGuid);
    }
