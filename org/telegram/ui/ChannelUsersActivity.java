...
public class ChannelUsersActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C58751 extends ActionBarMenuOnItemClick {
        C58751() {
        }
    ...
    class C58762 extends ActionBarMenuItemSearchListener {
        C58762() {
        }
    ...
    class C58803 implements OnItemClickListener {

        class C58771 implements ContactsActivityDelegate {
            C58771() {
            }
        ...
        public void onItemClick(View view, int position) {
            ...
            if (position == ChannelUsersActivity.this.addNewRow) {
                ...
                if (ChannelUsersActivity.this.type == 0) {
                    ...
                    fragment.setDelegate(new C58771());
    ...
    class C58814 implements OnItemLongClickListener {
        C58814() {
        }
    ...
    class C58825 extends OnScrollListener {
        C58825() {
        }
    ...
    class C58888 implements Runnable {
        C58888() {
        }
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        class C58931 implements ManageChatUserCellDelegate {
            C58931() {
            }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 0:
                    ...
                    ((ManageChatUserCell) view).setDelegate(new C58931());
                    break;
                case 1:
                ...
                case 4:
                    ...
                    frameLayout.addView(linearLayout, LayoutHelper.createFrame(-2, -2.0f, 17, CloseButton.TEXT_SIZE_SP, 0.0f, CloseButton.TEXT_SIZE_SP, 0.0f));
    ...
    private class SearchAdapter extends SelectionAdapter {
        ...
        class C59005 implements ManageChatUserCellDelegate {
            C59005() {
            }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 0:
                    ...
                    view.setBackgroundColor(Theme.getColor(Theme.key_windowBackgroundWhite));
                    ((ManageChatUserCell) view).setDelegate(new C59005());
                    break;
                default:
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C58751());
        if (this.selectType != 0 || this.type == 2 || this.type == 0) {
            this.searchListViewAdapter = new SearchAdapter(context);
            this.searchItem = this.actionBar.createMenu().addItem(0, (int) R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new C58762());
        ...
        this.listView.setOnItemClickListener(new C58803());
        this.listView.setOnItemLongClickListener(new C58814());
        if (this.searchItem != null) {
            this.listView.setOnScrollListener(new C58825());
        }
    ...
    private boolean createMenuForParticipant(final TLRPC$ChannelParticipant participant, boolean resultOnly) {
        ...
        builder.setItems(items2, new OnClickListener() {
            ...
            class C58861 implements RequestDelegate {
                C58861() {
                }
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (ChannelUsersActivity.this.type == 0) {
                    ...
                    ConnectionsManager.getInstance().sendRequest(req, new C58861());
                } else if (ChannelUsersActivity.this.type == 1) {
    ...
    public void didReceivedNotification(int id, Object... args) {
        if (id == NotificationCenter.chatInfoDidLoaded) {
            ...
            if (chatFull.id == this.chatId && !byChannelUsers) {
                AndroidUtilities.runOnUIThread(new C58888());
            }
        }
    }
            ...
            ConnectionsManager.getInstance().bindRequestToGuid(ConnectionsManager.getInstance().sendRequest(req, new RequestDelegate() {
                public void run(final TLObject response, final TLRPC$TL_error error) {
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        ...
                        class C58891 implements Comparator<TLRPC$ChannelParticipant> {
                            C58891() {
                            }
                        ...
                        class C58902 implements Comparator<TLRPC$ChannelParticipant> {
                            C58902() {
                            }
                            ...
                            if (error == null) {
                                ...
                                try {
                                    if (ChannelUsersActivity.this.type == 0 || ChannelUsersActivity.this.type == 2) {
                                        Collections.sort(res.participants, new C58891());
                                    } else if (ChannelUsersActivity.this.type == 1) {
                                        Collections.sort(res.participants, new C58902());
                                    }
                                } catch (Exception e) {
                                    FileLog.e(e);
                                }
