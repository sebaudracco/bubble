...
public class ManageSpaceActivity extends Activity implements ActionBarLayoutDelegate {
    ...
    class C65941 implements OnTouchListener {
        C65941() {
        }
    ...
    class C65952 implements OnClickListener {
        C65952() {
        }
    ...
    class C65963 implements OnGlobalLayoutListener {
        C65963() {
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (AndroidUtilities.isTablet()) {
            ...
            shadowTablet.setOnTouchListener(new C65941());
            shadowTablet.setOnClickListener(new C65952());
    ...
    public void fixLayout() {
        if (AndroidUtilities.isTablet() && this.actionBarLayout != null) {
            this.actionBarLayout.getViewTreeObserver().addOnGlobalLayoutListener(new C65963());
        }
    }
