...
public class ChannelPermissionsActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C58601 extends ActionBarMenuOnItemClick {
        C58601() {
        }
    ...
    class C58623 implements OnItemClickListener {
        C58623() {
        }
    ...
    class C58634 implements OnClickListener {
        C58634() {
        }
    ...
    class C58645 implements OnClickListener {
        C58645() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C58601());
        ...
        this.listView.setOnItemClickListener(new C58623());
        ...
        this.radioButtonCell3.setOnClickListener(new C58634());
        ...
        this.radioButtonCell4.setOnClickListener(new C58645());
