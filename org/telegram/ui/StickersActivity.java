...
public class StickersActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C68791 extends ActionBarMenuOnItemClick {
        C68791() {
        }
    ...
    class C68802 implements OnItemClickListener {
        C68802() {
        }
        ...
        public void onItemClick(View view, int position) {
            if (position >= StickersActivity.this.stickersStartRow && position < StickersActivity.this.stickersEndRow && StickersActivity.this.getParentActivity() != null) {
                ...
                TL_messages_stickerSet stickerSet = (TL_messages_stickerSet) StickersQuery.getStickerSets(StickersActivity.this.currentType).get(position - StickersActivity.this.stickersStartRow);
    ...
    class C68813 implements RequestDelegate {
        C68813() {
        }
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        class C68842 implements OnClickListener {
            C68842() {
            }
        ...
        public long getItemId(int i) {
            if (i >= StickersActivity.this.stickersStartRow && i < StickersActivity.this.stickersEndRow) {
                return ((TL_messages_stickerSet) StickersQuery.getStickerSets(StickersActivity.this.currentType).get(i - StickersActivity.this.stickersStartRow)).set.id;
            }
        ...
        private void processSelectionOption(int which, TL_messages_stickerSet stickerSet) {
            ...
            if (which == 0) {
                ...
                StickersQuery.removeStickersSet(parentActivity, stickerSet2, i, StickersActivity.this, true);
            } else if (which == 1) {
                ...
                try {
                    ...
                    StickersActivity.this.getParentActivity().startActivityForResult(Intent.createChooser(intent, LocaleController.getString("StickersShare", R.string.StickersShare)), HttpStatus.SC_INTERNAL_SERVER_ERROR);
                } catch (Exception e) {
                    FileLog.e(e);
                }
            } else if (which == 3) {
                try {
                    ((ClipboardManager) ApplicationLoader.applicationContext.getSystemService("clipboard")).setPrimaryClip(ClipData.newPlainText(PlusShare.KEY_CALL_TO_ACTION_LABEL, String.format(Locale.US, "https://" + MessagesController.getInstance().linkPrefix + "/addstickers/%s", new Object[]{stickerSet.set.short_name})));
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            switch (holder.getItemViewType()) {
                case 0:
                    ArrayList<TL_messages_stickerSet> arrayList = StickersQuery.getStickerSets(StickersActivity.this.currentType);
                    int row = position - StickersActivity.this.stickersStartRow;
                    ((StickerSetCell) holder.itemView).setStickersSet((TL_messages_stickerSet) arrayList.get(row), row != arrayList.size() + -1);
                    return;
                case 1:
                    if (position == StickersActivity.this.featuredInfoRow) {
                        String text = LocaleController.formatString("FeaturedStickersInfo", R.string.FeaturedStickersInfo, new Object[]{ApplicationLoader.getConfig().getAppName()});
                            ...
                            try {
                                ...
                                stringBuilder.setSpan(new URLSpanNoUnderline("@stickers") {
                                    public void onClick(View widget) {
                                        MessagesController.openByUserName(StickerManager.STICKERS_PREF, StickersActivity.this, 1);
                                    }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 0:
                    ...
                    ((StickerSetCell) view).setOnOptionsClick(new C68842());
                    break;
                case 1:
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C68791());
        ...
        this.listView.setOnItemClickListener(new C68802());
    ...
    private void sendReorder() {
        if (this.needReorder) {
            ...
            ConnectionsManager.getInstance().sendRequest(req, new C68813());
