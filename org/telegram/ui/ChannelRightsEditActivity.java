...
public class ChannelRightsEditActivity extends BaseFragment {
    ...
    class C58651 extends ActionBarMenuOnItemClick {
        C58651() {
        }
    ...
    class C58733 implements OnItemClickListener {

        class C58691 implements OnDateSetListener {

            class C58682 implements OnClickListener {
                C58682() {
                }
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                try {
                    ...
                    dialog.setButton(-2, LocaleController.getString("Cancel", R.string.Cancel), new C58682());
        ...
        class C58702 implements OnClickListener {
            C58702() {
            }
        ...
        class C58713 implements OnClickListener {
            C58713() {
            }
        ...
        public void onItemClick(View view, int position) {
            ...
            if (position == 0) {
                ...
                if (ChannelRightsEditActivity.this.getParentActivity() != null) {
                    Calendar calendar = Calendar.getInstance();
                    try {
                        DatePickerDialog dialog = new DatePickerDialog(ChannelRightsEditActivity.this.getParentActivity(), new C58691(), calendar.get(1), calendar.get(2), calendar.get(5));
                        ...
                        dialog.setButton(-1, LocaleController.getString("Set", R.string.Set), dialog);
                        dialog.setButton(-3, LocaleController.getString("UserRestrictionsUntilForever", R.string.UserRestrictionsUntilForever), new C58702());
                        dialog.setButton(-2, LocaleController.getString("Cancel", R.string.Cancel), new C58713());
    ...
    class C58744 implements ThemeDescriptionDelegate {
        C58744() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C58651());
        if (this.canEdit) {
        ...
        this.listView.setOnItemClickListener(new C58733());
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ThemeDescriptionDelegate сellDelegate = new C58744();
