...
public class ConvertGroupActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C63591 extends ActionBarMenuOnItemClick {
        C63591() {
        }
    ...
    class C63612 implements OnItemClickListener {

        class C63601 implements OnClickListener {
            C63601() {
            }
        ...
        public void onItemClick(View view, int position) {
            if (position == ConvertGroupActivity.this.convertRow) {
                ...
                builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new C63601());
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C63591());
        ...
        this.listView.setOnItemClickListener(new C63612());
