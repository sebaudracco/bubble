...
public class StickerPreviewViewer {
    ...
    private Runnable showSheetRunnable = new C68741();
    private int startX;
    private int startY;
    ...
    class C68741 implements Runnable {

        class C68732 implements OnDismissListener {
            C68732() {
            }
        ...
        public void run() {
            if (StickerPreviewViewer.this.parentActivity != null && StickerPreviewViewer.this.currentSet != null) {
                ...
                if (!items.isEmpty()) {
                    ...
                    StickerPreviewViewer.this.visibleDialog.setOnDismissListener(new C68732());
    ...
    class C68774 implements OnTouchListener {
        C68774() {
        }
    ...
    class C68785 implements Runnable {
        C68785() {
        }
            ...
            if (event.getAction() == 1 || event.getAction() == 3 || event.getAction() == 6) {
                ...
                if (isVisible()) {
                    ...
                    if (event.getAction() != 2) {
                        AndroidUtilities.cancelRunOnUIThread(this.openStickerPreviewRunnable);
                        this.openStickerPreviewRunnable = null;
                    } else if (Math.hypot((double) (((float) this.startX) - event.getX()), (double) (((float) this.startY) - event.getY())) > ((double) AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT))) {
                        AndroidUtilities.cancelRunOnUIThread(this.openStickerPreviewRunnable);
                        this.openStickerPreviewRunnable = null;
                    }
                }
    ...
    public void setParentActivity(Activity activity) {
        if (this.parentActivity != activity) {
            ...
            this.containerView.setOnTouchListener(new C68774());
    ...
    public void open(Document sticker, boolean isRecent) {
        if (this.parentActivity != null && sticker != null) {
            ...
            this.centerImage.setImage(sticker, null, sticker.thumb.location, null, "webp", 1);
        ...
        if (this.containerView != null && this.backgroundDrawable != null) {
            ...
            if (this.isVisible) {
                ...
                if (this.showProgress == 0.0f) {
                    ...
                    AndroidUtilities.runOnUIThread(new C68785());
                    try {
                        if (this.windowView.getParent() != null) {
                            ((WindowManager) this.parentActivity.getSystemService("window")).removeView(this.windowView);
                        }
