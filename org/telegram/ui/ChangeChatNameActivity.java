...
public class ChangeChatNameActivity extends BaseFragment implements AvatarUpdaterDelegate {
    ...
    class C57201 extends ActionBarMenuOnItemClick {

        class C57191 implements OnClickListener {
            C57191() {
            }
        ...
        public void onItemClick(int id) {
            if (id == -1) {
                ...
                if (ChangeChatNameActivity.this.avatarUpdater.uploadingAvatar != null) {
                    ...
                    ChangeChatNameActivity.this.progressDialog.setButton(-2, LocaleController.getString("Cancel", R.string.Cancel), new C57191());
    ...
    class C57212 implements OnTouchListener {
        C57212() {
        }
    ...
    class C57233 implements View.OnClickListener {

        class C57221 implements OnClickListener {
            C57221() {
            }
    ...
    class C57265 implements View.OnClickListener {

        class C57251 implements OnClickListener {
            C57251() {
            }
        ...
        public void onClick(View v) {
            ...
            builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new C57251());
            builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
            ChangeChatNameActivity.this.showDialog(builder.create());
        }
    }

    class C57287 implements Runnable {
        C57287() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C57201());
        ...
        this.fragmentView.setOnTouchListener(new C57212());
        ...
        this.avatarImage.setOnClickListener(new C57233());
        ...
        this.nameTextView.addTextChangedListener(new C57244());
        ...
        if (this.currentChat.creator) {
            ...
            shadowSectionCell.setOnClickListener(new C57265());
    ...
    public void onTransitionAnimationEnd(boolean isOpen, boolean backward) {
        if (isOpen) {
            AndroidUtilities.runOnUIThread(new C57287(), 100);
        }
    }
