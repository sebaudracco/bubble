...
public class GroupStickersActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C64481 extends ActionBarMenuOnItemClick {
        C64481() {
        }
    ...
    class C64503 implements TextWatcher {
    ...
    class C64514 implements OnClickListener {
        C64514() {
        }
    ...
    class C64536 implements OnItemClickListener {
        C64536() {
        }
    ...
    class C64547 extends OnScrollListener {
        C64547() {
        }
    ...
    class C64589 implements Runnable {
        C64589() {
        }
                            ...
                            try {
                                ...
                                stringBuilder.setSpan(new URLSpanNoUnderline("@stickers") {
                                    public void onClick(View widget) {
                                        MessagesController.openByUserName(StickerManager.STICKERS_PREF, GroupStickersActivity.this, 1);
                                    }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C64481());
        ...
        this.usernameTextView.addTextChangedListener(new C64503());
        ...
        this.eraseImageView.setOnClickListener(new C64514());
        ...
        this.listView.setOnItemClickListener(new C64536());
        this.listView.setOnScrollListener(new C64547());
    ...
    private void resolveStickerSet() {
        if (this.listAdapter != null) {
            ...
            Runnable c64578 = new Runnable() {

                class C64561 implements RequestDelegate {
                    C64561() {
                    }
                ...
                public void run() {
                    if (GroupStickersActivity.this.queryRunnable != null) {
                        ...
                        GroupStickersActivity.this.reqId = ConnectionsManager.getInstance().sendRequest(req, new C64561());
                    }
                }
            };
            this.queryRunnable = c64578;
            AndroidUtilities.runOnUIThread(c64578, 500);
        }
    }

    public void onTransitionAnimationEnd(boolean isOpen, boolean backward) {
        if (isOpen) {
            AndroidUtilities.runOnUIThread(new C64589(), 100);
        }
    }
