...
public class PhotoAlbumPickerActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C66811 extends ActionBarMenuOnItemClick {
        C66811() {
        }
    ...
    class C66822 implements OnTouchListener {
        C66822() {
        }
    ...
    class C66833 implements OnClickListener {
        C66833() {
        }
    ...
    class C66844 implements OnClickListener {
        C66844() {
        }
    ...
    class C66855 implements OnPreDrawListener {
        C66855() {
        }
    ...
    class C66866 implements PhotoPickerActivityDelegate {
        C66866() {
        }
    ...
    private class ListAdapter extends SelectionAdapter {
        ...
        class C66881 implements PhotoPickerAlbumsCellDelegate {
            C66881() {
            }
        ...
        class C66892 implements PhotoPickerSearchCellDelegate {
            C66892() {
            }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C66811());
        ...
        this.emptyView.setTextSize(CloseButton.TEXT_SIZE_SP);
        ...
        this.emptyView.setOnTouchListener(new C66822());
        ...
        this.pickerBottomLayout.cancelButton.setOnClickListener(new C66833());
        this.pickerBottomLayout.doneButton.setOnClickListener(new C66844());
    ...
    private void fixLayout() {
        if (this.listView != null) {
            this.listView.getViewTreeObserver().addOnPreDrawListener(new C66855());
        }
    }
    ...
    private void openPhotoPicker(AlbumEntry albumEntry, int type) {
        ...
        if (albumEntry != null) {
            ...
            fragment.setDelegate(new C66866());
        } else {
