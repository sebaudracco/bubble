...
public class ContactsActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C63511 extends ActionBarMenuOnItemClick {
        C63511() {
        }
    ...
    class C63522 extends ActionBarMenuItemSearchListener {
        C63522() {
        }
    ...
    class C63543 implements OnItemClickListener {
        C63543() {
        }
                ...
                if ((ContactsActivity.this.onlyUsers && ContactsActivity.this.chat_id == 0) || section != 0) {
                    ...
                    if (item instanceof User) {
                        ...
                        if (usePhone != null && ContactsActivity.this.getParentActivity() != null) {
                            ...
                            builder.setMessage(LocaleController.getAppNameString("InviteUser", R.string.InviteUser));
                            ...
                            builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new OnClickListener() {
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    try {
                                        ...
                                        ContactsActivity.this.getParentActivity().startActivityForResult(intent, HttpStatus.SC_INTERNAL_SERVER_ERROR);
                                    } catch (Exception e) {
                                        FileLog.e(e);
                                    }
                                }
    ...
    class C63554 extends OnScrollListener {
        C63554() {
        }
    ...
    class C63587 implements ThemeDescriptionDelegate {
        C63587() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C63511());
        ActionBarMenu menu = this.actionBar.createMenu();
        menu.addItem(0, (int) R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new C63522()).getSearchField().setHint(LocaleController.getString("Search", R.string.Search));
        ...
        this.listView.setOnItemClickListener(new C63543());
        this.listView.setOnScrollListener(new C63554());
    ...
    private void didSelectResult(final User user, boolean useAlert, String param) {
        if (!useAlert || this.selectAlertString == null) {
            ...
            if (!user.bot && this.needForwardCount) {
                ...
                editText.setTextSize(1, RadialCountdown.TEXT_SIZE_SP);
                editText.setText("50");
                    ...
                    public void afterTextChanged(Editable s) {
                        try {
                            ...
                            if (str.length() != 0) {
                                ...
                                if (value < 0) {
                                    editTextFinal.setText(SchemaSymbols.ATTVAL_FALSE_0);
                                    editTextFinal.setSelection(editTextFinal.length());
                                } else if (value > HttpStatus.SC_MULTIPLE_CHOICES) {
            ...
            builder.setPositiveButton(LocaleController.getString("OK", R.string.OK), new OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
                    ContactsActivity.this.didSelectResult(user, false, finalEditText != null ? finalEditText.getText().toString() : SchemaSymbols.ATTVAL_FALSE_0);
                }
            });
            builder.setNegativeButton(LocaleController.getString("Cancel", R.string.Cancel), null);
    ...
    public ThemeDescription[] getThemeDescriptions() {
        ThemeDescriptionDelegate сellDelegate = new C63587();
