...
public class InviteContactsActivity extends BaseFragment implements NotificationCenterDelegate, OnClickListener {
    ...
    class C64731 extends ActionBarMenuOnItemClick {
        C64731() {
        }
    ...
    class C64775 implements Callback {
        C64775() {
        }
    ...
    class C64786 implements OnKeyListener {
    ...
    class C64797 implements TextWatcher {
        C64797() {
        }
    ...
    class C64808 implements OnItemClickListener {
        C64808() {
        }
        ...
        public void onItemClick(View view, int position) {
            ...
            if (position == 0 && !InviteContactsActivity.this.searching) {
                try {
                    ...
                    InviteContactsActivity.this.getParentActivity().startActivityForResult(Intent.createChooser(intent, text), HttpStatus.SC_INTERNAL_SERVER_ERROR);
                } catch (Exception e) {
                    FileLog.e(e);
                }
    ...
    class C64819 extends OnScrollListener {
        C64819() {
        }
    ...
    public class InviteAdapter extends SelectionAdapter {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 1:
                    ...
                    ((InviteTextCell) view).setTextAndIcon(LocaleController.formatString("ShareTelegram", R.string.ShareTelegram, new Object[]{ApplicationLoader.getConfig().getAppName()}), R.drawable.share);
                    break;
                default:
        ...
        public void searchDialogs(final String query) {
            ...
            this.searchTimer.schedule(new TimerTask() {
                ...
                class C64831 implements Runnable {

                    class C64821 implements Runnable {
                        C64821() {
                        }
                    ...
                    public void run() {
                        Utilities.searchQueue.postRunnable(new C64821());
                    }
                }
                ...
                public void run() {
                    ...
                    AndroidUtilities.runOnUIThread(new C64831());
                }
            }, 200, 300);
        }
    ...
    private class SpansContainer extends ViewGroup {
        ...
        class C64861 extends AnimatorListenerAdapter {
            C64861() {
            }
        ...
        public void addSpan(GroupCreateSpan span) {
            ...
            this.currentAnimation.addListener(new C64861());
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C64731());
        ...
        this.scrollView = new ScrollView(context) {
            public boolean requestChildRectangleOnScreen(View child, Rect rectangle, boolean immediate) {
                ...
                rectangle.top += InviteContactsActivity.this.fieldY + AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP);
        ...
        this.editText.setCustomSelectionActionModeCallback(new C64775());
        this.editText.setOnKeyListener(new C64786());
        this.editText.addTextChangedListener(new C64797());
        ...
        this.listView.setOnItemClickListener(new C64808());
        this.listView.setOnScrollListener(new C64819());
        ...
        this.infoTextView.setText(LocaleController.formatString("InviteFriendsHelp", R.string.InviteFriendsHelp, new Object[]{ApplicationLoader.getConfig().getAppName()}));
        ...
        this.counterView.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                try {
                    ...
                    InviteContactsActivity.this.getParentActivity().startActivityForResult(intent, HttpStatus.SC_INTERNAL_SERVER_ERROR);
        ...
        this.counterTextView.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT), -1));
        this.counterTextView.setMinWidth(AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP));
        ...
        this.textView.setText(LocaleController.formatString("InviteToTelegram", R.string.InviteToTelegram, new Object[]{ApplicationLoader.getConfig().getAppName()}).toUpperCase());
