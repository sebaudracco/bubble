...
public class PrivacyControlActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C67511 extends ActionBarMenuOnItemClick {
        C67511() {
        }
    ...
    class C67542 implements OnItemClickListener {
        C67542() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C67511());
        ...
        this.listView.setOnItemClickListener(new C67542());
