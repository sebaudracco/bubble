...
public class AlertDialog extends Dialog implements Callback {
    ...
    class C54953 implements View.OnClickListener {
        C54953() {
        }
    ...
    class C54986 implements View.OnClickListener {
        C54986() {
        }
    ...
    class C55008 implements View.OnClickListener {
        C55008() {
        }
    ...
    L_0x0065:
        ...
        r3 = r24.getContext();
        r3 = r3.getResources();
        r4 = 2131231278; // 0x7f08022e float:1.8078633E38 double:1.052968158E-314;
    ...
    L_0x01a8:
        ...
        r2 = r24.getContext();
        r2 = r2.getResources();
        r5 = 2131231002; // 0x7f08011a float:1.8078073E38 double:1.0529680214E-314;
        ...
        r2 = r24.getContext();
        r2 = r2.getResources();
        r5 = 2131231003; // 0x7f08011b float:1.8078075E38 double:1.052968022E-314;
        r2 = r2.getDrawable(r5);
        r2 = r2.mutate();
        r2 = (android.graphics.drawable.BitmapDrawable) r2;
        r3[r4] = r2;
