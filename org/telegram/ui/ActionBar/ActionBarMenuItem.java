...
public class ActionBarMenuItem extends FrameLayout {
    ...
    class C54791 implements Runnable {
        C54791() {
        }
    ...
    class C54802 implements OnTouchListener {
        C54802() {
        }
    ...
    class C54813 implements OnDispatchKeyEventListener {
        C54813() {
        }
    ...
    class C54824 implements OnClickListener {
        C54824() {
        }
    ...
    class C54835 implements OnKeyListener {
        C54835() {
        }
    ...
    class C54868 implements Callback {
        C54868() {
        }
    ...
    class C54879 implements OnEditorActionListener {
        C54879() {
        }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getActionMasked() == 0) {
            if (hasSubMenu() && (this.popupWindow == null || !(this.popupWindow == null || this.popupWindow.isShowing()))) {
                this.showMenuRunnable = new C54791();
    ...
    private void createPopupLayout() {
        if (this.popupLayout == null) {
            ...
            this.popupLayout.setOnTouchListener(new C54802());
            this.popupLayout.setDispatchKeyEventListener(new C54813());
        }
    }
    ...
    public TextView addSubItem(int id, String text) {
        ...
        textView.setOnClickListener(new C54824());
        ...
        if (this.popupLayout != null) {
            ...
            if (this.popupWindow == null || !this.popupWindow.isShowing()) {
                if (this.popupWindow == null) {
                    ...
                    this.popupWindow.getContentView().setOnKeyListener(new C54835());
                }
    ...
    public ActionBarMenuItem setIsSearchField(boolean value) {
        if (this.parentMenu != null) {
            if (value && this.searchContainer == null) {
                ...
                this.searchFieldCaption.setTextSize(1, RadialCountdown.TEXT_SIZE_SP);
                ...
                this.searchField.setTextSize(1, RadialCountdown.TEXT_SIZE_SP);
                ...
                if (VERSION.SDK_INT < 23) {
                    this.searchField.setCustomSelectionActionModeCallback(new C54868());
                }
                this.searchField.setOnEditorActionListener(new C54879());
