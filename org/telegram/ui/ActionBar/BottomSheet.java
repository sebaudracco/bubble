...
public class BottomSheet extends Dialog {
    ...
    protected class ContainerView extends FrameLayout implements NestedScrollingParent {
        ...
        class C55141 extends AnimatorListenerAdapter {
            C55141() {
            }
        ...
        private void checkDismiss(float velX, float velY) {
            ...
            if (backAnimation) {
                ...
                this.currentAnimation.addListener(new C55141());
    ...
    class C55042 implements OnApplyWindowInsetsListener {
        C55042() {
        }
    ...
    class C55064 implements OnTouchListener {
        C55064() {
        }
    ...
    class C55075 implements View.OnClickListener {
        C55075() {
        }
    ...
    class C55086 implements Runnable {
        C55086() {
        }
    ...
    class C55097 extends AnimatorListenerAdapter {
        C55097() {
        }
    ...
    class C55139 extends AnimatorListenerAdapter {

        class C55121 implements Runnable {
            C55121() {
            }
        ...
        public void onAnimationEnd(Animator animation) {
            if (BottomSheet.this.currentSheetAnimation != null && BottomSheet.this.currentSheetAnimation.equals(animation)) {
                BottomSheet.this.currentSheetAnimation = null;
                AndroidUtilities.runOnUIThread(new C55121());
            }
        }
    ...
    public BottomSheet(Context context, boolean needFocus) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            this.container.setOnApplyWindowInsetsListener(new C55042());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (this.title != null) {
            ...
            titleView.setOnTouchListener(new C55064());
            topOffset = 0 + 48;
        }
        if (this.customView != null) {
            ...
            while (a < this.items.length) {
                if (this.items[a] != null) {
                    ...
                    cell.setOnClickListener(new C55075());
    ...
    public void show() {
        ...
        if (VERSION.SDK_INT >= 18) {
            ...
            Runnable c55086 = new C55086();
            this.startAnimationRunnable = c55086;
            AndroidUtilities.runOnUIThread(c55086, 150);
            return;
        }
        startOpenAnimation();
    }
    ...
    private void startOpenAnimation() {
        if (!this.dismissed) {
            ...
            if (!onCustomOpenAnimation()) {
                ...
                animatorSet.addListener(new C55097());
                animatorSet.start();
    ...
    public void dismissWithButtonClick(final int item) {
        if (!this.dismissed) {
            ...
            AnimatorSet animatorSet = new AnimatorSet();
            r1 = new Animator[2];
            r1[0] = ObjectAnimator.ofFloat(this.containerView, "translationY", new float[]{(float) (this.containerView.getMeasuredHeight() + AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT))});
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() {
                ...
                class C55101 implements Runnable {
                    C55101() {
                    }
                ...
                public void onAnimationEnd(Animator animation) {
                    if (BottomSheet.this.currentSheetAnimation != null && BottomSheet.this.currentSheetAnimation.equals(animation)) {
                        ...
                        AndroidUtilities.runOnUIThread(new C55101());
                    }
                }
    ...
    public void dismiss() {
        if ((this.delegate == null || this.delegate.canDismiss()) && !this.dismissed) {
            ...
            if (!this.allowCustomAnimation || !onCustomCloseAnimation()) {
                AnimatorSet animatorSet = new AnimatorSet();
                r2 = new Animator[2];
                r2[0] = ObjectAnimator.ofFloat(this.containerView, "translationY", new float[]{(float) (this.containerView.getMeasuredHeight() + AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT))});
                ...
                animatorSet.setInterpolator(new AccelerateInterpolator());
                animatorSet.addListener(new C55139());
                animatorSet.start();
                this.currentSheetAnimation = animatorSet;
            }
        }
