...
public class ActionBarLayout extends FrameLayout {
    ...
    class C54724 extends AnimatorListenerAdapter {
        C54724() {
        }
    ...
    class C54746 implements Runnable {
        C54746() {
        }
    ...
    class C54757 implements Runnable {
        C54757() {
        }
    ...
    class C54768 implements Runnable {
        C54768() {
        }
    ...
    private void startLayoutAnimation(final boolean open, final boolean first) {
        ...
        this.animationRunnable = c54702;
        AndroidUtilities.runOnUIThread(c54702);
    }
    ...
    public boolean presentFragment(final BaseFragment fragment, final boolean removeLast, boolean forceWithoutAnimation, boolean check) {
        ...
        if (!needAnimation) {
            ...
            this.currentAnimation.addListener(new C54724());
            ...
            fragment.onTransitionAnimationStart(true, false);
            AnimatorSet animation = fragment.onCustomTransitionAnimation(true, new C54746());
            if (animation == null) {
