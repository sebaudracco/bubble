...
public class Theme {
    ...
    static class C55181 extends StateListDrawable {
        C55181() {
        }
    ...
    static class C55192 extends StateListDrawable {
        C55192() {
        }
    ...
    static class C55203 extends StateListDrawable {
        C55203() {
        }
    ...
    static class C55214 extends Drawable {
        C55214() {
        }

        public void draw(Canvas canvas) {
            Rect bounds = getBounds();
            canvas.drawCircle((float) bounds.centerX(), (float) bounds.centerY(), (float) AndroidUtilities.dp(RadialCountdown.TEXT_SIZE_SP), Theme.maskPaint);
        }
    ...
    static class C55225 implements Comparator<ThemeInfo> {
        C55225() {
        }
    ...
    static class C55236 implements Runnable {
        C55236() {
        }
    ...
    static class C55257 implements Runnable {

        class C55241 implements Runnable {
            C55241() {
            }
                ...
                if (!ApplicationLoader.applicationContext.getSharedPreferences("mainconfig", 0).getBoolean("overrideThemeWallpaper", false)) {
                    ...
                    if (backgroundColor != null) {
                        ...
                        try {
                            ...
                            if (Theme.wallpaper == null) {
                                ...
                                if (i == 0) {
                                    if (selectedBackground == 1000001) {
                                        ...
                                        if (toFile.exists()) {
                                            Theme.wallpaper = Drawable.createFromPath(toFile.getAbsolutePath());
                                            Theme.isCustomTheme = true;
                                        } else {
                                            Theme.wallpaper = ApplicationLoader.applicationContext.getResources().getDrawable(R.drawable.background_hd);
                                            Theme.isCustomTheme = false;
                            ...
                            AndroidUtilities.runOnUIThread(new C55241());
                        }
                    }
                }
                if (Theme.wallpaper == null) {
    ...
    public static class ThemeInfo {
        ...
        public JSONObject getSaveJson() {
            try {
                ...
                jsonObject.put(ClientCookie.PATH_ATTR, this.pathToFile);
                return jsonObject;
            } catch (Exception e) {
                FileLog.e(e);
                return null;
        ...
        public static ThemeInfo createWithJson(JSONObject object) {
            ...
            try {
                ...
                themeInfo.pathToFile = object.getString(ClientCookie.PATH_ATTR);
                return themeInfo;
            } catch (Exception e) {
                FileLog.e(e);
                return null;
    ...
    public static Drawable createEmojiIconSelectorDrawable(Context context, int resource, int defaultColor, int pressedColor) {
        ...
        StateListDrawable stateListDrawable = new C55181();
    ...
    public static Drawable createEditTextDrawable(Context context, boolean alert) {
        ...
        StateListDrawable stateListDrawable = new C55192();
    ...
    public static Drawable createSimpleSelectorDrawable(Context context, int resource, int defaultColor, int pressedColor) {
        ...
        StateListDrawable stateListDrawable = new C55203();
    ...
    private static void sortThemes() {
        Collections.sort(themes, new C55225());
    }
    ...
    public static void applyTheme(ThemeInfo themeInfo, boolean save, boolean removeWallpaperOverride) {
        if (themeInfo != null) {
            ...
            try {
                ...
                AndroidUtilities.runOnUIThread(new C55236());
            } catch (Exception e) {
                FileLog.e(e);
            }
        }
    ...
    public static void createChatResources(Context context, boolean fontsOnly) {
        ...
        chat_msgTextPaintThreeEmoji.setTextSize((float) AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP));
        ...
        chat_msgBotButtonPaint.setTextSize((float) AndroidUtilities.dp(CtaButton.TEXT_SIZE_SP));
        if (!fontsOnly && chat_botProgressPaint != null) {
            ...
            chat_docNamePaint.setTextSize((float) AndroidUtilities.dp(CtaButton.TEXT_SIZE_SP));
            chat_locationTitlePaint.setTextSize((float) AndroidUtilities.dp(CtaButton.TEXT_SIZE_SP));
            ...
            chat_audioPerformerPaint.setTextSize((float) AndroidUtilities.dp(CtaButton.TEXT_SIZE_SP));
            chat_botButtonPaint.setTextSize((float) AndroidUtilities.dp(CtaButton.TEXT_SIZE_SP));
            chat_contactNamePaint.setTextSize((float) AndroidUtilities.dp(CtaButton.TEXT_SIZE_SP));
            ...
            chat_contextResult_titleTextPaint.setTextSize((float) AndroidUtilities.dp(CtaButton.TEXT_SIZE_SP));
    ...
    public static void loadWallpaper() {
        if (wallpaper == null) {
            Utilities.searchQueue.postRunnable(new C55257());
        }
    }
