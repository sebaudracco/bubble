...
public class ActionBar extends FrameLayout {
    ...
    class C54651 implements OnClickListener {
        C54651() {
        }
    ...
    class C54662 implements OnClickListener {
        C54662() {
        }
    ...
    class C54673 extends AnimatorListenerAdapter {
        C54673() {
        }
    ...
    class C54684 extends AnimatorListenerAdapter {
        C54684() {
        }
    ...
    private void createBackButtonImage() {
        if (this.backButtonImageView == null) {
            ...
            this.backButtonImageView.setOnClickListener(new C54662());
        }
    }
    ...
    public void showActionMode() {
        if (this.actionMode != null && !this.actionModeVisible) {
            ...
            this.actionModeAnimation.addListener(new C54673());
    ...
    public void hideActionMode() {
        if (this.actionMode != null && this.actionModeVisible) {
            ...
            this.actionModeAnimation.playTogether(animators);
            this.actionModeAnimation.setDuration(200);
            this.actionModeAnimation.addListener(new C54684());
            this.actionModeAnimation.start();
            if (this.titleTextView != null) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.backButtonImageView == null || this.backButtonImageView.getVisibility() == 8) {
            textLeft = AndroidUtilities.dp(AndroidUtilities.isTablet() ? 26.0f : RadialCountdown.TEXT_SIZE_SP);
        } else {
