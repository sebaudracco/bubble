...
public class ActionBarPopupWindow extends PopupWindow {
    private static final OnScrollChangedListener NOP = new C54881();
    ...
    static class C54881 implements OnScrollChangedListener {
        C54881() {
        }
    ...
    class C54892 implements AnimatorListener {
        C54892() {
        }
    ...
    class C54903 implements AnimatorListener {
        C54903() {
        }
    ...
    public void startAnimation() {
        if (this.animationEnabled && this.windowAnimatorSet == null) {
            ...
            this.windowAnimatorSet.addListener(new C54892());
    ...
    public void dismiss(boolean animated) {
        ...
        if (this.animationEnabled && animated) {
            ...
            this.windowAnimatorSet.addListener(new C54903());
            this.windowAnimatorSet.start();
            return;
        }
        try {
