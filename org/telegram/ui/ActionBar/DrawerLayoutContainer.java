...
public class DrawerLayoutContainer extends FrameLayout {
    ...
    class C55151 implements OnApplyWindowInsetsListener {
        C55151() {
        }
    ...
    class C55162 extends AnimatorListenerAdapter {
        C55162() {
        }
    ...
    class C55173 extends AnimatorListenerAdapter {
        C55173() {
        }
    ...
    public DrawerLayoutContainer(Context context) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            setOnApplyWindowInsetsListener(new C55151());
    ...
    public void openDrawer(boolean fast) {
        if (this.allowOpenDrawer) {
            ...
            animatorSet.addListener(new C55162());
            animatorSet.start();
    ...
    public void closeDrawer(boolean fast) {
        ...
        animatorSet.addListener(new C55173());
        animatorSet.start();
    }
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (this.scrimOpacity <= 0.0f || !drawingContent) {
            ...
            float alpha = Math.max(0.0f, Math.min(this.drawerPosition / ((float) AndroidUtilities.dp(CloseButton.TEXT_SIZE_SP)), 1.0f));
            if (alpha == 0.0f) {
                return result;
            }
