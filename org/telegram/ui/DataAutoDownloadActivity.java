...
public class DataAutoDownloadActivity extends BaseFragment {
    ...
    class C63711 extends ActionBarMenuOnItemClick {
        C63711() {
        }
    ...
    class C63722 implements OnItemClickListener {
        C63722() {
        }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C63711());
        ...
        this.listView.setOnItemClickListener(new C63722());
