...
public class SecretMediaViewer implements NotificationCenterDelegate, OnGestureListener, OnDoubleTapListener {
    ...
    class C68211 implements VideoPlayerDelegate {
        C68211() {
        }
    ...
    class C68244 implements OnApplyWindowInsetsListener {
        C68244() {
        }
    ...
    class C68255 extends ActionBarMenuOnItemClick {
        C68255() {
        }
    ...
    class C68266 implements Runnable {
        C68266() {
        }
    ...
    class C68277 extends AnimatorListenerAdapter {
        C68277() {
        }
    ...
    class C68299 extends AnimatorListenerAdapter {
        C68299() {
        }
    ...
    private class SecretDeleteTimer extends FrameLayout {
        ...
        private void updateParticles(long dt) {
            ...
            while (a < count) {
                ...
                if (particle.currentTime >= particle.lifeTime) {
                    ...
                    particle.f12668x += ((particle.vx * particle.velocity) * ((float) dt)) / 500.0f;
                    particle.f12669y += ((particle.vy * particle.velocity) * ((float) dt)) / 500.0f;
        ...
        protected void onDraw(Canvas canvas) {
            if (SecretMediaViewer.this.currentMessageObject != null && SecretMediaViewer.this.currentMessageObject.messageOwner.destroyTime != 0) {
                ...
                this.drawable.setBounds(x, y, AndroidUtilities.dp(Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT) + x, AndroidUtilities.dp(14.0f) + y);
                this.drawable.draw(canvas);
                float radProgress = -360.0f * progress;
                canvas.drawArc(this.deleteProgressRect, RadialCountdown.START_ANGLE, radProgress, false, this.afterDeleteProgressPaint);
                int count = this.particles.size();
                for (a = 0; a < count; a++) {
                    Particle particle = (Particle) this.particles.get(a);
                    this.particlePaint.setAlpha((int) (255.0f * particle.alpha));
                    canvas.drawPoint(particle.f12668x, particle.f12669y, this.particlePaint);
                }
                ...
                for (a = 0; a < 1; a++) {
                    ...
                    newParticle.f12668x = cx;
                    newParticle.f12669y = cy;
                    double angle = 0.017453292519943295d * ((double) (Utilities.random.nextInt(PDUiBeacon.Gimbal) - 70));
                    if (angle < 0.0d) {
                    ...
                    newParticle.lifeTime = (float) (Utilities.random.nextInt(100) + HttpStatus.SC_BAD_REQUEST);
                    newParticle.velocity = CloseButton.TEXT_SIZE_SP + (Utilities.random.nextFloat() * 4.0f);
    ...
    private void preparePlayer(File file) {
        if (this.parentActivity != null) {
            ...
            if (this.videoPlayer == null) {
                ...
                this.videoPlayer.setDelegate(new C68211());
            }
    ...
    public void setParentActivity(Activity activity) {
        if (this.parentActivity != activity) {
            ...
            if (VERSION.SDK_INT >= 21) {
                ...
                this.containerView.setOnApplyWindowInsetsListener(new C68244());
            ...
            this.actionBar.setActionBarMenuOnItemClick(new C68255());
    ...
    public void openMedia(MessageObject messageObject, PhotoViewerProvider provider) {
        if (this.parentActivity != null && messageObject != null && messageObject.isSecretPhoto() && provider != null) {
            ...
            if (object != null) {
                ...
                this.photoAnimationEndRunnable = new C68266();
                this.imageMoveAnimation.setDuration(250);
                this.imageMoveAnimation.addListener(new C68277());
    ...
    private void toggleActionBar(boolean show, boolean animated) {
        ...
        if (animated) {
            ...
            if (!show) {
                this.currentActionBarAnimation.addListener(new C68299());
            }
        ...
        if (this.parentActivity != null && this.isPhotoVisible && !checkPhotoAnimation()) {
            ...
            if (animated) {
                ...
                this.imageMoveAnimation.addListener(new AnimatorListenerAdapter() {
                    ...
                    class C68201 implements Runnable {
                        C68201() {
                        }
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ...
                        AndroidUtilities.runOnUIThread(new C68201());
                    }
                });
                this.photoTransitionAnimationStartTime = System.currentTimeMillis();
                if (VERSION.SDK_INT >= 18) {
