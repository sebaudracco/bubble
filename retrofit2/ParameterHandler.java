...
abstract class ParameterHandler<T> {
    ...
    class C69721 extends ParameterHandler<Iterable<T>> {
        C69721() {
        }
    ...
    class C69732 extends ParameterHandler<Object> {
        C69732() {
        }
    ...
    static final class PartMap<T> extends ParameterHandler<Map<String, T>> {
        ...
        void apply(RequestBuilder builder, Map<String, T> value) throws IOException {
            ...
            for (Entry<String, T> entry : value.entrySet()) {
                ...
                builder.addPart(Headers.of(new String[]{"Content-Disposition", "form-data; name=\"" + entryKey + "\"", MIME.CONTENT_TRANSFER_ENC, this.transferEncoding}), (RequestBody) this.valueConverter.convert(entryValue));
            }
        }
    }
