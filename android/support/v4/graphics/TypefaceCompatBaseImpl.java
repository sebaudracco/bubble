...
class TypefaceCompatBaseImpl implements TypefaceCompatImpl {
    ...
    class C01781 implements StyleExtractor<FontInfo> {
        C01781() {
        }
    ...
    class C01792 implements StyleExtractor<FontFileResourceEntry> {
        C01792() {
        }
    ...
    protected FontInfo findBestInfo(FontInfo[] fonts, int style) {
        return (FontInfo) findBestFont(fonts, style, new C01781());
    }
    ...
    private FontFileResourceEntry findBestEntry(FontFamilyFilesResourceEntry entry, int style) {
        return (FontFileResourceEntry) findBestFont(entry.getEntries(), style, new C01792());
    }
