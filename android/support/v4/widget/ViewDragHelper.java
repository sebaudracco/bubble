...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C03061();
    ...
    private final Runnable mSetIdleRunnable = new C03072();
    ...
    private ViewDragHelper(Context context, ViewGroup forParent, Callback cb) {
        if (forParent == null) {
            ...
            this.mEdgeSize = (int) ((CloseButton.TEXT_SIZE_SP * context.getResources().getDisplayMetrics().density) + 0.5f);
