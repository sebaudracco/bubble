...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    public void setStyle(int size) {
        if (size == 0) {
            ...
            setSizeParameters(CENTER_RADIUS, STROKE_WIDTH, Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT, 5.0f);
        }
        invalidateSelf();
    }
    ...
    private void applyFinishTranslation(float interpolatedTime, Ring ring) {
        ...
        float targetRotation = (float) (Math.floor((double) (ring.getStartingRotation() / MAX_PROGRESS_ARC)) + MoPubAdapter.DEFAULT_MOPUB_IMAGE_SCALE);
