...
public class MediaSessionCompat {
    ...
    class C02241 extends Callback {
        C02241() {
        }
    }

    class C02252 extends Callback {
        C02252() {
        }
    }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C02281();
        VolumeProviderCompat mVolumeProvider;
        int mVolumeType;

        class C02281 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C02281() {
            }
    ...
    static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        class C02261 implements OnPlaybackPositionUpdateListener {
            C02261() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setPlaybackPositionUpdateListener(new C02261());
        }
    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        class C02271 implements OnMetadataUpdateListener {
            C02271() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setMetadataUpdateListener(new C02271());
        }
    ...
    public static final class QueueItem implements Parcelable {
        public static final Creator<QueueItem> CREATOR = new C02291();
        public static final int UNKNOWN_ID = -1;
        private final MediaDescriptionCompat mDescription;
        private final long mId;
        private Object mItem;

        static class C02291 implements Creator<QueueItem> {
            C02291() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        public static final Creator<ResultReceiverWrapper> CREATOR = new C02301();
        private ResultReceiver mResultReceiver;

        static class C02301 implements Creator<ResultReceiverWrapper> {
            C02301() {
            }
    ...
    public static final class Token implements Parcelable {
        public static final Creator<Token> CREATOR = new C02311();
        private final IMediaSession mExtraBinder;
        private final Object mInner;

        static class C02311 implements Creator<Token> {
            C02311() {
            }
