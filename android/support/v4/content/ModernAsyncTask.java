...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C01721();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C01732();

    static class C01721 implements ThreadFactory {
    ...
    class C01732 extends WorkerRunnable<Params, Result> {
        C01732() {
        }
