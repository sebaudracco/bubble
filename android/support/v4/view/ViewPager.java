...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C02741();
    ...
    private static final Interpolator sInterpolator = new C02752();
    ...
    private final Runnable mEndScrollRunnable = new C02763();
    ...
    static class C02741 implements Comparator<ItemInfo> {
        C02741() {
        }
    ...
    static class C02752 implements Interpolator {
        C02752() {
        }
    ...
    class C02774 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C02781 implements ClassLoaderCreator<SavedState> {
            C02781() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02774());
    }
