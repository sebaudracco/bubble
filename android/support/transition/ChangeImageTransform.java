...
public class ChangeImageTransform extends Transition {
    ...
    private static final TypeEvaluator<Matrix> NULL_MATRIX_EVALUATOR = new C01001();
    ...
    static class C01001 implements TypeEvaluator<Matrix> {
        C01001() {
        }
    ...
    private static Matrix copyImageMatrix(ImageView view) {
        switch (C01023.$SwitchMap$android$widget$ImageView$ScaleType[view.getScaleType().ordinal()]) {
            case 1:
