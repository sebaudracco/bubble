...
class ViewGroupUtilsApi14 implements ViewGroupUtilsImpl {
    ...
    class C01241 extends LayoutTransition {
        C01241() {
        }
    ...
    public void suppressLayout(@NonNull ViewGroup group, boolean suppress) {
        if (sEmptyLayoutTransition == null) {
            sEmptyLayoutTransition = new C01241();
        ...
        if (suppress) {
            ...
            if (layoutTransition != null) {
                ...
                if (layoutTransition != sEmptyLayoutTransition) {
                    group.setTag(C0111R.id.transition_layout_save, layoutTransition);
                }
            }
        ...
        layoutTransition = (LayoutTransition) group.getTag(C0111R.id.transition_layout_save);
        if (layoutTransition != null) {
            group.setTag(C0111R.id.transition_layout_save, null);
