...
class GhostViewApi14 extends View implements GhostViewImpl {
    ...
    private final OnPreDrawListener mOnPreDrawListener = new C01071();
    int mReferences;
    ViewGroup mStartParent;
    View mStartView;
    final View mView;

    class C01071 implements OnPreDrawListener {
        C01071() {
        }
    ...
    private static void setGhostView(@NonNull View view, GhostViewApi14 ghostView) {
        view.setTag(C0111R.id.ghost_view, ghostView);
    }

    static GhostViewApi14 getGhostView(@NonNull View view) {
        return (GhostViewApi14) view.getTag(C0111R.id.ghost_view);
    }
}
