...
public class ConstraintSet {
    ...
    static {
        ...
        mapToConstant.append(C0005R.styleable.ConstraintSet_layout_constraintLeft_creator, 60);
        mapToConstant.append(C0005R.styleable.ConstraintSet_layout_constraintTop_creator, 60);
        mapToConstant.append(C0005R.styleable.ConstraintSet_layout_constraintRight_creator, 60);
        mapToConstant.append(C0005R.styleable.ConstraintSet_layout_constraintBottom_creator, 60);
        mapToConstant.append(C0005R.styleable.ConstraintSet_layout_constraintBaseline_creator, 60);
