...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C03311();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C03322();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C03333();

    class C03311 extends ViewPropertyAnimatorListenerAdapter {
        C03311() {
        }
    ...
    class C03322 extends ViewPropertyAnimatorListenerAdapter {
        C03322() {
        }
    ...
    class C03333 implements ViewPropertyAnimatorUpdateListener {
        C03333() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0334R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0334R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0334R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0334R.id.action_bar_container);
        ...
        if (a.getBoolean(C0334R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0334R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0334R.attr.actionBarWidgetTheme, outValue, true);
