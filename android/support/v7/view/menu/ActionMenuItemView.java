...
public class ActionMenuItemView extends AppCompatTextView implements ItemView, OnClickListener, ActionMenuChildView {
    ...
    public ActionMenuItemView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0334R.styleable.ActionMenuItemView, defStyle, 0);
        this.mMinWidth = a.getDimensionPixelSize(C0334R.styleable.ActionMenuItemView_android_minWidth, 0);
        a.recycle();
    ...
    private boolean shouldAllowTextWithIcon() {
        ...
        return widthDp >= SizeUtils.DEFAULT_INTERSTITIAL_HEIGHT || ((widthDp >= 640 && config.screenHeightDp >= SizeUtils.DEFAULT_INTERSTITIAL_HEIGHT) || config.orientation == 2);
    }
