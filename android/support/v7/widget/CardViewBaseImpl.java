...
class CardViewBaseImpl implements CardViewImpl {
    ...
    class C03771 implements RoundRectHelper {
        C03771() {
        }
        ...
        public void drawRoundRect(Canvas canvas, RectF bounds, float cornerRadius, Paint paint) {
            ...
            if (cornerRadius >= 1.0f) {
                ...
                canvas.drawArc(CardViewBaseImpl.this.mCornerRect, BitmapDescriptorFactory.HUE_CYAN, 90.0f, true, paint);
    ...
    public void initStatic() {
        RoundRectDrawableWithShadow.sRoundRectHelper = new C03771();
    }
