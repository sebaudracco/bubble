...
import android.support.v7.recyclerview.C0340R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C04051();
        ...
        private final Callback mVerticalBoundCheckCallback = new C04062();
        private int mWidth;
        ...
        class C04062 implements Callback {
            C04062() {
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0340R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0340R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0340R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0340R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0340R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    class C04024 implements ProcessCallback {
        C04024() {
        }
    ...
    class C04035 implements Callback {
        C04035() {
        }
    ...
    class C04046 implements Callback {
        C04046() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C04071();
        Parcelable mLayoutState;

        static class C04071 implements ClassLoaderCreator<SavedState> {
            C04071() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mViewInfoProcessCallback = new C04024();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0340R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0340R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0340R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = a.getBoolean(C0340R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) a.getDrawable(C0340R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a.getDrawable(C0340R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a.getDrawable(C0340R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a.getDrawable(C0340R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            a.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C04035());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C04046());
    }
    ...
    void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        FastScroller fastScroller = new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C0340R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0340R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0340R.dimen.fastscroll_margin));
    }
