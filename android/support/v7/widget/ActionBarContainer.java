...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0334R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C0334R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C0334R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C0334R.styleable.ActionBar_height, -1);
        if (getId() == C0334R.id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C0334R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
        if (this.mIsSplit) {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0334R.id.action_bar);
        this.mContextView = findViewById(C0334R.id.action_context_bar);
    }
