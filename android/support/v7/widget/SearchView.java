...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C04113 implements OnFocusChangeListener {
        C04113() {
        }
    ...
    class C04124 implements OnLayoutChangeListener {
        C04124() {
        }
    ...
    class C04135 implements OnClickListener {
        C04135() {
        }
    ...
    class C04146 implements OnKeyListener {
        C04146() {
        }
    ...
    class C04157 implements OnEditorActionListener {
        C04157() {
        }
    ...
    class C04168 implements OnItemClickListener {
        C04168() {
        }
    ...
    class C04179 implements OnItemSelectedListener {
        C04179() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C04181();
        boolean isIconified;

        static class C04181 implements ClassLoaderCreator<SavedState> {
            C04181() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0334R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attrs, int defStyle) {
            super(context, attrs, defStyle);
            this.mRunShowSoftInputIfNecessary = new C04191();
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            if (widthDp >= Settings.MAX_DYNAMIC_ACQUISITION || (widthDp >= 640 && heightDp >= SizeUtils.DEFAULT_INTERSTITIAL_HEIGHT)) {
                return 192;
            }
            return 160;
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0334R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mUpdateDrawableStateRunnable = new C04091();
        this.mReleaseCursorRunnable = new C04102();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C04135();
        this.mTextKeyListener = new C04146();
        this.mOnEditorActionListener = new C04157();
        this.mOnItemClickListener = new C04168();
        this.mOnItemSelectedListener = new C04179();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0334R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0334R.styleable.SearchView_layout, C0334R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0334R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0334R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0334R.id.search_plate);
        this.mSubmitArea = findViewById(C0334R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0334R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0334R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0334R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0334R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0334R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0334R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0334R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0334R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0334R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0334R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0334R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0334R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0334R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0334R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a.getResourceId(C0334R.styleable.SearchView_suggestionRowLayout, C0334R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0334R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C04113());
        setIconifiedByDefault(a.getBoolean(C0334R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0334R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0334R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0334R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0334R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0334R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0334R.styleable.SearchView_android_focusable, true));
        a.recycle();
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C04124());
        }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0334R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0334R.dimen.abc_search_view_preferred_height);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0334R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0334R.dimen.abc_dropdownitem_text_padding_left) : 0;
    ...
    private Intent createIntentFromSuggestion(Cursor c, int actionKey, String actionMsg) {
        try {
            ...
            if (data != null) {
                ...
                if (id != null) {
                    data = data + BridgeUtil.SPLIT_MARK + Uri.encode(id);
                }
            }
