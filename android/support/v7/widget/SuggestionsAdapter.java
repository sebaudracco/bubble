...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            this.mIconRefine = (ImageView) v.findViewById(C0334R.id.edit_query);
        }
    }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        ((ImageView) v.findViewById(C0334R.id.edit_query)).setImageResource(this.mCommitIconResId);
        return v;
    }
    ...
    private CharSequence formatUrl(CharSequence url) {
        if (this.mUrlColor == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0334R.attr.textColorSearchUrl, colorValue, true);
    ...
    private Drawable getDrawableFromResourceValue(String drawableId) {
        if (drawableId == null || drawableId.isEmpty() || SchemaSymbols.ATTVAL_FALSE_0.equals(drawableId)) {
            return null;
        }
        Drawable drawable;
        try {
            int resourceId = Integer.parseInt(drawableId);
            String drawableUri = "android.resource://" + this.mProviderContext.getPackageName() + BridgeUtil.SPLIT_MARK + resourceId;
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchable, String query, int limit) {
        ...
        Builder uriBuilder = new Builder().scheme(FirebaseAnalytics$Param.CONTENT).authority(authority).query("").fragment("");
