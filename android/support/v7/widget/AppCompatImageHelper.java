...
public class AppCompatImageHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attrs, C0334R.styleable.AppCompatImageView, defStyleAttr, 0);
        try {
            ...
            if (a.hasValue(C0334R.styleable.AppCompatImageView_tint)) {
                ImageViewCompat.setImageTintList(this.mView, a.getColorStateList(C0334R.styleable.AppCompatImageView_tint));
            }
            if (a.hasValue(C0334R.styleable.AppCompatImageView_tintMode)) {
                ImageViewCompat.setImageTintMode(this.mView, DrawableUtils.parseTintMode(a.getInt(C0334R.styleable.AppCompatImageView_tintMode, -1), null));
            }
            a.recycle();
        } catch (Throwable th) {
            a.recycle();
