...
public class PopupMenu {
    ...
    class C03961 implements Callback {
        C03961() {
        }
    ...
    class C03972 implements android.widget.PopupWindow.OnDismissListener {
        C03972() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0334R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C03961());
        ...
        this.mPopup.setOnDismissListener(new C03972());
    }
