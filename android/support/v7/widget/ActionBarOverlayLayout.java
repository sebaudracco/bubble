...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0334R.attr.actionBarSize, 16842841};
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.ACTION_BAR_ANIMATE_DELAY = Settings.MAX_DYNAMIC_ACQUISITION;
        this.mTopAnimatorListener = new C03601();
        this.mRemoveActionBarHideOffset = new C03612();
        this.mAddActionBarHideOffset = new C03623();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0334R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0334R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0334R.id.action_bar));
        }
    }
