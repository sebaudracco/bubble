...
public final class Palette {
    ...
    static final Filter DEFAULT_FILTER = new C03371();
    ...
    static class C03371 implements Filter {
        ...
        private boolean isNearRedILine(float[] hslColor) {
            return hslColor[0] >= Settings.LOCATION_REQUEST_SMALLEST_DISPLACEMENT && hslColor[0] <= 37.0f && hslColor[1] <= 0.82f;
        }
    }
