...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int inactiveLabelSize = res.getDimensionPixelSize(C0026R.dimen.design_bottom_navigation_text_size);
        int activeLabelSize = res.getDimensionPixelSize(C0026R.dimen.design_bottom_navigation_active_text_size);
        this.mDefaultMargin = res.getDimensionPixelSize(C0026R.dimen.design_bottom_navigation_margin);
        ...
        this.mIcon = (ImageView) findViewById(C0026R.id.icon);
        this.mSmallLabel = (TextView) findViewById(C0026R.id.smallLabel);
        this.mLargeLabel = (TextView) findViewById(C0026R.id.largeLabel);
    }
