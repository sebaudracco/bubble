...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    class C00321 implements OnApplyWindowInsetsListener {
        C00321() {
        }
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0026R.styleable.ScrimInsetsFrameLayout, defStyleAttr, C0026R.style.Widget_Design_ScrimInsetsFrameLayout);
        this.mInsetForeground = a.getDrawable(C0026R.styleable.ScrimInsetsFrameLayout_insetForeground);
        a.recycle();
        setWillNotDraw(true);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C00321());
    }
