...
public final class Http1Codec implements HttpCodec {
    ...
    private final class ChunkedSink implements Sink {
        ...
        public void write(Buffer source, long byteCount) throws IOException {
            if (this.closed) {
                ...
                Http1Codec.this.sink.writeUtf8(LineSeparator.Windows);
    ...
    public void writeRequest(Headers headers, String requestLine) throws IOException {
        ...
        this.sink.writeUtf8(requestLine).writeUtf8(LineSeparator.Windows);
        int size = headers.size();
        for (int i = 0; i < size; i++) {
            this.sink.writeUtf8(headers.name(i)).writeUtf8(": ").writeUtf8(headers.value(i)).writeUtf8(LineSeparator.Windows);
        }
        this.sink.writeUtf8(LineSeparator.Windows);
        this.state = 1;
    }
