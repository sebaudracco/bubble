...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final Runnable cleanupRunnable = new C47521();
    boolean closed;
    ...
    class C47521 implements Runnable {
        C47521() {
        }
    ...
    class C47543 implements Iterator<Snapshot> {
