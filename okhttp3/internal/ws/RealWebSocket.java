...
public final class RealWebSocket implements WebSocket, FrameCallback {
    ...
    class C47721 implements Runnable {
        C47721() {
        }
    ...
    public RealWebSocket(Request request, WebSocketListener listener, Random random) {
        if ("GET".equals(request.method())) {
            ...
            this.writerRunnable = new C47721();
            return;
        }
    ...
    public void connect(OkHttpClient client) {
        ...
        final Request request = this.originalRequest.newBuilder().header(HttpHeaders.UPGRADE, "websocket").header("Connection", HttpHeaders.UPGRADE).header("Sec-WebSocket-Key", this.key).header("Sec-WebSocket-Version", "13").build();
